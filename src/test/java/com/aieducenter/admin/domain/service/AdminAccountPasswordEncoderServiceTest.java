...
/**
 * AdminPasswordEncoderService 领域服务测试。
 */
@ExtendWith(MockitoExtension.class)
class AdminAccountPasswordEncoderServiceTest {

    @Mock
    private PasswordEncoder encoderPort;

    private AdminPasswordEncoderService adminPasswordEncoderService;

    @BeforeEach
    void setUp() {
        adminPasswordEncoderService = new AdminPasswordEncoderService(encoderPort);
    }
    ...
    void given_plainPassword_when_encodePassword_then_delegateToPort() {
        ...
        // When
        String actualEncoded = adminPasswordEncoderService.encodePassword(plainPassword);
    ...
    void given_correctPassword_when_verifyPassword_then_returnTrue() {
        ...
        // When
        boolean result = adminPasswordEncoderService.verifyPassword(plainPassword, encodedPassword);
    ...
    void given_nullPassword_when_encodePassword_then_delegateToPort() {
        ...
        // When
        String actualEncoded = adminPasswordEncoderService.encodePassword(nullPassword);
    ...
    void given_emptyPassword_when_verifyPassword_then_delegateToPort() {
        ...
        // When
        boolean result = adminPasswordEncoderService.verifyPassword(emptyPassword, encodedPassword);
