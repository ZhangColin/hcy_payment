...
import com.icbc.api.request.EcddRegistrationApplicationFormRequestV1;
import com.icbc.api.request.EcddRegistrationApplicationFormRequestV1.EcddRegistrationApplicationFormRequestV1Biz;
import com.icbc.api.request.EcddRegistrationApplicationFormRequestV1.PrivateEntity;
...
public class EcddRegistrationApplicationFormResponseV1Test {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String URL = "http://[需替换]地址/ecdd/registrationApplicationForm/V1";

            DefaultIcbcClient client = new DefaultIcbcClient(APP_ID, PRI_KEY,
                    APIGW_PUBLIC_KEY);

            EcddRegistrationApplicationFormRequestV1Biz bizContent = new EcddRegistrationApplicationFormRequestV1Biz();
            ...
            EcddRegistrationApplicationFormRequestV1 request = new EcddRegistrationApplicationFormRequestV1();
