...
import com.icbc.api.request.JftUiPayAuthRequestV1;
import com.icbc.api.request.JftUiPayAuthRequestV1.JftUiPayAuthRequestV1Biz;

public class JftUiPayAuthTestV1 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			JftUiPayAuthRequestV1 request = new JftUiPayAuthRequestV1();
			
			request.setServiceUrl("http://ip:prot/ui/jft/ui/pay/auth/V1");
			
			JftUiPayAuthRequestV1Biz bizContent = new JftUiPayAuthRequestV1Biz();
			bizContent.setOutUserId("12345116789000");
			bizContent.setOutVendorId("456652201223");
			bizContent.setSiteType("2");
