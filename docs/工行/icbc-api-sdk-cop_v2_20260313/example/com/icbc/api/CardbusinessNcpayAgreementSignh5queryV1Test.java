...
import com.icbc.api.request.CardbusinessNcpayAgreementSignh5queryRequestV1;
import com.icbc.api.request.CardbusinessNcpayAgreementSignh5queryRequestV1.CardbusinessNcpayAgreementSignh5queryRequestV1Biz;
import com.icbc.api.response.CardbusinessNcpayAgreementSignh5queryResponseV1;

/**
 * 请商户配置SDK中的lib文件夹中的jar包后，根据备注1-6提示进行数据替换
 */
public class CardbusinessNcpayAgreementSignh5queryV1Test {
	...
	public static void main(String[] args) throws Exception {
		...
		CardbusinessNcpayAgreementSignh5queryRequestV1 request = new CardbusinessNcpayAgreementSignh5queryRequestV1();
		
		//4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("http://****/api/cardbusiness/ncpay/agreement/signh5query/V1");
		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		CardbusinessNcpayAgreementSignh5queryRequestV1Biz bizContent = new CardbusinessNcpayAgreementSignh5queryRequestV1Biz();
		...
		CardbusinessNcpayAgreementSignh5queryResponseV1 response;
		try {
