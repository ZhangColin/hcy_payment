...
import com.icbc.api.request.MybankLoanInclufinPersloanPcrscheckRequestV1;
import com.icbc.api.request.MybankLoanInclufinPersloanPcrscheckRequestV1.MybankLoanInclufinPersloanPcrscheckRequestV1Biz;
import com.icbc.api.response.MybankLoanInclufinPersloanPcrscheckResponseV1;

public class MybankLoanInclufinPersloanPcrscheckTestV1{
	...
	protected static final String URL = "http://xxxxxxx/api/mybank/loan/inclufin/persloan/pcrscheck/V1";
	
	public static void main(String[] args){
		MybankLoanInclufinPersloanPcrscheckRequestV1 request = new MybankLoanInclufinPersloanPcrscheckRequestV1();
		MybankLoanInclufinPersloanPcrscheckResponseV1 response=new MybankLoanInclufinPersloanPcrscheckResponseV1();
		MybankLoanInclufinPersloanPcrscheckRequestV1Biz bizContent = new MybankLoanInclufinPersloanPcrscheckRequestV1Biz();
		//公共参数
