 ...
 */
public class MybankFarmPrcSyncProjectTest {
	...
	public static void main(String[] args) throws Exception {
		String URI = "mybank/account/farm/syncProject/V1";
				
		DefaultIcbcClient client = new DefaultIcbcClient(APP_ID,"RSA2", PRI_KEY, APIGW_PUBLIC_KEY);
		try {
			MybankFarmPrcSyncProjectRequestV1 request = new MybankFarmPrcSyncProjectRequestV1();
			MybankFarmPrcSyncProjectRequestV1.MybankFarmPrcSyncProjectRequestBizV1 requestBizV1 = new MybankFarmPrcSyncProjectRequestV1.MybankFarmPrcSyncProjectRequestBizV1();
			...
			requestBizV1.setDetail("{\"projectId\":\"028\",\"projectName\":\"测试222\",\"propertyId\":\"2024030200010403\"," +
            "\"startDate\":\"20210805\",\"endDate\":\"20210805\",\"projectAmt\":\"100\"" +
            ",\"sellerName\":\"王e\",\"sellerId\":\"1111ee\",\"sellerTel\":\"18000000004\"," +
            "\"acctNo\":\"0200099819277917939\",\"acctName\":\"财智账户卡下挂账号\"," +
            "\"acctType\":\"1\"" +
            ",\"acctStatus\":\"1\",\"acctNankCode\":\"123123\",\"acctNankName\":\"工商银行\",\"marketNo\":\"0723672\"" +
            ",\"receiverMemberNo\":\"000000000802105\",\"timedValue\":\"T+0\"}");
			...
			MybankFarmPrcSyncProjectResponseV1 response = client.execute(request);
