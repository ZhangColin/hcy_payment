...
import com.icbc.api.request.JftPayrollUiWagingpayRequestV1;
import java.util.logging.Logger;
public class JftPayrollUiWagingpayTestV1 {
    public static void main(String[] args) throws IcbcApiException {
      ...
      Logger log = Logger.getLogger(JftPayrollUiWagingpayTestV1.class.getName());
      JftPayrollUiWagingpayRequestV1 requestV1=new JftPayrollUiWagingpayRequestV1();
        requestV1.setServiceUrl("http://ip:port/ui/jft/payroll/wagingpay/V1");

        JftPayrollUiWagingpayRequestV1.JftPayrollUiWagingpayRequestV1Biz bizContent=new  JftPayrollUiWagingpayRequestV1.JftPayrollUiWagingpayRequestV1Biz();
