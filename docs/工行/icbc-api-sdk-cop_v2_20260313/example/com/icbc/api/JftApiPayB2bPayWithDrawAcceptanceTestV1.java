package com.icbc.ndf.jft.b2bpay.service.impl;
...
import com.icbc.api.request.JftApiPayB2bPayWithDrawAcceptanceRequestV1;
...
public class JftApiPayB2bPayWithDrawAcceptanceTestV1 {
    ...
    protected static final String icbcPulicKey = "-----请使用正确的网关公钥-----D4kzEVPdOj03ctKM7KV+16bWZ5BMNgvEeuEQwfQYkRVwI9HFOGkwNTMn5hiJXHnlXYCX+zp5r6R52MY0O7BsTCLT7aHaxsANsvI9ABGx3OaTVlPB59M6GPbJh0uXvio0m1r/lTW3Z60RU6Q3oid/rNhP3CiNgg0W6O3AGqwIDAQAB";

    protected static final String APP_ID = "10000000000000205515";

    protected static String AES_Key = "5xGJdh7qb+B95SUoxDlatg==";
    ...
    public static void main(String[] args) {
        ...
        JftApiPayB2bPayWithDrawAcceptanceRequestV1 request = new JftApiPayB2bPayWithDrawAcceptanceRequestV1();
        request.setServiceUrl("http://ip:port/api/jft/api/b2bpay/withdraw/acceptance/V1");
        JftApiPayB2bPayWithDrawAcceptanceRequestV1Biz bizContent = new JftApiPayB2bPayWithDrawAcceptanceRequestV1Biz();

        //外部订单号列表

        List<JftApiPayB2bPayWithDrawAcceptanceRequestV1Biz.OrderIds> orderList = new ArrayList<>();
        JftApiPayB2bPayWithDrawAcceptanceRequestV1Biz.OrderIds orderIds = new JftApiPayB2bPayWithDrawAcceptanceRequestV1Biz.OrderIds();
        orderIds.setOriOutOrderId("20190301111111112010101");
        orderIds.setTradeTime("2020-07-30 10:10:10");
        orderIds.setOriPayMethod("01");
        orderList.add(orderIds);

        bizContent.setAppId("10000000000000205515");//平台商户标识
        bizContent.setOutVendorId("04221125");//子商户标识
        bizContent.setOutUserId("123");//流水号
        bizContent.setOutWithdrawId("1231"); //提现流水号（必输）
        bizContent.setWithdrawAmount("50.00");
        bizContent.setWithDrawTime("2020-07-30 10:10:10");
        bizContent.setWithdrawType("00");
        bizContent.setOriOrderIdList(orderList);
 
        bizContent.setNotifyUrl("www.zhihu.com");

        request.setBizContent(bizContent);

        JftApiPayB2bPayWithDrawAcceptanceResponseV1 response;
        try {
