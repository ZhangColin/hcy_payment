...
import com.icbc.api.request.MybankEnterpriseGyjrQryguaranteeletterinfoRequestV1;
import com.icbc.api.request.MybankEnterpriseGyjrQryguaranteeletterinfoRequestV1.MybankEnterpriseGyjrQryguaranteeletterinfoRequestBizV1;
import com.icbc.api.request.MybankEnterpriseGyjrQryguaranteeletterinfoRequestV1.TransCommV10;

public class MybankEnterpriseGyjrQryguaranteeletterinfoTest {
    ...
    public static void main(String[] args) throws Exception {
        String serviceUri = BASE_URL + "mybank/enterprise/gyjr/qrycontractinfo/V1";
        IcbcClient client = new DefaultIcbcClient(APP_ID, MY_PRIVATE_KEY, APIGW_PUBLIC_KEY);
        MybankEnterpriseGyjrQryguaranteeletterinfoRequestBizV1 bizContent =
                new MybankEnterpriseGyjrQryguaranteeletterinfoRequestBizV1();
        MybankEnterpriseGyjrQryguaranteeletterinfoRequestV1 request =
                new MybankEnterpriseGyjrQryguaranteeletterinfoRequestV1();
        ...
        if (null == validate) {
            com.icbc.api.response.MybankEnterpriseGyjrQryguaranteeletterinfoResponseV1 response = client.execute(request);
