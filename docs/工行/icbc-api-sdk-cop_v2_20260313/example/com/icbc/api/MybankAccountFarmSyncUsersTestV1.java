...
import com.icbc.api.request.MybankAccountFarmSyncUsersRequestV1;
import com.icbc.api.response.MybankAccountFarmSyncUsersResponseV1;

public class MybankAccountFarmSyncUsersTestV1 {
protected static String APP_ID = "10000000000004096993";
	...
	public static void main(String[] args) throws Exception {
		String URI = "mybank/account/farm/syncUsers/V1";

		
		DefaultIcbcClient client = new DefaultIcbcClient(APP_ID,"RSA2", PRI_KEY, APIGW_PUBLIC_KEY);
		try {
			MybankAccountFarmSyncUsersRequestV1 request = new MybankAccountFarmSyncUsersRequestV1();
			MybankAccountFarmSyncUsersRequestV1.MybankAccountFarmSyncUsersBizV1 requestBizV1 = new MybankAccountFarmSyncUsersRequestV1.MybankAccountFarmSyncUsersBizV1();

			requestBizV1.setfSeqNo("124325");
			requestBizV1.setTransDate("20220202");
			requestBizV1.setCorpCode("icbc");
			requestBizV1.setParamType("1");
			requestBizV1.setDetail("{\"users : [{\"userId":"8878992282322","instId":"11","sysType":"3","mobilePhone":"13013001300"},{"userId":"8878992282322","instId":"11","sysType":"3","mobilePhone":"13013001300"}]}");
	        ...
	        MybankAccountFarmSyncUsersResponseV1 response = client.execute(request);
