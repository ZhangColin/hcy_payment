...
import com.icbc.api.request.CertVoiceprintVoiceprintupdateRequestV1;
import com.icbc.api.request.CertVoiceprintVoiceprintupdateRequestV1.CertVoiceprintVoiceprintupdateRequestV1Biz;
import com.icbc.api.response.CertVoiceprintVoiceprintupdateResponseV1;

public class CertVoiceprintVoiceprintupdateTest {
	//	调用方自己的AppId
	private static final String APP_ID = new String("10000000s000004097a529");
	//	调用方私钥
...
//		签名类型为SHA256WithRSA时，传入appid，私钥和网关公钥，签名类型使用定值IcbcConstants.SIGN_TYPE_RSA2，其他参数使用缺省
		...
		CertVoiceprintVoiceprintupdateRequestV1 request = new CertVoiceprintVoiceprintupdateRequestV1();
		
//		测试环境替换ip和端口，生成环境已有默认值，此语句可删除
		request.setServiceUrl(API_SERVICE_URL + "/cert/voiceprint/voiceprintupdate/V1");
		Logger log = Logger.getLogger(CertVoiceprintVoiceprintaddTest.class.getName());
//		请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		CertVoiceprintVoiceprintupdateRequestV1Biz bizContent =  new CertVoiceprintVoiceprintupdateRequestV1Biz();
		bizContent.setChannel("EPASS2");
		bizContent.setAppName("F-EPASS");
		bizContent.setAppVersion("1.0");
		bizContent.setAppInfo("T-EPASS");
		bizContent.setTrCode("BAS0asgjdf23");
		bizContent.setTrxZone("1001");
		bizContent.setProgramName("testVoice");
		bizContent.setUserId("00098asdf2138090");
		bizContent.setCustomerAgreement("1");
		bizContent.setHack1("0");
		...
		CertVoiceprintVoiceprintupdateResponseV1 response;
		try {
