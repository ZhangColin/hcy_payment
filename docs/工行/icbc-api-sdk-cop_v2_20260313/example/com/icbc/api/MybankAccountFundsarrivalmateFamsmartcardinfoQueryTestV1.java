...
import com.icbc.api.request.MybankAccountFundsarrivalmateFamsmartcardinfoQueryRequestV1;
import com.icbc.api.response.MybankAccountFundsarrivalmateFamsmartcardinfoQueryResponseV1;

public interface MybankAccountFundsarrivalmateFamsmartcardinfoQueryTestV1 {
    ...
    public static void main(String[] args) {
        ...
        MybankAccountFundsarrivalmateFamsmartcardinfoQueryRequestV1 request = new MybankAccountFundsarrivalmateFamsmartcardinfoQueryRequestV1();
        request.setServiceUrl("http://ip:port/api/mybank/account/fundsarrivalmate/famsmartcardinfoqry/V1");

        MybankAccountFundsarrivalmateFamsmartcardinfoQueryRequestV1.FamSmartCardInfoQueryRequestV1Biz bizContent = new MybankAccountFundsarrivalmateFamsmartcardinfoQueryRequestV1.FamSmartCardInfoQueryRequestV1Biz();
        bizContent.setAgreeno("1");
        bizContent.setAccno("1");
//        bizContent.setSmartcardno("9558820120211180003");
//        bizContent.setType("1");
        bizContent.setUseflag("1");
        bizContent.setPage("1");
        bizContent.setPagesize("10");
        bizContent.setSellerid("1103");

        request.setBizContent(bizContent);
        MybankAccountFundsarrivalmateFamsmartcardinfoQueryResponseV1 response;
        try {
