...
import com.icbc.api.request.JftLoanApiWhiteUploadRequestV1;
import com.icbc.api.response.JftLoanApiWhiteUploadResponseV1;
import org.junit.Test;

import java.util.ArrayList;

public class JftLoanApiWhiteUploadTest {
    ...
    public void test_cop() {
        ...
        JftLoanApiWhiteUploadRequestV1 request = new JftLoanApiWhiteUploadRequestV1();
        request.setServiceUrl("https://ip:port/api/jft/api/loan/whiteUpload/V1");
        JftLoanApiWhiteUploadRequestV1.JftLoanApiWhiteUploadRequestV1Biz bizContent = new JftLoanApiWhiteUploadRequestV1.JftLoanApiWhiteUploadRequestV1Biz();
        bizContent.setAppId("10000000000000286524");
        bizContent.setParam_list(new ArrayList<>());
        request.setBizContent(bizContent);
        JftLoanApiWhiteUploadResponseV1 response;
        try {
            response = (JftLoanApiWhiteUploadResponseV1) client.execute(request, System.currentTimeMillis()+"");
