...
import com.icbc.api.response.CardbusinessAggregatepayB2cOnlineDepositResponseV1;
import com.icbc.api.request.CardbusinessAggregatepayB2cOnlineDepositRequestV1;
import com.icbc.api.request.CardbusinessAggregatepayB2cOnlineDepositRequestV1.CardbusinessAggregatepayB2cOnlineDepositRequestV1Biz;

public class CardbusinessAggregatepayB2cOnlineDepositV1Test {
	...
	private Logger logger = Logger.getLogger(CardbusinessAggregatepayB2cOnlineDepositV1Test.class.getName());


	public void test_cop() throws IcbcApiException {
		CardbusinessAggregatepayB2cOnlineDepositRequestV1 request = new CardbusinessAggregatepayB2cOnlineDepositRequestV1();
		// 4、需传入appid，私钥，字符集
		UiIcbcClient client;
		...
		request.setServiceUrl("https://ip:port/api/cardbusiness/aggregatepay/b2c/online/deposit/V1");
		CardbusinessAggregatepayB2cOnlineDepositRequestV1Biz bizContent = new CardbusinessAggregatepayB2cOnlineDepositRequestV1Biz();
		request.setBizContent(bizContent);
		// 6、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		bizContent.setMer_id("xxx");
		bizContent.setOut_trade_no("xxx");
		bizContent.setPay_mode("xxx");
		bizContent.setAccess_type("xxx");
		bizContent.setMer_prtcl_no("xxx");
		bizContent.setOrig_date_time("xxx");
		bizContent.setDecive_info("xxx");
		bizContent.setBody("xxx");
		bizContent.setFee_type("xxx");
		bizContent.setSpbill_create_ip("xxx");
		...
		CardbusinessAggregatepayB2cOnlineDepositResponseV1 response;
		try {
