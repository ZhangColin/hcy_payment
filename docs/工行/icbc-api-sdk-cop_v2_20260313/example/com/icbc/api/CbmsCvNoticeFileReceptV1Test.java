...
import com.icbc.api.request.CbmsCvNoticeFileReceptRequestV1;
import com.icbc.api.request.CbmsCvNoticeFileReceptRequestV1.CbmsCvNoticeFileReceptRequestV1Biz;
import com.icbc.api.response.CbmsCvNoticeFileReceptResponseV1;

public class CbmsCvNoticeFileReceptV1Test {
	// 1、网关公钥
	...
	public static void main(String[] args) throws Exception {
		...
		CbmsSaInfoReceptRequestV1 request = new CbmsSaInfoReceptRequestV1();

		// 4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("http://ip:port/api/saes/servmer/ordersubmit/V1");
		// 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		CbmsSaInfoReceptRequestV1Biz bizContent = new CbmsSaInfoReceptRequestV1Biz();
		bizContent.setNoticeId("0000000001");
		bizContent.setSaTrxId("0000000001");
		bizContent.setNoticeName("xx临时存款账户开户通知");
		bizContent.setNoticeRecTime("2021-09-13 11:07:00");
		bizContent.setNoticeValidEndTime("2031-09-13 11:07:00");
		bizContent.setNoticeType(1);
		bizContent.setNoticeBusType(0);
		bizContent.setNoticeFile("asdasd");

		request.setBizContent(bizContent);

		CbmsSaInfoReceptResponseV1 response;
		try {
