...
import com.icbc.api.request.EnterpriseSalarySubmitRequestV1;
import com.icbc.api.request.EnterpriseSalarySubmitRequestV1.EnterpriseSalarySubmitRequestV1Biz;
import com.icbc.api.response.EnterpriseSalarySubmitResponseV1;
import java.util.logging.Logger;
public class EnterpriseSalarySubmitTest {
...
//, MY_PUB_KEY, password
		// ?��?????��???��request
		EnterpriseSalarySubmitRequestV1 request = new EnterpriseSalarySubmitRequestV1();

		// ?��?????��????
		request.setServiceUrl("//ip:port/ui/enterprise/salary/submit/V1");

		EnterpriseSalarySubmitRequestV1Biz bizContent = new EnterpriseSalarySubmitRequestV1Biz();

		bizContent.setApiName( "SalarySubmit") ;
		bizContent.setApiVersion("XXX.XXX.XXX.XXX");//�̶�¼��001.001.001.001
		bizContent.setAppName ("????��???????");
		bizContent.setLanguage("ZH_CN");

		request.setBizContent(bizContent);
		EnterpriseSalarySubmitResponseV1 response;

		Random rand = new Random();
		String msgId = rand.nextInt(99999) + "msg";
		Logger log = Logger.getLogger(EnterpriseSalarySubmitTest.class.getName());
		try {
