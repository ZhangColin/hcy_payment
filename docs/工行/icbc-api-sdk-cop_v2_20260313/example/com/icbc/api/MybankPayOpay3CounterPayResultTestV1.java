...
import com.icbc.api.request.MybankPayOpay3CounterPayResultRequestV1.MybankPayOpay3CounterPayResultRequestV1Biz;
import com.icbc.api.request.MybankPayTppcustomerPayResultQryRequestV1;
import com.icbc.api.response.MybankPayTppcustomerPayResultQryResponseV1;

public class MybankPayOpay3CounterPayResultTestV1 {

	// 调用方自己的AppId
	private static final String APP_ID = new String("100000000xxxx5545"); //20年1月
	// 调用方私钥
	...
	public static void main(String[] args) {
		...
		MybankPayTppcustomerPayResultQryRequestV1 request = new MybankPayTppcustomerPayResultQryRequestV1();
		
		//访问工行API平台URL
		request.setServiceUrl(API_SERVICE_URL + "/mybank/pay/opay3/counterpayresult/V1");

		MybankPayOpay3CounterPayResultRequestV1Biz bizContent = new MybankPayOpay3CounterPayResultRequestV1Biz();

		//APPID
		bizContent.setMerID("0119xxx0461");
		bizContent.setAreaCode("01x9");
		bizContent.setOrderId("006xxx2718001255");
		request.setBizContent(bizContent);

		MybankPayTppcustomerPayResultQryResponseV1 response;
