...
import com.icbc.api.request.EnterpriseBranchReduceGroupinfoRequestV1;
import com.icbc.api.request.EnterpriseBranchReduceGroupinfoRequestV1.EnterpriseBranchReduceGroupinfoRequestV1Biz;
import com.icbc.api.request.EnterpriseBranchReduceGroupinfoRequestV1.EnterpriseBranchReduceGroupinfoRequestV1Biz.AlterInfo;
import com.icbc.api.request.EnterpriseBranchReduceGroupinfoRequestV1.EnterpriseBranchReduceGroupinfoRequestV1Biz.ChanCommV10;
import com.icbc.api.response.EnterpriseBranchReduceGroupinfoResponseV1;

public class EnterpriseBranchReduceGroupinfoTest {
	...
	public static void main(String[] args) {
		...
		EnterpriseBranchReduceGroupinfoRequestV1 request = new EnterpriseBranchReduceGroupinfoRequestV1();
		//地址(如果是内部API，地址需要使用http而不是https)
		request.setServiceUrl("https://ip:port/api/enterprise/branch/reduce/groupinfo/V1");
		EnterpriseBranchReduceGroupinfoRequestV1Biz bizContent = new EnterpriseBranchReduceGroupinfoRequestV1Biz();
		bizContent.setGroupId("1111111");
		AlterInfo alterInfo = bizContent.new AlterInfo();
		alterInfo.setBzSwitch("0");
		bizContent.setAlterInfo(alterInfo);
		ChanCommV10 chanCommV10 = bizContent.new ChanCommV10();
		chanCommV10.setSerialno("111111111");
		bizContent.setChanCommV10(chanCommV10);

		request.setBizContent(bizContent);
		EnterpriseBranchReduceGroupinfoResponseV1 response;

		Random rand = new Random();
		String msgId = rand.nextInt(99999) + "msg";

		try {
			Logger log = Logger.getLogger(EnterpriseBranchReduceGroupinfoTest.class.getName());
