...
import com.icbc.api.request.MybankDepositQrcodePayQueryRequestV1;
import com.icbc.api.request.MybankDepositQrcodePayQueryRequestV1.MybankDepositQrcodePayQueryRequestV1Biz;
import com.icbc.api.response.MybankDepositQrcodePayQueryResponseV1;
 ...
 */
public class MybankDepositQrcodePayQueryV1Test {
	...
	public static void main(String[] args) throws Exception {
		...
		MybankDepositQrcodePayQueryRequestV1 request = new MybankDepositQrcodePayQueryRequestV1();
		
		//4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("http://****/api/mybank/deposit/qrcode/scanned/query/V1");
		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		MybankDepositQrcodePayQueryRequestV1Biz bizContent = new MybankDepositQrcodePayQueryRequestV1Biz();
		...
		MybankDepositQrcodePayQueryResponseV1 response;
		try {
