...
import com.icbc.api.request.CardbusinessAggregatepayB2cOnlineSendMsgRequestV1;
import com.icbc.api.response.CardbusinessAggregatepayB2cOnlineSendMsgResponseV1;
import com.icbc.api.request.CardbusinessAggregatepayB2cOnlineSendMsgRequestV1.CardbusinessAggregatepayB2cOnlineSendMsgV1Biz;
import org.junit.Test;

import java.util.logging.Logger;
import static org.junit.Assert.assertTrue;

public class CardbusinessAggregatepayB2cOnlineSendMsgV1Test {
	...
	private Logger logger = Logger.getLogger(CardbusinessAggregatepayB2cOnlineSendMsgV1Test.class.getName());


	public void test_cop() throws IcbcApiException {
		CardbusinessAggregatepayB2cOnlineSendMsgRequestV1 request = new CardbusinessAggregatepayB2cOnlineSendMsgRequestV1();
		// 4、需传入appid，私钥，字符集
		UiIcbcClient client;
		...
		request.setServiceUrl("https://ip:port/api/cardbusiness/aggregatepay/b2c/online/sendmsg/V1");
		CardbusinessAggregatepayB2cOnlineSendMsgV1Biz bizContent = new CardbusinessAggregatepayB2cOnlineSendMsgV1Biz();
		...
		bizContent.setValid_month("xxx");
		bizContent.setBill_time("xxx");
		bizContent.setBill_num("xxx");
		bizContent.setMobile_phone("xxx");
		bizContent.setBill_type("xxx");
		bizContent.setCustomer_nm("xxx");
		bizContent.setCertiftp("xxx");
		bizContent.setCertifid("xxx");
		bizContent.setTrxcardtype("xxx");
		bizContent.setExpired("xxx");
		bizContent.setCvn2("xxx");
		bizContent.setNotifyurl("xxx");

		CardbusinessAggregatepayB2cOnlineSendMsgResponseV1 response;
		try {
