...
import com.icbc.api.request.CacaReceiptCommonreceiptQueryfreceiptRequestV1;
import com.icbc.api.response.CacaReceiptCommonreceiptQueryfreceiptResponseV1;

public class CacaReceiptCommonreceiptQueryfreceiptTestV1 {
    ...
    public static void main(String[] args) {
        ...
        CacaReceiptCommonreceiptQueryfreceiptRequestV1 request = new CacaReceiptCommonreceiptQueryfreceiptRequestV1();
        request.setServiceUrl("https://ip:port/api/caca/receipt/commonreceipt/queryfreceipt/V1");
        CacaReceiptCommonreceiptQueryfreceiptRequestV1.QueryFReceiptBySSTSRequestV1Biz bizContent = new CacaReceiptCommonreceiptQueryfreceiptRequestV1.QueryFReceiptBySSTSRequestV1Biz();
        // public 通讯区定义赋值
        CacaReceiptCommonreceiptQueryfreceiptRequestV1.QueryFReceiptBySSTSRequestV1Pub pubObj = new CacaReceiptCommonreceiptQueryfreceiptRequestV1.QueryFReceiptBySSTSRequestV1Pub();
        pubObj.setCode("29009");
        pubObj.setZone("0200");
        pubObj.setFr("0");
        pubObj.setDt("2017-07-06");
        // private 通讯区定义赋值
        CacaReceiptCommonreceiptQueryfreceiptRequestV1.QueryFReceiptBySSTSRequestV1In inObj = new CacaReceiptCommonreceiptQueryfreceiptRequestV1.QueryFReceiptBySSTSRequestV1In();
        ...
        try {
            CacaReceiptCommonreceiptQueryfreceiptResponseV1 response = client.execute(request);
