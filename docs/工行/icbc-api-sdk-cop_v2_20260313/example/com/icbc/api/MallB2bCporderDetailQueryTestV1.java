...
import com.icbc.api.request.MallB2bCporderDetailQueryRequestV1;
import com.icbc.api.request.MallB2bCporderDetailQueryRequestV1.MallB2bCporderDetailQueryRequestV1Biz;
import com.icbc.api.response.MallB2bCporderDetailQueryResponseV1;

public class MallB2bCporderDetailQueryTestV1 {
	...
	DefaultIcbcClient client = new DefaultIcbcClient(APP_ID,"RSA", MY_PRIVATE_KEY,"UTF-8", 
		...
		MallB2bCporderDetailQueryRequestV1 request = new MallB2bCporderDetailQueryRequestV1();

		request.setServiceUrl("http://ip:port/api/mall/b2b/cporder/detail/query/V1");
		MallB2bCporderDetailQueryRequestV1Biz biz = new MallB2bCporderDetailQueryRequestV1Biz();
		biz.setOrderId("202002210000005870");
		biz.setVendorId("10001309");
		request.setBizContent(biz);

		MallB2bCporderDetailQueryResponseV1 response;
		try {
			response = (MallB2bCporderDetailQueryResponseV1) client.execute(request, System.currentTimeMillis()+"");
