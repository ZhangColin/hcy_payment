...
import com.icbc.api.request.JftApiVendorPicDownloadRequestV1.JftApiVendorPicDownloadRequestV1Biz;
 ...
 */
public class JftApiVendorPicDownloadTest {
	...
	public static void main(String[] args) throws Exception {
		...
		request.setServiceUrl("https://ip:port/api/jft/api/vendor/pic/download/V1");
			
		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		JftApiVendorPicDownloadRequestV1Biz bizContent = new JftApiVendorPicDownloadRequestV1Biz();
		String imageKey = "f31425fb56a24bafab6ca245bedcad27";
		bizContent.setImageKey(imageKey);
		bizContent.setAppId(APP_ID);
		bizContent.setOutVendorId("90000000");
