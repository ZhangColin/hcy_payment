...
public class CardbusinessNcpayNcpreauthTestV1 {
    public static void main(String[] args) throws IcbcApiException {
        ...
        request.setServiceUrl("http://ip:port/api/cardbusiness/ncpay/ncpreauth/V1");//功能
        //request.setServiceUrl("http://gw.dccnet.com.cn:8088/api/cardbusiness/ncpay/ncpreauth/V1");//功能外网
        ...
        bizContent.setTrxSerno("08211401440000057");
        ...
        bizContent.setSiteName("测试站点");
        bizContent.setVerifyCode("");
        bizContent.setTrxAmt("100");
        bizContent.setSignMedtype("3");
        bizContent.setPlateNum("桂J55555");
        bizContent.setPlateColor("0");
        bizContent.setTankerNo("8");
        bizContent.setNozzleNo("1");
        bizContent.setOperatorId("007");
        bizContent.setExtendInfo("test-pre-auth");
        ...
        CardbusinessNcpayNcpreauthResponseV1 response = client.execute(request, msgId);
