...
import com.icbc.api.request.CustacqOrderInstallpayRequestV2;
import com.icbc.api.request.CustacqOrderInstallpayRequestV2.CustacqOrderInstallpayRequestV2Biz;
 ...
 */
public class CustacqOrderInstallpayTestV2 {
	...
	public void order(HttpServletRequest request1, HttpServletResponse response) throws Exception {
		...
		CustacqOrderInstallpayRequestV2 request = new CustacqOrderInstallpayRequestV2();
		
		//4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("https://ip:port/ui/custacq/order/installpay/V2");
		
		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		CustacqOrderInstallpayRequestV2Biz bizContent = new CustacqOrderInstallpayRequestV2Biz();
