...
import com.icbc.api.request.MybankAccountFarmQryOpenStatusRequestV1;
import com.icbc.api.response.MybankAccountFarmQryOpenStatusResponseV1;

public class MybankAccountFarmQryOpenStatusTestV1 {
protected static String APP_ID = "10000000000004096993";
	...
	public static void main(String[] args) throws Exception {
		String URI = "mybank/account/farm/qryOpenStatus/V1";

		
		DefaultIcbcClient client = new DefaultIcbcClient(APP_ID,"RSA2", PRI_KEY, APIGW_PUBLIC_KEY);
		try {
			MybankAccountFarmQryOpenStatusRequestV1 request = new MybankAccountFarmQryOpenStatusRequestV1();
			MybankAccountFarmQryOpenStatusRequestV1.MybankAccountFarmQryOpenStatusBizV1 requestBizV1 = new MybankAccountFarmQryOpenStatusRequestV1.MybankAccountFarmQryOpenStatusBizV1();

			requestBizV1.setfSeqNo("124325");
			requestBizV1.setTransDate("20220202");
			requestBizV1.setCorpCode("icbc");
			requestBizV1.setParamType("1");
			requestBizV1.setDetail("{\"acctNo\":\"8878992282322\"}");
	        ...
	        MybankAccountFarmQryOpenStatusResponseV1 response = client.execute(request);
