...
import com.icbc.api.request.MybankLoanHousefundsupHfsagreequeryRequestV1;
import com.icbc.api.request.MybankLoanHousefundsupHfsagreequeryRequestV1.MybankLoanHousefundsupHfsagreequeryRequestV1Biz;
import com.icbc.api.response.MybankLoanHousefundsupHfsagreequeryResponseV1;

public class MybankLoanHousefundsupHfsagreequeryV1Test {
    static Logger log = Logger.getLogger(MybankLoanHousefundsupHfsagreequeryV1Test.class.getName());
    //估值表
    ...
    public static void main(String[] args) throws Exception {
       ...
       // DefaultIcbcClient client = new DefaultIcbcClient(APP_ID, "RSA2",PRI_KEY, APIGW_PUBLIC_KEY);
        ...
        try {
            ...
            // 请求实体
        	MybankLoanHousefundsupHfsagreequeryRequestV1 request = new  MybankLoanHousefundsupHfsagreequeryRequestV1();
            // bizContent实体
        	MybankLoanHousefundsupHfsagreequeryRequestV1Biz bizContent  = new  MybankLoanHousefundsupHfsagreequeryRequestV1Biz();

    		bizContent.setSerialNo("xxxxxxxxxxxxxx");
        	bizContent.setAppNo("AppNo");  
        	bizContent.setVer("1.0");
        	bizContent.setLanguage("zh_CN");
        	bizContent.setAreaCode("002000072");
        	bizContent.setEmployeeCode("888800135");
        	bizContent.setTransNo("123456789");
            ...
            String url = "http"+"://8"+"3.33"+".222."+"62:80"+"81/api/mybank/loa"+"n/housefundsup/hfsagreequery/V1"; 
            
            request.setServiceUrl(url);
            request.setBizContent(bizContent);
            MybankLoanHousefundsupHfsagreequeryResponseV1 response = client.execute(request);
