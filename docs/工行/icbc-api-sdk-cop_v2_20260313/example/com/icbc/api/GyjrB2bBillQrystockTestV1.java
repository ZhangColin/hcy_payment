...
import com.icbc.api.request.GyjrB2bBillQrystockRequestV1;
import com.icbc.api.response.GyjrB2bBillQrystockResponseV1;

import java.util.Random;

public class GyjrB2bBillQrystockTestV1 {
    //签名私钥
    ...
    public static void main(String[] args) {
        ...
        GyjrB2bBillQrystockRequestV1 request = new GyjrB2bBillQrystockRequestV1();
        request.setServiceUrl("http://IP:PORT/api/gyjr/b2b/bill/querystockbill/V1");
        GyjrB2bBillQrystockRequestV1.BizContentV1Biz bizContent = new GyjrB2bBillQrystockRequestV1.BizContentV1Biz();
        GyjrB2bBillQrystockRequestV1.TransInfoV1Biz transInfo
                = new GyjrB2bBillQrystockRequestV1.TransInfoV1Biz();
