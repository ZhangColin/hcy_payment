...
import com.icbc.api.request.CustomCardInfoQueryRequestV1;
import com.icbc.api.request.CustomCardInfoRequestV1.CustomCardInfoQueryRequestV1Biz;
import com.icbc.api.response.CustomCardInfoQueryResponseV1;

public class CustomCardInfoQueryTestV1{
	...
	public static void main(String[] args) throws Exception {
		...
		CustomCardInfoQueryRequestV1 request = new CustomCardInfoQueryRequestV1();
		
		//4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("http://ip:port/api/custom/card/info/V1");
		
		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		CustomCardInfoQueryRequestV1Biz bizContent = new CustomCardInfoQueryRequestV1Biz();
		bizContent.setCorpNo("0147");
		bizContent.setCustCiNo("hO7da6iW6BLvCYswj2k1PQ==");
		bizContent.setCustAcc("0000200000644");
		
		request.setBizContent(bizContent);

		CustomCardInfoQueryResponseV1 response = new CustomCardInfoQueryResponseV1();
		try {
