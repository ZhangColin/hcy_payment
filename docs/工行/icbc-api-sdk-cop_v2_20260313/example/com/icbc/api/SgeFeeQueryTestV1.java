...
import com.icbc.api.request.SgeFeeQueryRequestV1;
import com.icbc.api.request.SgeFeeQueryRequestV1.SgeFeeQueryRequestBiz;
import com.icbc.api.response.SgeFeeQueryResponseV1;

public class SgeFeeQueryTestV1 {
	...
	public void test_cop() throws IcbcApiException {
		...
		SgeFeeQueryRequestV1 request = new SgeFeeQueryRequestV1();
		request.setServiceUrl("http://ip:port/api/sge/fee/query/V1");

		SgeFeeQueryRequestBiz bizContent = new SgeFeeQueryRequestBiz();
		...
		bizContent.setPagingDate("2017-01-04");
    	request.setBizContent(bizContent);

		SgeFeeQueryResponseV1 response = client.execute(request);
