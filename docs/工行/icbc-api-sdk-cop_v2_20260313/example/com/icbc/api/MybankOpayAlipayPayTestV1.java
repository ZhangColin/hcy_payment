...
import com.icbc.api.request.MybankOpayAlipayPayRequestV1;
import com.icbc.api.request.MybankOpayAlipayPayRequestV1.MybankOpayAlipayPayRequestV1Biz;
import com.icbc.api.response.MybankOpayAlipayPayResponseV1;

public class MybankOpayAlipayPayTestV1 {
	    ...
	    static Logger log = Logger.getLogger(MybankOpayAlipayPayTestV1.class.getName());
		...
		public static void main(String[] args) {
			...
			MybankOpayAlipayPayTestV1 request = new MybankOpayAlipayPayTestV1();
			
			//访问工行API平台URL
			request.setServiceUrl(API_SERVICE_URL + "/mybank/opay/alipay/pay/V1);

			MybankOpayAlipayPayRequestV1Biz bizContent = new MybankOpayAlipayPayRequestV1Biz();

			bizContent.setAcquirerId("1022188000000000000");
			bizContent.setPspId("1022172000000000000");
			bizContent.setOrder(null);
			bizContent.setPaymentRequestId("201811291907410100070000000000");
			bizContent.setPaymentAmount(null);
			bizContent.setPayToAmount(null);
			bizContent.setPaymentMethod(null);
			bizContent.setPaymentFactor(null);
			bizContent.setPaymentQuote(null);
			bizContent.setSurchargeInfo(null);
			bizContent.setPaymentPromoInfo(null);
			bizContent.setpassThroughInfo("");
			bizContent.setEnv(null);

			request.setBizContent(bizContent);

			MybankOpayAlipayPayResponseV1 response;
