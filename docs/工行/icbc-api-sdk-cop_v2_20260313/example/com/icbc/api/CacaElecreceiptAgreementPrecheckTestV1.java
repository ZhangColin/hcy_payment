...
import com.icbc.api.request.CacaElecreceiptAgreementPrecheckRequestV1;
import com.icbc.api.response.CacaElecreceiptAgreementPrecheckResponseV1;

public class CacaElecreceiptAgreementPrecheckTestV1 {
    ...
    public static void main(String[] args) {
        ...
        //5、设置请求对象
        CacaElecreceiptAgreementPrecheckRequestV1 request = new CacaElecreceiptAgreementPrecheckRequestV1();
        //6、设置请求路径；联测时，请联系我行告知并替换成测试环境地址。
        request.setServiceUrl("http://ip:port/api/caca/elecreceipt/agreement/precheck/V1");
        //7、设置业务参数
        CacaElecreceiptAgreementPrecheckRequestV1.CacaElecreceiptAgreementPrecheckRequestV1Biz bizContent =
                new CacaElecreceiptAgreementPrecheckRequestV1.CacaElecreceiptAgreementPrecheckRequestV1Biz();
        //8、组装请求参数
        ...
        CacaElecreceiptAgreementPrecheckResponseV1 response;
        try {
