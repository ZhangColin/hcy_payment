...
import com.icbc.api.request.Queryca29108RequestV1;
import com.icbc.api.request.Queryca29108RequestV1.Queryca29108RequestV1Biz;
import com.icbc.api.request.Queryca29108RequestV1.Queryca29108RequestV1Pub;
import com.icbc.api.request.Queryca29108RequestV1.Queryca29108RequestV1In;
import com.icbc.api.response.Queryca29108ResponseV1;
import com.icbc.api.response.Queryca29108ResponseV1.Queryca29108ResponseV1Pub;
import com.icbc.api.response.Queryca29108ResponseV1.Queryca29108ResponseV1Out;
import com.icbc.api.response.Queryca29108ResponseV1.Queryca29108ResponseV1Grptotal;
import com.icbc.api.response.Queryca29108ResponseV1.Queryca29108ResponseV1Tydwtotal;

public class Queryca29108Test {
	...
	public void test_CA() throws IcbcApiException {
		...
		Queryca29108RequestV1 request = new Queryca29108RequestV1();
		request.setServiceUrl("http://ip:port/api/queryca29108/query/V1");

		Queryca29108RequestV1Biz bizContent = new Queryca29108RequestV1Biz();
		
		Queryca29108RequestV1Pub pub = new Queryca29108RequestV1Pub();
		pub.setCode("29108");
		pub.setZone("0200");
		pub.setFr("0");
		pub.setDt("2018-12-26");
		
		Queryca29108RequestV1In in = new Queryca29108RequestV1In();
		...
		Queryca29108ResponseV1 response = client.execute(request, "msgId");

		if (response.isSuccess()) {
			// 接收成功
			Queryca29108ResponseV1Pub RetPub = response.getPub();
			Queryca29108ResponseV1Out RetOut = response.getOut();
			if(RetOut.getResult().equals("00000000")){
				//查询成功 获取返回结果
				List<Queryca29108ResponseV1Grptotal> resultList = RetOut.getGrptotal();
				//获取结果集中字段
				for(Queryca29108ResponseV1Grptotal detail:resultList){
					//获取信息.....
					detail.getGRPMERNO();
				}
			} else {
