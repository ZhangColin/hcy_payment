...
import com.icbc.api.request.CacaReceiptQdsreceiptQueryreceiptRequestV1;
import com.icbc.api.response.CacaReceiptQdsreceiptQueryreceiptResponseV1;

public class CacaReceiptQdsreceiptQueryreceiptTestV1 {
    ...
    public static void main(String[] args) {
        ...
        CacaReceiptQdsreceiptQueryreceiptRequestV1 request = new CacaReceiptQdsreceiptQueryreceiptRequestV1();
        request.setServiceUrl("https://ip:port/api/caca/receipt/posreceipt/QueryReceiptBySSTSzcreceipt/V1");
        CacaReceiptQdsreceiptQueryreceiptRequestV1.QueryReceiptBySSTSRequestV1Biz bizContent = new CacaReceiptQdsreceiptQueryreceiptRequestV1.QueryReceiptBySSTSRequestV1Biz();
        // public 通讯区定义赋值
        CacaReceiptQdsreceiptQueryreceiptRequestV1.QueryReceiptBySSTSRequestV1Pub pubObj = new CacaReceiptQdsreceiptQueryreceiptRequestV1.QueryReceiptBySSTSRequestV1Pub();
        pubObj.setCode("29043");
        pubObj.setZone("0200");
        pubObj.setFr("0");
        pubObj.setDt("2017-07-06");
        // private 通讯区定义赋值
        CacaReceiptQdsreceiptQueryreceiptRequestV1.QueryReceiptBySSTSRequestV1In inObj = new CacaReceiptQdsreceiptQueryreceiptRequestV1.QueryReceiptBySSTSRequestV1In();
        ...
        try {
            CacaReceiptQdsreceiptQueryreceiptResponseV1 response = client.execute(request);
