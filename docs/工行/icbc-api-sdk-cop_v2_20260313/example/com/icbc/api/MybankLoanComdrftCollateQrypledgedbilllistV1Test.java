...
import com.icbc.api.request.MybankLoanComdrftCollateQrypledgedbilllistRequestV1;
import com.icbc.api.response.MybankLoanComdrftCollateQrypledgedbilllistResponseV1;
import com.icbc.api.response.MybankPayComdrftInstrQueryinstrlistResponseV1;

import java.util.ArrayList;
import java.util.List;

public class MybankLoanComdrftCollateQrypledgedbilllistV1Test {
    ...
    public static void main(String[] args) {
        ...
        MybankLoanComdrftCollateQrypledgedbilllistRequestV1 request = new MybankLoanComdrftCollateQrypledgedbilllistRequestV1();
        ...
        MybankLoanComdrftCollateQrypledgedbilllistRequestV1.MybankLoanComdrftCollateQrypledgedbilllistRequestBizV1 bizContent = new MybankLoanComdrftCollateQrypledgedbilllistRequestV1.MybankLoanComdrftCollateQrypledgedbilllistRequestBizV1();
        bizContent.setCdTp("AC01");
        bizContent.setAccptrClass("101");
        bizContent.setPackAmtBgn("0");
        bizContent.setPackAmtEnd("100000");
        bizContent.setPledgeeAcctId("13456789");
        ...
        MybankLoanComdrftCollateQrypledgedbilllistResponseV1 response;
        try {
