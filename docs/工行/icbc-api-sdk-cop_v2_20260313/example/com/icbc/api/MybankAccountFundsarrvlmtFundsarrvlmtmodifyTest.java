...
public class MybankAccountFundsarrvlmtFundsarrvlmtmodifyTest {
	...
	public static void main(String[] args) throws Exception  {
		...
		// 设置 请求对象request
		 MybankAccountFundsarrvlmtFundsarrvlmtmodifyRequestV1 request = new  MybankAccountFundsarrvlmtFundsarrvlmtmodifyRequestV1();
		// 设置 请求路径
		request.setServiceUrl("http://ip:port/mybank/account/fundsarrvlmt/fundsarrvlmtModify/V1");
		// 设置 通知url
		request.setNotifyUrl("https://www.xxx.com/do.notify");

		//构造 biz_content
		 MybankAccountFundsarrvlmtFundsarrvlmtmodifyRequestV1. MybankAccountFundsarrvlmtFundsarrvlmtmodifyRequestV1Biz bizContent = new  MybankAccountFundsarrvlmtFundsarrvlmtmodifyRequestV1. MybankAccountFundsarrvlmtFundsarrvlmtmodifyRequestV1Biz();
