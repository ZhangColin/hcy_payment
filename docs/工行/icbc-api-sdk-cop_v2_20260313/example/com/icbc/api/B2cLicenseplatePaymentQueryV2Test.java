...
import com.icbc.api.request.B2cLicenseplatePaymentQueryRequestV2;
import com.icbc.api.request.B2cLicenseplatePaymentQueryRequestV2.B2cLicenseplatePaymentQueryRequestV2Biz;
import com.icbc.api.response.B2cLicenseplatePaymentQueryResponseV2;

public class B2cLicenseplatePaymentQueryV2Test {
	...
	public void test_cop() throws IcbcApiException {
		...
		B2cLicenseplatePaymentQueryRequestV2 request = new B2cLicenseplatePaymentQueryRequestV2();
		
		//根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("https://ip:port/api/b2c/licenseplate/payment/query/V2");

		B2cLicenseplatePaymentQueryRequestV2Biz bizContent = new B2cLicenseplatePaymentQueryRequestV2Biz();
		...
		B2cLicenseplatePaymentQueryResponseV2 response;
		try {
