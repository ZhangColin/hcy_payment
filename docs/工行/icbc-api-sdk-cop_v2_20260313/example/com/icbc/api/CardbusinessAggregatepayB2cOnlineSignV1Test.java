...
import com.icbc.api.request.CardbusinessAggregatepayB2cOnlineSignRequestV1;
import com.icbc.api.response.CardbusinessAggregatepayB2cOnlineSignResponseV1;
import com.icbc.api.request.CardbusinessAggregatepayB2cOnlineSignRequestV1.CardbusinessAggregatepayB2cOnlineSignV1Biz;
...
public class CardbusinessAggregatepayB2cOnlineSignV1Test {
	...
	private Logger logger = Logger.getLogger(CardbusinessAggregatepayB2cOnlineSignV1Test.class.getName());

	
	public void test_cop() throws IcbcApiException {
		CardbusinessAggregatepayB2cOnlineSignRequestV1 request = new CardbusinessAggregatepayB2cOnlineSignRequestV1();
		// 4、需传入appid，私钥，字符集
		UiIcbcClient client;
		...
		request.setServiceUrl("https://ip:port/api/cardbusiness/aggregatepay/b2c/online/sign/V1");
		CardbusinessAggregatepayB2cOnlineSignV1Biz bizContent = new CardbusinessAggregatepayB2cOnlineSignV1Biz();
		...
		bizContent.setSms_code("xxx");
		bizContent.setCertiftp("xxx");
		bizContent.setCertifid("xxx");
		bizContent.setExpired("xxx");
		bizContent.setCvn2("xxx");
		bizContent.setCustomerNm("xxx");
		CardbusinessAggregatepayB2cOnlineSignResponseV1 response;
		try {
