...
public class MybankFarmThirdRoleDelTest {
	...
	public	 static void main(String[] args) throws Exception {
		String URI = "/mybank/farm/farmplatf/delCorpRole/V1";
		...
		try {
			...
			bizContent.setfSeqNo("sjxfSeqNoQry0002");
			bizContent.setOperatorUserId("SJXtestuserid001");
			bizContent.setRoleId("CR000206"); // 需要新加角色后才会有
