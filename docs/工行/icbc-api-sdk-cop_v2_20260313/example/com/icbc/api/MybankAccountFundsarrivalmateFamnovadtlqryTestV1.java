...
import com.icbc.api.request.MybankAccountFundsarrivalmateFamnovadtlqryRequestV1;
import com.icbc.api.response.MybankAccountFundsarrivalmateFamnovadtlqryResponseV1;

public interface MybankAccountFundsarrivalmateFamnovadtlqryTestV1 {
    ...
    public static void main(String[] args) {
        ...
        MybankAccountFundsarrivalmateFamnovadtlqryRequestV1 request = new MybankAccountFundsarrivalmateFamnovadtlqryRequestV1();
        request.setServiceUrl("http://ip:port/api/mybank/account/fundsarrivalmate/famnovadtlqry/V1");

        MybankAccountFundsarrivalmateFamnovadtlqryRequestV1.FamMsgdtlInfoQueryRequestV1Biz bizContent = new MybankAccountFundsarrivalmateFamnovadtlqryRequestV1.FamMsgdtlInfoQueryRequestV1Biz();
        bizContent.setAgreeno("1");
        bizContent.setSellerid("1103");
        bizContent.setCustomerid("guq_dealer_002");
        bizContent.setRecipacc("1");
        bizContent.setRecipnam("测试户002");
        bizContent.setAccno("1");
        bizContent.setCardno("1");
        ...
        MybankAccountFundsarrivalmateFamnovadtlqryResponseV1 response;
        try {
