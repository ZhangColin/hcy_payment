...
import com.icbc.api.request.JftApiVendorRevokeRequestV1;
import com.icbc.api.request.JftApiVendorRevokeRequestV1.JftApiVendorRevokeRequestV1Biz;
import com.icbc.api.response.JftApiVendorRevokeResponseV1;
 ...
 * @Description:
 */
public class JftApiVendorRevokeTestV1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JftApiVendorRevokeRequestV1 request = new JftApiVendorRevokeRequestV1();

        //4、根据测试环境和生产环境替换相应ip和端口
        request.setServiceUrl("https://ip:port/api/jft/api/vendor/revoke/V1");

        //5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值ֵ

        JftApiVendorRevokeRequestV1Biz bizContent = new JftApiVendorRevokeRequestV1Biz();
        ...
        JftApiVendorRevokeResponseV1 response;

        try {
            response = (JftApiVendorRevokeResponseV1)client.execute(request, System.currentTimeMillis()+"");
