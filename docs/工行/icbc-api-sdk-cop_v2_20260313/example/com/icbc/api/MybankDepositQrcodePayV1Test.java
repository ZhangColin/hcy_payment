...
import com.icbc.api.request.MybankDepositQrcodePayRequestV1;
import com.icbc.api.request.MybankDepositQrcodePayRequestV1.MybankDepositQrcodePayRequestV1Biz;
import com.icbc.api.response.MybankDepositQrcodePayResponseV1;
 ...
 */
public class MybankDepositQrcodePayV1Test {
	...
	public static void main(String[] args) throws Exception {
		...
		MybankDepositQrcodePayRequestV1 request = new MybankDepositQrcodePayRequestV1();
		
		//4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("http://****/api/mybank/deposit/qrcode/scanned/pay/V1");
		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		MybankDepositQrcodePayRequestV1Biz bizContent = new MybankDepositQrcodePayRequestV1Biz();
		...
		MybankDepositQrcodePayResponseV1 response;
		try {
