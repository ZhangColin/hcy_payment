...
import com.icbc.api.request.MybankMicrofundOrderMicrofundorderpayRequestV1;
import com.icbc.api.request.MybankMicrofundOrderMicrofundorderpayRequestV1.MybankMicrofundOrderMicrofundorderpayRequestV1Biz;
import com.icbc.api.response.MybankMicrofundOrderMicrofundorderpayResponseV1;

public class MybankMicrofundOrderMicrofundorderpayV1Test {
	/**
	 * @param args
	 */
  ...
  // 2、appid
	...
	public static void main(String[] args) {
		...
		// 设置请求对象request
		MybankMicrofundOrderMicrofundorderpayRequestV1 req = new MybankMicrofundOrderMicrofundorderpayRequestV1();
		
		// 设置请求路径
		req.setServiceUrl("http://ip:port/api/mybank/microfund/order/microfundorderpay/V1");

		MybankMicrofundOrderMicrofundorderpayRequestV1Biz biz = new MybankMicrofundOrderMicrofundorderpayRequestV1Biz();
