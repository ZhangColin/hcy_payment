...
import com.icbc.api.request.CardbusinessFovaPeripheryCashboxHandelRequestV1;
import com.icbc.api.request.CardbusinessFovaPeripheryCashboxHandelRequestV1.CardbusinessFovaPeripheryCashboxHandelRequestV1Biz;
...
/**
 * @ClassName CardbusinessFovaPeripheryCashboxHandelV1Test
 * @Description TODO
 * @author: kfzx-zhangxx02
 * @create: 2023-01-05 16:35
 **/
public class CardbusinessFovaPeripheryCashboxHandelV1Test {
    ...
    public void test_cop() throws IcbcApiException {
        ...
        CardbusinessFovaPeripheryCashboxHandelRequestV1 request = new CardbusinessFovaPeripheryCashboxHandelRequestV1();

        // 4、根据测试环境和生产环境替换相应ip和端口
        request.setServiceUrl("http://IP:port/api/cardbusiness/fova/periphery/cashboxHandel/V1");
        // 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
        CardbusinessFovaPeripheryCashboxHandelRequestV1Biz bizContent = new CardbusinessFovaPeripheryCashboxHandelRequestV1Biz();
        ...
        bizContent.setAtm_no("xxx");
        bizContent.setCurr_type("xxx");
        bizContent.setAmount("xxx");
        bizContent.setStat_code("xxx");
        bizContent.setChkamtflg("xxx");
        bizContent.setAmttelll_no("xxx");
        bizContent.setAmtbr_no("xxx");
        bizContent.setLocal_flag("xxx");
        bizContent.setField("xxx");

        request.setBizContent(bizContent);
        CardbusinessFovaPeripheryCashboxHandelResponseV1 response;
