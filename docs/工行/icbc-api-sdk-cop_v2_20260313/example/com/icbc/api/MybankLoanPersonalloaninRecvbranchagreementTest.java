...
import com.icbc.api.request.MybankLoanPersonalloaninRecvbranchagreementRequestV1;
import com.icbc.api.request.MybankLoanPersonalloaninRecvbranchagreementRequestV1.MybankLoanPersonalloaninRecvbranchagreement;
import com.icbc.api.request.MybankLoanPersonalloaninRecvbranchagreementRequestV1.MybankLoanPersonalloaninRecvbranchagreementBizContent;
import com.icbc.api.response.MybankLoanPersonalloaninRecvbranchagreementResponseV1;
import com.icbc.api.DefaultIcbcClient;
import com.icbc.api.IcbcApiException;

public class MybankLoanPersonalloaninRecvbranchagreementTest {
	...
	public static void main(String[] args) throws IcbcApiException{
		...
		MybankLoanPersonalloaninRecvbranchagreementRequestV1 request = new MybankLoanPersonalloaninRecvbranchagreementRequestV1();
		//  "http://ip:port/api/mybank/loan/personalloanin/recvbranchagreement/V1"
		request.setServiceUrl("http://ip:port/api/mybank/loan/personalloanin/recvbranchagreement/V1");
		MybankLoanPersonalloaninRecvbranchagreementBizContent bizContent = new MybankLoanPersonalloaninRecvbranchagreementBizContent();
		...
		MybankLoanPersonalloaninRecvbranchagreement map = new MybankLoanPersonalloaninRecvbranchagreement();
		...
		MybankLoanPersonalloaninRecvbranchagreementResponseV1 response=new MybankLoanPersonalloaninRecvbranchagreementResponseV1();
		try{
