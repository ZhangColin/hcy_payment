...
//		request.setServiceUrl("http://ip:port/api/cardbusiness/ncpay/ncgoodsreturn/V1");
		request.setServiceUrl("http://gw.dccnet.com.cn:8088/api/cardbusiness/ncpay/ncgoodsreturn/V1"); //功能外网
		...
		bizContent.setSceneAgreement("XXX");
		bizContent.setoBankTrxDate("2021-09-20");
		bizContent.setoBankTrxSerno("XXX");
		bizContent.setoTrxAmt("10");
		bizContent.setTrxAmt("10");
		bizContent.setExtendInfo("test-refund");
		bizContent.setNewMernoFlag("0");
		bizContent.setMerPrtclNo("XXX");
		bizContent.setOrderId("12343423423)");

		// msgId消息通讯唯一编号，要求每次调用独立生成，APP级唯一
		String msgId = String.valueOf(System.currentTimeMillis());
		CardbusinessNcpayNcgoodsreturnResponseV1 response = client.execute(request, msgId);
