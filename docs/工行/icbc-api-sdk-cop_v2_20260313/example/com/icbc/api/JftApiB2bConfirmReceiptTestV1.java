...
import com.icbc.api.request.JftApiB2bConfirmReceiptRequestV1;
import com.icbc.api.request.JftApiB2bConfirmReceiptRequestV1.JftApiB2bPayQueryOrderRequestV1Biz;
import com.icbc.api.response.JftApiB2bConfirmReceiptResponseV1;

public class JftApiB2bConfirmReceiptTestV1 {
    ...
    public static void main(String[] args) {
        ...
        JftApiB2bConfirmReceiptRequestV1 request=new JftApiB2bConfirmReceiptRequestV1();
        request.setServiceUrl("https://apipcs4.dccnet.com.cn/api/jft/api/pay/b2bpay/b2bconfirmreceipt/V1");
        JftApiB2bPayQueryOrderRequestV1Biz bizContent=new JftApiB2bPayQueryOrderRequestV1Biz();



        bizContent.setAppId("10000000000000205515");//平台商户标识
        bizContent.setOutVendorId("04221125");//子商户标识
        bizContent.setOutOrderId("20200227T1i4000000a1");//平台订单ID
        bizContent.setOutUserId("202004221117");//用户编号
        bizContent.setNotifyUrl("http://www.baidu.com");//确认收货通知地址
        bizContent.setOutVendorOrderId("11331234303");//平台商户确认收货外部编号（E企付支付必传）
        bizContent.setConfirmReceiptAmount("1.00");//确认收货金额（E企付支付必传）

        request.setBizContent(bizContent);

        JftApiB2bConfirmReceiptResponseV1 response;
        try {
