...
import com.icbc.api.request.BcssCateringMemQrcodePayRequestV1;
import com.icbc.api.request.BcssCateringMemQrcodePayRequestV1.BcssCateringMemQrcodePayRequestBizV1;
...
public class BcssCateringMemQrcodePayV1Test {
    // 网关公钥
    ...
    public static void main(String[] args) throws IcbcApiException {
        ...
        BcssCateringMemQrcodePayRequestV1 request = new BcssCateringMemQrcodePayRequestV1();
        // 根据测试环境和生产环境替换相应ip和端口
        request.setServiceUrl("http://***.***.***.***:****/api/bcss/consume/memqrcode/pay/V1");
        BcssCateringMemQrcodePayRequestBizV1 bizContent = new BcssCateringMemQrcodePayRequestBizV1();
        ...
        List<BcssCateringMemQrcodePayRequestBizV1.BcssCateringMemQrcodePayGoodsInfoDto> goods = new ArrayList<>();
        BcssCateringMemQrcodePayRequestBizV1.BcssCateringMemQrcodePayGoodsInfoDto good1 = new BcssCateringMemQrcodePayRequestBizV1.BcssCateringMemQrcodePayGoodsInfoDto();
        ...
        goods.add(good1);
        BcssCateringMemQrcodePayRequestBizV1.BcssCateringMemQrcodePayGoodsInfoDto good2 = new BcssCateringMemQrcodePayRequestBizV1.BcssCateringMemQrcodePayGoodsInfoDto();
