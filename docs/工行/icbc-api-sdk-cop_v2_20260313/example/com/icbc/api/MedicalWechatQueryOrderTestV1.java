...
import com.icbc.api.request.MedicalWechatQueryOrderRequsetV1;
import com.icbc.api.response.MedicalWechatQueryOrderResponseV1;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;


public class MedicalWechatQueryOrderTestV1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //构建请求
        MedicalWechatQueryOrderRequsetV1 requset = new MedicalWechatQueryOrderRequsetV1();
        requset.setServiceUrl("http://ip:port/api/mybank/medical/mixorder/queryorder/V1");
        //构建请求参数
        MedicalWechatQueryOrderRequsetV1.MedicalWechatQueryOrderRequsetV1Biz bizContext = new MedicalWechatQueryOrderRequsetV1.MedicalWechatQueryOrderRequsetV1Biz();
        ...
        try {
            ...
            MedicalWechatQueryOrderResponseV1 response1 = client.execute(requset);
