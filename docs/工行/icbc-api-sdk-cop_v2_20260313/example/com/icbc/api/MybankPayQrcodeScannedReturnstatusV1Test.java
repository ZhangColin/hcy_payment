...
import com.icbc.api.request.QrcodeScannedReturnstatusRequestV1.QrcodeScannedReturnstatusRequestV1Biz;
import com.icbc.api.response.QrcodeScannedReturnstatusResponseV1;

public class MybankPayQrcodeScannedReturnstatusV1Test {
	// 1、网关公钥
	...
	public static void main(String[] args) throws Exception {
		...
		request.setServiceUrl("http://*****/api/mybank/pay/qrcode/scanned/returnstatus/V1");
		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		QrcodeScannedReturnstatusRequestV1Biz bizContent = new QrcodeScannedReturnstatusRequestV1Biz();
