...
import com.icbc.api.request.EpmOrgTreeUpdateRequestV1;
import com.icbc.api.response.EpmOrgTreeUpdateResponseV1;

public class EpmOrgTreeUpdateApiServiceImplTest extends HttpServlet {
	...
	public static void main(String[] args) {
		...
		EpmOrgTreeUpdateRequestV1 request = new EpmOrgTreeUpdateRequestV1();		
		request.setServiceUrl("http://ip:port/api/epm/org/tree/update/V1");
		EpmOrgTreeUpdateRequestV1.EpmOrgTreeUpdateRequestV1Biz bizContent = new EpmOrgTreeUpdateRequestV1.EpmOrgTreeUpdateRequestV1Biz();
		request.setBizContent(bizContent);
		bizContent.setProtocolNo("PT20181213100000108002");
		bizContent.setOrgId("100152");
		bizContent.setOrgName("娴嬭瘯鏈烘瀯2绾�152");

		EpmOrgTreeUpdateResponseV1 response;
		try {
			...
			System.out.println(response.getOldUpdateTime());
			System.out.println(response.getNewUpdateTime());
