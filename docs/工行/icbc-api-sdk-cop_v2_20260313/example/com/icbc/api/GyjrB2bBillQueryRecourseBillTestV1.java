...
import com.icbc.api.request.GyjrB2bBillQueryRecourseBillRequestV1;
import com.icbc.api.response.GyjrB2bBillQueryRecourseBillResponseV1;

import java.util.ArrayList;
import java.util.List;
import java.util.Random;

public class GyjrB2bBillQueryRecourseBillTestV1 {
    ...
    public static void main(String[] args) {
        ...
        GyjrB2bBillQueryRecourseBillRequestV1 request = new GyjrB2bBillQueryRecourseBillRequestV1();
        request.setServiceUrl("http://IP:PORT/api/gyjr/b2b/bill/QueryRecourseBill/V1");
        GyjrB2bBillQueryRecourseBillRequestV1.BizContentV1Biz bizContent = new GyjrB2bBillQueryRecourseBillRequestV1.BizContentV1Biz();
        GyjrB2bBillQueryRecourseBillRequestV1.TransInfoV1Biz transInfo
                = new GyjrB2bBillQueryRecourseBillRequestV1.TransInfoV1Biz();
        ...
        List<String> rcrsrAcctIds = new ArrayList<>();
        rcrsrAcctIds.add("111111111");
        transInfo.setRcrsrAcctIds(rcrsrAcctIds);
        transInfo.setPackAmtBgn("0");
        transInfo.setPackAmtEnd("1000000000");
        transInfo.setDueDateBgn("20230201");
        transInfo.setDueDateEnd("20230202");
        transInfo.setRcrsType("");

        List<String> packNoList = new ArrayList<>();
        packNoList.add("[ {\n" +
                "            \"packNo\": \"000000296020211123877770032209\",\n" +
                "            \"rangeBgn\": \"000000000001\",\n" +
                "            \"rangeEnd\": \"000000123436\"\n" +
                "          }]");
        transInfo.setPackNoList(packNoList);
        transInfo.setUkeyId("dil.oo1.ic");
        bizContent.setTransInfoBiz(transInfo);
        request.setBizContent(bizContent);

        GyjrB2bBillQueryRecourseBillResponseV1 response;
        try {
