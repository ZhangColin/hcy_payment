 ...
 * @author kfzx-linfeng
 */
public class EcspNftQueryV1Test {
    // 1、网关公钥
    ...
    public static void main(String[] args) throws Exception {
        ...
        EcspNftQueryRequestV1 request = new EcspNftQueryRequestV1();

        // 4、根据测试环境和生产环境替换相应ip和端口
        request.setServiceUrl("http://ip:port/api/ecsp/nft/query/V1");
        // 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
        EcspNftQueryRequestV1.EcspNftQueryRequestV1Biz bizContent = new EcspNftQueryRequestV1.EcspNftQueryRequestV1Biz();
        bizContent.setCorpId("0000000001");
        bizContent.setTxType(1);
        bizContent.setPhoneNo("13333333333");
        request.setBizContent(bizContent);

        EcspNftQueryResponseV1 response;
        try {
