...
import com.icbc.api.request.InvestmentDepositDptransferamtqryRequestV1;
import com.icbc.api.response.InvestmentDepositDptransferamtqryResponseV1;
...
public class InvestmentDepositDptransferamtqryTestV1 {
    ...
    public void test_cop() throws IcbcApiException {
        ...
        InvestmentDepositDptransferamtqryRequestV1 request = new InvestmentDepositDptransferamtqryRequestV1();
        request.setServiceUrl(Const.URL_PREFIX + "/investment/deposit/dptransferamtqry/V1");
        InvestmentDepositDptransferamtqryRequestV1.InvestmentDepositDptransferamtqryRequestV1Biz bizContent =
                new InvestmentDepositDptransferamtqryRequestV1.InvestmentDepositDptransferamtqryRequestV1Biz();
        ...
        bizContent.setTrxcode("02120");
        bizContent.setWorkdate(Const.WORK_DATE);
        bizContent.setWorktime("10:10:10");
        // PMD检查
        bizContent.setCardno("622202" +
                "8080825888039");
        bizContent.setAccno("");
        bizContent.setCardflag("0");


        request.setBizContent(bizContent);
        InvestmentDepositDptransferamtqryResponseV1 response;
        try {
            ...
            LOGGER.error("DefaultIcbcClient.execute error:", e);
        }
    }
}
