...
import com.icbc.api.request.SstsQueryEnvelopeRequestV1;
import com.icbc.api.response.SstsQueryEnvelopeResponseV1;
import org.junit.Test;

import java.util.HashMap;

public class SstsQueryEnvelopeTestV1 {
	...
	public void test_cop() throws IcbcApiException {
		...
		SstsQueryEnvelopeRequestV1 request = new SstsQueryEnvelopeRequestV1();
		request.setServiceUrl("http://ip:port/api/ssts/envelope/query/V1");

		SstsQueryEnvelopeRequestV1.SstsFhAddTranlogRequestV1Biz bizContent = new SstsQueryEnvelopeRequestV1.SstsFhAddTranlogRequestV1Biz();
		bizContent.setBaseinfo(new HashMap<>());
		bizContent.setChanCommV10(new HashMap<>());
		bizContent.setInfoCommV10(new HashMap<>());
		request.setBizContent(bizContent);

		SstsQueryEnvelopeResponseV1 response = client.execute(request);
