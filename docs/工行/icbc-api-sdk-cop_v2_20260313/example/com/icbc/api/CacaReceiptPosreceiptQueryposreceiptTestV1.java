...
import com.icbc.api.request.CacaReceiptPosreceiptQueryposreceiptRequestV1;
import com.icbc.api.response.CacaReceiptPosreceiptQueryposreceiptResponseV1;

public class CacaReceiptPosreceiptQueryposreceiptTestV1 {
    ...
    public static void main(String[] args) {
        ...
        CacaReceiptPosreceiptQueryposreceiptRequestV1 request = new CacaReceiptPosreceiptQueryposreceiptRequestV1();
        request.setServiceUrl("https://ip:port/api/caca/receipt/posreceipt/queryposreceipt/V1");
        CacaReceiptPosreceiptQueryposreceiptRequestV1.QueryPosRequestV1Biz bizContent = new CacaReceiptPosreceiptQueryposreceiptRequestV1.QueryPosRequestV1Biz();
        // public 通讯区定义赋值
        CacaReceiptPosreceiptQueryposreceiptRequestV1.QueryPosRequestV1Pub pubObj = new CacaReceiptPosreceiptQueryposreceiptRequestV1.QueryPosRequestV1Pub();
        pubObj.setCode("29009");
        pubObj.setZone("0200");
        pubObj.setFr("0");
        pubObj.setDt("2017-07-06");
        // private 通讯区定义赋值
        CacaReceiptPosreceiptQueryposreceiptRequestV1.QueryPosRequestV1In inObj = new CacaReceiptPosreceiptQueryposreceiptRequestV1.QueryPosRequestV1In();
        ...
        try {
            CacaReceiptPosreceiptQueryposreceiptResponseV1 response = client.execute(request);
