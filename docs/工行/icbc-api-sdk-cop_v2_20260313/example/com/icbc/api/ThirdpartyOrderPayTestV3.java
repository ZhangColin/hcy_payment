...
import com.icbc.api.request.ThirdpartyOrderPayRequestV3.ThirdpartyOrderPayRequestV3Biz;
 ...
 */
public class ThirdpartyOrderPayTestV3 {
	...
	public void order(HttpServletRequest request1, HttpServletResponse response) throws Exception {
		...
		request.setServiceUrl("http://ip:port/ui/thirdparty/order/pay/V3");
		
		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		ThirdpartyOrderPayRequestV3Biz bizContent = new ThirdpartyOrderPayRequestV3Biz();
