...
import com.icbc.api.request.MybankAccountEnterpriseAccopenoutsiteinfoqueryRequestV1;
import com.icbc.api.request.MybankAccountEnterpriseAccopenoutsiteinfoqueryRequestV1.MybankAccountEnterpriseAccopenoutsiteinfoqueryRequestV1Biz;
...
public class MybankAccountEtradeMemberTestV1 {
    ...
    protected static final String SIGN_TYPE = "RSA2"; 
		// 5.API的访问url
    protected static String URL = "http://ip:port/api/mybank/account/enterprise/accopenoutsiteinfoquery/V1	";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            PrivateMap privateMap = new PrivateMap();           
						privateMap.setQueryType("2");
						privateMap.setOpenPhoneNo("13988889901");
			 			privateMap.setBegainRow("1");
			 			privateMap.setIsAllCredOpen("1")
			 			privateMap.setQryCount("10");
			 			privateMap.setBusLiscense('915113007274823628');
 
            
            MybankAccountEnterpriseAccopenoutsiteinfoqueryRequestV1Biz biz = new MybankAccountEnterpriseAccopenoutsiteinfoqueryRequestV1Biz();
            biz.setChanCommV11(chancomm);
            biz.setInfoCommV11(infocomm);
            biz.setPrivateMap(privateMap);
						
						// 7.调用服务返回结果
            MybankAccountEnterpriseAccopenoutsiteinfoqueryRequestV1 requestV1 = new MybankAccountEnterpriseAccopenoutsiteinfoqueryRequestV1();
            requestV1.setBizContent(biz);
            requestV1.setServiceUrl(URL);
            //client.execute(requestV1);
            MybankAccountEnterpriseAccopenoutsiteinfoqueryResponseV1 responseV1 = client.execute(requestV1);
