...
import com.icbc.api.request.SettlementAccountCloseOrderRequestV1;
import com.icbc.api.request.SettlementAccountCloseOrderRequestV1.SettlementAccountCloseOrderRequestV1Biz;
import com.icbc.api.response.SettlementAccountCloseOrderResponseV1;

public class settlementAccountCloseorderTest {
	...
	public void test_cop() throws IcbcApiException{
		...
		SettlementAccountCloseOrderRequestV1 request = new SettlementAccountCloseOrderRequestV1();
		request.setServiceUrl("https://ip:port/api/settlement/account/close/order/V1");
		SettlementAccountCloseOrderRequestV1Biz bizContent = new SettlementAccountCloseOrderRequestV1Biz();
