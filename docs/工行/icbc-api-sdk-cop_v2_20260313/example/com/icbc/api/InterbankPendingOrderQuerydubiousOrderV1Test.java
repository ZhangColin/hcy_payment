...
import com.icbc.api.request.InterbankPendingOrderQuerydubiousOrderRequestV1;
import com.icbc.api.request.InterbankPendingOrderQuerydubiousOrderRequestV1.InterbankPendingOrderQuerydubiousOrderRequestV1Biz;
import com.icbc.api.response.InterbankPendingOrderQuerydubiousOrderResponseV1;

/*
 * @author kfzx-caof
 * @date 2021/03/19 19:39
 */
public class InterbankPendingOrderQuerydubiousOrderV1Test {
    public static void main(String[] args) {
        ...
        //5、设置请求对象
        InterbankPendingOrderQuerydubiousOrderRequestV1 request = new InterbankPendingOrderQuerydubiousOrderRequestV1();

        //6、设置请求路径；联测时，请联系我行告知并替换成测试环境地址。
        request.setServiceUrl("https://ip:port/api/interbank/pending/order/queryDubiousOrder/V1");
        //7、设置业务参数
        InterbankPendingOrderQuerydubiousOrderRequestV1Biz bizContent = new InterbankPendingOrderQuerydubiousOrderRequestV1Biz();
        ...
        InterbankPendingOrderQuerydubiousOrderResponseV1 response;
        try {
