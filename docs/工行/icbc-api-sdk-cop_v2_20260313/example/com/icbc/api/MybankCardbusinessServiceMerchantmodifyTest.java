...
import com.icbc.api.request.MybankCardbusinessServiceMerchantmodifyRequestV1;
import com.icbc.api.response.MybankCardbusinessServiceMerchantmodifyResponseV1;

import java.util.HashMap;
import java.util.Map;

public class MybankCardbusinessServiceMerchantmodifyTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        MybankCardbusinessServiceMerchantmodifyRequestV1 request = new MybankCardbusinessServiceMerchantmodifyRequestV1();

        request.setServiceUrl("http://ip:port:16257/api/mybank/cardbusiness/shop/queryElcMerInfo/V1");
        MybankCardbusinessServiceMerchantmodifyRequestV1.MybankCardbusinessServiceMerchantmodifyRequestV1Biz bizRes = new MybankCardbusinessServiceMerchantmodifyRequestV1.MybankCardbusinessServiceMerchantmodifyRequestV1Biz();

        Map<String, Object> bwg_ci16070_comm = new HashMap<>();

        bizRes.setAppserino("2023051112323445678745454545");
        bizRes.setTrxtime("2023-05-10 11:16:33");
        bizRes.setSerid("0200********");
        bizRes.setIcbc_id("0200********");
        bizRes.setShortname("**商店");
        bizRes.setFee_code("AB0001");
        bizRes.setMobile("188********");

        request.setBizContent(bizRes);

        MybankCardbusinessServiceMerchantmodifyResponseV1 response;
