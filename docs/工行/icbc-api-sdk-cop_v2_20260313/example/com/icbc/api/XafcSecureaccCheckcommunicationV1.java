...
public class XafcSecureaccCheckcommunicationV1 {
	public static void main(String[] args) {
		...
		String ICBCAPI_URL = "http://ip:port/api/xafc/secureacc/checkcommunication/V1"; // 工行API平台测试环境付款指令URL，调用方需要修改为贵州分行前置机上游IP和端口

		// 以下bizContent为业务数据字段，需要set具体业务数据
		String reqparams = "<ZXBMsg>"
				+"<Head>"
				+"<ReqSN>"+System.currentTimeMillis()+"</ReqSN>"
				+"<MsgTyp>CT0001</MsgTyp>"
