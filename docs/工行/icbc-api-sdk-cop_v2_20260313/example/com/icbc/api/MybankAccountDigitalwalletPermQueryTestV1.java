...
import com.icbc.api.request.MybankAccountDigitalwalletPermQueryRequestV1;
import com.icbc.api.response.MybankAccountDigitalwalletPermQueryResponseV1;


public interface MybankAccountDigitalwalletPermQueryTestV1 {
    ...
    public static void main(String[] args) {
        ...
        MybankAccountDigitalwalletPermQueryRequestV1 request = new MybankAccountDigitalwalletPermQueryRequestV1();
        request.setServiceUrl("http://IP:PORT/api/mybank/account/digitalwallet/permquery/V1");
        //5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值，非必输字段可不上送
        MybankAccountDigitalwalletPermQueryRequestV1.DigitalwalletPermQueryRequestV1Biz bizContent = new MybankAccountDigitalwalletPermQueryRequestV1.DigitalwalletPermQueryRequestV1Biz();
        ...
        MybankAccountDigitalwalletPermQueryResponseV1 response;
        try {
