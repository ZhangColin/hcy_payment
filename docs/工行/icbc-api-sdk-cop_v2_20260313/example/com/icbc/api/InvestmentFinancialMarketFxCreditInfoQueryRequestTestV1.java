...
import com.icbc.api.request.InvestmentFinancialMarketFxCreditInfoQueryRequestV1;
import com.icbc.api.request.InvestmentFinancialMarketFxCreditInfoQueryRequestV1.InvestmentFinancialMarketFxCreditInfoQueryRequestBizV1;
import com.icbc.api.request.InvestmentFinancialMarketFxCreditInfoQueryRequestV1.InvestmentFinancialMarketFxCreditInfoQueryRequestBizV1.InParam;
import com.icbc.api.request.InvestmentFinancialMarketFxCreditInfoQueryRequestV1.InvestmentFinancialMarketFxCreditInfoQueryRequestBizV1.InParam.InPrivateInfo;
import com.icbc.api.request.InvestmentFinancialMarketFxCreditInfoQueryRequestV1.InvestmentFinancialMarketFxCreditInfoQueryRequestBizV1.InParam.InPublicInfo;
import com.icbc.api.response.InvestmentFinancialMarketFxCreditInfoQueryResponseV1;

import junit.framework.Assert;

public class InvestmentFinancialMarketFxCreditInfoQueryRequestTestV1 {
	//1、网关公钥
			...
			public static void main(String[] args) throws Exception {
				...
				InvestmentFinancialMarketFxCreditInfoQueryRequestV1 request = new InvestmentFinancialMarketFxCreditInfoQueryRequestV1();
				
				//4、根据测试环境和生产环境替换相应ip和端口
				request.setServiceUrl("https://ip:port/api/investment/financialmarket/fxcreditinfoquery/V1");
				...
				inPublicInfo.setServiceType("fmFxCreditInfoQueryService");
				
				InPrivateInfo inPrivateInfo = new InPrivateInfo(); 
				
				inPrivateInfo.setProdCode("prodTrdFxSwap");
				inPrivateInfo.setSource("3");
				inPrivateInfo.setApplyMemberCode("ICBC");
				inPrivateInfo.setTradeMethod("1");
				inPrivateInfo.setWorkdate("20200409");
				...
				InvestmentFinancialMarketFxCreditInfoQueryRequestBizV1 bizContent = new InvestmentFinancialMarketFxCreditInfoQueryRequestBizV1();
				...
				InvestmentFinancialMarketFxCreditInfoQueryResponseV1 response;
				try {
