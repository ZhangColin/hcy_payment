...
import com.icbc.api.request.MybankLoanCloudquickloanLoanstatusRequestV1;
 ...
 * @Date: 2019/11/11
 */
public class MybankLoanCloudquickloanLoanstatusTestV1 {
    /*public static void main(String[] args) {
        ...
        //5、设置请求对象
        MybankLoanCloudquickloanLoanstatusRequestV1 request = new MybankLoanCloudquickloanLoanstatusRequestV1();
        //6、设置请求路径；联测时，请联系我行告知并替换成测试环境地址。
        request.setServiceUrl("http://ip:port/api/mybank/loan/cloudquickloan/loanstatus/V1");
        //7、设置业务参数
        MybankLoanCloudquickloanLoanstatusRequestV1.MybankLoanLoanstatusRequestV1Biz bizContent = new MybankLoanCloudquickloanLoanstatusRequestV1.MybankLoanLoanstatusRequestV1Biz();

        //8、组装请求参数
        List<MybankLoanCloudquickloanLoanstatusRequestV1.SubInput> subInput = new ArrayList<>();
        MybankLoanCloudquickloanLoanstatusRequestV1.SubInput subInput1 = new MybankLoanCloudquickloanLoanstatusRequestV1.SubInput();
        subInput1.setCIS("xxx");
        subInput1.setOrderNo("xxx");
        subInput1.setRemark1("");
        subInput1.setRemark2("");
        subInput1.setRemark3("");

        subInput.add(subInput1);
        //8、组装请求参数
        ...
        MybankLoanCloudquickloanLoanstatusResponseV1 response;
        try {
            //测试请求时，建议交易流水号请递加1，不然对应的app设置是防重放的话，会报错
