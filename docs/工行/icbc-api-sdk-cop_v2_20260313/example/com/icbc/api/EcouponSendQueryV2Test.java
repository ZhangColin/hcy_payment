...
import com.icbc.api.request.EcouponSendQueryRequestV2;
import com.icbc.api.request.EcouponSendQueryRequestV2.EcouponSendQueryRequestV2Biz;
import com.icbc.api.response.EcouponSendQueryResponseV2;

public class EcouponSendQueryV2Test {
	// 1、网关公钥
	...
	public static void main(String[] args) throws Exception {
		...
		EcouponSendQueryRequestV2 request = new EcouponSendQueryRequestV2();
		// 4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("https://ip:port/api/ecoupon/send/query/V2");

		// 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		EcouponSendQueryRequestV2Biz bizContent = new EcouponSendQueryRequestV2Biz();
		...
		EcouponSendQueryResponseV2 response;
		try {
