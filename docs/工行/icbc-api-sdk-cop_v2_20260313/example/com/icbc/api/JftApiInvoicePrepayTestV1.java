...
import com.icbc.api.request.JftApiInvoicePrepayRequestV1;
import com.icbc.api.request.JftApiInvoicePrepayRequestV1.JftApiInvoicePrepayRequestV1Biz;
import com.icbc.api.response.JftApiInvoicePrepayResponseV1;
public class JftApiInvoicePrepayTestV1 {
	...
	public static void main(String[] args) {
		...
		JftApiInvoicePrepayRequestV1 request = new JftApiInvoicePrepayRequestV1();
		request.setServiceUrl("[需替换]工行API网关地址/jft/api/invoice/prepay/V1");
		JftApiInvoicePrepayRequestV1Biz bizContent = new JftApiInvoicePrepayRequestV1Biz();
		bizContent.setAppId(APP_ID);//平台商户标识
		bizContent.setOutOrderId("20200202002");//平台对接方订单ID
		request.setBizContent(bizContent);

		JftApiInvoicePrepayResponseV1 response;
		try {
