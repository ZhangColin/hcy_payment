...
import com.icbc.api.request.JftApiVendorCouponQueryRequestV1;
import com.icbc.api.request.JftApiVendorCouponQueryRequestV1.JftApiVendorCouponQueryRequestV1Biz;
 ...
 */
public class JftApiVendorCouponQueryTestV1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JftApiVendorCouponQueryRequestV1 request = new JftApiVendorCouponQueryRequestV1();

        //4、根据测试环境和生产环境替换相应ip和端口
        request.setServiceUrl("https://ip:port//api/jft/api/vendor/coupon/query/V1");

        //5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
        JftApiVendorCouponQueryRequestV1Biz bizContent = new JftApiVendorCouponQueryRequestV1Biz();
        bizContent.setAppId("10000000000000004207");
        //优惠券信息
        List<String> coupons = new ArrayList<>();
        coupons.add("02020001234323401010");
        coupons.add("02020001234323401011");
        coupons.add("02020001234323401012");
        bizContent.setCouponList(coupons);
        bizContent.setPromotionId("02020001234323401014");
        bizContent.setQueryType("2");
        request.setBizContent(bizContent);

        JftApiVendorCouponQueryResponseV1 response;
        try {
            response = (JftApiVendorCouponQueryResponseV1) client.execute(request, System.currentTimeMillis()+"");
