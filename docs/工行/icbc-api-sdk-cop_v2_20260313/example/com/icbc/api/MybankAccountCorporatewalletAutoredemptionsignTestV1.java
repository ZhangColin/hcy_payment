...
import com.icbc.api.request.MybankAccountCorporatewalletAutoredemptionsignRequestV1;
import com.icbc.api.response.MybankAccountCorporatewalletAutoredemptionsignResponseV1;
import java.util.List;

public class MybankAccountCorporatewalletAutoredemptionsignTestV1 {
    ...
    public static void main(String[] args) {
        ...
        MybankAccountCorporatewalletAutoredemptionsignRequestV1 request = new MybankAccountCorporatewalletAutoredemptionsignRequestV1();
        request.setServiceUrl("http://IP:PORT/api/mybank/account/corporatewallet/autoredemptionsign/V1");

        MybankAccountCorporatewalletAutoredemptionsignRequestV1.MybankAccountCorporatewalletAutoredemptionsignRequestV1Biz bizContent = new MybankAccountCorporatewalletAutoredemptionsignRequestV1.MybankAccountCorporatewalletAutoredemptionsignRequestV1Biz();
        ...
        bizContent.setCustom_value(customValueList);
        request.setBizContent(bizContent);
        System.out.println("request:" + request.toString());
        MybankAccountCorporatewalletAutoredemptionsignResponseV1 response;
        try {
