...
import com.icbc.api.request.QrcodeQueryRequestV4;
import com.icbc.api.request.QrcodeQueryRequestV4.QrcodeQueryRequestV4Biz;
 ...
 */
public class QrcodeQueryTestV4 {
	...
	public static void main(String[] args) throws Exception {
		...
		QrcodeQueryRequestV4 request = new QrcodeQueryRequestV4();
		
		//4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("https://ip:port/api/qrcode/query/V4");

		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		QrcodeQueryRequestV4Biz bizContent = new QrcodeQueryRequestV4Biz();
		...
		QrcodeQueryResponseV4 response;
		try {
