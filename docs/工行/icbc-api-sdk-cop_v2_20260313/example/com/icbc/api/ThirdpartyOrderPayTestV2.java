...
import com.icbc.api.request.ThirdpartyOrderPayRequestV2;
import com.icbc.api.request.ThirdpartyOrderPayRequestV2.ThirdpartyOrderPayRequestV2Biz;
 ...
 */
public class ThirdpartyOrderPayTestV2 {
	...
	public void order(HttpServletRequest request1, HttpServletResponse response) throws Exception {
		...
		ThirdpartyOrderPayRequestV2 request = new ThirdpartyOrderPayRequestV2();
		
		//4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("http://ip:port/ui/thirdparty/order/pay/V2");
		
		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		ThirdpartyOrderPayRequestV2Biz bizContent = new ThirdpartyOrderPayRequestV2Biz();
		...
		bizContent.setAllPointsFlag("1");// 该字段非必输项
		bizContent.setGoodPoints("500");// 该字段非必输项
