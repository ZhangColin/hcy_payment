...
import com.icbc.api.request.BcssCateringMemOnlinePayRequestV1;
import com.icbc.api.request.BcssCateringMemOnlinePayRequestV1.BcssCateringMemOnlinePayRequestBizV1;
...
public class BcssCateringMemOnlinePayV1Test {
    // 网关公钥
    ...
    public static void main(String[] args) throws IcbcApiException {
        BcssCateringMemOnlinePayRequestV1 request = new BcssCateringMemOnlinePayRequestV1();
        // 根据测试环境和生产环境替换相应ip和端口
        request.setServiceUrl("http://***.***.***.***:****/api/bcss/consume/memonline/pay/V1");
        BcssCateringMemOnlinePayRequestBizV1 bizContent = new BcssCateringMemOnlinePayRequestBizV1();
        bizContent.setCorpId("0***********3");
        bizContent.setMerNo("0***********3************3");
        bizContent.setIndustry("001");
        bizContent.setClientTransNo("0*************************2");
        bizContent.setPayAmt(new BigDecimal(3));
        bizContent.setMemCardNo("412324122333");
        bizContent.setTimeStamp("2024-07-01 10:58:41");
        ...
        List<BcssCateringMemOnlinePayRequestBizV1.BcssCateringMemOnlinePayGoodsInfoDto> goods = new ArrayList<>();
        BcssCateringMemOnlinePayRequestBizV1.BcssCateringMemOnlinePayGoodsInfoDto good1 = new BcssCateringMemOnlinePayRequestBizV1.BcssCateringMemOnlinePayGoodsInfoDto();
        ...
        goods.add(good1);
        BcssCateringMemOnlinePayRequestBizV1.BcssCateringMemOnlinePayGoodsInfoDto good2 = new BcssCateringMemOnlinePayRequestBizV1.BcssCateringMemOnlinePayGoodsInfoDto();
