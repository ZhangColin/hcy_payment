...
import com.icbc.api.request.MybankAccountFarmSyncRetransferRequestV1;
import com.icbc.api.response.MybankAccountFarmSyncRetransferResponseV1;

public class MybankAccountFarmSyncRetransferTestV1 {
protected static String APP_ID = "10000000000004096993";
	...
	public static void main(String[] args) throws Exception {
		String URI = "mybank/account/farm/syncRetransfer/V1";

		
		DefaultIcbcClient client = new DefaultIcbcClient(APP_ID,"RSA2", PRI_KEY, APIGW_PUBLIC_KEY);
		try {
			MybankAccountFarmSyncRetransferRequestV1 request = new MybankAccountFarmSyncRetransferRequestV1();
			MybankAccountFarmSyncRetransferRequestV1.MybankAccountFarmSyncRetransferBizV1 requestBizV1 = new MybankAccountFarmSyncRetransferRequestV1.MybankAccountFarmSyncRetransferBizV1();
	        ...
	        MybankAccountFarmSyncRetransferResponseV1 response = client.execute(request);
