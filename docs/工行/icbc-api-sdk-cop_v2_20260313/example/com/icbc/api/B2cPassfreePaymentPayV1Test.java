...
import com.icbc.api.request.B2cPassfreePaymentPayRequestV1;
import com.icbc.api.request.B2cPassfreePaymentPayRequestV1.B2cPassfreePaymentPayRequestV1Biz;
import com.icbc.api.response.B2cPassfreePaymentPayResponseV1;

public class B2cPassfreePaymentPayV1Test {
	...
	public void test_cop() throws IcbcApiException {
		...
		B2cPassfreePaymentPayRequestV1 request = new B2cPassfreePaymentPayRequestV1();
		
		//根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("https://ip:port/api/b2c/passfree/payment/pay/V1");

		B2cPassfreePaymentPayRequestV1Biz bizContent = new B2cPassfreePaymentPayRequestV1Biz();
		...
		B2cPassfreePaymentPayResponseV1 response;
		try {
