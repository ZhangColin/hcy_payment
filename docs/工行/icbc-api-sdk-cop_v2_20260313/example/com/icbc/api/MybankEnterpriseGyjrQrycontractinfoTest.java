...
import com.icbc.api.request.MybankEnterpriseGyjrQrycontractinfoRequestV1;
import com.icbc.api.request.MybankEnterpriseGyjrQrycontractinfoRequestV1.MybankEnterpriseGyjrQrycontractinfoRequestBizV1;
import com.icbc.api.request.MybankEnterpriseGyjrQrycontractinfoRequestV1.TransCommV10;
import com.icbc.api.response.MybankEnterpriseGyjrQrycontractinfoResponseV1;

public class GyjrB2bRzstContractQryContractInfoTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        MybankEnterpriseGyjrQrycontractinfoRequestBizV1 bizContent =
        new MybankEnterpriseGyjrQrycontractinfoRequestBizV1();
        MybankEnterpriseGyjrQrycontractinfoRequestV1 request =
        new MybankEnterpriseGyjrQrycontractinfoRequestV1();
        ...
        if (null == validate) {
        MybankEnterpriseGyjrQrycontractinfoResponseV1 response = client.execute(request);
