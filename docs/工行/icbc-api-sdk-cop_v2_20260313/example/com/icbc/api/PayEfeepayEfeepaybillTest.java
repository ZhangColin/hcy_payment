...
import com.icbc.api.request.PayEfeepayEfeepaybillRequestV1;
import com.icbc.api.request.PayEfeepayEfeepaybillRequestV1.PayEfeepayEfeepaybillRequestV1Biz;
import com.icbc.api.IcbcResponse;



public class PayEfeepayEfeepaybillTest {
	...
	public static void main(String[] args) throws IcbcApiException {
		...
		PayEfeepayEfeepaybillRequestV1 request = new PayEfeepayEfeepaybillRequestV1();
		request.setServiceUrl("http://ip:port/ui/pay/efeepay/efeepaybill/V1");
		//请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		PayEfeepayEfeepaybillRequestV1Biz bizContent = new PayEfeepayEfeepaybillRequestV1Biz();
