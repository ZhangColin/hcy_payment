...
import com.icbc.api.request.SgeBalanceQueryRequestV1;
import com.icbc.api.request.SgeBalanceQueryRequestV1.SgeBalanceQueryRequestBiz;
import com.icbc.api.response.SgeBalanceQueryResponseV1;
public class SgeBalanceQueryTestV1 {
	...
	public void test_cop() throws IcbcApiException {
		...
		SgeBalanceQueryRequestV1 request = new SgeBalanceQueryRequestV1();
		request.setServiceUrl("http://ip:port/api/sge/balance/query/V1");

		SgeBalanceQueryRequestBiz bizContent = new SgeBalanceQueryRequestBiz();
		bizContent.setClientId(1311022886);

		request.setBizContent(bizContent);

		SgeBalanceQueryResponseV1 response = client.execute(request);
