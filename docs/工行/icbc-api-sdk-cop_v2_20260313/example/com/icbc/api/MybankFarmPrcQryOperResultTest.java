...
import com.icbc.api.request.MybankFarmPrcQryOperResultRequestV1;
import com.icbc.api.response.MybankFarmPrcQryOperResultResponseV1;
 ...
 */
public class MybankFarmPrcQryOperResultTest {
	...
	public static void main(String[] args) throws Exception {
		String URI = "mybank/account/farm/qryOperResult/V1";
				
		DefaultIcbcClient client = new DefaultIcbcClient(APP_ID,"RSA2", PRI_KEY, APIGW_PUBLIC_KEY);
		try {
			MybankFarmPrcQryOperResultRequestV1 request = new MybankFarmPrcQryOperResultRequestV1();
			MybankFarmPrcQryOperResultRequestV1.MybankFarmPrcQryOperResultRequestBizV1 requestBizV1 = new MybankFarmPrcQryOperResultRequestV1.MybankFarmPrcQryOperResultRequestBizV1();
			...
			requestBizV1.setDetail("{\"propertyId\":\"20240326000122011\",\"sellerId\":\"1234567\",\"acctNo\":\"123\"}");
			...
			MybankFarmPrcQryOperResultResponseV1 response = client.execute(request);
