...
import com.icbc.api.request.JftApiVacctNovelAcctOpenCardUpdateRequestV1;
import com.icbc.api.request.JftApiVacctNovelAcctOpenCardUpdateRequestV1.JftApiVacctNovelAcctOpenCardUpdateRequestV1Biz;
import com.icbc.api.response.JftApiVacctNovelAcctOpenCardUpdateResponseV1;
import org.junit.Test;

public class JftApiVacctNovelAcctOpenCardUpdateTest {
    ...
    public void test_cop() {
        ...
        JftApiVacctNovelAcctOpenCardUpdateRequestV1 request = new JftApiVacctNovelAcctOpenCardUpdateRequestV1();
        request.setServiceUrl("http://ip:port/api/jft/api/vacct/novel/acct/open/card/update/V1");
        JftApiVacctNovelAcctOpenCardUpdateRequestV1Biz bizContent = new JftApiVacctNovelAcctOpenCardUpdateRequestV1Biz();
        bizContent.setAppId("10000000000000286524");
        bizContent.setOutSubVendorId("05280950");
        bizContent.setAcctNo("2021070109070000000040");
        bizContent.setIsOpenCard("0");
        request.setBizContent(bizContent);
        JftApiVacctNovelAcctOpenCardUpdateResponseV1 response;
        try {
            response = (JftApiVacctNovelAcctOpenCardUpdateResponseV1) client.execute(request, System.currentTimeMillis()+"");
