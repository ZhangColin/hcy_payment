...
import com.icbc.api.request.CardbusinessCardqrh5UiConsumptionRequestV1;
import com.icbc.api.request.CardbusinessCardqrh5UiConsumptionRequestV1.CardbusinessCardqrh5UiConsumptionRequestV1Biz;

public class CardbusinessCardqrh5UiConsumptionV1Test {
	...
	private Logger logger = Logger.getLogger(CardbusinessCardqrh5UiConsumptionV1Test.class.getName());



	public void test_cop() throws IcbcApiException {
		UiIcbcClient client = null;
		CardbusinessCardqrh5UiConsumptionRequestV1 request = new CardbusinessCardqrh5UiConsumptionRequestV1();
		...
		request.setServiceUrl("https://ip:port/ui/cardbusiness/cardqrh5/ui/consumption/V1");
		CardbusinessCardqrh5UiConsumptionRequestV1Biz bizContent = new CardbusinessCardqrh5UiConsumptionRequestV1Biz();
		request.setBizContent(bizContent);
		//请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		bizContent.setServiceId("xxx");
		bizContent.setCisno("xxx");
		bizContent.setUserId("xxx");
		bizContent.setReqChannelType("xxx");
		bizContent.setDeviceId("xxx");
		bizContent.setUserType("xxx");
		bizContent.setMobile("xxx");
		bizContent.setUserCity("xxx");
		bizContent.setQrCode("xxx");
		bizContent.setCardQRToken("xxx");
		bizContent.setCrdQrTongCallbackUrl("xxx");
