 ...
 */
public class MybankFarmThirdUserAddTest {
    ...
    public static void main(String[] args) throws Exception {
		String URI = "/mybank/farm/farmplatf/addThirdUser/V1";
		...
		try {
			...
			bizContent.setfSeqNo("111111111");
			bizContent.setCorpCode("GX");
			bizContent.setTranType("1");
			bizContent.setInstId("1101");
			bizContent.setAuthSwitch("1");
			bizContent.setMobilePhone("13100000001");
			bizContent.setCorpUserId("testCorpUseId");
			bizContent.setRoleId("CRT00001");
			bizContent.setUserName("测试用户姓名");
