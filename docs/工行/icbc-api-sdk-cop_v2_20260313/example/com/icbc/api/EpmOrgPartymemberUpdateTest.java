...
import com.icbc.api.request.PartyerUpdateRequestV1;
import com.icbc.api.response.PartyerUpdateResponseV1;

public class EpmOrgPartymemberUpdateTest extends HttpServlet{

	private static final long serialVersionUID = -5532204010005647452L;

	public static void main(String[] args) {
		String appId ="10000000000000469001";
		String MY_PRIVATE_KEY = "-----请使用正确的APP私钥-----EvgIBADANBgkqhkiG9w0BAQEFAASCBKgwggSkAgEAAoIBAQCG8kbF/xbf2YnIW\r\n" + 
		...
		String url = "http://ip:port/api/epm/org/partymember/update/V1";
		DefaultIcbcClient client = new DefaultIcbcClient(appId, MY_PRIVATE_KEY, APIGW_PUBLIC_KEY);
		
		PartyerUpdateRequestV1 request = new PartyerUpdateRequestV1();
		PartyerUpdateRequestV1.PartyerUpdateRequestV1Biz bizContent = new PartyerUpdateRequestV1.PartyerUpdateRequestV1Biz();
		bizContent.setProtocolNo("PT201812131000001080020"); 
		bizContent.setAddress("地址");
		bizContent.setDep("dep");
		bizContent.setEmail("123@qq.com");
		bizContent.setIdNo("123456789987654567321");
		bizContent.setIdType("1");
		bizContent.setInfo("info");
		bizContent.setName("name");
		bizContent.setOrgId("100");
		bizContent.setPartyerType("1");
		bizContent.setPartyTime("20190331");
		bizContent.setPersonalId("989822377");
		bizContent.setPhone("18755530808");
		request.setServiceUrl(url);
		request.setBizContent(bizContent);	
		PartyerUpdateResponseV1 resp = new PartyerUpdateResponseV1();
