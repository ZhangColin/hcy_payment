...
import com.icbc.api.request.EnterpriseSalaryAnnuityAssetqueryRequestV1;
...
/**
 * @Author: kfzx-libl
 * @Description: 个人年金资产数据查询测试案例
 * @Date: 2021/1/11
 */
public class EnterpriseSalaryAnnuityAssetqueryV1Test {
    ...
    public void test_cop() {
        ...
        //6、设置请求对象
        EnterpriseSalaryAnnuityAssetqueryRequestV1 request = new EnterpriseSalaryAnnuityAssetqueryRequestV1();
        //7、设置请求路径；联测时，请联系我行告知并替换成测试环境地址。
        request.setServiceUrl("https://ip:port/api/enterprise/salary/annuity/assetquery/V1");
        //8、设置业务参数
        EnterpriseSalaryAnnuityAssetqueryRequestV1.EnterpriseSalaryAnnuityAssetqueryRequestV1Biz bizContent = new EnterpriseSalaryAnnuityAssetqueryRequestV1.EnterpriseSalaryAnnuityAssetqueryRequestV1Biz();
        ...
        EnterpriseSalaryAnnuityAssetqueryResponseV1 response = null;
        try {
            response = client.execute(request);
        } catch (IcbcApiException e) {
            // 测试环境案例经常调不通 给个默认值
            response = new EnterpriseSalaryAnnuityAssetqueryResponseV1();
        }
