...
import com.icbc.api.request.JftApiVacctNovelAcctOrderRefundRequestV1;
import com.icbc.api.request.JftApiVacctNovelAcctOrderRefundRequestV1.JftApiVacctNovelAcctOrderRefundRequestV1Biz;
import com.icbc.api.response.JftApiVacctNovelAcctOrderRefundResponseV1;
import org.junit.Test;

public class JftApiVacctNovelAcctOrderRefundTestV1 {
    ...
    public void test_cop() {
        ...
        JftApiVacctNovelAcctOrderRefundRequestV1 request = new JftApiVacctNovelAcctOrderRefundRequestV1();
        request.setServiceUrl("http://ip:port/api/jft/api/vacct/novel/acct/order/refund/V1");
        JftApiVacctNovelAcctOrderRefundRequestV1Biz bizContent = new JftApiVacctNovelAcctOrderRefundRequestV1Biz();
        bizContent.setAppId("10000000000000286524");
        bizContent.setOutSubVendorId("05280940");
        bizContent.setBusiNo("0JFT20210701000113633261");
        bizContent.setSerialNo("30902000146002001095449610");
        bizContent.setOriginTranId("0JFT20210700900113222283");
        bizContent.setAcctNo("2021070110590000000044");
        bizContent.setAmount("100");
        bizContent.setVersion("1.0.0");//设置接口访问版本号
        request.setBizContent(bizContent);
        JftApiVacctNovelAcctOrderRefundResponseV1 response;
        try {
            response = (JftApiVacctNovelAcctOrderRefundResponseV1) client.execute(request, System.currentTimeMillis()+"");
