...
import com.icbc.api.request.CacaReceiptAllreceiptQueryposreceiptbyseqnoRequestV1;
import com.icbc.api.response.CacaReceiptAllreceiptQueryposreceiptbyseqnoResponseV1;

import java.util.*;

public class CacaReceiptAllreceiptQueryposreceiptbyseqnoTestV1 {
    ...
    public static void main(String[] args) {
        ...
        CacaReceiptAllreceiptQueryposreceiptbyseqnoRequestV1 request = new CacaReceiptAllreceiptQueryposreceiptbyseqnoRequestV1();
        request.setServiceUrl("https://ip:port/api/caca/receipt/allreceipt/queryposreceiptbyseqno/V1");
        CacaReceiptAllreceiptQueryposreceiptbyseqnoRequestV1.QPosReceiptBySeqnoRequestV1Biz bizContent = new CacaReceiptAllreceiptQueryposreceiptbyseqnoRequestV1.QPosReceiptBySeqnoRequestV1Biz();

        // public 通讯区定义赋值
        CacaReceiptAllreceiptQueryposreceiptbyseqnoRequestV1.QPosReceiptBySeqnoRequestV1Pub pubObj = new CacaReceiptAllreceiptQueryposreceiptbyseqnoRequestV1.QPosReceiptBySeqnoRequestV1Pub();
        pubObj.setCode("29060");
        pubObj.setZone("0200");
        pubObj.setFr("0");
        pubObj.setDt("2017-07-06");
        // private 通讯区定义赋值
        CacaReceiptAllreceiptQueryposreceiptbyseqnoRequestV1.QPosReceiptBySeqnoRequestV1In inObj = new CacaReceiptAllreceiptQueryposreceiptbyseqnoRequestV1.QPosReceiptBySeqnoRequestV1In();
        inObj.setZone("0200");
        inObj.setBrno("");
        inObj.setTelno("");
        inObj.setChannel("");
        CacaReceiptAllreceiptQueryposreceiptbyseqnoRequestV1.QPosReceiptBySeqnoCondRequestV1In qPosReceiptBySeqnoCondRequestV1In = new CacaReceiptAllreceiptQueryposreceiptbyseqnoRequestV1.QPosReceiptBySeqnoCondRequestV1In();
        qPosReceiptBySeqnoCondRequestV1In.setAccno("");
        qPosReceiptBySeqnoCondRequestV1In.setCurrtype("");
        qPosReceiptBySeqnoCondRequestV1In.setSerialno("");
        qPosReceiptBySeqnoCondRequestV1In.setSadlindate("");
        ArrayList<CacaReceiptAllreceiptQueryposreceiptbyseqnoRequestV1.QPosReceiptBySeqnoCondRequestV1In> qPosReceiptBySeqnoCondRequestV1Ins = new ArrayList<>();
        qPosReceiptBySeqnoCondRequestV1Ins.add(qPosReceiptBySeqnoCondRequestV1In);
        inObj.setCond(qPosReceiptBySeqnoCondRequestV1Ins);
        bizContent.setIn(inObj);
        bizContent.setPub(pubObj);
        request.setBizContent(bizContent);
        try {
            CacaReceiptAllreceiptQueryposreceiptbyseqnoResponseV1 response = client.execute(request);
