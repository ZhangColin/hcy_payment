...
import com.icbc.api.response.epassuserinfoqueryResponseV1;
import com.icbc.api.response.epassuserinfoqueryResponseV1.PRIVATEResponseV1Message;
import com.icbc.api.response.epassuserinfoqueryResponseV1.appstatv10ResponseV1Message;
import com.icbc.api.response.epassuserinfoqueryResponseV1.ThirtinfoResponseV1Message;//嵌套层
import com.icbc.api.IcbcConstants;
import com.icbc.api.request.epassuserinfoqueryRequestV1;
import com.icbc.api.request.epassuserinfoqueryRequestV1.epassuserinfoqueryRequestV1Biz;

public class epassuserinfoqueryTestV1 {
	...
	public static void main(String[] args) {
		...
		epassuserinfoqueryRequestV1 request = new epassuserinfoqueryRequestV1();
		
		//4、根据测试环境和生产环境替换相应ip和端口
		//行外流程
		request.setServiceUrl("http://ip:port/api/cert/epass/thirdparty/epassuserinfoquery/V1");
		
		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值			
		epassuserinfoqueryRequestV1Biz bizContent = new epassuserinfoqueryRequestV1Biz();
...
//		}
		...
		epassuserinfoqueryRequestV1.ChanCommV10RequestV1Message ChanCommV10 = new epassuserinfoqueryRequestV1.ChanCommV10RequestV1Message();
		ChanCommV10.setOAPP("F-WAPB");
		ChanCommV10.setCHANTYPE("303");
		bizContent.setChanCommV10(ChanCommV10);

		epassuserinfoqueryRequestV1.InfoCommV10RequestV1Message InfoCommV10 = new epassuserinfoqueryRequestV1.InfoCommV10RequestV1Message();
		...
		epassuserinfoqueryRequestV1.InputV10RequestV1Message InputV10 = new epassuserinfoqueryRequestV1.InputV10RequestV1Message();
		InputV10.setCHANNELCODE("13090909090");
		InputV10.setUSERID("123");
		bizContent.setInputV10(InputV10);
		
		request.setBizContent(bizContent);
		//建立返回项
		epassuserinfoqueryResponseV1 response = new epassuserinfoqueryResponseV1();
		try {
			response = client.execute(request);
			//System.out.println(JSONObject.toJSONString(response));
			epassuserinfoqueryResponseV1.appstatv10ResponseV1Message appstatv10 = response.getAppstatv10();
			epassuserinfoqueryResponseV1.PRIVATEResponseV1Message privatev10 = response.getPrivatev10();
			...
			if(privatev10!=null){
				epassuserinfoqueryResponseV1.ThirtinfoResponseV1Message[] Thirtinfo = privatev10.getThirtinfo();
				System.out.println("OPENID:"+Thirtinfo[0].getOPENID());
			    System.out.println("THIRDTYPE:"+Thirtinfo[0].getTHIRDTYPE());
				System.out.println("CHANNELCODE:"+Thirtinfo[0].getCHANNELCODE());
				System.out.println("RELATETIME:"+Thirtinfo[0].getRELATETIME());
			    System.out.println("RELIEVE_RELATETIME:"+Thirtinfo[0].getRELIEVE_RELATETIME());
				System.out.println("STATUS:"+Thirtinfo[0].getSTATUS());				
			}
