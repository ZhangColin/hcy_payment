...
import com.icbc.api.request.JftApiRescindUserProtocolRequestV1;
import com.icbc.api.request.JftApiRescindUserProtocolRequestV1.JftApiRescindUserProtocolRequestV1Biz;
import com.icbc.api.response.JftApiRescindUserProtocolResponseV1;
 ...
 */
public class JftApiRescindUserProtocolTestV1 {
	...
	public static void main(String[] args) throws Exception {
		...
		JftApiRescindUserProtocolRequestV1 request = new JftApiRescindUserProtocolRequestV1();

		//4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("https://ip:port/api/jft/api/rescind/user/protocol/V1");

		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		JftApiRescindUserProtocolRequestV1Biz bizContent = new JftApiRescindUserProtocolRequestV1Biz();
		...
		JftApiRescindUserProtocolResponseV1 response;
		try {
			response = (JftApiRescindUserProtocolResponseV1) client.execute(request, System.currentTimeMillis() + "");//msgId消息通讯唯一编号，要求每次调用独立生成，APP级唯一
