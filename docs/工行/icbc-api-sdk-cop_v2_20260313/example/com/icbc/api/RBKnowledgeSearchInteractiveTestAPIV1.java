...
/**
 * RBInteractKwlgSearchService交互式智能搜索服务化接口（V0022服务化接口）
 * 
...
public class RBKnowledgeSearchInteractiveTestAPIV1 {
	...
	public static void main(String[] args) throws Exception {
		...
		bizContent.setSpTransCode("V0022");	//写死V0022
		bizContent.setSChannel("01");	//来源渠道
		bizContent.setSSerialNo("13591097788");// 01渠道为手机号（各渠道不同）
		bizContent.setSInQuestion("信用卡办理");//客户问题
