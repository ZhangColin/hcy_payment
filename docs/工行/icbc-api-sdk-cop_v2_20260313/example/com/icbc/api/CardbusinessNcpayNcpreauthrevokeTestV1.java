...
public class CardbusinessNcpayNcpreauthrevokeTestV1 {
    public static void main(String[] args) throws IcbcApiException {
        ...
        request.setServiceUrl("http://ip:port/api/cardbusiness/ncpay/ncpreauthrevoke/V1");//功能
        //request.setServiceUrl("http://gw.dccnet.com.cn:8088/api/cardbusiness/ncpay/ncpreauthrevoke/V1");//功能外网
        ...
        bizContent.setTrxSerno("0821140144000005");
        ...
        bizContent.setoAuthorNo("820730");
        bizContent.setoTrxAmt("10");
        bizContent.setSceneAgreement("202009090030909163100973807");
        bizContent.setoBankTrxDate("2021-10-02");
        bizContent.setoBankTrxSerno("020001040286000722009090036001");
        bizContent.setExtendInfo("test-revoke");
        ...
        CardbusinessNcpayNcpreauthrevokeResponseV1 response = client.execute(request, msgId);
