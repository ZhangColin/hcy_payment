...
import com.icbc.api.request.ScisCustInfoMaintainRequestV1;
import com.icbc.api.response.ScisCustInfoMaintainResponseV1;
 ...
 **/
public class ScisCustInfoMaintainRequestTestV1 {

    protected static Logger log = Logger.getLogger(ScisCustInfoMaintainRequestTestV1.class.getName());
    ...
    public static void main(String[] args) {
        ...
        String URI = "scis/cust/info/maintain/V1";
        DefaultIcbcClient client = new DefaultIcbcClient(APP_ID, PRI_KEY, APIGW_PUBLIC_KEY);
        try {
            ScisCustInfoMaintainRequestV1.ScisCustomerInfoRequestV1Biz bizContent = new ScisCustInfoMaintainRequestV1.ScisCustomerInfoRequestV1Biz();
            ScisCustInfoMaintainRequestV1 request = new ScisCustInfoMaintainRequestV1();

            String reqData = "<?xml version=\"1.0\" encoding=\"UTF-8\" ?>\n" +
                    "<APPROOT from=\"F-CORP\" to=\"F-SCIS\" mode=\"syn\" >\n" +
                    "\t<PUBLIC>\n" +
                    "\t\t<!-- 交易代码 -->\n" +
                    "\t\t<TxCode>SCI02000</TxCode>\n" +
                    "\t\t<!-- 公司代码 参照工行统一机构代码的分配-->\n" +
                    ...
                    "\t\t<Common>\n" +
                    "\t\t\t<!-- 客户信息号  必输-->\n" +
                    "\t\t\t<CUST_ID>900110000000011</CUST_ID>\n" +
                    ...
                    "\t\t\t<!-- 出生日期 -->\n" +
                    "\t\t\t<field name='BIRTH_DATE'>YYYYMMDD</field>\t\t\t\n" +
                    "\t\t\t<!-- 性别 1-男 2-女 0-未知 -->\n" +
                    "\t\t\t<field name='GENDER'>1</field>\n" +
                    "\t\t\t<!-- 死亡日期 -->\n" +
                    "\t\t\t<field name='DEATH_DATE'>YYYYMMDD</field>\t\t\t\t\t\n" +
                    "\t\t\t<!-- 生存状态 -->\t\t\t\n" +
                    "\t\t\t<field name='LIVE_STATUS'>1</field>\n" +
                    "\t\t\t<!-- 婚姻状况-->\n" +
                    "\t\t\t<field name='MARITAL_STAT'>1</field>\n" +
                    "\t\t\t<!-- 国籍 -->\n" +
                    "\t\t\t<field name='PRIM_NAT'>020021</field>\t\t\t\t\n" +
                    "\t\t\t<!-- 户口所在地 -->\t\t\t\n" +
                    ...
                    "\t\t\t<!-- 证件类型 -->\t\t\t  \t\t\n" +
                    "\t\t\t<field name='REG_TYPE'>50</field>\n" +
                    "\t\t\t<!-- 证件号码 --> \n" +
                    "\t\t\t<field name='REG_NO'>032210211112031</field>\n" +
                    "\t\t\t<!-- 客户名称 -->\n" +
                    "\t\t\t<field name='NAME'></field>\t\t\t\t\t\t\t\t \n" +
                    "\t\t\t<!-- 客户所属国家地区(证件注册国家) -->\n" +
                    "\t\t\t<field name='PRIM_NAT'></field>\t\t\t\t\n" +
                    "\t\t\t<!-- 证件签发日期 -->\n" +
            ...
            request.setBizContent(bizContent);
            ScisCustInfoMaintainResponseV1 response = (ScisCustInfoMaintainResponseV1) client.execute(request);
