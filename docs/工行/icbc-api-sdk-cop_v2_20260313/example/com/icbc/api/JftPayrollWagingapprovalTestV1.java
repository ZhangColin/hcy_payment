...
import com.icbc.api.request.JftPayrollWagingapprovalRequestV1;
import com.icbc.api.request.JftPayrollWagingapprovalRequestV1.JftPayrollWagingapprovalRequestV1Biz;

public class JftPayrollWagingapprovalTestV1 {
    ...
    JftPayrollWagingapprovalRequestV1 requestV1=new JftPayrollWagingapprovalRequestV1();
        requestV1.setServiceUrl("http://ip:port//ui/jft/payroll/wagingapproval/V1");
        Logger log = Logger.getLogger(JftPayrollWagingapprovalTestV1.class.getName());
        JftPayrollWagingapprovalRequestV1.JftPayrollWagingapprovalRequestV1Biz bizContent=new  JftPayrollWagingapprovalRequestV1.JftPayrollWagingapprovalRequestV1Biz();
