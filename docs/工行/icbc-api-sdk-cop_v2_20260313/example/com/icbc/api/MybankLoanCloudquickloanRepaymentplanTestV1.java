...
import com.icbc.api.request.MybankLoanCloudquickloanRepaymentplanRequestV1;
import com.icbc.api.response.MybankLoanCloudquickloanRepaymentplanResponseV1;
 ...
 * @Date: 2019/11/11
 */
public class MybankLoanCloudquickloanRepaymentplanTestV1 {
    /*public static void main(String[] args) {
        ...
        //5、设置请求对象
        MybankLoanCloudquickloanRepaymentplanRequestV1 request = new MybankLoanCloudquickloanRepaymentplanRequestV1();
        //6、设置请求路径；联测时，请联系我行告知并替换成测试环境地址。
        request.setServiceUrl("http://ip:port/api/mybank/loan/cloudquickloan/repaymentplan/V1");
        //7、设置业务参数
        MybankLoanCloudquickloanRepaymentplanRequestV1.MybankLoanRepaymentplanRequestV1Biz bizContent = new MybankLoanCloudquickloanRepaymentplanRequestV1.MybankLoanRepaymentplanRequestV1Biz();

        //8、组装请求参数
        bizContent.setType("01");
        bizContent.setQueryType("1");
        bizContent.setCIS("05819f7c1a80d35d0fd3c01ad03f5000");
        bizContent.setOrderNo("CS1911141448DJ21B");//请改成真实的订单号
        bizContent.setLoanAmt("11");
        bizContent.setLoanTerm("11");
        bizContent.setLoanDate("19000101");
        bizContent.setRemark1("");
        bizContent.setRemark2("");
        bizContent.setRemark3("");
        bizContent.setCooperUnit("ST0340014");

        request.setBizContent(bizContent);

        MybankLoanCloudquickloanRepaymentplanResponseV1 response;
        try {
