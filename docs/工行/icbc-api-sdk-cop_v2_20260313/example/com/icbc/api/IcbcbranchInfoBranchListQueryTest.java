...
import com.icbc.api.request.IcbcbranchInfoBranchListQueryRequestV1;
import com.icbc.api.request.IcbcbranchInfoBranchListQueryRequestV1.IcbcbranchInfoBranchListQueryRequestV1V1Biz;
import com.icbc.api.response.IcbcbranchInfoBranchListQueryResponseV1;

/**
 *
 * @ClassName IcbcbranchInfoBranchListQueryTest
 *  @Description TODO
 * @author: kfzx-zhanyic
 * @create: 2022-12-08 17:02
 **/
public class IcbcbranchInfoBranchListQueryTest {
    public static void main(String[] args) {
        ...
        jsonObj.put("lat", "123.45678");
        jsonObj.put("lon", "43.54321");
        jsonObj.put("queryNum", "5");
        // ��ȡ���ö������÷����Ӧ��uri�����÷�ʽ�����ò�����
        DefaultInvoker invoker = context.getDefaultInvoker();
        invoker.setUri("/icbcbranch/info/branchList/query/V1");
