...
import com.icbc.api.request.MybankLoanCloudquickloanOrderexitRequestV1;
 ...
 * @Date: 2019/12/10
 */
public class MybankLoanCloudquickloanOrderexitTestV1 {
    /*public static void main(String[] args) throws IcbcApiException {
        ...
        //5、设置请求对象
        MybankLoanCloudquickloanOrderexitRequestV1 request = new MybankLoanCloudquickloanOrderexitRequestV1();
        //6、设置请求路径；联测时，请联系我行告知并替换成测试环境地址。
        request.setServiceUrl("http://ip:port/api/mybank/loan/cloudquickloan/orderexit/V1");
        //7、设置业务参数
        MybankLoanCloudquickloanOrderexitRequestV1.MybankLoanOrderexitRequestV1Biz bizContent = new MybankLoanCloudquickloanOrderexitRequestV1.MybankLoanOrderexitRequestV1Biz();

        //8、组装请求参数
        bizContent.setType("01");
        bizContent.setOutid("xx");
        bizContent.setCooperUnit("xx");
        bizContent.setOrderNo("xx");
        bizContent.setTradingNo("xx");
        bizContent.setCancelAmt("xx");
        bizContent.setCancelAdvAmt("xx");
        bizContent.setAccount("xx");
        ...
        MybankLoanCloudquickloanOrderexitResponseV1 response;
        try {
