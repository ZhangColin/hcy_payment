...
public class MybankFarmThirdRoleAddTest {
	...
	public	 static void main(String[] args) throws Exception {
		String URI = "/mybank/farm/farmplatf/addCorpRole/V1";
		...
		try { 
			...
			bizContent.setfSeqNo("sjxfSeqNoAdd"+new Random().nextInt(1000));
			bizContent.setOperatorUserId("SJXtestuserid001");
			bizContent.setRoleDesc("测试角色"+new Date());
			bizContent.setRoleLevel("2");
			List<String> list = new ArrayList();
			list.add("M0006001");
			//bizContent.setMenuIdList(Arrays.asList("M0001000|M0006000|M0006001|M0006002|M0006003|M0006004|M0006005|M0006006|M0006007|M0006008|M0006009"
			//		.split("\\|")));
			bizContent.setMenuIdList(list);
