...
import com.icbc.api.request.OfstQrcodeRejectRequestV1;
import com.icbc.api.request.OfstQrcodeRejectRequestV1.OfstQrcodeRejectRequestV1Biz;
import com.icbc.api.response.OfstQrcodeRejectResponseV1;
 ...
 */
public class OfstQrcodeRejectTest extends JFrame {
	...
	public static void main(String[] args) throws Exception {
		...
		OfstQrcodeRejectRequestV1 request = new OfstQrcodeRejectRequestV1();
		
		//4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("https://ip:port/api/ofst/qrcode/V1/reject");

		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		OfstQrcodeRejectRequestV1Biz bizContent = new OfstQrcodeRejectRequestV1Biz();
		...
		OfstQrcodeRejectResponseV1 response;
		try {
