...
import com.icbc.api.request.JftApiUserRireceiveAddRequestV1.JftApiUserRireceiveAddRequestV1Biz;
import com.icbc.api.response.JftApiUserRireceiveAddResponseV1;

public class JftApiUserRireceiveAddV1Test {
    //1、网关公钥
    ...
    public static void main(String[] args) throws Exception {
        ...
        String apiUrl = host + "/api/jft/api/user/rireceive/add/V1";
        ...
        try {
            response = (JftApiUserRireceiveAddResponseV1) client.execute(request,
