...
import com.icbc.api.request.JftApiPayQrcodeRequestV2.JftApiPayQrcodeRequestV2Biz;
import com.icbc.api.response.JftApiPayQrcodeResponseV2;

public class JftApiPayQrcodeTestV2 {
	...
	public static void main(String[] args) {
		...
		request.setServiceUrl("http://ip:port/api/jft/api/pay/qrcode/V2");
		JftApiPayQrcodeRequestV2Biz bizContent = new JftApiPayQrcodeRequestV2Biz();
