...
import com.icbc.api.request.CardbusinessMerTripUpdatefacedataRequestV1;
import com.icbc.api.response.CardbusinessMerTripUpdatefacedataResponseV1;
 ...
 * 同步人脸信息
 */
public class CardbusinessMerTripUpdatefacedataTest {
	...
	public static void main(String[] args) throws IcbcApiException {
		...
		CardbusinessMerTripUpdatefacedataRequestV1 request = new CardbusinessMerTripUpdatefacedataRequestV1();
		// 是否使用AES加密请求数据
...
//		request.setServiceUrl("http://ip:port/api/cardbusiness/ncpay/ncpay/V1");//功能
		request.setServiceUrl("http://gw.dccnet.com.cn:8088/api/cardbusiness/mer/trip/faceinfosync/V1");//功能外网

		// 5、请参照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		CardbusinessMerTripUpdatefacedataRequestV1.CardbusinessMerTripUpdatefacedataRequestV1Biz bizContent = new CardbusinessMerTripUpdatefacedataRequestV1.CardbusinessMerTripUpdatefacedataRequestV1Biz();
		...
		bizContent.setCorpId("XXX");
		bizContent.setStartTime(dataStr);
		bizContent.setEndTime(timeStr);
		bizContent.setPageNum(3);
		bizContent.setPageSize(10);


		// msgId消息通讯唯一编号，要求每次调用独立生成，APP级唯一
		String msgId = String.valueOf(System.currentTimeMillis());
		CardbusinessMerTripUpdatefacedataResponseV1 response = client.execute(request, msgId);
