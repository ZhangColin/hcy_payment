...
import com.icbc.api.request.EcspSaveCarNoRequestV1;
import com.icbc.api.response.EcspSaveCarNoResponseV1;

/**
 * @author kfzx-caibb
 */
public class EcspSaveCarNoV1Test {
    // 1、网关公钥
    ...
    public static void main(String[] args) throws Exception {
        ...
        EcspSaveCarNoRequestV1 request = new EcspSaveCarNoRequestV1();

        // 4、根据测试环境和生产环境替换相应ip和端口
        request.setServiceUrl("http://ip:port/api/ecsp/oc/prop/car/saveCarNo/V1");
        // 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
        EcspSaveCarNoRequestV1.EcspSaveCarNoRequestV1Biz bizContent = new EcspSaveCarNoRequestV1.EcspSaveCarNoRequestV1Biz();
        bizContent.setCorpId("0000000001");
        bizContent.setUserName("张三");
        bizContent.setPhone("13711111111");
        bizContent.setOldCarNo("粤C12345");
        bizContent.setNewCarNo("粤B12345");
        bizContent.setParkingId("001");
        request.setBizContent(bizContent);

        EcspSaveCarNoResponseV1 response;
        try {
