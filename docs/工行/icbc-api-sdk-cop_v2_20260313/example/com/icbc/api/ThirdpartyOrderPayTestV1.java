...
import com.icbc.api.request.ThirdpartyOrderPayRequestV1;
import com.icbc.api.request.ThirdpartyOrderPayRequestV1.ThirdpartyOrderPayRequestV1Biz;
 ...
 */
public class ThirdpartyOrderPayTestV1 {
	...
	public void order(HttpServletRequest request1, HttpServletResponse response) throws Exception {
		...
		ThirdpartyOrderPayRequestV1 request = new ThirdpartyOrderPayRequestV1();
		
		//4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("http://ip:port/ui/thirdparty/order/V1/pay");
		
		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		ThirdpartyOrderPayRequestV1Biz bizContent = new ThirdpartyOrderPayRequestV1Biz();
