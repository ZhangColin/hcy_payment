...
import com.icbc.api.request.MybankPayInsuranceCustprtlCustprtlcancleRequestV1;
import com.icbc.api.response.MybankPayInsuranceCustprtlCustprtlcancleResponseV1;
import java.util.logging.Logger;

public class MybankPayInsuranceCustprtlCustprtlcancleV1Test {
    static Logger log = Logger.getLogger(MybankPayInsuranceCustprtlCustprtlcancleV1Test.class.getName());
    //估值表
    protected static String APP_ID = "xxxxxxxxxxxxxxxxxxxxx";
    ...
    public static void main(String[] args) throws Exception {
        String URI = "mybank/pay/insurance/custprtl/custprtlcancle/V1"; // api地址
      //  String URI = "investment/insurance/prodapply/applycheck/V1"; // api地址
       // DefaultIcbcClient client = new DefaultIcbcClient(APP_ID, "RSA2",PRI_KEY, APIGW_PUBLIC_KEY);
        ...
        try {
            ...
            // 请求实体
            MybankPayInsuranceCustprtlCustprtlcancleRequestV1 request = new MybankPayInsuranceCustprtlCustprtlcancleRequestV1();
            // bizContent实体
            MybankPayInsuranceCustprtlCustprtlcancleRequestV1.CustPrtlCancelRequestV1Biz bizContent
                    = new MybankPayInsuranceCustprtlCustprtlcancleRequestV1.CustPrtlCancelRequestV1Biz();
            MybankPayInsuranceCustprtlCustprtlcancleRequestV1.CommonReqInfo commonReqInfoContent
                    = new MybankPayInsuranceCustprtlCustprtlcancleRequestV1.CommonReqInfo();
            MybankPayInsuranceCustprtlCustprtlcancleRequestV1.TransReqInfo transReqInfoContent
                    = new MybankPayInsuranceCustprtlCustprtlcancleRequestV1.TransReqInfo();
            MybankPayInsuranceCustprtlCustprtlcancleRequestV1.BizContentInfo bizContentInfo =
                    new MybankPayInsuranceCustprtlCustprtlcancleRequestV1.BizContentInfo();
            ...
            transReqInfoContent.setCustIdNo("xxxxxxxxxxxx");
            ...
            MybankPayInsuranceCustprtlCustprtlcancleResponseV1 response = client.execute(request);
