...
import com.icbc.api.request.CcouponSendQueryRequestV1;
import com.icbc.api.request.CcouponSendQueryRequestV1.CcouponSendQueryRequestV1Biz;
import com.icbc.api.response.CcouponSendQueryResponseV1;

public class CcouponSendQueryTest {
	// 1、网关公钥
	...
	public static void main(String[] args) throws Exception {
		...
		CcouponSendQueryRequestV1 request = new CcouponSendQueryRequestV1();
		// 4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("https://ip:port/api/eiop/ccoupon/send/query/V1");

		// 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		CcouponSendQueryRequestV1Biz bizContent = new CcouponSendQueryRequestV1Biz();
		bizContent.setEcActId("cbc20190720160851595");
		bizContent.setCisnoHsm("gGNNZ2OWz+SJXuFTSv4hieVWhfZSlr4m");
		bizContent.setUserMobileNo("13579246810");
		bizContent.setSerNo("13579246810");
		request.setBizContent(bizContent);

		CcouponSendQueryResponseV1 response;
		try {
