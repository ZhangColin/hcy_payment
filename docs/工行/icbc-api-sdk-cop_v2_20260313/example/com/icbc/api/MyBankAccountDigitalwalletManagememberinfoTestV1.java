...
import com.icbc.api.request.MyBankAccountDigitalwalletManagememberinfoRequestV1;
import com.icbc.api.response.MyBankAccountDigitalwalletManagememberinfoResponseV1;
import java.util.logging.Logger;

public interface MyBankAccountDigitalwalletManagememberinfoTestV1 {
    static Logger logger = Logger.getLogger(MyBankAccountDigitalwalletManagememberinfoTestV1.class);
    public static void main(String[] args) {
        //1、密钥对认证方式，公钥在F-APIP平台登记，此处为私钥
        String MY_PRIVATE_KEY = "-----请使用正确的APP私钥-----"
        //2、appid
        String APP_ID = "11100000000000005331";
        //3、网关公钥
        String APIGW_PUBLIC_KEY = "-----请使用正确的网关公钥-----"
        //4、创建与F-APIP外网网关的连接
        DefaultIcbcClient client = new DefaultIcbcClient(APP_ID, IcbcConstants.SIGN_TYPE_RSA2, MY_PRIVATE_KEY, "UTF-8", "json", APIGW_PUBLIC_KEY, (String)null, (String)null, (String)null, (String)null);
        MyBankAccountDigitalwalletManagememberinfoRequestV1 request = new MyBankAccountDigitalwalletManagememberinfoRequestV1();
        request.setServiceUrl("http://IP:PORT/api/mybank/account/digitalwallet/managememberinfo/V1");
        //5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值，非必输字段可不上送
        MyBankAccountDigitalwalletManagememberinfoRequestV1.MyBankAccountDigitalwalletManagememberinfoRequestV1Biz bizContent = new MyBankAccountDigitalwalletManagememberinfoRequestV1.MyBankAccountDigitalwalletManagememberinfoRequestV1Biz();
        ...
        MyBankAccountDigitalwalletManagememberinfoResponseV1 response;
        try {
