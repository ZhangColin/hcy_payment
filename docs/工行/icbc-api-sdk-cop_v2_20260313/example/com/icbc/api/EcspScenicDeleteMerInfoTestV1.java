...
import com.icbc.api.request.EcspScenicDeleteMerInfoRequestV1;
import com.icbc.api.request.EcspScenicDeleteMerInfoRequestV1.EcspScenicDeleteMerInfoRequestV1Biz;
import com.icbc.api.response.EcspScenicDeleteMerInfoResponseV1;
 ...
 */
public class EcspScenicDeleteMerInfoTestV1 {
  // 1、网关公钥
  ...
  public static void main(String[] args) throws Exception {
    ...
    EcspScenicDeleteMerInfoRequestV1 request = new EcspScenicDeleteMerInfoRequestV1();
    // 4、根据测试环境和生产环境替换相应ip和端口
    request.setServiceUrl("https://ip:port/api/ecsp/religion/alarm/deleteMerInfo/V1");

    // 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
    EcspScenicDeleteMerInfoRequestV1Biz bizContent = new EcspScenicDeleteMerInfoRequestV1Biz();
    bizContent.setCustId("1111");
    request.setBizContent(bizContent);

    EcspScenicDeleteMerInfoResponseV1 response;
    try {
