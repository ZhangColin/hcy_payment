...
import com.icbc.api.request.EcspAssnClassMeetingRequestV1;
 ...
 * @author kfzx-linfeng
 */
public class EcspAssnClassMeetingTest {
  // 1、网关公钥
  ...
  public static void main(String[] args) throws Exception {
    ...
    EcspAssnClassMeetingRequestV1 request = new EcspAssnClassMeetingRequestV1();
    // 4、根据测试环境和生产环境替换相应ip和端口
    request.setServiceUrl("http://****/api/ecsp/assn/class/meeting/sign/V1");

    // 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
    EcspAssnClassMeetingRequestV1.EcspAssnClassMeetingRequestV1Biz bizContent = new EcspAssnClassMeetingRequestV1.EcspAssnClassMeetingRequestV1Biz();
    bizContent.setCorpId("1").setImeiNo("2").setKey("3");
    request.setBizContent(bizContent);

    EcspAssnClassMeetingResponseV1 response;
    try {
