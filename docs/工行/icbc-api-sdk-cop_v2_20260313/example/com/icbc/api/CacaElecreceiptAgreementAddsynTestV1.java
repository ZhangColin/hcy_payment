...
import com.icbc.api.request.CacaElecreceiptAgreementAddsynRequestV1;
import com.icbc.api.response.CacaElecreceiptAgreementAddsynResponseV1;

import java.util.ArrayList;
import java.util.List;

public class CacaElecreceiptAgreementAddsynTestV1 {
    ...
    public static void main(String[] args) {
        ...
        //5、设置请求对象
        CacaElecreceiptAgreementAddsynRequestV1 request = new CacaElecreceiptAgreementAddsynRequestV1();
        //6、设置请求路径；联测时，请联系我行告知并替换成测试环境地址。
        request.setServiceUrl("http://ip:port/api/caca/elecreceipt/agreement/addsyn/V1");
        //7、设置业务参数
        CacaElecreceiptAgreementAddsynRequestV1.CacaElecreceiptAgreementAddsynRequestV1ACCLIST acc = new CacaElecreceiptAgreementAddsynRequestV1.CacaElecreceiptAgreementAddsynRequestV1ACCLIST();
        acc.setACCOUNT("");
        acc.setACCNAME("");
        acc.setCURRTYPE("");
        acc.setKZONENO("");
        ...
        acc.setCINO("");
        acc.setACCTYPE("");
        List<CacaElecreceiptAgreementAddsynRequestV1.CacaElecreceiptAgreementAddsynRequestV1ACCLIST> acclist = new ArrayList<>();
        acclist.add(acc);

        CacaElecreceiptAgreementAddsynRequestV1.CacaElecreceiptAgreementAddsynRequestV1Biz bizContent =
                new CacaElecreceiptAgreementAddsynRequestV1.CacaElecreceiptAgreementAddsynRequestV1Biz();
        //8、组装请求参数
        ...
        CacaElecreceiptAgreementAddsynResponseV1 response;
        try {
