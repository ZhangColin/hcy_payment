...
import com.icbc.api.request.EpasscServicePageRequestV1;
import com.icbc.api.request.EpasscServicePageRequestV1.EpasscServicePageRequestV1Biz;
 ...
 */
public class EpasscServicePageRequestTestV1 {


    public static void main(String[] args) {

        DefaultIcbcClient client = new DefaultIcbcClient(data, data_sign, appflag,algorithm);
        EpasscServicePageRequestV1 request = new EpasscServicePageRequestV1();
        request.setServiceUrl("https://domain:port/ui/epassc/static/password/login/V1");
        EpasscServicePageRequestV1Biz bizContent = new EpasscServicePageRequestV1Biz();
