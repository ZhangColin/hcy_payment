...
import com.icbc.api.request.JftUiUserEdpopenacctInfoRequestV1;
import com.icbc.api.request.JftUiUserEdpopenacctInfoRequestV1.JftUiUserEdpopenacctInfoRequestV1Biz;
...
public class JftUiUserEdpopenacctInfoTestServletV1 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            // 通过工行 SDK 调用《聚富通网络货运收方入驻结果展示页面接口V1》页面接口
            UiIcbcClient client = new UiIcbcClient(APP_ID, IcbcConstants.SIGN_TYPE_RSA2, MY_PRIVATE_KEY, IcbcConstants.CHARSET_UTF8);
            JftUiUserEdpopenacctInfoRequestV1 request = new JftUiUserEdpopenacctInfoRequestV1();
            // 指定《聚富通网络货运收方入驻结果展示页面接口V1》URL
            request.setServiceUrl("https://ip:port/ui/jft/ui/user/edpopenacct/info/V1");

            /**
             * 组装调用页面接口上送报文。接口各请求参数说明详见接口文档
             */
            JftUiUserEdpopenacctInfoRequestV1Biz bizContent = new JftUiUserEdpopenacctInfoRequestV1Biz();
            ...
            // 调用工行 SDK，生成自动提交表单，将用户跳转到收方入驻结果展示页面
