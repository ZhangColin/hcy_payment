...
import com.icbc.api.request.EnterpriseSalaryAnnuityInvestSubAudInvestSchemeRequestV1;
import com.icbc.api.response.EnterpriseSalaryAnnuityInvestSubAudInvestSchemeResponseV1;
import org.junit.Assert;
import org.junit.Test;


public class EnterpriseSalaryAnnuityInvestSubAudInvestSchemeV1Test {


    public void test_schemeconvert() {
        ...
        //6、设置请求对象
        EnterpriseSalaryAnnuityInvestSubAudInvestSchemeRequestV1 request = new EnterpriseSalaryAnnuityInvestSubAudInvestSchemeRequestV1();
        //7、设置请求路径；联测时，请联系我行告知并替换成测试环境地址。
        request.setServiceUrl("http://ip:port/api/personal/invest/assets/scheme/convert/V1");
        //8、设置业务参数
        EnterpriseSalaryAnnuityInvestSubAudInvestSchemeRequestV1.EnterpriseSalaryAnnuityInvestSubAudInvestSchemeRequestBizV1 bizContent =
                new EnterpriseSalaryAnnuityInvestSubAudInvestSchemeRequestV1.EnterpriseSalaryAnnuityInvestSubAudInvestSchemeRequestBizV1();
        EnterpriseSalaryAnnuityInvestSubAudInvestSchemeRequestV1.EnterpriseSalaryAnnuityInvestSubAudInvestSchemeRequestBizV1.ChanCommV10 chanCommV10 = new EnterpriseSalaryAnnuityInvestSubAudInvestSchemeRequestV1.EnterpriseSalaryAnnuityInvestSubAudInvestSchemeRequestBizV1.ChanCommV10();
        EnterpriseSalaryAnnuityInvestSubAudInvestSchemeRequestV1.EnterpriseSalaryAnnuityInvestSubAudInvestSchemeRequestBizV1.InfoCommV10 infoCommV10 = new EnterpriseSalaryAnnuityInvestSubAudInvestSchemeRequestV1.EnterpriseSalaryAnnuityInvestSubAudInvestSchemeRequestBizV1.InfoCommV10();
        //9、组装请求参数
        ...
        EnterpriseSalaryAnnuityInvestSubAudInvestSchemeResponseV1 response = null;
        try {
            response = client.execute(request);
        } catch (IcbcApiException e) {
            // 测试环境案例经常调不通 给个默认值
            response = new EnterpriseSalaryAnnuityInvestSubAudInvestSchemeResponseV1();
        } catch (Throwable e2) {
            e2.printStackTrace();
        }
