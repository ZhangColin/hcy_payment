...
import com.icbc.api.request.FundPricequeryRequestV1;
import com.icbc.api.request.FundPricequeryRequestV1.FundPricequeryRequestV1Biz;
import com.icbc.api.response.FundPricequeryResponseV1;

public class FundPricequeryTestV1 {
	...
	public void test_cop() throws IcbcApiException {
		...
		FundPricequeryRequestV1 request = new FundPricequeryRequestV1();
		request.setServiceUrl("http://ip:port/api/fund/V1/pricequery");

		FundPricequeryRequestV1Biz bizContent = new FundPricequeryRequestV1Biz();
		bizContent.setCorpNo("126");
		bizContent.setFundId("000848");
	
		request.setBizContent(bizContent);

		FundPricequeryResponseV1 response = client.execute(request);
