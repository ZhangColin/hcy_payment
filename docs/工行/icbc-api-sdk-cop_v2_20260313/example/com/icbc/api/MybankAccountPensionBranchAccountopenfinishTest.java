...
import com.icbc.api.request.MybankAccountPensionBranchAccountopenfinishRequestV1;
import com.icbc.api.request.MybankAccountPensionBranchAccountscodeverifyRequestV1;
import com.icbc.api.response.MybankAccountPensionBranchAccountopenfinishResponseV1;
 ...
 * 第三支柱正式开户测试案例
 */
public class MybankAccountPensionBranchAccountopenfinishTest {

    
    public void test_accountopenfinish() {
        ...
        //6、设置请求对象
        MybankAccountPensionBranchAccountopenfinishRequestV1 request = new MybankAccountPensionBranchAccountopenfinishRequestV1();
        //7、设置请求路径；联测时，请联系我行告知并替换成测试环境地址。
        request.setServiceUrl("http://ip:port/api/mybank/account/pension/branch/accountopenfinish/V1");
        //8、设置业务参数
        MybankAccountPensionBranchAccountopenfinishRequestV1.MybankAccountPensionBranchAccountopenfinishRequestV1Biz bizContent =
                new MybankAccountPensionBranchAccountopenfinishRequestV1.MybankAccountPensionBranchAccountopenfinishRequestV1Biz();
        MybankAccountPensionBranchAccountopenfinishRequestV1.ChanCommV10 chanCommV10 = new MybankAccountPensionBranchAccountopenfinishRequestV1.ChanCommV10();
        MybankAccountPensionBranchAccountopenfinishRequestV1.InfoCommV10 infoCommV10 = new MybankAccountPensionBranchAccountopenfinishRequestV1.InfoCommV10();
        //9、组装请求参数
        ...
        bizContent.setOutServiceCode("openfinish");//外部服务代码
        ...
        MybankAccountPensionBranchAccountopenfinishResponseV1 response = null;
        try {
            response = client.execute(request);
        } catch (IcbcApiException e) {
            // 测试环境案例经常调不通 给个默认值
            response = new MybankAccountPensionBranchAccountopenfinishResponseV1();
        } catch (Throwable e2) {
            e2.printStackTrace();
        }
