...
import com.icbc.api.request.MybankPayOpay2MerordercloseRequestV1;
import com.icbc.api.request.MybankPayOpay2MerordercloseRequestV1.MybankPayOpay2MerordercloseRequestV1Biz;
import com.icbc.api.response.MybankPayOpay2MerordercloseResponseV1;

public class MybankPayOpay2MerordercloseTestV1 {
	
	// 调用方自己的AppId
		//private static final String APP_ID = new String("10000000000004095545"); //10月
		//private static final String APP_ID = new String("10000000000004095745"); //9月
		//private static final String APP_ID = new String("10000000000004095775"); //11月
//		private static final String APP_ID = new String("test2002 "); //20年2月10000000000004096999
	
		private static final String APP_ID = new String("10000xxxxxxx9"); //20年2月
		// 调用方私钥
		...
		//private static final String API_SERVICE_URL = new String("http://ip:port/api");
//		private static final String API_SERVICE_URL = new String("http://ip:port/api");
//		private static final String API_SERVICE_URL = new String("http://ip:port/api");http://ip:port/api
		private static final String API_SERVICE_URL = new String("http://ip:port/api");
		...
		public static void main(String[] args) {
			...
			MybankPayOpay2MerordercloseRequestV1 request = new MybankPayOpay2MerordercloseRequestV1();
			
			//访问工行API平台URL
			request.setServiceUrl(API_SERVICE_URL + "/mybank/pay/opay2/merorderclose/V1");

			MybankPayOpay2MerordercloseRequestV1Biz bizContent = new MybankPayOpay2MerordercloseRequestV1Biz();

			//APPID
			bizContent.setAppID("28xxx4");
			bizContent.setMerID("0119Ex0461");
			bizContent.setAreaCode("0xx9");
			bizContent.setOrderid("21xxxx4534");
			bizContent.setPaytype("1");
			request.setBizContent(bizContent);

			MybankPayOpay2MerordercloseResponseV1 response;
