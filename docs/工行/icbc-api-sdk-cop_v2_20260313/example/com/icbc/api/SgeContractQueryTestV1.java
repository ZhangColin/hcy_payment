...
import com.icbc.api.request.SgeContractQueryRequestV1;
import com.icbc.api.request.SgeContractQueryRequestV1.SgeContractQueryRequestBiz;
import com.icbc.api.response.SgeContractQueryResponseV1;

public class SgeContractQueryTestV1 {
	...
	public static void test_cop() throws IcbcApiException {

		DefaultIcbcClient client = new DefaultIcbcClient(APP_ID, MY_PRIVATE_KEY, APIGW_PUBLIC_KEY);

		SgeContractQueryRequestV1 request = new SgeContractQueryRequestV1();
		request.setServiceUrl("http://ip:port:7014/api/preciousmetal/sge/contract/query/V1");

		SgeContractQueryRequestBiz bizContent = new SgeContractQueryRequestBiz();
		bizContent.setContractId("iAu100g");
		bizContent.setQueryFlag(1);
		bizContent.setQueryRow(5);
		request.setBizContent(bizContent);

		SgeContractQueryResponseV1 response = client.execute(request);
