...
import com.icbc.api.request.JftApiSignUserProtocolRequestV1;
import com.icbc.api.request.JftApiSignUserProtocolRequestV1.JftApiSignUserProtocolRequestV1Biz;
import com.icbc.api.response.JftApiSignUserProtocolResponseV1;
 ...
 */
public class JftApiSignUserProtocolTestV1 {
	...
	public static void main(String[] args) throws Exception {
		...
		JftApiSignUserProtocolRequestV1 request = new JftApiSignUserProtocolRequestV1();
		
		//4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("https://ip:port/api/jft/api/sign/user/protocol/V1");
		
		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		JftApiSignUserProtocolRequestV1Biz bizContent = new JftApiSignUserProtocolRequestV1Biz();
		...
		JftApiSignUserProtocolResponseV1 response;
		try {
			response = (JftApiSignUserProtocolResponseV1) client.execute(request, System.currentTimeMillis()+"");
