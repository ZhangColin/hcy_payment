...
import com.icbc.api.request.ElifeUserinfoQueryRequestV1;
import com.icbc.api.request.ElifeUserinfoQueryRequestV1.ElifeUserinfoQueryRequestV1Biz;
import com.icbc.api.response.ElifeUserinfoQueryResponseV1;
 ...
 */
public class ElifeUserinfoQueryTestV1 {
	...
	public static void main(String[] args) throws Exception {
		...
		ElifeUserinfoQueryRequestV1 request = new ElifeUserinfoQueryRequestV1();
		
		//4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("https://ip:port/api/elife/userinfo/query/V1");

		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		ElifeUserinfoQueryRequestV1Biz bizContent = new ElifeUserinfoQueryRequestV1Biz();
		bizContent.setToken("ba5ef271ed00e20ee75d9d0db6ee812b6c0a8000");
		bizContent.setQueryType("etc");

		request.setBizContent(bizContent);

		ElifeUserinfoQueryResponseV1 response;
		try {
