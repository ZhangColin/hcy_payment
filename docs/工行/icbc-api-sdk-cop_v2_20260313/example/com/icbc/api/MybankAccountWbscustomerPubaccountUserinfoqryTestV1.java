...
import com.icbc.api.request.MybankAccountWbscustomerPubaccountUserinfoqryRequestV1;
import com.icbc.api.request.MybankAccountWbscustomerPubaccountUserinfoqryRequestV1.MybankAccountWbscustomerPubaccountUserinfoqryRequestV1Biz;
import com.icbc.api.response.MybankAccountWbscustomerPubaccountUserinfoqryResponseV1;
import java.util.logging.Logger;

public class MybankAccountWbscustomerPubaccountUserinfoqryTestV1 {
	// 1、网关公钥
	...
	public static void main(String[] args) {
		...
		MybankAccountWbscustomerPubaccountUserinfoqryRequestV1 request = new MybankAccountWbscustomerPubaccountUserinfoqryRequestV1();

		// 4、根据测试环境和生产环境替换相应ip和端口
		// 行外流程
		request.setServiceUrl("http://ip:port/api/wbs/customer/pubaccount/userinfoqry/V1");

		// 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		MybankAccountWbscustomerPubaccountUserinfoqryRequestV1Biz bizContent = new MybankAccountWbscustomerPubaccountUserinfoqryRequestV1Biz();
		...
		// 建立返回项
		MybankAccountWbscustomerPubaccountUserinfoqryResponseV1 response = new MybankAccountWbscustomerPubaccountUserinfoqryResponseV1();
		try {
			...
			logger.info("unionid:" + response.getUnionid());
			...
			logger.info("province:" + response.getProvince());
			logger.info("language:" + response.getLanguage());
			logger.info("headImgUrl:" + response.getHeadImgUrl());
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
