...
import com.icbc.api.request.SgeDiscrepancyQueryRequestV1;
import com.icbc.api.request.SgeDiscrepancyQueryRequestV1.SgeDiscrepancyQueryRequestBiz;
import com.icbc.api.response.SgeDiscrepancyQueryResponseV1;

public class SgeDiscrepancyQueryTestV1 {
	...
	public void test_cop() throws IcbcApiException {
		...
		SgeDiscrepancyQueryRequestV1 request = new SgeDiscrepancyQueryRequestV1();
		request.setServiceUrl("http://ip:port/api/sge/discrepancy/query/V1");

		SgeDiscrepancyQueryRequestBiz bizContent = new SgeDiscrepancyQueryRequestBiz();
		bizContent.setQueryFlag(1);
		bizContent.setQueryRow(5);
		request.setBizContent(bizContent);

		SgeDiscrepancyQueryResponseV1 response = client.execute(request);
