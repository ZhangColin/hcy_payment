...
import com.icbc.api.request.CacaElecreceiptAgreementTerminatesynRequestV1;
import com.icbc.api.response.CacaElecreceiptAgreementTerminatesynResponseV1;

public class CacaElecreceiptAgreementTerminatesynTestV1 {
    ...
    public static void main(String[] args) {
        ...
        //5、设置请求对象
        CacaElecreceiptAgreementTerminatesynRequestV1 request = new CacaElecreceiptAgreementTerminatesynRequestV1();
        //6、设置请求路径；联测时，请联系我行告知并替换成测试环境地址。
        request.setServiceUrl("http://ip:port/api/caca/elecreceipt/agreement/terminatesyn/V1");
        //7、设置业务参数
        CacaElecreceiptAgreementTerminatesynRequestV1.CacaElecreceiptAgreementTerminatesynRequestV1Biz bizContent =
                new CacaElecreceiptAgreementTerminatesynRequestV1.CacaElecreceiptAgreementTerminatesynRequestV1Biz();
        //8、组装请求参数
        ...
        CacaElecreceiptAgreementTerminatesynResponseV1 response;
        try {
