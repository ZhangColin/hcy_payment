...
import com.icbc.api.request.CvAfLetterTransmitRequestV1;
import com.icbc.api.response.CvAfLetterTransmitResponseV1;

public class CvAfLetterTransmitRequestV1Test {
    // 1、网关公钥
    ...
    public static void main(String[] args) throws Exception {
        ...
        CvAfLetterTransmitRequestV1 request = new CvAfLetterTransmitRequestV1();
        request.setServiceUrl("https://gw.icloud.icbc.com.cn/api/cv/af/letter/qry/V1");

        CvAfLetterTransmitRequestV1.CvAfLetterTransmitRequestV1Biz bizContent = new CvAfLetterTransmitRequestV1.CvAfLetterTransmitRequestV1Biz();
        ...
        bizContent.setAfLetterFile("sfdaiSSsESFD");
        request.setBizContent(bizContent);

        CvAfLetterTransmitResponseV1 response;
        try {
