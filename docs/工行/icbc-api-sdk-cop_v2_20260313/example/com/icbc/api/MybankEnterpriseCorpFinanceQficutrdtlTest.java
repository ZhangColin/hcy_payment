...
public class MybankEnterpriseCorpFinanceQficutrdtlTest {
    ...
    public static void main(String[] args) throws Exception {
        String serviceUri = BASE_URL + "mybank/enterprise/corp/finance/qficutrdtl/V1";
        IcbcClient client = new DefaultIcbcClient(APP_ID, PRI_KEY, APIGW_PUBLIC_KEY);
        MybankEnterpriseCorpFinanceQficutrdtlRequestBizV1 bizContent =
                new MybankEnterpriseCorpFinanceQficutrdtlRequestBizV1();
        MybankEnterpriseCorpFinanceQficutrdtlRequestV1 request =
                new MybankEnterpriseCorpFinanceQficutrdtlRequestV1();
        // 请对照接口文档用bizContent.setXxx()方法对业务上送数据进行赋值
        bizContent.setTransCode("QFICUTRDTL");
        bizContent.setTranDate("20190101");
        bizContent.setTranTime("103231001");
        bizContent.setLanguage("zh_CN");
        bizContent.setfSeqNo("QFICUTRDTL0084827875");
        ...
        if (null == validate) {
            MybankEnterpriseCorpFinanceQficutrdtlResponseV1 response = client.execute(request);
