...
import com.icbc.api.request.JftApiVendorPicUploadRequestV1.JftApiVendorPicUploadRequestV1Biz;
 ...
 */
public class JftApiVendorPicUploadTestV1 {
	...
	public static void main(String[] args) throws Exception {
		...
		request.setServiceUrl("https://ip:port/api/jft/api/vendor/pic/upload/V1");
				
		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		JftApiVendorPicUploadRequestV1Biz bizContent = new JftApiVendorPicUploadRequestV1Biz();
		String imageFile = "/9j/4AAQSkZJRgABAQAAAQABAAD/2w...";
		...
		try {
			response =  (JftApiVendorPicUploadResponseV1) client.execute(request, System.currentTimeMillis()+"");
