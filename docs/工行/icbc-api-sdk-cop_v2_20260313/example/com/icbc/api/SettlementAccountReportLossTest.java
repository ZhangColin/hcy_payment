...
import com.icbc.api.request.SettlementAccountReportLossRequestV1;
import com.icbc.api.request.SettlementAccountReportLossRequestV1.SettlementAccountReportLossRequestV1Biz;
import com.icbc.api.response.SettlementAccountReportLossResponseV1;

public class SettlementAccountReportLossTest {
	...
	public void test_cop() throws IcbcApiException{
		...
		SettlementAccountReportLossRequestV1 request = new SettlementAccountReportLossRequestV1();
		SettlementAccountReportLossRequestV1Biz bizContent = new SettlementAccountReportLossRequestV1Biz();
		
		request.setServiceUrl("http://ip:port/api/settlement/account/report/loss/V1");
		...
		bizContent.setOutServiceCode("reportloss"); //外部服务代码
