...
import com.icbc.api.request.Queryca29125RequestV1;
import com.icbc.api.request.Queryca29125RequestV1.Queryca29125RequestV1Biz;
import com.icbc.api.request.Queryca29125RequestV1.Queryca29125RequestV1Pub;
import com.icbc.api.request.Queryca29125RequestV1.Queryca29125RequestV1In;
import com.icbc.api.response.Queryca29125ResponseV1;
import com.icbc.api.response.Queryca29125ResponseV1.Queryca29125ResponseV1Pub;
import com.icbc.api.response.Queryca29125ResponseV1.Queryca29125ResponseV1Out;
import com.icbc.api.response.Queryca29125ResponseV1.Queryca29125ResponseV1Grptotal;
import com.icbc.api.response.Queryca29125ResponseV1.Queryca29125ResponseV1Tydwtotal;

public class Queryca29125Test {
	...
	public void test_CA() throws IcbcApiException {
		...
		Queryca29125RequestV1 request = new Queryca29125RequestV1();
		request.setServiceUrl("http://ip:port/api/queryca29125/query/V1");

		Queryca29125RequestV1Biz bizContent = new Queryca29125RequestV1Biz();
		
		Queryca29125RequestV1Pub pub = new Queryca29125RequestV1Pub();
		pub.setCode("29125");
		pub.setZone("0200");
		pub.setFr("0");
		pub.setDt("2018-12-26");
		
		Queryca29125RequestV1In in = new Queryca29125RequestV1In();
		...
		Queryca29125ResponseV1 response = client.execute(request, "msgId");

		if (response.isSuccess()) {
			// 接收成功
			Queryca29125ResponseV1Pub RetPub = response.getPub();
			Queryca29125ResponseV1Out RetOut = response.getOut();
			List<Queryca29125ResponseV1Grptotal> RetTotall= RetOut.getGrptotal();
			Queryca29125ResponseV1Grptotal RetTotal = RetTotall.get(0);
			String aa = RetTotal.getGRPMERCN();
			if(RetOut.getResult().equals("00000000")){
				//查询成功 获取返回结果
				List<Queryca29125ResponseV1Grptotal> resultList = RetOut.getGrptotal();
				//获取结果集中字段
				for(Queryca29125ResponseV1Grptotal detail:resultList){
					//获取信息.....
					detail.getGRPMERNO();
				}
			} else {
