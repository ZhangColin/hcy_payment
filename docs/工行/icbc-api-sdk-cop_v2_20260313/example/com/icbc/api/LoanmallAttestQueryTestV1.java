...
import com.icbc.api.request.LoanmallAttestQueryRequestV1;
import com.icbc.api.request.LoanmallAttestQueryRequestV1.LoanmallAttestQueryRequestV1Biz;
import com.icbc.api.response.LoanmallAttestQueryResponseV1;

public class LoanmallAttestQueryTestV1 {
	...
	public static void main(String[] args) throws Exception {
		...
		LoanmallAttestQueryRequestV1 request = new LoanmallAttestQueryRequestV1();
		// 4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("https://ip:port/api/loanmall/attest/query/V1");

		// 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		LoanmallAttestQueryRequestV1Biz bizContent = new LoanmallAttestQueryRequestV1Biz();
		bizContent.setOutTradeNo("1111111");
		bizContent.setThirdloanId("1332233");
		request.setBizContent(bizContent);

		LoanmallAttestQueryResponseV1 response;
		try {
