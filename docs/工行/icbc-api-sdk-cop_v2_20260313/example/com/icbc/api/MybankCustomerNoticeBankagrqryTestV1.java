...
/**
 * @Author: kfzx-lihh
 * @Description: 银行客户协议查询，测试类
 * @Date: 2020/02/14
 */
public class MybankCustomerNoticeBankagrqryTestV1 {
    /*public static void main(String[] args) {
        ...
        //5、设置请求对象
        MybankCustomerNoticeBankagrqryRequestV1 request = new MybankCustomerNoticeBankagrqryRequestV1();
        //6、设置请求路径；联测时，请联系我行告知并替换成测试环境地址。
        request.setServiceUrl("http://ip:port/api/mybank/customer/notice/bankagrqry/V1");
        //7、设置业务参数
        MybankCustomerNoticeBankagrqryRequestV1.MybankCustomerNoticeBankagrqryRequestV1Biz bizContent = new MybankCustomerNoticeBankagrqryRequestV1.MybankCustomerNoticeBankagrqryRequestV1Biz();

        //8、组装请求参数
        bizContent.setCorpno("160200410000000");
        bizContent.setMultibankflag("1");
        bizContent.setDatasources("2");

        request.setBizContent(bizContent);
       MybankCustomerNoticeBankagrqryResponseV1 response;
        try {
