...
import com.icbc.api.request.PartyfeeBillWriteoffRequestV1;
import com.icbc.api.response.PartyfeeBillWriteoffResponseV1;

public class EpmPartyfeeBillWriteoffTest extends HttpServlet{
	...
	public static void main(String[] args) {
		...
		String url = "http://ip:port/api/epm/partyfee/bill/writeoff/V1";
		DefaultIcbcClient client = new DefaultIcbcClient(appId, MY_PRIVATE_KEY, APIGW_PUBLIC_KEY);
		
		PartyfeeBillWriteoffRequestV1 request = new PartyfeeBillWriteoffRequestV1();
		PartyfeeBillWriteoffRequestV1.PartyfeeBillWriteoffRequestV1Biz bizContent = new PartyfeeBillWriteoffRequestV1.PartyfeeBillWriteoffRequestV1Biz();

		bizContent.setOrgId("100102100");
		bizContent.setProtocolNo("PT20181213100000108002"); 
		bizContent.setPayAmt("11.11");
		bizContent.setBillNo("23542342");

		request.setServiceUrl(url);
		request.setBizContent(bizContent);	
		PartyfeeBillWriteoffResponseV1 resp = new PartyfeeBillWriteoffResponseV1();
