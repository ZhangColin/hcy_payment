...
import com.icbc.api.request.MybankOspayCborderVendorAgreementstatusqueryRequestV1;
import com.icbc.api.request.MybankOspayCborderVendorAgreementstatusqueryRequestV1.MybankOspayCborderVendorAgreementstatusqueryRequestV1Biz;
import com.icbc.api.response.MybankOspayCborderVendorAgreementstatusqueryResponseV1;

public class MybankOspayCborderVendorAgreementstatusqueryTestV1 {
	...
	public static void main(String[] args) {
		...
		MybankOspayCborderVendorAgreementstatusqueryRequestV1 request = new MybankOspayCborderVendorAgreementstatusqueryRequestV1();
		request.setServiceUrl("http://ip:port/api/mybank/ospay/cborder/vendor/agreementstatusquery/V1");
		MybankOspayCborderVendorAgreementstatusqueryRequestV1Biz bizContent = new MybankOspayCborderVendorAgreementstatusqueryRequestV1Biz();
		bizContent.setParentVendorId("2");
		bizContent.setVendorId("2");
		bizContent.setIcbcPlatformId("2");
		request.setBizContent(bizContent);

		MybankOspayCborderVendorAgreementstatusqueryResponseV1 response = null;
