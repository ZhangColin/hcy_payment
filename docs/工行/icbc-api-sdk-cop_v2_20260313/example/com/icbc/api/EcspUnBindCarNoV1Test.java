...
import com.icbc.api.request.EcspUnBindCarNoRequestV1;
import com.icbc.api.response.EcspUnBindCarNoResponseV1;

/**
 * @author kfzx-caibb
 */
public class EcspUnBindCarNoV1Test {
    // 1、网关公钥
    ...
    public static void main(String[] args) throws Exception {
        ...
        EcspUnBindCarNoRequestV1 request = new EcspUnBindCarNoRequestV1();

        // 4、根据测试环境和生产环境替换相应ip和端口
        request.setServiceUrl("http://ip:port/api/ecsp/oc/prop/car/unBindCarNo/V1");
        // 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
        EcspUnBindCarNoRequestV1.EcspUnBindCarNoRequestV1Biz bizContent = new EcspUnBindCarNoRequestV1.EcspUnBindCarNoRequestV1Biz();
        bizContent.setCorpId("0000000001");
        bizContent.setCarNo("粤B12345");
        bizContent.setParkingId("001");
        bizContent.setPhone("17811112222");
        request.setBizContent(bizContent);

        EcspUnBindCarNoResponseV1 response;
        try {
