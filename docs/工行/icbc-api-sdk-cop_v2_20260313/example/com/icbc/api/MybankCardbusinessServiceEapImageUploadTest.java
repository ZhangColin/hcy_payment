...
import com.icbc.api.request.MybankCardbusinessServiceEapImageUploadRequestV1;
...
public class MybankCardbusinessServiceEapImageUploadTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        MybankCardbusinessServiceEapImageUploadRequestV1 request = new MybankCardbusinessServiceEapImageUploadRequestV1();

        request.setServiceUrl("http://ip:port:16257/api/mybank/cardbusiness/shop/queryElcMerInfo/V1");
        MybankCardbusinessServiceEapImageUploadRequestV1.MybankCardbusinessServiceEapImageUploadRequestV1Biz bizRes = new MybankCardbusinessServiceEapImageUploadRequestV1.MybankCardbusinessServiceEapImageUploadRequestV1Biz();

        Map<String, Object> bwg_ci16070_comm = new HashMap<>();

        bizRes.setSerid(10L);
        bizRes.setZoneNo(200);
        bizRes.setBrno(998);
        bizRes.setFile(new ArrayList<>());
        bizRes.setFilename(new ArrayList<>());

        request.setBizContent(bizRes);

        MybankCardbusinessServiceEapImageUploadResponseV1 response;
