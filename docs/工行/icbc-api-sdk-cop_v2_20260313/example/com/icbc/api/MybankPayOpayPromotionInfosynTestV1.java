...
import com.icbc.api.request.MybankPayOpayPromotionInfosynRequestV1;
import com.icbc.api.request.MybankPayOpayPromotionInfosynRequestV1.MybankPayOpayPromotionInfosynRequestV1Biz;

public class MybankPayOpayPromotionInfosynTestV1 {
	...
	// 调用方自己的AppId
		...
		private static final String APP_ID = new String("test2002 "); //20年2月
		// 调用方私钥
		...
		public static void main(String[] args) {
			...
			MybankPayOpayPromotionInfosynRequestV1 request = new MybankPayOpayPromotionInfosynRequestV1();
			
			//访问工行API平台URL
			request.setServiceUrl(API_SERVICE_URL + "/mybank/pay/opay/promotion/infosyn/V1");

			MybankPayOpayPromotionInfosynRequestV1Biz bizContent = new MybankPayOpayPromotionInfosynRequestV1Biz();

			//APPID
			bizContent.setOperflag("*");
			bizContent.setSerialno("2020*******1");
			bizContent.setAreacode("0**9");
			bizContent.setCoupontype("*");
			bizContent.setGetchannel("*");
			bizContent.setStatus("*");
			bizContent.setActivitystarttime("2020****************00");
			bizContent.setActivityendtime("2020****************00");
			request.setBizContent(bizContent);

			MybankPayOpayPromotionInfosynResponseV1 response;
