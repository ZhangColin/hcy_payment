...
import com.icbc.api.request.CardbusinessQrcodeQrgenerateRequestV4;
import com.icbc.api.response.CardbusinessQrcodeQrgenerateResponseV4;

import java.util.HashMap;
import java.util.logging.Logger;

public class CardbusinessQrcodeQrgenerateV4Test {
	...
	private static Logger logger = Logger.getLogger(CardbusinessQrcodeQrgenerateV4Test.class.getName());

	public static void main(String[] args) throws Exception {
		DefaultIcbcClient client = new DefaultIcbcClient(APP_ID, MY_PRIVATE_KEY, APIGW_PUBLIC_KEY);
		CardbusinessQrcodeQrgenerateRequestV4 request = new CardbusinessQrcodeQrgenerateRequestV4();
		request.setServiceUrl("http://ip:port/api/cardbusiness/qrcode/qrgenerate/V4");
		CardbusinessQrcodeQrgenerateRequestV4.CardbusinessQrcodeQrgenerateRequestV4Biz bizContent = new CardbusinessQrcodeQrgenerateRequestV4.CardbusinessQrcodeQrgenerateRequestV4Biz();
		...
		CardbusinessQrcodeQrgenerateResponseV4 response;
