	...
	import com.icbc.api.request.ThirdpartyLoanAttestRequestV2;
	import com.icbc.api.request.ThirdpartyLoanAttestRequestV2.ThirdpartyLoanAttestRequestV2Biz;

	public class ThirdpartyLoanAttestTestV2 {
		...
		//3、AES密钥                                                                                             -----请使用正确的网关公钥-----D4kzEVPdOj03ctKM7KV+16bWZ5BMNgvEeuEQwfQYkRVwI9HFOGkwNTMn5hiJXHnlXYCX+zp5r6R52MY0O7BsTCLT7aHaxsANsvI9ABGx3OaTVlPB59M6GPbJh0uXvio0m1r/lTW3Z60RU6Q3oid/rNhP3CiNgg0W6O3AGqwIDAQAB
...
//		public static void main(String[] args) throws IcbcApiException{
	        ...
	        ThirdpartyLoanAttestRequestV2 request = new ThirdpartyLoanAttestRequestV2();
			//4、根据测试环境和生产环境替换相应ip和端口
			request.setServiceUrl("http://ip:port/ui/thirdparty/loan/attest/V2");
			
			//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
			ThirdpartyLoanAttestRequestV2Biz bizContent = new ThirdpartyLoanAttestRequestV2Biz();
			bizContent.setCisNo("hO7da6iW6BLvCYswj2k1PQ==");
			bizContent.setAreaCode("1243");
			...
			bizContent.setNotifyUrl("ip:port");
