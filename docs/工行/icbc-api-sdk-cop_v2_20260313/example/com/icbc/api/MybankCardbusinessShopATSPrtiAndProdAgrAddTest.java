...
import com.icbc.api.request.MybankCardbusinessShopATSPrtiAndProdAgrAddRequestV1;
import com.icbc.api.response.MybankCardbusinessShopATSPrtiAndProdAgrAddResponseV1;
...
public class MybankCardbusinessShopATSPrtiAndProdAgrAddTest {
    ...
    public static void main(String[] args) throws Exception{
        ...
        MybankCardbusinessShopATSPrtiAndProdAgrAddRequestV1 request = new MybankCardbusinessShopATSPrtiAndProdAgrAddRequestV1();
        ...
        MybankCardbusinessShopATSPrtiAndProdAgrAddRequestV1.MybankCardbusinessShopATSPrtiAndProdAgrAddRequestV1Biz bizRes = new MybankCardbusinessShopATSPrtiAndProdAgrAddRequestV1.MybankCardbusinessShopATSPrtiAndProdAgrAddRequestV1Biz();
        ...
        List saesPubCustmerInfList = new ArrayList();
        Map<String,String> saesPubCustmerInf = new HashMap<>();
        saesPubCustmerInf.put("taxRegNo","");
        saesPubCustmerInf.put("organizeCode","");
        saesPubCustmerInf.put("merCustType","100");
        saesPubCustmerInf.put("buslicenseNo","12592225-2");
        saesPubCustmerInf.put("buslicenseExpire","2030-03-23");
        saesPubCustmerInf.put("mercName","23");
        saesPubCustmerInf.put("industryCode","A0111");
        saesPubCustmerInf.put("industryScope","23");
        saesPubCustmerInf.put("workAddr","广州省-广州市-天河区 莲花街道");
        saesPubCustmerInf.put("compPerCount",null);
        saesPubCustmerInf.put("totalAssets",null);
        saesPubCustmerInf.put("regCapitalCrncy","1");
        saesPubCustmerInf.put("regCapital","23333");
        saesPubCustmerInf.put("shdleName","张三");
        saesPubCustmerInf.put("shdleLicenseType","0");
        saesPubCustmerInf.put("shdleLicenseNo","441522198706200042");
        saesPubCustmerInf.put("shdleLicenseExpire","2030-03-23");
        saesPubCustmerInf.put("represtName","张三花");
        saesPubCustmerInf.put("represtLicenseType","0");
        saesPubCustmerInf.put("represtLicenseNo","441522184902097778");
        saesPubCustmerInf.put("represtLicenseExpire",null);
        saesPubCustmerInf.put("empowerName","账务");
        saesPubCustmerInf.put("empowerLicenceType","3");
        saesPubCustmerInf.put("empowerLicenceNo","610582199102245678");
        saesPubCustmerInf.put("empowerLicenceExpire","9999-12-31");
        saesPubCustmerInf.put("empowerMobile","");
        saesPubCustmerInf.put("benefitName1","张三111");
        saesPubCustmerInf.put("benefitAddr1","广州省-广州市-天河区 莲花街道");
        saesPubCustmerInf.put("benefitLicenceType1","0");
        saesPubCustmerInf.put("benefitLicenceNo1","44152219870620027X");
        saesPubCustmerInf.put("benefitLicenceExpire1","2030-03-23");
        saesPubCustmerInf.put("benefitName2","");
        saesPubCustmerInf.put("benefitAddr2","");
        saesPubCustmerInf.put("benefitLicenceType2",null);
        saesPubCustmerInf.put("benefitLicenceNo2","");
        saesPubCustmerInf.put("benefitName3","");
        saesPubCustmerInf.put("benefitAddr3","");
        saesPubCustmerInf.put("benefitLicenceType3",null);
        saesPubCustmerInf.put("benefitLicenceNo3","");
        saesPubCustmerInf.put("benefitLicenceExpire3",null);
        saesPubCustmerInf.put("benefitName4","");
        saesPubCustmerInf.put("benefitAddr4","");
        saesPubCustmerInf.put("benefitLicenceType4",null);
        saesPubCustmerInf.put("benefitLicenceNo4","");
        saesPubCustmerInf.put("workAddrPostcode","");
        saesPubCustmerInfList.add(saesPubCustmerInf);



        List agrForeignPermitList = new ArrayList();
        List saesProdSerRelPermitList = new ArrayList();
        Map<String,String> saesProdSerRelPermit = new HashMap<>();
        saesProdSerRelPermit.put("prodId","100000020802");
        saesProdSerRelPermit.put("serId","20000001683");
        saesProdSerRelPermit.put("serAgrType","1");
        saesProdSerRelPermit.put("serAgrId","");
        saesProdSerRelPermit.put("reaStatus","1");
        saesProdSerRelPermit.put("lastModDate",null);
        saesProdSerRelPermit.put("createUser","");
        saesProdSerRelPermit.put("createStruId","");
        saesProdSerRelPermitList.add(saesProdSerRelPermit);
        List saesProdSerFeePermitList = new ArrayList();
        List saesProdSerAgrFeePermitList = new ArrayList();
        List saesProdSerAgrLimitPermitList = new ArrayList();
        List saesProdAgrLimitPermitList = new ArrayList();
        ...
        bizRes.setSaesPubCustmerInfList(JSON.toJSONString(saesPubCustmerInfList));
        bizRes.setAgrForeignPermitList(JSON.toJSONString(agrForeignPermitList));
        bizRes.setSaesProdSerRelPermitList(JSON.toJSONString(saesProdSerRelPermitList));
        bizRes.setSaesProdSerFeePermitList(JSON.toJSONString(saesProdSerFeePermitList));
        bizRes.setSaesProdSerAgrLimitPermitList(JSON.toJSONString(saesProdSerAgrFeePermitList));
        bizRes.setSaesProdSerAgrLimitPermitList(JSON.toJSONString(saesProdSerAgrLimitPermitList));
        bizRes.setSaesProdAgrLimitPermitList(JSON.toJSONString(saesProdAgrLimitPermitList));
        bizRes.setRemark("备注信息");
        request.setBizContent( bizRes);
        MybankCardbusinessShopATSPrtiAndProdAgrAddResponseV1 response = new MybankCardbusinessShopATSPrtiAndProdAgrAddResponseV1();
        try{
