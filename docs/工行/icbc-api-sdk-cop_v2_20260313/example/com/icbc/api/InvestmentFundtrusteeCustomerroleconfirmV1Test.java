...
import com.icbc.api.request.InvestmentFundtrusteeCustomerroleconfirmRequestV1;
...
public class InvestmentFundtrusteeCustomerroleconfirmV1Test {
    ...
    public void test_cop() throws IcbcApiException {
        ...
        InvestmentFundtrusteeCustomerroleconfirmRequestV1 request = new InvestmentFundtrusteeCustomerroleconfirmRequestV1();
        InvestmentFundtrusteeCustomerroleconfirmRequestV1.InvestmentFundtrusteeCustomerroleconfirmRequestV1Biz bizContent = new InvestmentFundtrusteeCustomerroleconfirmRequestV1.InvestmentFundtrusteeCustomerroleconfirmRequestV1Biz();
        bizContent.setEscrowAcntNo("10012317293_00003880".replace("_", ""));
        bizContent.setUserName("张三");
        bizContent.setRoleId("1");
        bizContent.setCertType("0");
        bizContent.setCertId("3548261983_07225157".replace("_", ""));
        bizContent.setMobilePhone("13913913900");

        request.setBizContent(bizContent);

        request.setServiceUrl("http://122_64_61_81/api/investment/fundtrustee/customerroleconfirm/V1".replaceAll("_", "."));
        InvestmentFundtrusteeCustomerroleconfirmResponseV1 response = client.execute(request);
