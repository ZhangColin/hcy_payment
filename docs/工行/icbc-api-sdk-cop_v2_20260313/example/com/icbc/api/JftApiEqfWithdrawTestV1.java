...
import com.icbc.api.request.JftApiEqfWithdrawRequestV1;
import com.icbc.api.request.JftApiEqfWithdrawRequestV1.JftApiEqfWithdrawRequestV1Biz;
import com.icbc.api.response.JftApiEqfWithdrawResponseV1;

/**
 * 聚富通对公钱包e企付结算接口
 * 
 */
public class JftApiEqfWithdrawTestV1 {
	...
	public static void main(String[] args) throws Exception {
		...
		JftApiEqfWithdrawRequestV1 request = new JftApiEqfWithdrawRequestV1();

		// 4根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("https://ip:port/api/jft/api/eqf/withdraw/V1");

		// 5请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		JftApiEqfWithdrawRequestV1Biz bizContent = new JftApiEqfWithdrawRequestV1Biz();
		...
		JftApiEqfWithdrawResponseV1 response;
		try {
			response = (JftApiEqfWithdrawResponseV1) client.execute(request, System.currentTimeMillis() + "");
