...
import com.icbc.api.request.EcspNftCustomerInfoCheckRequestV1;
import com.icbc.api.request.EcspNftQueryRequestV1;
import com.icbc.api.response.EcspNftCustomerInfoCheckResponseV1;
import com.icbc.api.response.EcspNftQueryResponseV1;

/**
 * @author kfzx-linfeng
 */
public class EcspNftCustomerInfoCheckV1Test {
    // 1、网关公钥
    ...
    public static void main(String[] args) throws Exception {
        ...
        EcspNftCustomerInfoCheckRequestV1 request = new EcspNftCustomerInfoCheckRequestV1();

        // 4、根据测试环境和生产环境替换相应ip和端口
        request.setServiceUrl("http://ip:port/api/ecsp/nft/customer/info/check/V1");
        // 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
        EcspNftCustomerInfoCheckRequestV1.EcspNftCustomerInfoCheckRequestV1Biz bizContent = new EcspNftCustomerInfoCheckRequestV1.EcspNftCustomerInfoCheckRequestV1Biz();
        bizContent.setCorpId("0000000001");
        bizContent.setTxType(1);
        bizContent.setPhoneNo("180xxxxxxxx");
        request.setBizContent(bizContent);

        EcspNftCustomerInfoCheckResponseV1 response;
        try {
