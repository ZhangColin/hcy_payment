...
import com.icbc.api.request.CardbusinessMerMemberScenicticketwriteoffRequestV1;
import com.icbc.api.response.CardbusinessMerMemberScenicticketwriteoffResponseV1;
import com.icbc.api.request.CardbusinessMerMemberScenicticketwriteoffRequestV1.MemberScenicTicketWriteOffRequestV1Biz;

public class MemberScenicTicketWriteOffRequestTestV1 {
	
	
	public static void main(String[] args) {
		// 企业交易秘钥
		String corpPayKeyAppId = "1000000000BBCS0004100418";
		...
		// 构造请求
		MemberScenicTicketWriteOffRequestV1Biz biz = new MemberScenicTicketWriteOffRequestV1Biz();
		biz.setCorpId("00000BBCS00272");
	    biz.setTradeNo("342BBCS34324");
	    biz.setChannelType("4533BBCS44423");
		biz.setCientTransNo("00000BBCS00272");
		biz.setClientCorpId("342BBCS34324");
		biz.setEnterType("4533BBCS44423");
		biz.setIdNo("00000BBCS00272");
		biz.setInOutDirect("342BBCS34324");
		biz.setMemAccno("4533BBCS44423");
		biz.setMergeTicketNo("00000BBCS00272");
		biz.setMerNotVerTktNum("342BBCS34324");
		biz.setPackageTicketNo("4533BBCS44423");
		biz.setPckNotVerTktNum("00000BBCS00272");
		biz.setResortId("342BBCS34324");
		biz.setSpotId("4533BBCS44423");
		biz.setStrTESn("00000BBCS00272");
		biz.setTicketNo("342BBCS34324");
		biz.setTicketType("4533BBCS44423");
		biz.setTradeNo("4533BBCS44423");
		// 请求IP地址，请根据测试环境和生产环境替换相应ip和端口
		String serviceUrl = "https://ip:port/api/mybank/mer/member/scenicticketwriteoff/V1";
		CardbusinessMerMemberScenicticketwriteoffRequestV1 requestV1 = new CardbusinessMerMemberScenicticketwriteoffRequestV1();
		...
		try {
		      CardbusinessMerMemberScenicticketwriteoffResponseV1 responseV1 = client.execute(requestV1);
