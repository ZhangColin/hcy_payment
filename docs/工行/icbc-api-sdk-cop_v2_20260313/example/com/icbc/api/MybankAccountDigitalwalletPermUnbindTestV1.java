...
import com.icbc.api.request.MybankAccountDigitalwalletPermUnbindRequestV1;
import com.icbc.api.response.MybankAccountDigitalwalletPermUnbindResponseV1;


public interface MybankAccountDigitalwalletPermUnbindTestV1 {
    ...
    public static void main(String[] args) {
        ...
        MybankAccountDigitalwalletPermUnbindRequestV1 request = new MybankAccountDigitalwalletPermUnbindRequestV1();
        request.setServiceUrl("http://IP:PORT/api/mybank/account/digitalwallet/permunbind/V1");
        //5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值，非必输字段可不上送
        MybankAccountDigitalwalletPermUnbindRequestV1.MybankAccountDigitalwalletPermUnbindRequestV1Biz bizContent = new MybankAccountDigitalwalletPermUnbindRequestV1.MybankAccountDigitalwalletPermUnbindRequestV1Biz();
        ...
        bizContent.setApplyPerm("1");


		
        request.setBizContent(bizContent);
        System.out.println("request:" + request);
        MybankAccountDigitalwalletPermUnbindResponseV1 response;
        try {
