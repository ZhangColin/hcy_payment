...
import com.icbc.api.request.JftApiVendorEnterpriseInfoModifyRequestV1;
import com.icbc.api.request.JftApiVendorEnterpriseInfoModifyRequestV1.JftApiVendorEnterpriseInfoModifyRequesBiz;
 ...
 * @Description:
 */
public class JftApiVendorEnterpriseInfoModifyTestV1 {
    //1、网关公钥
...
//		DefaultIcbcClient client = new DefaultIcbcClient(APP_ID,"RSA", MY_PRIVATE_KEY,"UTF-8", "json",APIGW_PUBLIC_KEY,"AES","nezfRV32iH9deJq4IrcCpw==", "", "");
        ...
        JftApiVendorEnterpriseInfoModifyRequestV1 request = new JftApiVendorEnterpriseInfoModifyRequestV1();

        //4、根据测试环境和生产环境替换相应ip和端口
        request.setServiceUrl("https://ip:port/api/jft/api/vendor/enterprise/info/modify/V1");
        //5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
        JftApiVendorEnterpriseInfoModifyRequesBiz bizContent = new JftApiVendorEnterpriseInfoModifyRequesBiz();
        //必填
        ...
        try {
            response = (JftApiVendorEnterpriseInfoModifyResponseV1) client.execute(request, System.currentTimeMillis()+"");
