...
import com.icbc.api.request.RefundQueryRequestV1.RefundQueryRequestV1Biz;
import com.icbc.api.response.RefundQueryResponseV1;

public class RefundQueryTestV1 {
    ...
    public static void main(String[] args) {
        ...
        request.setServiceUrl("http://ip:port/api/jft/api/pay/refund/query/V1");

        RefundQueryRequestV1Biz bizContent = new RefundQueryRequestV1Biz();
        bizContent.setAppId("10000000000000213532");//平台商户标识
        bizContent.setPayType("02");//平台商户标识
        bizContent.setVendorId("10000000000000003923");//子商户标识
        bizContent.setpRefundId("201804041003");//原平台订单ID
        bizContent.setRefundId("201804044013");//平台退款单ID
        bizContent.setIsParent("1");

        request.setBizContent(bizContent);

        RefundQueryResponseV1 response;
        try {
