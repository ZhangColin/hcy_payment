...
import com.icbc.api.request.MybankPayInsurancePrimumChargeRequestV1;
import com.icbc.api.response.MybankPayInsurancePrimumChargeResponseV1;

import java.util.logging.Logger;

public class MybankPayInsurancePrimumChargeV1Test {
    static Logger log = Logger.getLogger(MybankPayInsurancePrimumChargeV1Test.class.getName());
    //估值表
    protected static String APP_ID = "xxxxxxxxxxxxxx";
    ...
    public static void main(String[] args) throws Exception {
        String URI = "mybank/pay/insurance/primum/charge/V1"; // api地址
        ...
        try {
            ...
            // bizContent实体
            MybankPayInsurancePrimumChargeRequestV1.ApiInvestmentMybankPayInsurancePrimumChargeRequestV1Biz bizContent
                    = new MybankPayInsurancePrimumChargeRequestV1.ApiInvestmentMybankPayInsurancePrimumChargeRequestV1Biz();
            ...
            commonReqInfoContent.setTransDate("xxxxxx");
            ...
            transReqInfoContent.setCustIdNo("xxxxxxxxxxxxxxxx");
            transReqInfoContent.setPrtlNo("xxxxxxxxxxxx");
            transReqInfoContent.setInsuPrtlType("1");
            transReqInfoContent.setInsuPrtlNo("xxxxxxxxxxxxx");
            transReqInfoContent.setTransSeq("xxxxxxxxxxx");
            transReqInfoContent.setReptFlag("0");
            transReqInfoContent.setTransAmt("xxxxxxxxxxx");
            transReqInfoContent.setTransNotes("保费代扣");
            ...
            MybankPayInsurancePrimumChargeResponseV1 response = client.execute(request);
