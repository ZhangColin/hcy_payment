...
import com.icbc.api.request.Queryca29130RequestV1;
import com.icbc.api.request.Queryca29130RequestV1.Queryca29130RequestV1Biz;
import com.icbc.api.request.Queryca29130RequestV1.Queryca29130RequestV1Pub;
import com.icbc.api.request.Queryca29130RequestV1.Queryca29130RequestV1In;
import com.icbc.api.response.Queryca29130ResponseV1;
import com.icbc.api.response.Queryca29130ResponseV1.Queryca29130ResponseV1Pub;
import com.icbc.api.response.Queryca29130ResponseV1.Queryca29130ResponseV1Out;
import com.icbc.api.response.Queryca29130ResponseV1.Queryca29130ResponseV1Detail;

public class Queryca29130Test {
	...
	public void test_CA() throws IcbcApiException {
		...
		Queryca29130RequestV1 request = new Queryca29130RequestV1();
		request.setServiceUrl("http://ip:port/api/queryca29130/query/V1");

		Queryca29130RequestV1Biz bizContent = new Queryca29130RequestV1Biz();
		
		Queryca29130RequestV1Pub pub = new Queryca29130RequestV1Pub();
		pub.setCode("29130");
		pub.setZone("0200");
		pub.setFr("0");
		pub.setDt("2018-12-26");
		
		Queryca29130RequestV1In in = new Queryca29130RequestV1In();
		in.setLineflag("2");
		...
		Queryca29130ResponseV1 response = client.execute(request, "msgId");

		if (response.isSuccess()) {
			// 接收成功
			Queryca29130ResponseV1Pub RetPub = response.getPub();
			Queryca29130ResponseV1Out RetOut = response.getOut();
			if(RetOut.getResult().equals("00000000")){
				//查询成功 获取返回结果
				List<Queryca29130ResponseV1Detail> resultList = RetOut.getDetail();
				//获取结果集中字段
				for(Queryca29130ResponseV1Detail detail:resultList){
					//获取信息.....
					detail.getPOSNO();
				}
			} else {
