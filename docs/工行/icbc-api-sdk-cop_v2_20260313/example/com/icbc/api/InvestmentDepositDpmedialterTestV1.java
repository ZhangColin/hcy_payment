...
import com.icbc.api.request.InvestmentDepositDpmedialterRequestV1;
...
public class InvestmentDepositDpmedialterTestV1 {
    ...
    public void test_cop() throws IcbcApiException {
        ...
        InvestmentDepositDpmedialterRequestV1 request = new InvestmentDepositDpmedialterRequestV1();
        request.setServiceUrl(Const.URL_PREFIX + "/investment/deposit/Dpmedialter/V1");
        InvestmentDepositDpmedialterRequestV1.InvestmentDepositDpmedialterRequestV1Biz bizContent =
                new InvestmentDepositDpmedialterRequestV1.InvestmentDepositDpmedialterRequestV1Biz();
        ...
        // PMD检查
        bizContent.setOldcardno("62220" +
                "80200000020618");
        bizContent.setOldaccno("0200" +
                "1234567678444");
        bizContent.setOldaccounttype("1");
        bizContent.setNewaccounttype("1");
        bizContent.setNewaccno("020" +
                "01234567678444");
        bizContent.setNewcardno("62220" +
                "80200000020618");
        bizContent.setOperflag("1");
        bizContent.setMessagecodeno("6a4b9d6f27e84e04ae1482beb31027d7");
        bizContent.setMessageverifyno("666666");
        bizContent.setPhonenumber("13512311235");


        request.setBizContent(bizContent);
        InvestmentDepositDpmedialterResponseV1 response;
        try {
