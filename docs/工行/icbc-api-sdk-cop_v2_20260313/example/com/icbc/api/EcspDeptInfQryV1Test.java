...
import com.icbc.api.request.EcspDeptInfQryRequestV1;
import com.icbc.api.response.EcspDeptInfQryResponseV1;

public class EcspDeptInfQryV1Test {
	// 1、网关公钥
	...
	public static void main(String[] args) throws Exception {
		...
		EcspDeptInfQryRequestV1 request = new EcspDeptInfQryRequestV1();

		// 4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("http://ip:port/api/saes/servmer/ordersubmit/V1");
		// 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		EcspDeptInfQryRequestV1.EcspDeptInfQryRequestV1Biz bizContent = new EcspDeptInfQryRequestV1.EcspDeptInfQryRequestV1Biz();
		bizContent.setCorpId("0000000001");
		bizContent.setZoneId(2401);

		request.setBizContent(bizContent);

		EcspDeptInfQryResponseV1 response;
		try {
