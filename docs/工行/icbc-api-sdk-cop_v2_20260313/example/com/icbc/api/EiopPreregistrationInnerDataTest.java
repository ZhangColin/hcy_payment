...
import com.icbc.api.request.EiopPreregistrationInnerDataRequestV1;
import com.icbc.api.request.EiopPreregistrationInnerDataRequestV1.EiopPreregistrationInnerDataRequestV1Biz;
import com.icbc.api.request.EiopPreregistrationInnerDataRequestV1.ActivityInfo;
public class EiopPreregistrationInnerDataTest {
	//1、网关公钥
	protected static final String APIGW_PUBLIC_KEY = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQSDFDGDFHDSZDSAEPdOj03ctKM7KV+16bWZ5BMNgvEeuEQwfQYkRVwI9HFOGkwNTMn5hiJXHnlXYCX+zp5r6R52MY0O7BsTCLT7aHaxsANsvI9ABGx3OaTVlPB59M6GPbJh0uXvio0m1r/lTW3Z60RU6Q3oid/rNhP3CiNgg0W6O3AGqwIDAQAB";
	
	//2、appid 通行证第三方测试1 (行外)
	protected static final String APP_ID = "10000000000000016789";
	...
	public static void main(String[] args) {
		...
		EiopPreregistrationInnerDataRequestV1 request = new EiopPreregistrationInnerDataRequestV1();
		
		//4、根据测试环境和生产环境替换相应ip和端口
		//行外流程
		request.setServiceUrl("http://ip:port/api/eiop/coupon/preregistration/innerData/V1");
		
		//5、请对照接口文档用bizContent.setEiopCouponResultQuery()方法对业务上送数据进行赋值
		EiopPreregistrationInnerDataRequestV1Biz bizContent = new  EiopPreregistrationInnerDataRequestV1Biz();

		List<ActivityInfo> activityInfoList=new ArrayList<EiopActAdvinfo>();
		ActivityInfo  activityInfo=new ActivityInfo();
		activityInfo.setActivityId("123");
		activityInfo.setActivityId("123");
		activityInfoList.add(activityInfo);

		bizContent.setPreregistratioType("1");
		bizContent.setPreregistratioNo("15203736668");
		bizContent.setCustomerNoType("3");
		bizContent.setChannel("702193");
		bizContent.setCustomerTagAfterLocation("1");
		bizContent.setActivityInfo(activityInfoList);
		request.setBizContent(bizContent);

		EiopPreregistrationInnerDataResponseV1 response = new EiopPreregistrationInnerDataResponseV1();
		try {
