...
import com.icbc.api.request.CvRegFileReceptRequestV1;
import com.icbc.api.response.CvRegFileReceptResponseV1;

/**
 * @author kfzx-liyc
 * @date 2021年12月2021/12/9日 11:18
 */
public class CvRegFileReceptV1Test {
    ...
    public static void main(String[] args) throws Exception {
        ...
        CvRegFileReceptRequestV1 request = new CvRegFileReceptRequestV1();

        // 4、根据测试环境和生产环境替换相应ip和端口
        request.setServiceUrl("http://ip:port/api/saes/servmer/ordersubmit/V1");

        // 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
        CvRegFileReceptRequestV1.CvRegFileReceptRequestV1Biz bizContent = new CvRegFileReceptRequestV1.CvRegFileReceptRequestV1Biz();
        bizContent.setCorpId("0000000001");
        bizContent.setSaTrxId("0000000001");
        bizContent.setRegId("0000000001");
        bizContent.setRegFile("asdasd");
        bizContent.setRegTrxType((byte)1);

        request.setBizContent(bizContent);

        CvRegFileReceptResponseV1 response;
        try {
