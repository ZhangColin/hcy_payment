...
import com.icbc.api.request.GyjrB2bBillOrdercancelRequestV1;
import com.icbc.api.response.GyjrB2bBillOrdercancelResponseV1;

import java.util.Arrays;
import java.util.Random;

public class GyjrB2bBillOrdercancelTestV1 {
    ...
    public static void main(String[] args) {
        ...
        request.setServiceUrl("http://IP:PORT/api/gyjr/b2b/bill/ordercancel/V1");
        ...
        transInfo.setOrderNo("23254365322");
        transInfo.setCustomerName("102100099889");

        request.setBizContent(transInfo);
