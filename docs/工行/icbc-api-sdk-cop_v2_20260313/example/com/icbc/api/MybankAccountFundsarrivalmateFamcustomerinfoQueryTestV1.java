...
import com.icbc.api.request.MybankAccountFundsarrivalmateFamcustomerinfoQueryRequestV1;
import com.icbc.api.response.MybankAccountFundsarrivalmateFamcustomerinfoQueryResponseV1;

public interface MybankAccountFundsarrivalmateFamcustomerinfoQueryTestV1 {
    ...
    public static void main(String[] args) {
        ...
        MybankAccountFundsarrivalmateFamcustomerinfoQueryRequestV1 request = new MybankAccountFundsarrivalmateFamcustomerinfoQueryRequestV1();
        request.setServiceUrl("http://ip:port/api/mybank/account/fundsarrivalmate/famcustomerinfoqry/V1");

        MybankAccountFundsarrivalmateFamcustomerinfoQueryRequestV1.FamCustomerInfoQueryRequestV1Biz bizContent = new MybankAccountFundsarrivalmateFamcustomerinfoQueryRequestV1.FamCustomerInfoQueryRequestV1Biz();
        bizContent.setAgreeno("1");
        bizContent.setCustomerid("guq_dealer_002");
        bizContent.setCustomername("guq测试002");
        bizContent.setRecipacc("1");
        bizContent.setRecipnam("测试户002");
        bizContent.setPage("1");
        bizContent.setPagesize("9");

        request.setBizContent(bizContent);
        MybankAccountFundsarrivalmateFamcustomerinfoQueryResponseV1 response;
        try {
