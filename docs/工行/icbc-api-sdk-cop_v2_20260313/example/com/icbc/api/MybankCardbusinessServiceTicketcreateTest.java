...
import src.com.icbc.api.response.MybankCardbusinessServiceTicketcreateResponseV1;
import src.com.icbc.api.request.MybankCardbusinessServiceTicketcreateRequestV1;

public class MybankCardbusinessServiceTicketcreateTest {
    public static void main(String[] args) throws Exception {
        ...
        MybankCardbusinessServiceTicketcreateRequestV1 request = new MybankCardbusinessServiceTicketcreateRequestV1();

        request.setServiceUrl("http://ip:port:16257/api/mybank/cardbusiness/service/ticketcreate/V1");

        MybankCardbusinessServiceTicketcreateRequestV1.MybankCardbusinessServiceTicketcreateRequestV1Biz bizRes = new MybankCardbusinessServiceTicketcreateRequestV1.MybankCardbusinessServiceTicketcreateRequestV1Biz();

        bizRes.setSerno("20000054230");
        bizRes.setOutTicketNo("0");
        bizRes.setPrtiId("111111111111");
        bizRes.setMerName("0");
        bizRes.setMerAddr("0");
        bizRes.setMerType("0");
        bizRes.setTicketType("0");
        bizRes.setPriority("0");
        bizRes.setExpectedTime("2024-10-10");
        bizRes.setPosno("111111111111222");
        bizRes.setPostyp("0");
        bizRes.setDevbrandno("0");
        bizRes.setDevserno("0");
        bizRes.setRemark("0");
        bizRes.setTransactor("0");
        bizRes.setContactPhone("0");
        bizRes.setDeviceType("1");
        request.setBizContent(bizRes);
        try {
            MybankCardbusinessServiceTicketcreateResponseV1 response = client.execute(request);
            // 判断调用是否成功，进行后续业务处理
