...
import com.icbc.api.request.FmtadAtsprodpriceexposeserviceQueryprodpricesRequestV1;
import com.icbc.api.request.FmtadAtsprodpriceexposeserviceQueryprodpricesRequestV1.FmtadAtsprodpriceexposeserviceQueryprodpricesRequestBizV1;
import com.icbc.api.request.FmtadAtsprodpriceexposeserviceQueryprodpricesRequestV1.ChanCommV10;
import com.icbc.api.request.FmtadAtsprodpriceexposeserviceQueryprodpricesRequestV1.InfoCommV10;
import com.icbc.api.response.AccountBillInfoQueryResponseV2;
import com.icbc.api.response.FmtadAtsprodpriceexposeserviceQueryprodpricesResponseV1;

public class FmtadAtsprodpriceexposeserviceQueryprodpricesTestV1 {
    //1、网关公钥
    ...
    public static void main(String[] args) throws Exception {
        ...
        FmtadAtsprodpriceexposeserviceQueryprodpricesRequestV1 request = new FmtadAtsprodpriceexposeserviceQueryprodpricesRequestV1();
        //4、根据测试环境和生产环境替换相应ip和端口
        request.setServiceUrl("https://ip:port/api/account/bill/info/query/V2");

        //5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
        FmtadAtsprodpriceexposeserviceQueryprodpricesRequestBizV1 bizContent = new FmtadAtsprodpriceexposeserviceQueryprodpricesRequestBizV1();
        ...
        bizContent.setBaseCcy(1);
        bizContent.setBidCcy(14);
        request.setBizContent(bizContent);



        FmtadAtsprodpriceexposeserviceQueryprodpricesResponseV1 response;
        try {
