...
import com.icbc.api.request.SgePositionQueryRequestV1;
import com.icbc.api.request.SgePositionQueryRequestV1.SgePositionQueryRequestBiz;
import com.icbc.api.response.SgePositionQueryResponseV1;

public class SgePositionQueryTestV1 {
	...
	public void test_cop() throws IcbcApiException {
		...
		SgePositionQueryRequestV1 request = new SgePositionQueryRequestV1();
		request.setServiceUrl("http://ip:port/api/sge/position/query/V1");

		SgePositionQueryRequestBiz bizContent = new SgePositionQueryRequestBiz();
		bizContent.setClientId(1311022886);
		bizContent.setContractId("");
		bizContent.setQueryFlag(1);
		bizContent.setQueryRow(5);
		request.setBizContent(bizContent);

		SgePositionQueryResponseV1 response = client.execute(request);
