...
public class PcPayTestServletV1 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)throws ServletException, IOException {
		...
		try {
			...
			request.setServiceUrl("http://ip:port/ui/jft/ui/pay/pc/V1");
			...
			bizContent.setFixedCommissionOwn("1.00");
			bizContent.setFixedCommissionOther("1.00");
			bizContent.setFixedCommissionWx("0.01");
			bizContent.setFixedCommissionZfb("0.01");
			bizContent.setAutoConfirm("1");
