...
import com.icbc.api.request.B2cPcPayTransferRequestV3;

public class B2cPcPayTransferTestV3 extends HttpServlet {
	/**
	 * Comment for <code>serialVersionUID</code>
	 */
	private static final long serialVersionUID = 1588786734333856129L;

	public B2cPcPayTransferTestV3() {
		super();
	}
	...
	protected void service(HttpServletRequest request,
		...
		try {
			B2cPcPayTransferRequestV3 requestApi = new B2cPcPayTransferRequestV3();
	...
	public String dealPostData(HttpServletRequest request)
		...
		String prodProtocol = request.getParameter("prodProtocol");
		...
		ApiJsonUtils.setValueAt(bean, "order_info.prodProtocol", prodProtocol);
