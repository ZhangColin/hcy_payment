...
import com.icbc.api.request.MybankPayQrcodeScannedPayRequestV2.MybankPayQrcodeScannedPayRequestV2Biz;
 ...
 */
public class MybankPayQrcodeScannedPayV2Test {
	...
	public static void main(String[] args) throws Exception {
		...
		request.setServiceUrl("http://****/api/mybank/pay/qrcode/scanned/pay/V2");
		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		MybankPayQrcodeScannedPayRequestV2Biz bizContent = new MybankPayQrcodeScannedPayRequestV2Biz();
