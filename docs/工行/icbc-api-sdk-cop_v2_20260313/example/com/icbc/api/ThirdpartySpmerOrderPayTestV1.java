...
import com.icbc.api.request.ThirdpartySpmerOrderPayRequestV1;
import com.icbc.api.request.ThirdpartySpmerOrderPayRequestV1.ThirdpartySpmerOrderPayRequestV1Biz;
 ...
 */
public class ThirdpartySpmerOrderPayTestV1 {

	static Logger LOGGER = Logger.getLogger(ThirdpartySpmerOrderPayTestV1.class.getName());
	...
	public void order(HttpServletRequest request1, HttpServletResponse response) throws Exception {
		...
		ThirdpartySpmerOrderPayRequestV1 request = new ThirdpartySpmerOrderPayRequestV1();
		
		//4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("http://ip:port/ui/thirdparty/spmer/order/pay/V1");
		
		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		ThirdpartySpmerOrderPayRequestV1Biz bizContent = new ThirdpartySpmerOrderPayRequestV1Biz();
		...
		bizContent.setAllPointsFlag("0");// 该字段非必输项
		bizContent.setGoodPoints("");// 该字段非必输项
		bizContent.setInstallmentFlag("0");// 该字段非必输项
		bizContent.setInstallmentTimes("");// 该字段非必输项
		bizContent.setCardType("111");// 该字段非必输项
		bizContent.setIntgMerId("020053010901");// 该字段非必输项
		bizContent.setOnlinePrtclNo("0200089901470201");// 该字段非必输项
		bizContent.setPayMode("100");// 该字段非必输项
