...
import com.icbc.api.request.JftUiVacctStatementPcViewRequestV1;
...
public class JftUiVacctStatementPcViewTestServletV1 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)throws ServletException, IOException {
		...
		try {
			...
			JftUiVacctStatementPcViewRequestV1 request = new JftUiVacctStatementPcViewRequestV1();

			request.setServiceUrl("https://apipcs4.dccnet.com.cn/ui/jft/ui/vacct/statement/pc/view/V1");
			JftUiVacctStatementPcViewRequestV1.JftUiVacctStatementPcViewRequestV1Biz bizContent = new JftUiVacctStatementPcViewRequestV1.JftUiVacctStatementPcViewRequestV1Biz();
