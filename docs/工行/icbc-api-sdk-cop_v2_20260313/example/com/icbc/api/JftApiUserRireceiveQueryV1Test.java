...
import com.icbc.api.request.JftApiUserRireceiveQueryRequestV1.JftApiUserRireceiveQueryRequestV1Biz;
import com.icbc.api.response.JftApiUserRireceiveQueryResponseV1;

public class JftApiUserRireceiveQueryV1Test {
    //1、网关公钥
    ...
    public static void main(String[] args) throws Exception {
        ...
        String apiUrl = host + "/api/jft/api/user/rireceive/query/V1";
        ...
        try {
            response = (JftApiUserRireceiveQueryResponseV1) client.execute(request,
