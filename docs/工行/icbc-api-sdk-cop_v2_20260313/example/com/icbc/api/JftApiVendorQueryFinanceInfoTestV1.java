...
import com.icbc.api.request.JftApiVendorQueryFinanceInfoRequestV1;
import com.icbc.api.request.JftApiVendorQueryFinanceInfoRequestV1.JftApiVendorQueryFinanceInfoRequestV1Biz;
import com.icbc.api.response.JftApiVendorQueryFinanceInfoResponseV1;

/**
 * 聚富通平台会员查询接口
 */
public class JftApiVendorQueryFinanceInfoTestV1 {
	...
	public static void main(String[] args) throws Exception {
		...
		JftApiVendorQueryFinanceInfoRequestV1 request = new JftApiVendorQueryFinanceInfoRequestV1();

		//4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("https://ip:port/api/jft/api/vendor/query/finance/info/V1");
		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		JftApiVendorQueryFinanceInfoRequestV1Biz bizContent = new JftApiVendorQueryFinanceInfoRequestV1Biz();
		...
		JftApiVendorQueryFinanceInfoResponseV1 response;
		try {
			response = (JftApiVendorQueryFinanceInfoResponseV1) client.execute(request, System.currentTimeMillis()+"");
