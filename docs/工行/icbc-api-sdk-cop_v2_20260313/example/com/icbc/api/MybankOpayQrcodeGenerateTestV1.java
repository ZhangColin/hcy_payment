...
import com.icbc.api.request.MybankOpayQrcodeGenerateRequestV1;
import com.icbc.api.request.MybankOpayQrcodeGenerateRequestV1.MybankOpayQrcodeGenerateRequestV1Biz;
import com.icbc.api.response.MybankOpayQrcodeGenerateResponseV1;

public class MybankOpayQrcodeGenerateTestV1 {
...
//		private static final String API_SERVICE_URL = new String("http://ip:port/api");http://ip:port/api
	    ...
	    static Logger log = Logger.getLogger(MybankOpayQrcodeGenerateTestV1.class.getName());
		...
		public static void main(String[] args) {
			...
			MybankOpayQrcodeGenerateRequestV1 request = new MybankOpayQrcodeGenerateRequestV1();
			
			//访问工行API平台URL
			request.setServiceUrl(API_SERVICE_URL + "/mybank/opay/qrcode/generate/V1");


			MybankOpayQrcodeGenerateRequestV1Biz bizContent = new MybankOpayQrcodeGenerateRequestV1Biz();

			//APPID
			bizContent.setPalm_global_user_id("1111111");
			bizContent.setAuthorization_id("11111111");
			bizContent.setDevice_id("1111111");
			bizContent.setIp("1111111");
			...
			MybankOpayQrcodeGenerateResponseV1 response;

			try {
				response = client.execute(request);
				
			} catch (IcbcApiException e) {
				log.error("IcbcApiException occurred", e);
			}
