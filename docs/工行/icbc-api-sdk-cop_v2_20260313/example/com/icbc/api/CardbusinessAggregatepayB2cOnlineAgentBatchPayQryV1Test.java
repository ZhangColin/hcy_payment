...
import com.icbc.api.request.CardbusinessAggregatepayB2cOnlineAgentBatchPayQryRequestV1;
import com.icbc.api.response.CardbusinessAggregatepayB2cOnlineAgentBatchPayQryResponseV1;
import com.icbc.api.request.CardbusinessAggregatepayB2cOnlineAgentBatchPayQryRequestV1.CardbusinessAggregatepayB2cOnlineAgentBatchPayQryV1Biz;
...
public class CardbusinessAggregatepayB2cOnlineAgentBatchPayQryV1Test {
    ...
    private Logger logger = Logger.getLogger(CardbusinessAggregatepayB2cOnlineAgentBatchPayQryV1Test.class.getName());


    public void test_cop() throws IcbcApiException {
        CardbusinessAggregatepayB2cOnlineAgentBatchPayQryRequestV1 request = new CardbusinessAggregatepayB2cOnlineAgentBatchPayQryRequestV1();
        // 4、需传入appid，私钥，字符集
        UiIcbcClient client;
        ...
        request.setServiceUrl("https://ip:port/api/cardbusiness/aggregatepay/b2c/online/AgentBatchPayQry/V1");
        CardbusinessAggregatepayB2cOnlineAgentBatchPayQryV1Biz bizContent = new CardbusinessAggregatepayB2cOnlineAgentBatchPayQryV1Biz();
        request.setBizContent(bizContent);
        // 6、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
        bizContent.setMer_ser_flag("x");
        bizContent.setMer_id("xxxxxx");
        bizContent.setBatchNo("xxxxxxxx");
        bizContent.setTxn_time("xxxx");

        CardbusinessAggregatepayB2cOnlineAgentBatchPayQryResponseV1 response;
        try {
