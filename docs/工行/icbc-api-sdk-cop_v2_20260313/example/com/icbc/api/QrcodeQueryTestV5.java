...
import com.icbc.api.request.QrcodeQueryRequestV5.QrcodeQueryRequestV5Biz;
 ...
 */
public class QrcodeQueryTestV5 {
	...
	public static void main(String[] args) throws Exception {
		...
		request.setServiceUrl("https://ip:port/api/qrcode/query/V5");

		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		QrcodeQueryRequestV5Biz bizContent = new QrcodeQueryRequestV5Biz();
