...
import com.icbc.api.request.MybankLoanDatachainloanOrderwithdrawRequestV2;
import com.icbc.api.request.MybankLoanDatachainloanOrderwithdrawRequestV2.MybankLoanDatachainloanOrderwithdrawRequestV2Biz;
import com.icbc.api.request.MybankLoanDatachainloanOrderwithdrawRequestV2.MybankLoanDatachainloanOrderwithdrawRequestV2Biz.AODPayInfoDTO;
import com.icbc.api.request.MybankLoanDatachainloanOrderwithdrawRequestV2.MybankLoanDatachainloanOrderwithdrawRequestV2Biz.AODServeInfoDTO;
import com.icbc.api.response.MybankLoanDatachainloanOrderwithdrawResponseV2;

public class MybankLoanDatachainloanOrderwithdrawTestV2 {
	...
	public static void main(String[] args) {
     ...
     try {
     	...
     	MybankLoanDatachainloanOrderwithdrawRequestV2 request =
                 new MybankLoanDatachainloanOrderwithdrawRequestV2();
         request.setServiceUrl(BASE_URL + "/" + URI);
         request.setBizContent(bizContent);
         MybankLoanDatachainloanOrderwithdrawResponseV2 response = client.execute(request);
