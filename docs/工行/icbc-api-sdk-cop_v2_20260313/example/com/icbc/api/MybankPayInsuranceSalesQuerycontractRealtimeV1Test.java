...
public class MybankPayInsuranceSalesQuerycontractRealtimeV1Test {
	...
	public static void main(String[] args){
		...
		invoker.setUri("/mybank/pay/insurance/sales/querycontractRealtime/V1");
		...
		try {
			...
			inputJson = "{\"SerNo\":\"20211009012100121545\",\n" +
					"\"TransStartTime\":\"143000\",\n" +
					"\"TransEndTime\":\"143500\",\n" +
					"\"PageNo\":\"1\",\n" +
					"\"PageSize\":\"5\",\n" +
					"\"QrySeqNo\":\"2021100901210012\"\n" +
					"}";
			...
			//业务处理返回
			System.out.println("业务处理返回return_code:"+resp.get("RetCode"));
			System.out.println("业务处理返回return_msg:"+resp.get("RetMsg"));
		} catch (Exception e) {
