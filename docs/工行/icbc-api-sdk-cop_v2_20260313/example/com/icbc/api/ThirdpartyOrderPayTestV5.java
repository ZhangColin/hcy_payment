 ...
 */
public class ThirdpartyOrderPayTestV5 {

	static Logger LOGGER = Logger.getLogger(ThirdpartyOrderPayTestV5.class.getName());
	...
	public void order(HttpServletRequest request1, HttpServletResponse response) throws Exception {
		...
		ThirdpartyOrderPayRequestV5 request = new ThirdpartyOrderPayRequestV5();
		
		//4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("http://ip:port/ui/thirdparty/order/pay/V5");
		
		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		ThirdpartyOrderPayRequestV5Biz bizContent = new ThirdpartyOrderPayRequestV5Biz();
