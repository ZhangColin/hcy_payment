...
import com.icbc.api.request.JftApiUserRireceiveDeleteRequestV1.JftApiUserRireceiveDeleteRequestV1Biz;
import com.icbc.api.response.JftApiUserRireceiveDeleteResponseV1;

public class JftApiUserRireceiveDeleteV1Test {
    //1、网关公钥
    ...
    public static void main(String[] args) throws Exception {
        ...
        String apiUrl = host + "/api/jft/api/user/rireceive/delete/V1";
        ...
        try {
            response = (JftApiUserRireceiveDeleteResponseV1) client.execute(request,
