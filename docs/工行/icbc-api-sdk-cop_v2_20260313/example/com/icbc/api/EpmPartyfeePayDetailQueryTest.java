...
import com.icbc.api.request.PartyfeePayDetailQueryRequestV1;
import com.icbc.api.response.PartyfeePayDetailQueryResponseV1;

public class EpmPartyfeePayDetailQueryTest extends HttpServlet{
	...
	public static void main(String[] args) {
		...
		String url = "http://ip:port/api/epm/partyfee/paydetail/query/V1";
		DefaultIcbcClient client = new DefaultIcbcClient(appId, MY_PRIVATE_KEY, APIGW_PUBLIC_KEY);
		
		PartyfeePayDetailQueryRequestV1 request = new PartyfeePayDetailQueryRequestV1();
		PartyfeePayDetailQueryRequestV1.PartyfeePayDetailQueryRequestV1Biz bizContent = new PartyfeePayDetailQueryRequestV1.PartyfeePayDetailQueryRequestV1Biz();
		...
		bizContent.setStartDate("20180905");
		bizContent.setEndDate("20180930");
		bizContent.setQueryFlag("1");
		request.setServiceUrl(url);
		request.setBizContent(bizContent);	
		PartyfeePayDetailQueryResponseV1 resp = new PartyfeePayDetailQueryResponseV1();
