...
import com.icbc.ndf.jft.pay.controller.JftUiPayPcQueryRequestV1.JftUiPayPcQueryRequestV1Biz;


public class JftUiPayPcQueryTestServletV1 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)throws ServletException, IOException {
		...
		try {
			...
			JftUiPayPcQueryRequestV1 request = new JftUiPayPcQueryRequestV1();
			
			request.setServiceUrl("http://ip:port/ui/jft/ui/pay/queryRefundOrOrderByPC/V1");
			JftUiPayPcQueryRequestV1Biz bizContent = new JftUiPayPcQueryRequestV1Biz();
