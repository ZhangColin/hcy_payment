...
import com.icbc.api.request.PartyerAddRequestV1;
import com.icbc.api.response.PartyerAddResponseV1;

public class EpmOrgPartymemberAddTest extends HttpServlet{
	...
	public static void main(String[] args) {
		...
		String url1 = "http://ip:port/api/epm/org/partymember/add/V1";
		DefaultIcbcClient client = new DefaultIcbcClient(appId, MY_PRIVATE_KEY, APIGW_PUBLIC_KEY);
		PartyerAddRequestV1 request = new PartyerAddRequestV1();
		
		PartyerAddRequestV1.PartyerAddRequestV1Biz bizContent = new PartyerAddRequestV1.PartyerAddRequestV1Biz();
		...
		bizContent.setIdNo("123456789987654321");
		...
		bizContent.setPersonalId("9898212377");
		bizContent.setPhone("18755530808");
		request.setServiceUrl(url1);
		request.setBizContent(bizContent);	
		PartyerAddResponseV1 resp = new PartyerAddResponseV1();
