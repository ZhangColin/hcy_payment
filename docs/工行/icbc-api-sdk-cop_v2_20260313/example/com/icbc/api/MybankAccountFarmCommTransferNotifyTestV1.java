...
import com.icbc.api.request.MybankAccountFarmCommTransferNotifyRequestV1;
import com.icbc.api.response.MybankAccountFarmCommTransferNotifyResponseV1;

public class MybankAccountFarmCommTransferNotifyTestV1 {
protected static String APP_ID = "10000000000004096993";
	...
	public static void main(String[] args) throws Exception {
		String URI = "mybank/account/farm/commTransferNotify/V1";

		
		DefaultIcbcClient client = new DefaultIcbcClient(APP_ID,"RSA2", PRI_KEY, APIGW_PUBLIC_KEY);
		try {
			MybankAccountFarmCommTransferNotifyRequestV1 request = new MybankAccountFarmCommTransferNotifyRequestV1();
			MybankAccountFarmCommTransferNotifyRequestV1.MybankAccountFarmCommTransferNotifyBizV1 requestBizV1 = new MybankAccountFarmCommTransferNotifyRequestV1.MybankAccountFarmCommTransferNotifyBizV1();

			requestBizV1.setfSeqNo("124325");
			requestBizV1.setTransDate("20220202");
			requestBizV1.setCorpCode("icbc");
			requestBizV1.setParamType("1");
			requestBizV1.setDetail("{\"busiClientId\":\"yangrId003\",\"protocolId\":\"yangprojectId003\"}");
	        ...
	        MybankAccountFarmCommTransferNotifyResponseV1 response = client.execute(request);
