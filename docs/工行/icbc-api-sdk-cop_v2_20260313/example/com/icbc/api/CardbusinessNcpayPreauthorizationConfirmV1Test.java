...
public class CardbusinessNcpayPreauthorizationConfirmV1Test {
    //1、网关公钥
    ...
    public static void main(String[] args) throws Exception {
        ...
        CardbusinessNcpayPreAuthorizationConfirmRequestV1 request = new CardbusinessNcpayPreAuthorizationConfirmRequestV1();

        //4、根据测试环境和生产环境替换相应ip和端口 http://ip:port/api
        request.setServiceUrl("http://ip:port/api/cardbusiness/ncpay/preauthorization/confirm/V1");
        ...
        CardbusinessNcpayPreAuthorizationConfirmResponseV1 response;
        try {
