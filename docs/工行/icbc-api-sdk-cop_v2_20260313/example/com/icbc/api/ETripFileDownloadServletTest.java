...
import com.icbc.api.request.ETripFileDownRequestV1;
import com.icbc.api.request.ETripFileDownRequestV1.ETripFileDownRequestV1Biz;

/**
 * Servlet implementation class ETripFileUploadServlet
 */
public class ETripFileDownloadServletTest extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			ETripFileDownRequestV1 requests = new ETripFileDownRequestV1();
			requests.setServiceUrl("https://ip:port/ui/mall/b2c/trip/updownFiles/download/V1");
			ETripFileDownRequestV1Biz bizContent = new ETripFileDownRequestV1Biz();
