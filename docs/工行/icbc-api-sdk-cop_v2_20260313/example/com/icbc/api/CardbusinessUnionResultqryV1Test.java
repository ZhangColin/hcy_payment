...
import com.icbc.api.request.CardbusinessUnionResultqryRequestV1;
import com.icbc.api.response.CardbusinessUnionResultqryResponseV1;
import com.icbc.api.request.CardbusinessUnionResultqryRequestV1.CardbusinessUnionResultqryRequestV1Biz;
...
public class CardbusinessUnionResultqryV1Test {
	// 1、网关公钥
	...
	private Logger logger = Logger.getLogger(CardbusinessUnionResultqryV1Test.class.getName());
	...
	public void test_cop() throws IcbcApiException {
		...
		DefaultIcbcClient client = new DefaultIcbcClient(APP_ID, IcbcConstants.SIGN_TYPE_RSA, MY_PRIVATE_KEY,
				APIGW_PUBLIC_KEY);
		CardbusinessUnionResultqryRequestV1 request = new CardbusinessUnionResultqryRequestV1();
		// 5、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("http://ip:port/api/cardbusiness/union/resultqry/V1");
		CardbusinessUnionResultqryRequestV1Biz bizContent = new CardbusinessUnionResultqryRequestV1Biz();
		...
		bizContent.setChancomm_preflag("xxx");
		...
		CardbusinessUnionResultqryResponseV1 response;
		try {
