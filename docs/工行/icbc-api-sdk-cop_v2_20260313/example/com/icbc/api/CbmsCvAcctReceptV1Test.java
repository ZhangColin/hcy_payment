...
public class CbmsSaInfoReceptV1Test {
	...
	public static void main(String[] args) throws Exception {
		...
		CbmsCvAcctReceptRequestV1 request = new CbmsCvAcctReceptRequestV1();

		// 4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("http://ip:port/api/saes/servmer/ordersubmit/V1");
		// 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		CbmsCvAcctReceptRequestV1Biz bizContent = new CbmsCvAcctReceptRequestV1Biz();
		...
		CbmsCvAcctReceptResponseV1 response;
		try {
