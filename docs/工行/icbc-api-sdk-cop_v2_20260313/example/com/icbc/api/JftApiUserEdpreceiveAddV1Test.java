...
import com.icbc.api.request.JftApiUserEdpreceiveAddRequestV1.JftApiUserEdpreceiveAddRequestV1Biz;
import com.icbc.api.response.JftApiUserEdpreceiveAddResponseV1;

public class JftApiUserEdpreceiveAddV1Test {
    //1、网关公钥
    ...
    public static void main(String[] args) throws Exception {
        ...
        JftApiUserEdpreceiveAddRequestV1.JftApiUserEdpreceiveAddRequestV1Biz bizContent = new JftApiUserEdpreceiveAddRequestV1.JftApiUserEdpreceiveAddRequestV1Biz();
        bizContent.setAppId(APP_ID);
        bizContent.setAppIdSub("[需替换]");
        bizContent.setOutUserId("[需替换]");
        bizContent.setReceiverAccount("6224769709001234567");
        bizContent.setReceiverName("收方户名");
        ...
        bizContent.setReceiverType("");
        bizContent.setReceiverRole("");
        bizContent.setMobile("");
        bizContent.setIdType("");
        bizContent.setIdNo("");
        bizContent.setOccupation("");
        bizContent.setAddress("");
        bizContent.setCompanyName("");
        bizContent.setCompanyIdType("");
        bizContent.setCompanyIdNo("");
        ...
        JftApiUserEdpreceiveAddResponseV1 response;
        try {
            response = (JftApiUserEdpreceiveAddResponseV1) client.execute(request,
