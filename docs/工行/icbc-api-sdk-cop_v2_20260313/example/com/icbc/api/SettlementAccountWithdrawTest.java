...
import com.icbc.api.request.SettlementAccountWithdrawRequestV1.SettlementAccountWithdrawRequestV1Biz;
import com.icbc.api.response.SettlementAccountWithdrawResponseV1;

public class SettlementAccountWithdrawTest {
	...
	public void test_cop() throws IcbcApiException {
		...
		SettlementAccountWithdrawRequestV1Biz bizContent = new SettlementAccountWithdrawRequestV1Biz();

		request.setServiceUrl("http://ip:port/api/settlement/account/V1/withdraw");
		...
		SettlementAccountWithdrawResponseV1 response = client.execute(request, "msgId");
