...
import com.icbc.api.request.PartyfeeBillQueryRequestV1;
import com.icbc.api.response.PartyfeeBillQueryResponseV1;

public class EpmPartyfeeBillQueryTest extends HttpServlet{
	...
	public static void main(String[] args) {
		...
		String url = "http://ip:port/api/epm/partyfee/bill/query/V1";
		DefaultIcbcClient client = new DefaultIcbcClient(appId, MY_PRIVATE_KEY, APIGW_PUBLIC_KEY);
		
		PartyfeeBillQueryRequestV1 request = new PartyfeeBillQueryRequestV1();
		PartyfeeBillQueryRequestV1.PartyfeeBillQueryRequestV1Biz bizContent = new PartyfeeBillQueryRequestV1.PartyfeeBillQueryRequestV1Biz();
		bizContent.setBeginNum("1");
		bizContent.setFetchNum("5");
		bizContent.setOrgId("100102100");
		bizContent.setProtocolNo("PT20181213100000108002"); 
		bizContent.setPayDuration("201807");
		bizContent.setBillNo("23542342");
		bizContent.setPersonalId("46534534");
		bizContent.setName("name1");
		bizContent.setStatus("1");
		request.setServiceUrl(url);
		request.setBizContent(bizContent);	
		PartyfeeBillQueryResponseV1 resp = new PartyfeeBillQueryResponseV1();
