...
import com.icbc.api.request.MybankPayBaseMepAgreementqueryRequestV1;
import com.icbc.api.request.MybankPayBaseMepAgreementqueryRequestV1.MybankPayBaseMepAgreementqueryRequestV1Biz;
import com.icbc.api.response.MybankPayBaseMepAgreementqueryResponseV1;

import java.util.UUID;

public class MybankPayBaseMepAgreementqueryTestV1 {
    //企业私钥
    ...
    //请求url
    protected static final String REQ_URL = "https://apipcs3.dccnet.com.cn/api/mybank/pay/base/mep/agreementquery/V1";
    //签名类型
    ...
    public static void main(String[] args) {
        MybankPayBaseMepAgreementqueryRequestV1Biz bizContent = new MybankPayBaseMepAgreementqueryRequestV1Biz();
        ...
        MybankPayBaseMepAgreementqueryRequestV1 request = new MybankPayBaseMepAgreementqueryRequestV1();
        request.setServiceUrl(REQ_URL);
        request.setBizContent(bizContent);

        System.out.println("req=" + JSON.toJSONString(bizContent));

        MybankPayBaseMepAgreementqueryResponseV1 response = null;
