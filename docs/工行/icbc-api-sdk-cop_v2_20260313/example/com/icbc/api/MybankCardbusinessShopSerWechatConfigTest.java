...
import com.icbc.api.request.MybankCardbusinessShopSerWechatConfigRequestV1;
import com.icbc.api.response.MybankCardbusinessShopSerWechatConfigResponseV1;

public class MybankCardbusinessShopSerWechatConfigTest {
    ...
    public static void main(String[] args) throws Exception{
	    ...
	    MybankCardbusinessShopSerWechatConfigRequestV1 request = new MybankCardbusinessShopSerWechatConfigRequestV1();

        request.setServiceUrl("http://IP:PORT/api/mybank/cardbusiness/shop/wechatconfig/V1");
	    MybankCardbusinessShopSerWechatConfigRequestV1.MybankCardbusinessShopSerWechatConfigRequestV1Biz bizRes =
			    new MybankCardbusinessShopSerWechatConfigRequestV1.MybankCardbusinessShopSerWechatConfigRequestV1Biz();
		...
		bizRes.setWx_appid("wx931386123456789e");

        request.setBizContent( bizRes);
	    MybankCardbusinessShopSerWechatConfigResponseV1 response = new MybankCardbusinessShopSerWechatConfigResponseV1();
        try{
