...
public class JftApiUserRireceiveUpdateTestV1 {

    private static final Logger LOGGER = LoggerFactory.getLogger(JftApiUserRireceiveUpdateTestV1.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 组装调用《融e聚反向开票自然人修改接口V1》上送报文
        JftApiUserRireceiveUpdateRequestV1 request = new JftApiUserRireceiveUpdateRequestV1();
        request.setServiceUrl("[需替换]工行API网关地址/api/jft/api/user/rireceive/update/V1");
        ...
        bizContent.setReceiverAccount("123456789123456789");
        bizContent.setSignDate("2020-01-01");
        bizContent.setValidityPeriod("9999-12-30");
        bizContent.setBankCode("行号");
        bizContent.setBankName("行名");
        bizContent.setAccountCode("0");
        ...
        try {
            response = (JftApiUserRireceiveUpdateResponseV1) client.execute(request, System.currentTimeMillis() + "");//msgId消息通讯唯一编号，要求每次调用独立生成，APP级唯一
