...
import com.icbc.api.request.MybankDepositQrcodeConfirmQueryRequestV1;
import com.icbc.api.request.MybankDepositQrcodeConfirmQueryRequestV1.MybankDepositQrcodeConfirmQueryRequestV1Biz;
import com.icbc.api.response.MybankDepositQrcodeConfirmQueryResponseV1;
 ...
 */
public class MybankDepositQrcodeConfirmQueryV1Test {
	...
	public static void main(String[] args) throws Exception {
		...
		MybankDepositQrcodeConfirmQueryRequestV1 request = new MybankDepositQrcodeConfirmQueryRequestV1();
		
		//4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("http://****/api/mybank/deposit/qrcode/scanned/confirmQuery/V1");
		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		MybankDepositQrcodeConfirmQueryRequestV1Biz bizContent = new MybankDepositQrcodeConfirmQueryRequestV1Biz();

		bizContent.setMerId("020*****460001"); //商户编号
		bizContent.setOutTradeNo("1111116*****666666555"); //外部订单号
		bizContent.setOrderId("02011210****231231");//工行订单号
		bizContent.setOutConfirmNo("X000000002"); //商户系统生成的押金确认编号,商户系统唯一，不能与商户订单号重复
		bizContent.setTradeDate("20230515"); //交易日期  格式:YYYYMMDD
		bizContent.setTradeTime("091001");  //交易时间hhmmss

		request.setBizContent(bizContent);
		MybankDepositQrcodeConfirmQueryResponseV1 response;
		try {
