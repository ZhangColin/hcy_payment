...
public class EcddQueryCheckResultV1Test {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            EcddQueryCheckResultRequestV1Biz bizContent = new EcddQueryCheckResultRequestV1Biz();
            ...
            EcddQueryCheckResultRequestV1 request = new EcddQueryCheckResultRequestV1();
            request.setServiceUrl(URL);
            request.setBizContent(bizContent);
            EcddQueryCheckResultResponseV1 response = client.execute(request);
