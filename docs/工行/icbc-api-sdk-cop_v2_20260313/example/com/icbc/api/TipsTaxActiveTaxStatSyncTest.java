...
import com.icbc.api.request.TipsTaxActiveTaxStatSyncRequestV1;
 ...
 */
public class TipsTaxActiveTaxStatSyncTest {
	...
	//4、服务url
	protected static final String URL = "http://ip:port/api/mybank_pay/tipstax/activetaxstatsync/V1";
	// 加密类型和秘钥
...
//				APIGW_PUBLIC_KEY);
		...
		TipsTaxActiveTaxStatSyncRequestV1 request= new TipsTaxActiveTaxStatSyncRequestV1();
		// 4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl(URL);
		// 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		TipsTaxActiveTaxStatSyncRequestV1.TipsTaxActiveTaxStatSyncRequestV1Biz bizContent = new TipsTaxActiveTaxStatSyncRequestV1.TipsTaxActiveTaxStatSyncRequestV1Biz();
		TipsTaxActiveTaxStatSyncRequestV1.TipsTaxActiveTaxStatSyncRequestV1Biz.Msg msg = new TipsTaxActiveTaxStatSyncRequestV1.TipsTaxActiveTaxStatSyncRequestV1Biz.Msg();
		bizContent.setTrxCode("95170A");
		bizContent.setMsg(msg);
		msg.setZoneNo("00200");
		msg.setTaxOrgCode("14301940000");
		msg.setEntrustDate("20271015");
		msg.setOuterLevyNo("0067784633");
		msg.setTaxPayCode("330620240913011X");
		request.setBizContent(bizContent);
		TipsTaxActiveTaxStatSyncResponseV1 response;
		try {
