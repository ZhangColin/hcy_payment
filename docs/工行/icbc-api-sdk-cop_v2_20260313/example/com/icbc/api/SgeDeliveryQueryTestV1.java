...
import com.icbc.api.request.SgeDeliveryQueryRequestV1;
import com.icbc.api.request.SgeDeliveryQueryRequestV1.SgeDeliveryQueryRequestBiz;
import com.icbc.api.response.SgeDeliveryQueryResponseV1;

public class SgeDeliveryQueryTestV1 {
	...
	public void test_cop() throws IcbcApiException {
		...
		SgeDeliveryQueryRequestV1 request = new SgeDeliveryQueryRequestV1();
		request.setServiceUrl("http://ip:port/api/sge/delivery/query/V1");

		SgeDeliveryQueryRequestBiz bizContent = new SgeDeliveryQueryRequestBiz();
		bizContent.setDeliveryId("201");
		bizContent.setQueryFlag(1);
		bizContent.setQueryRow(5);
    	request.setBizContent(bizContent);

		SgeDeliveryQueryResponseV1 response = client.execute(request);
