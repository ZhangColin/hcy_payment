...
import com.icbc.api.request.CardbusinessUnionpayh5UiConsumptionRequestV1;
import com.icbc.api.request.CardbusinessUnionpayh5UiConsumptionRequestV1.CardbusinessUnionpayh5UiConsumptionRequestV1Biz;

public class CardbusinessUnionpayh5UiConsumptionV1Test {
	...
	private Logger logger = Logger.getLogger(CardbusinessUnionpayh5UiConsumptionV1Test.class.getName());


	public void test_cop() throws IcbcApiException {
		UiIcbcClient client = null;
		CardbusinessUnionpayh5UiConsumptionRequestV1 request = new CardbusinessUnionpayh5UiConsumptionRequestV1();
		...
		request.setServiceUrl("https://ip:port/ui/cardbusiness/unionpayh5/ui/consumption/V1");
		CardbusinessUnionpayh5UiConsumptionRequestV1Biz bizContent = new CardbusinessUnionpayh5UiConsumptionRequestV1Biz();
		request.setBizContent(bizContent);
		//请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		bizContent.setIcbc_appid("xxx");
		bizContent.setMer_ser_prtclno("xxx");
		bizContent.setMer_id("xxx");
		bizContent.setMer_order_id("xxx");
		bizContent.setOrder_amnt("xxx");
		bizContent.setTrnsc_ccy("xxx");
