...
import com.icbc.api.request.CreditCardCommonRepayRequestV1;
import com.icbc.api.request.CreditCardCommonRepayRequestV1.CreditCardCommonRepayRequestV1Biz;
import com.icbc.api.response.CreditCardCommonRepayResponseV1;

public class CreditCardCommonRepayV1Test {
		...
		public static void main(String[] args) {
			...
			CreditCardCommonRepayRequestV1 request = new CreditCardCommonRepayRequestV1();

			//访问工行API平台URL
			request.setServiceUrl(API_SERVICE_URL + "/mybank/pay/creditcard/transfer/repay/V1");

			CreditCardCommonRepayRequestV1Biz bizContent = new CreditCardCommonRepayRequestV1Biz();
			...
			CreditCardCommonRepayResponseV1 response;
