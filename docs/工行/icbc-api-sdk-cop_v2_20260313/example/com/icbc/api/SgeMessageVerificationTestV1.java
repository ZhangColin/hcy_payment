...
import com.icbc.api.request.SgeMessageVerificationRequestV1;
import com.icbc.api.request.SgeMessageVerificationRequestV1.SgeMessageVerificationRequestBiz;
import com.icbc.api.response.SgeMessageVerificationResponseV1;

public class SgeMessageVerificationTestV1 {
	...
	public void test_cop() throws IcbcApiException {
		...
		SgeMessageVerificationRequestV1 request = new SgeMessageVerificationRequestV1();
		request.setServiceUrl("http://ip:port/api/sge/message/verification/V1");

		SgeMessageVerificationRequestBiz bizContent = new SgeMessageVerificationRequestBiz();
		bizContent.setClientId(1311022886);  
	    bizContent.setActionMark(1);      
	    bizContent.setIdType(0);         
	    bizContent.setIdNumber("445123456214545891");                     
	    bizContent.setMessageType(1);      
	    bizContent.setVerificationCode(123456); 
		request.setBizContent(bizContent);

		SgeMessageVerificationResponseV1 response = client.execute(request);
