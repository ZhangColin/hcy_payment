...
import com.icbc.api.request.MybankEnterpriseBillRemarkRequestV1;
import com.icbc.api.request.MybankEnterpriseBillRemarkRequestV1.MybankEnterpriseBillRemarkRequestV1Biz;
import com.icbc.api.response.MybankEnterpriseBillQinstrResponseV1;

public class MybankEnterpriseBillRemarkTest {
    ...
    public static void main(String[] args) throws Exception {
        String URI = "mybank/enterprise/bill/remark"; 
        DefaultIcbcClient client = new DefaultIcbcClient(APP_ID, PRI_KEY, APIGW_PUBLIC_KEY);
        try {

            MybankEnterpriseBillRemarkRequestV1Biz bizContent = new MybankEnterpriseBillRemarkRequestV1Biz();
            MybankEnterpriseBillRemarkRequestV1 request = new MybankEnterpriseBillRemarkRequestV1();
            bizContent.setAcctNo("0200000208000020651");
            bizContent.setBillNo("111031000099802018093020000011");
            request.setServiceUrl(BASE_URL + "/" + URI);
            request.setBizContent(bizContent);
            MybankEnterpriseBillQinstrResponseV1 response = (MybankEnterpriseBillQinstrResponseV1) client.execute(request);
