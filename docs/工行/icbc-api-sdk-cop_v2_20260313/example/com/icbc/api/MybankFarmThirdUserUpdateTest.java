 ...
 */
public class MybankFarmThirdUserUpdateTest {
    ...
    public static void main(String[] args) throws Exception {
		String URI = "/mybank/farm/farmplatf/updateThirdUser/V1";
		...
		try {
			...
			bizContent.setFarmUserId("thirdU110124060000002");
			bizContent.setAuthSwitch("1");
			bizContent.setUserName("测试修改姓名");
