...
import com.icbc.api.request.EcspScenicQuerySpotsRequestV1;
import com.icbc.api.request.EcspScenicQuerySpotsRequestV1.EcspScenicQuerySpotsRequestV1Biz;
 ...
 */
public class EcspScenicSpotsQryTestV1 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    EcspScenicQuerySpotsRequestV1 request = new EcspScenicQuerySpotsRequestV1();
    // 4、根据测试环境和生产环境替换相应ip和端口
    request.setServiceUrl("http://appid/api/ecsp/scenic/spot/query/V1");

    // 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
    EcspScenicQuerySpotsRequestV1Biz bizContent = new EcspScenicQuerySpotsRequestV1Biz();
    bizContent.setCorpId("0000000272").setCurrentPage(1).setPageSize(10);
    request.setBizContent(bizContent);

    EcspScenicQuerySpotsResponseV1 response;
    try {
