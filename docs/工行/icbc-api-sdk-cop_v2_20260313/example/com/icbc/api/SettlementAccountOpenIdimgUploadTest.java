...
import com.icbc.api.request.SettlementAccountOpenIdimgUploadRequestV1;
import com.icbc.api.request.SettlementAccountOpenIdimgUploadRequestV1.SettlementAccountOpenIdimgUploadRequestV1Biz;
import com.icbc.api.response.SettlementAccountOpenIdimgUploadResponseV1;


public class SettlementAccountOpenIdimgUploadTest {
	...
	public void test_cop() throws IcbcApiException {
		...
		SettlementAccountOpenIdimgUploadRequestV1 request = new SettlementAccountOpenIdimgUploadRequestV1();
		SettlementAccountOpenIdimgUploadRequestV1Biz bizContent = new SettlementAccountOpenIdimgUploadRequestV1Biz();
		request.setServiceUrl("http://ip:port/api/settlement/account/open/idimg/upload/V1");
		...
		bizContent.setFrontImg("");
		bizContent.setBackImgType("01");
		bizContent.setBackImg("");
		...
		SettlementAccountOpenIdimgUploadResponseV1  response = client.execute(request, "msgId");
