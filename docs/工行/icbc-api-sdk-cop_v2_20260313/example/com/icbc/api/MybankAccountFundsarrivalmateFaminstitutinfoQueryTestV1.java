...
import com.icbc.api.request.MybankAccountFundsarrivalmateFaminstitutinfoQueryRequestV1;
import com.icbc.api.response.MybankAccountFundsarrivalmateFaminstitutinfoQueryResponseV1;

public interface MybankAccountFundsarrivalmateFaminstitutinfoQueryTestV1 {
    ...
    public static void main(String[] args) {
        ...
        MybankAccountFundsarrivalmateFaminstitutinfoQueryRequestV1 request = new MybankAccountFundsarrivalmateFaminstitutinfoQueryRequestV1();
        request.setServiceUrl("http://ip:port/api/mybank/account/fundsarrivalmate/faminstitutinfoqry/V1");


        MybankAccountFundsarrivalmateFaminstitutinfoQueryRequestV1.FamInstitutionInfoQueryRequestV1Biz bizContent = new MybankAccountFundsarrivalmateFaminstitutinfoQueryRequestV1.FamInstitutionInfoQueryRequestV1Biz();
        bizContent.setAgreeno("1");
        bizContent.setInstcode("1");
        bizContent.setInstname("分支机构04");
        bizContent.setPage("1");
        bizContent.setPagesize("10");

        request.setBizContent(bizContent);
        MybankAccountFundsarrivalmateFaminstitutinfoQueryResponseV1 response;
        try {
