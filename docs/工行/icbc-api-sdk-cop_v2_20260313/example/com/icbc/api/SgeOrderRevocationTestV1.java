...
import com.icbc.api.request.SgeOrderRevocationRequestV1;
import com.icbc.api.request.SgeOrderRevocationRequestV1.SgeOrderRevocationRequestBiz;
import com.icbc.api.response.SgeOrderRevocationResponseV1;

public class SgeOrderRevocationTestV1 {
	...
	public void test_cop() throws IcbcApiException {
		...
		SgeOrderRevocationRequestV1 request = new SgeOrderRevocationRequestV1();
		request.setServiceUrl("http://ip:port/api/sge/order/revocation/V1");

		SgeOrderRevocationRequestBiz bizContent = new SgeOrderRevocationRequestBiz();
		bizContent.setClientId(1311022886);
		bizContent.setOrderType(1);
		bizContent.setOrderNo(02005200101);
		request.setBizContent(bizContent);

		SgeOrderRevocationResponseV1 response = client.execute(request);
