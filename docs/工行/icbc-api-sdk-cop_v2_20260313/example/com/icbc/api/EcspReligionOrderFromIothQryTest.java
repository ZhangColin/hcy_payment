...
import com.icbc.api.request.EcspReligionOrderFromIothQryRequestV1;
import com.icbc.api.response.EcspReligionOrderFromIothQryResponseV1;
 ...
 * @author kfzx-linfeng
 */
public class EcspReligionOrderFromIothQryTest {
  // 1、网关公钥
  ...
  public static void main(String[] args) throws Exception {
    ...
    EcspReligionOrderFromIothQryRequestV1 request = new EcspReligionOrderFromIothQryRequestV1();
    // 4、根据测试环境和生产环境替换相应ip和端口
    request.setServiceUrl("https://gw.icloud.icbc.com.cn/api/ecsp/religion/order/from/ioth/qry/V1");

    // 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
    EcspReligionOrderFromIothQryRequestV1.EcspReligionOrderFromIothQryRequestV1Biz bizContent = new EcspReligionOrderFromIothQryRequestV1.EcspReligionOrderFromIothQryRequestV1Biz();
    bizContent.setCorpId("0000000001").setImeiNo("2").setKey("3");
    request.setBizContent(bizContent);

    EcspReligionOrderFromIothQryResponseV1 response;
    try {
