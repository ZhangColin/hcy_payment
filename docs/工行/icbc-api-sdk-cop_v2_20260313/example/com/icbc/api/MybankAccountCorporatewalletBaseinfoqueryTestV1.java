...
public interface MybankAccountCorporatewalletBaseinfoqueryTestV1 {
    ...
    public static void main(String[] args) {
        ...
        MybankAccountCorporatewalletBaseinfoqueryRequestV1 request = new MybankAccountCorporatewalletBaseinfoqueryRequestV1();
        request.setServiceUrl("http://IP:PORT/api/mybank/account/corporatewallet/baseinfoquery/V1");
        //5銆佽瀵圭収鎺ュ彛鏂囨。鐢╞izContent.setxxx()鏂规硶瀵逛笟鍔′笂閫佹暟鎹繘琛岃祴鍊硷紝闈炲繀杈撳瓧娈靛彲涓嶄笂閫�
        MybankAccountCorporatewalletBaseinfoqueryRequestV1.orate bizContent = new MybankAccountCorporatewalletBaseinfoqueryRequestV1.CorporatewalletBaseinfoqueryRequestV1Biz();
		bizContent.setCooperatorNo("1234567890");
		bizContent.setBusserialno("002000000201234567891200001");
