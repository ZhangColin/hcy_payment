...
import com.icbc.api.request.JftUiProductAuthRequestV1;
import com.icbc.api.request.JftUiProductAuthRequestV1.JftUiProductAuthRequestV1Biz;

public class JftUiProductAuthTestV1 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			JftUiProductAuthRequestV1 request = new JftUiProductAuthRequestV1();
			
			request.setServiceUrl("http://ip:prot/ui/jft/ui/product/auth/V1");
			
			JftUiProductAuthRequestV1Biz bizContent = new JftUiProductAuthRequestV1Biz();
			bizContent.setOutUserId("12345116789000");
			bizContent.setOutVendorId("456652201223");
			bizContent.setSiteType("3");
