...
import com.icbc.api.request.JftApiVendorMemberPlatQueryRequestV1;
import com.icbc.api.request.JftApiVendorMemberPlatQueryRequestV1.JftApiVendorMemberPlatQueryRequestV1Biz;
import com.icbc.api.response.JftApiVendorMemberPlatQueryResponseV1;

/**
 * 聚富通平台会员查询接口
 */
public class JftApiVendorMemberPlatQueryTestV1 {
	...
	public static void main(String[] args) throws Exception {
		...
		JftApiVendorMemberPlatQueryRequestV1 request = new JftApiVendorMemberPlatQueryRequestV1();
		
		//4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("https://ip:port/api/jft/api/vendor/member/plat/query/V1");
//		https://ip:port/api/jft/api/vendor/plat/member/modify/V1
		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		JftApiVendorMemberPlatQueryRequestV1Biz bizContent = new JftApiVendorMemberPlatQueryRequestV1Biz();
		bizContent.setAppId("10000000000000113005");
		bizContent.setOutVendorId("10000000000000113005");
		request.setBizContent(bizContent);

		JftApiVendorMemberPlatQueryResponseV1 response;
		try {
			response = (JftApiVendorMemberPlatQueryResponseV1) client.execute(request, System.currentTimeMillis()+"");
