...
import com.icbc.api.request.MybankLoanPersonalloaninPcrsgrantqryRequestV1;
import com.icbc.api.request.MybankLoanPersonalloaninPcrsgrantqryRequestV1.MybankLoanPersonalloaninPcrsgrantqryBizContent;
import com.icbc.api.response.MybankLoanPersonalloaninPcrsgrantqryResponseV1;
import com.icbc.api.DefaultIcbcClient;
import com.icbc.api.IcbcApiException;

public class MybankLoanPersonalloaninPcrsgrantqryTestV1 {
	...
	public static void main(String[] args) throws IcbcApiException{
		...
		MybankLoanPersonalloaninPcrsgrantqryRequestV1 request = new MybankLoanPersonalloaninPcrsgrantqryRequestV1();
		request.setServiceUrl("http://ip:port/api/mybank/loan/personalloanin/pcrsgrantqry/V1");
		MybankLoanPersonalloaninPcrsgrantqryBizContent bizContent = new MybankLoanPersonalloaninPcrsgrantqryBizContent();
        ...
        System.out.println("-------个贷客户征信授权入参--------"+bizContent);
		
		
		request.setBizContent(bizContent);
		System.out.println("-------bizContent--------"+bizContent);
		MybankLoanPersonalloaninPcrsgrantqryResponseV1 response=new MybankLoanPersonalloaninPcrsgrantqryResponseV1();
		try{
