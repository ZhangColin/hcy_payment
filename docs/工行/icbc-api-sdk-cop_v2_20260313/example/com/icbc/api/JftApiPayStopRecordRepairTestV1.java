...
import com.icbc.api.request.JftApiPayStopRecordRepairRequestV1;
import com.icbc.api.request.JftApiPayStopRecordRepairRequestV1.JftApiPayStopRecordRepairRequestV1Biz;
import com.icbc.api.response.JftApiPayStopRecordRepairResponseV1;

public class JftApiPayStopRecordRepairTestV1 {
	...
	public static void main(String[] args) {
		...
		JftApiPayStopRecordRepairRequestV1 request = new JftApiPayStopRecordRepairRequestV1();
		request.setServiceUrl("http://ip:port/api/jft/api/pay/stop/record/repair/V1");
		JftApiPayStopRecordRepairRequestV1Biz bizContent = new JftApiPayStopRecordRepairRequestV1Biz();
		...
		bizContent.setOperateType("01");//操作类型: 01-核销
		request.setBizContent(bizContent);

		JftApiPayStopRecordRepairResponseV1 response;
		try {
