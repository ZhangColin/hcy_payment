...
import com.icbc.api.request.CacaReceiptCommonreceiptQuerybreceiptRequestV1;
import com.icbc.api.response.CacaReceiptCommonreceiptQuerybreceiptResponseV1;

public class CacaReceiptCommonreceiptQuerybreceiptTestV1 {
    ...
    public static void main(String[] args) {
        ...
        CacaReceiptCommonreceiptQuerybreceiptRequestV1 request = new CacaReceiptCommonreceiptQuerybreceiptRequestV1();
        request.setServiceUrl("https://ip:port/api/caca/receipt/commonreceipt/querybreceipt/V1");
        CacaReceiptCommonreceiptQuerybreceiptRequestV1.QueryBReceiptBySSTSRequestV1Biz bizContent = new CacaReceiptCommonreceiptQuerybreceiptRequestV1.QueryBReceiptBySSTSRequestV1Biz();
        JSONObject input = new JSONObject();
        // public 通讯区定义赋值
        CacaReceiptCommonreceiptQuerybreceiptRequestV1.QueryBReceiptBySSTSRequestV1Pub pubObj = new CacaReceiptCommonreceiptQuerybreceiptRequestV1.QueryBReceiptBySSTSRequestV1Pub();
        pubObj.setCode("29056");
        pubObj.setZone("0200");
        pubObj.setFr("0");
        pubObj.setDt("2017-07-06");
        // private 通讯区定义赋值
        CacaReceiptCommonreceiptQuerybreceiptRequestV1.QueryBReceiptBySSTSRequestV1In inObj = new CacaReceiptCommonreceiptQuerybreceiptRequestV1.QueryBReceiptBySSTSRequestV1In();
        ...
        try {
            CacaReceiptCommonreceiptQuerybreceiptResponseV1 response = client.execute(request);
