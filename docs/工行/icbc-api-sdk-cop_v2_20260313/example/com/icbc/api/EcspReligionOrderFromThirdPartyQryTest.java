...
import com.icbc.api.request.EcspReligionOrderFromThirdPartyQryRequestV1;
import com.icbc.api.response.EcspReligionOrderFromThirdPartyQryResponseV1;

/**
 * @author kfzx-liyc
 * @date 2022年04月2022/4/24日 13:34
 */
public class EcspReligionOrderFromThirdPartyQryTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        EcspReligionOrderFromThirdPartyQryRequestV1 request = new EcspReligionOrderFromThirdPartyQryRequestV1();

        // 4、根据测试环境和生产环境替换相应ip和端口
        request.setServiceUrl("http://gw.icloud.icbc.com.cn/api/saes/servmer/ordersubmit/V1");
        // 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
        EcspReligionOrderFromThirdPartyQryRequestV1.EcspReligionOrderFromThirdPartyQryRequestV1Biz bizContent = new EcspReligionOrderFromThirdPartyQryRequestV1.EcspReligionOrderFromThirdPartyQryRequestV1Biz();
        bizContent.setCorpId("0000000001");

        request.setBizContent(bizContent);

        EcspReligionOrderFromThirdPartyQryResponseV1 response;
        try {
