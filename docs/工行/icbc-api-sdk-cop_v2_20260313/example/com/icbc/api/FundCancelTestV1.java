...
import com.icbc.api.request.FundCancelRequestV1;
import com.icbc.api.request.FundCancelRequestV1.FundCancelRequestV1Biz;
import com.icbc.api.response.FundCancelResponseV1;

public class FundCancelTestV1 {
	...
	public void test_cop() throws IcbcApiException {
		...
		FundCancelRequestV1 request = new FundCancelRequestV1();
		request.setServiceUrl("http://ip:port/api/fund/cancel/V1");

		FundCancelRequestV1Biz bizContent = new FundCancelRequestV1Biz();
		bizContent.setApplyNum("123456789");
		bizContent.setFundAccount("123456789");
		bizContent.setFundAmount("10000");
		bizContent.setFundId("000848");
		bizContent.setTradeKind("24");
	
		request.setBizContent(bizContent);

		FundCancelResponseV1 response = client.execute(request);
