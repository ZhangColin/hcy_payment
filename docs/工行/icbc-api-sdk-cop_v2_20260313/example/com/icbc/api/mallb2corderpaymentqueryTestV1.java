...
//		request.setServiceUrl("http://ip:port/api/MalluserInfo/ForOuter/Service/payment/query/V1");
		request.setServiceUrl("http://ip:port/api/mall/b2C/order/payment/query/V1");

		mallb2CorderpaymentqueryRequestV1Biz bizContent = new mallb2CorderpaymentqueryRequestV1Biz();
		bizContent.setAppId("xxx");
		bizContent.setThirdOrderId("xxx");
