...
import com.icbc.api.response.MybankLoanCloudquickloanOrderapplicationstatusResponseV1;
 ...
 * @Date: 2019/11/11
 */
public class MybankLoanCloudquickloanOrderapplicationstatusTestV1 {
    /*public static void main(String[] args) {
        ...
        //5、设置请求对象
        MybankLoanCloudquickloanOrderapplicationstatusRequestV1 request = new MybankLoanCloudquickloanOrderapplicationstatusRequestV1();
        //6、设置请求路径；联测时，请联系我行告知并替换成测试环境地址。
        request.setServiceUrl("http://ip:port/api/mybank/loan/cloudquickloan/orderapplicationstatus/V1");
        //7、设置业务参数
        MybankLoanCloudquickloanOrderapplicationstatusRequestV1.MybankLoanOrderapplicationstatusRequestV1Biz bizContent = new MybankLoanCloudquickloanOrderapplicationstatusRequestV1.MybankLoanOrderapplicationstatusRequestV1Biz();

        //8、组装请求参数
        MybankLoanCloudquickloanOrderapplicationstatusRequestV1.SubInput subInput = new MybankLoanCloudquickloanOrderapplicationstatusRequestV1.SubInput();

        subInput.setCIS("054edcaace80d2a60f17c0038276e620");
        subInput.setOrderNo("123456");
        subInput.setRemark1("");
        subInput.setRemark2("");
        subInput.setRemark3("");

        List<MybankLoanCloudquickloanOrderapplicationstatusRequestV1.SubInput> subInputs = new ArrayList<>();
        ...
        MybankLoanCloudquickloanOrderapplicationstatusResponseV1 response;
        try {
