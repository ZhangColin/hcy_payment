...
import com.icbc.api.request.InvestmentDepositDpriskrateRequestV1;
import com.icbc.api.response.InvestmentDepositDpriskrateResponseV1;
 ...
 * 积存金风险测评
 */
public class InvestmentDepositDpriskrateTestV1 {
    ...
    public void test_cop() throws IcbcApiException {
        ...
        InvestmentDepositDpriskrateRequestV1 request = new InvestmentDepositDpriskrateRequestV1();
        request.setServiceUrl(Const.URL_PREFIX + "/investment/deposit/dpriskrate/V1");
        InvestmentDepositDpriskrateRequestV1.InvestmentDepositDpriskrateRequestV1Biz bizContent =
                new InvestmentDepositDpriskrateRequestV1.InvestmentDepositDpriskrateRequestV1Biz();
        ...
        bizContent.setChanType("405");
        bizContent.setServFace("22");
        // PMD检查
        bizContent.setCardNo("622202" +
                "0200008791614");
        bizContent.setAccNo("");
        bizContent.setAnswer("AAAAB");

        request.setBizContent(bizContent);
        InvestmentDepositDpriskrateResponseV1 response;
        try {
