...
import com.icbc.api.request.CertVoiceprintVoiceprintcheckRequestV1;
import com.icbc.api.request.CertVoiceprintVoiceprintcheckRequestV1.CertVoiceprintVoiceprintcheckRequestV1Biz;
import com.icbc.api.response.CertVoiceprintVoiceprintcheckResponseV1;

public class CertVoiceprintVoiceprintcheckTest {
	//	调用方自己的AppId
	private static final String APP_ID = new String("100000s0000000409a529");
	//	调用方私钥
...
//		签名类型为SHA256WithRSA时，传入appid，私钥和网关公钥，签名类型使用定值IcbcConstants.SIGN_TYPE_RSA2，其他参数使用缺省
		...
		CertVoiceprintVoiceprintcheckRequestV1 request = new CertVoiceprintVoiceprintcheckRequestV1();
		
//		测试环境替换ip和端口，生成环境已有默认值，此语句可删除
		request.setServiceUrl(API_SERVICE_URL + "/cert/voiceprint/voiceprintcheck/V1");
		Logger log = Logger.getLogger(CertVoiceprintVoiceprintaddTest.class.getName());
//		请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		CertVoiceprintVoiceprintcheckRequestV1Biz bizContent =  new CertVoiceprintVoiceprintcheckRequestV1Biz();
		bizContent.setChannel("EPASS1");
		bizContent.setAppName("F-EPASS");
		bizContent.setAppVersion("1.0");
		bizContent.setAppInfo("F-EPASS");
		bizContent.setTrCode("BAS0fdhj23");
		bizContent.setTrxZone("1001");
		bizContent.setProgramName("checkvoice");
		bizContent.setThreshold("0.001");
		bizContent.setUserId("000982138sdhfjg090");
		...
		CertVoiceprintVoiceprintcheckResponseV1 response;
		try {
