...
import com.icbc.api.request.JftUiPayPcAuthRequestV1;
import com.icbc.api.request.JftUiPayPcAuthRequestV1.JftUiPayPcAuthRequestV1Biz;

public class JftUiPayPcAuthTestV1 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			JftUiPayPcAuthRequestV1 request = new JftUiPayPcAuthRequestV1();
			
			request.setServiceUrl("http://ip:prot/ui/jft/ui/pay/pc/auth/V1");
			
			JftUiPayPcAuthRequestV1Biz bizContent = new JftUiPayPcAuthRequestV1Biz();
			bizContent.setOutUserId("12345116789000");
			bizContent.setOutVendorId("456652201223");
			bizContent.setSiteType("5");
			bizContent.setUserType("2");
