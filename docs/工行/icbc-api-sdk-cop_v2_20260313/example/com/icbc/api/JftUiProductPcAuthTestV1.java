...
import com.icbc.api.request.JftUiProductPcAuthRequestV1;
import com.icbc.api.request.JftUiProductPcAuthRequestV1.JftUiProductPcAuthRequestV1Biz;

public class JftUiProductPcAuthTestV1 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			JftUiProductPcAuthRequestV1 request = new JftUiProductPcAuthRequestV1();
			
			request.setServiceUrl("http://ip:prot/ui/jft/ui/product/pc/auth/V1");
			
			JftUiProductPcAuthRequestV1Biz bizContent = new JftUiProductPcAuthRequestV1Biz();
			bizContent.setOutUserId("12345116789000");
			bizContent.setOutVendorId("456652201223");
			bizContent.setSiteType("6");
