...
import com.icbc.api.request.EcspScenicQueryTerminalRequestV1;
import com.icbc.api.request.EcspScenicQueryTerminalRequestV1.EcspScenicQueryTerminalRequestV1Biz;
...
import com.icbc.api.response.EcspScenicQueryTerminalResponseV1;
 ...
 */
public class EcspScenicTerminalQryTestV1 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    EcspScenicQueryTerminalRequestV1 request = new EcspScenicQueryTerminalRequestV1();
    // 4、根据测试环境和生产环境替换相应ip和端口
    request.setServiceUrl("http://appid/api/ecsp/scenic/terminal/query/V1");

    // 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
    EcspScenicQueryTerminalRequestV1Biz bizContent = new EcspScenicQueryTerminalRequestV1Biz();
    bizContent.setCorpId("0000000272").setCurrentPage(1).setPageSize(10).setDeviceType((byte) 0);
    request.setBizContent(bizContent);

    EcspScenicQueryTerminalResponseV1 response;
    try {
