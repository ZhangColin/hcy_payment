...
import com.icbc.api.request.SaesServmerOrderthawRequestV1;
import com.icbc.api.request.SaesServmerOrderthawRequestV1.SaesServmerOrderthawRequestV1Biz;
import com.icbc.api.response.SaesServmerOrderthawResponseV1;

public class SaesServmerOrderthawTestV1 {
	//1、网关公钥
	...
	SaesServmerOrderthawRequestV1 request = new SaesServmerOrderthawRequestV1();
	
	//4、根据测试环境和生产环境替换相应ip和端口
	request.setServiceUrl("http://ip:port/api/saes/servmer/orderthaw/V1");
	//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
	SaesServmerOrderthawRequestV1Biz bizContent = new SaesServmerOrderthawRequestV1Biz();
	...
	SaesServmerOrderthawResponseV1 response;
	try {
