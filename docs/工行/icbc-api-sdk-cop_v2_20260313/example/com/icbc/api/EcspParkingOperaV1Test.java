...
import com.icbc.api.request.EcspParkingOperaRequestV1;
import com.icbc.api.response.EcspParkingOperaResponseV1;

/**
 * @author kfzx-dengzp2
 */
public class EcspParkingOperaV1Test {
    // 1、网关公钥
    protected static final String APIGW_PUBLIC_KEY = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNA DCBiQKBgQCwFgHD4kzEVPdOj03ctKM7KV+16bWZ5BMNgvEeuEQwfQYkRVwI9HFOGkwNTMn5hiJXHnlXYCX+zp5r6R52MY0O7BsTCLT7aHaxsANsvI9ABGx3OaTVlPB59M6GPbJh0uXvio0m1r/lTW3Z60RU6Q3oid/rNhP3CiNgg0W6O3AGqwIDAQAB";
    ...
    public static void main(String[] args) throws Exception {
        ...
        EcspParkingOperaRequestV1 request = new EcspParkingOperaRequestV1();

        // 4、根据测试环境和生产环境替换相应ip和端口
        request.setServiceUrl("http://ip:port/api/ecsp/oc/prop/car/parkingOpera/V1");
        // 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
        EcspParkingOperaRequestV1.EcspParkingOperaRequestV1Biz bizContent = new EcspParkingOperaRequestV1.EcspParkingOperaRequestV1Biz();
        bizContent.setCorpId("0000000001");
        bizContent.setParkingId("05");
        bizContent.setParkingName("测试停车场");
        bizContent.setType("1");
        request.setBizContent(bizContent);

        EcspParkingOperaResponseV1 response;
        try {
            response = client.execute(request, "23344544454121");// msgId消息通讯唯一编号，要求每次调用独立生成，APP级唯一
