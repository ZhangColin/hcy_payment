...
public interface MybankAccountDigitalwalletAccountUnbindTestV1 {
    ...
    public static void main(String[] args) {
        ...
        com.icbc.api.request.MybankAccountDigitalwalletAccountunbindRequestV1 request = new com.icbc.api.request.MybankAccountDigitalwalletAccountunbindRequestV1();
        request.setServiceUrl("http://IP:PORT/api/mybank/account/digitalwallet/accountunbind/V1");
        //5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值，非必输字段可不上送
        com.icbc.api.request.MybankAccountDigitalwalletAccountunbindRequestV1.DigitalwalletAccountUnbindRequestV1Biz bizContent = new com.icbc.api.request.MybankAccountDigitalwalletAccountunbindRequestV1.DigitalwalletAccountUnbindRequestV1Biz();
        ...
        bizContent.setProtocolId("11231");
        ...
        com.icbc.api.response.MybankAccountDigitalwalletAccountunbindResponseV1 response;
        try {
