...
public class CorptelBranchModifyDuedateTest {
	...
	public static void main(String[] args) {
		try {
			...
			channelMap.put("oapp", "EBBC");
			channelMap.put("chan_serialno", "02212120202024472");
			Map<String, Object> infoCommMap = new HashMap<>();
			infoCommMap.put("trx_code", "50134");
			...
			infoCommMap.put("servface", "10");
			infoCommMap.put("term_id", "10");
			Map<String, Object> icomMsgMap = new HashMap<>();
			icomMsgMap.put("srv_code", "400");
			icomMsgMap.put("reg_card_no", "0200020419200001571");
			icomMsgMap.put("function_type", "2");
			icomMsgMap.put("useend_date", "2023-02-27");
			icomMsgMap.put("free_date", "12");
