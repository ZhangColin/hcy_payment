...
import com.icbc.api.request.JftApiPayB2bPayQueryRefundRequestV1;
import com.icbc.api.response.JftApiPayB2bPayQueryRefundResponseV1;

public class JftApiPayB2bPayQueryRefundTestV1 {
    ...
    public static void main(String[] args) {
        ...
        JftApiPayB2bPayQueryRefundRequestV1 request=new JftApiPayB2bPayQueryRefundRequestV1();
        request.setServiceUrl("http://ip:port/api/jft/api/pay/b2bpay/query/refund/V1");
        JftApiPayB2bPayQueryRefundRequestV1.JftApiPayB2bPayQueryRefundRequestV1Biz bizContent=new JftApiPayB2bPayQueryRefundRequestV1.JftApiPayB2bPayQueryRefundRequestV1Biz();
        ...
        JftApiPayB2bPayQueryRefundResponseV1 response;
        try {
            response =(JftApiPayB2bPayQueryRefundResponseV1) client.execute(request, System.currentTimeMillis()+"");//msgId消息通讯唯一编号，要求每次调用独立生成，APP级唯一
