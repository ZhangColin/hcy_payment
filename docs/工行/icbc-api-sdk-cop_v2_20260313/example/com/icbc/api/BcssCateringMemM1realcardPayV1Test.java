...
import com.icbc.api.request.BcssCateringMemM1realcardPayRequestV1;
import com.icbc.api.request.BcssCateringMemM1realcardPayRequestV1.BcssCateringMemM1realcardPayRequestBizV1;
...
public class BcssCateringMemM1realcardPayV1Test {
    // 网关公钥
    ...
    public static void main(String[] args) throws IcbcApiException {
        BcssCateringMemM1realcardPayRequestV1 request = new BcssCateringMemM1realcardPayRequestV1();
        // 根据测试环境和生产环境替换相应ip和端口
        request.setServiceUrl("http://***.***.***.***:****/api/bcss/consume/memm1realcard/pay/V1");
        BcssCateringMemM1realcardPayRequestBizV1 bizContent = new BcssCateringMemM1realcardPayRequestBizV1();
        ...
        List<BcssCateringMemM1realcardPayRequestBizV1.BcssCateringMemM1realcardPayGoodsInfoDto> goods = new ArrayList<>();
        BcssCateringMemM1realcardPayRequestBizV1.BcssCateringMemM1realcardPayGoodsInfoDto good1 = new BcssCateringMemM1realcardPayRequestBizV1.BcssCateringMemM1realcardPayGoodsInfoDto();
        ...
        goods.add(good1);
        BcssCateringMemM1realcardPayRequestBizV1.BcssCateringMemM1realcardPayGoodsInfoDto good2 = new BcssCateringMemM1realcardPayRequestBizV1.BcssCateringMemM1realcardPayGoodsInfoDto();
