...
public interface MybankAccountCorporatewalletUnholdTestV1 {
    ...
    public static void main(String[] args) {
        ...
        MybankAccountCorporatewalletUnholdRequestV1 request = new MybankAccountCorporatewalletUnholdRequestV1();
        request.setServiceUrl("http://IP:PORT/api/mybank/account/corporatewallet/unhold/V1");
        //5銆佽瀵圭収鎺ュ彛鏂囨。鐢╞izContent.setxxx()鏂规硶瀵逛笟鍔′笂閫佹暟鎹繘琛岃祴鍊硷紝闈炲繀杈撳瓧娈靛彲涓嶄笂閫�
        MybankAccountCorporatewalletUnholdRequestV1.orate bizContent = new MybankAccountCorporatewalletUnholdRequestV1.CorporatewalletUnholdRequestV1Biz();
        ...
        bizContent.setWalletid("0020000008888888******");
        bizContent.setCooperator_type("0020000008888888******");
        bizContent.setSerial_no("0020000********200123");
        bizContent.setOapp("F-E**C");
        bizContent.setAgrno("");
        ...
        MybankAccountCorporatewalletUnholdResponseV1 response;
        try {
