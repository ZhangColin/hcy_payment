 ...
 * @date 2022/7/5
 */
public class MsgServiceQuerymsglistV1Test {

    private static final Logger LOG = Logger.getLogger(MsgServiceQuerymsglistV1Test.class.getName());
    ...
    public static void main(String[] args) throws Exception {
        ...
        paramMap.put("msg_type", "108");
        paramMap.put("read_flag", "0");
        paramMap.put("msg_source", "001");
        paramMap.put("receive_date", "");
        ...
        invoker.setUri("/msg/service/querymsglist/V1");
