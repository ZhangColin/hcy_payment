...
import com.icbc.api.request.MybankAccountFundsarrivalmateFamnotifyrecinfoQueryRequestV1;
import com.icbc.api.response.MybankAccountFundsarrivalmateFamnotifyrecinfoQueryResponseV1;

public interface MybankAccountFundsarrivalmateFamnotifyrecinfoQueryTestV1 {
    ...
    public static void main(String[] args) {
        ...
        MybankAccountFundsarrivalmateFamnotifyrecinfoQueryRequestV1 request = new MybankAccountFundsarrivalmateFamnotifyrecinfoQueryRequestV1();
        request.setServiceUrl("http://ip:port/api/mybank/account/fundsarrivalmate/famnotifyrecinfoqry/V1");

        MybankAccountFundsarrivalmateFamnotifyrecinfoQueryRequestV1.FamNotifyRecInfoQueryRequestV1Biz bizContent = new MybankAccountFundsarrivalmateFamnotifyrecinfoQueryRequestV1.FamNotifyRecInfoQueryRequestV1Biz();
        bizContent.setAgreeno("1");
        bizContent.setNotifyid("guq_clerk_001");
        bizContent.setRoleid("2");
        bizContent.setMobile("2");

        bizContent.setPage("1");
        bizContent.setPagesize("10");

        request.setBizContent(bizContent);
        MybankAccountFundsarrivalmateFamnotifyrecinfoQueryResponseV1 response;
        try {
