...
import com.icbc.api.request.JftApiPayGenPayOrderQrcodeRequestV1;
import com.icbc.api.request.JftApiPayGenPayOrderQrcodeRequestV1.JftApiPayGenPayOrderQrcodeRequestV1Biz;
import com.icbc.api.response.JftApiPayGenPayOrderQrcodeResponseV1;

public class JftApiPayGenPayOrderQrcodeTestV1 {
	...
	public static void main(String[] args) {
		...
		JftApiPayGenPayOrderQrcodeRequestV1 request = new JftApiPayGenPayOrderQrcodeRequestV1();
		request.setServiceUrl("http://ip:port/api/jft/api/pay/gen/pay/order/qrcode/V1");
		JftApiPayGenPayOrderQrcodeRequestV1Biz bizContent = new JftApiPayGenPayOrderQrcodeRequestV1Biz();
		...
		JftApiPayGenPayOrderQrcodeResponseV1 response;
		try {
