...
import com.icbc.api.request.McssSoluGspsnReleaseRequestV1;
import com.icbc.api.response.McssSoluGspsnReleaseResponseV1;

public class McssSoluGspsnReleaseTestV1 {
    ...
    public static void main(String[] args) throws Exception{
        McssSoluGspsnReleaseTestV1 a=new McssSoluGspsnReleaseTestV1();
        a.test_cop();
    }
    public void test_cop() throws IcbcApiException {
        McssSoluGspsnReleaseRequestV1 request = new McssSoluGspsnReleaseRequestV1();
        request.setServiceUrl("http://ip:port/api/mcss/solu/gspsn/release/V1");
        ...
        McssSoluGspsnReleaseResponseV1 response = client.execute(request);
