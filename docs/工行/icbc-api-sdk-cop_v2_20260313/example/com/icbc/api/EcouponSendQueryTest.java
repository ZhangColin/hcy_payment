...
import com.icbc.api.request.EcouponSendQueryRequestV1;
import com.icbc.api.request.EcouponSendQueryRequestV1.EcouponSendQueryRequestV1Biz;
import com.icbc.api.response.EcouponSendQueryResponseV1;

public class EcouponSendQueryTest {
	// 1、网关公钥
	...
	public static void main(String[] args) throws Exception {
		...
		EcouponSendQueryRequestV1 request = new EcouponSendQueryRequestV1();
		// 4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("https://ip:port/api/ecoupon/send/query/V1");

		// 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		EcouponSendQueryRequestV1Biz bizContent = new EcouponSendQueryRequestV1Biz();
		bizContent.setMertId("362378801234567");
		bizContent.setEcActId("D20190720160851595");
		bizContent.setUserId("gGNNZ2OWz+SJXuFTSv4hieVWhfZSlr4m");
		bizContent.setUserMobileNo("13400000020");
		bizContent.setSerNo("13579");
		request.setBizContent(bizContent);

		EcouponSendQueryResponseV1 response;
		try {
