...
import com.icbc.api.request.SettlementAccountSCodeVerifyRequestV1.SettlementAccountSCodeVerifyRequestV1Biz;
import com.icbc.api.response.SettlementAccountSCodeVerifyResponseV1;

public class SettlementAccountSCodeVerifyTest {
	...
	public void test_cop() throws IcbcApiException {
		...
		SettlementAccountSCodeVerifyRequestV1Biz bizContent = new SettlementAccountSCodeVerifyRequestV1Biz();
		request.setServiceUrl("http://ip:port/api/settlement/account/scode/V1/verify");
		bizContent.setCorpDate("2017-03-15");
		bizContent.setCorpNo("corpInst1234");
		bizContent.setCorpSerno(UUID.randomUUID().toString());
		bizContent.setCorpSernoOriginal("abcddddddd12345");
		bizContent.setOutServiceCode("1");
		bizContent.setTrxAccDate("2017-03-15");
		bizContent.setTrxAccTime("13:30:01");
		bizContent.setSmsSCode("987654");
		bizContent.setSmsSendNo("123456");
