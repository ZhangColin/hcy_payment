...
import com.icbc.api.request.JftUiVacctStatementH5ViewRequestV1;


public class JftUiVacctStatementH5ViewTestServletV1 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)throws ServletException, IOException {
		...
		try {
			...
			JftUiVacctStatementH5ViewRequestV1 request = new JftUiVacctStatementH5ViewRequestV1();

			request.setServiceUrl("https://apipcs4.dccnet.com.cn/ui/jft/ui/vacct/statement/h5/view/V1");
			JftUiVacctStatementH5ViewRequestV1.JftUiVacctStatementH5ViewRequestV1Biz bizContent = new JftUiVacctStatementH5ViewRequestV1.JftUiVacctStatementH5ViewRequestV1Biz();
