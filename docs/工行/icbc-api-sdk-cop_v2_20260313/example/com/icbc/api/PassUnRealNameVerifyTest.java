...
public class PassUnRealNameVerifyTest {
	...
	public static void main(String[] args) throws Exception {
		...
		//行外流程ip:port
		request.setServiceUrl("http://ip:port/api/cert/epass/verifyinfo/epassunrealnameverify/V1");
		...
		inputV10.setServer_ip("ip:port");
		inputV10.setDt("2022-03-21");
		inputV10.setTm("092957");
		inputV10.setChannelIdentifier("ip:port.20230120092957.450");
