...
import com.icbc.api.request.MybankPayTppcustomerWithholdagrtSignRequestV1;
import com.icbc.api.request.MybankPayTppcustomerWithholdagrtSignRequestV1.MybankPayTppcustomerWithholdagrtSignRequestV1Biz;
import com.icbc.api.response.MybankPayTppcustomerWithholdagrtSignResponseV1;

public class MybankPayTppcustomerWithholdagrtSignTestV1 {
	...
	private static final String APP_ID = new String("test2002 "); //20年1月
	// 调用方私钥
	...
	public static void main(String[] args) {
		...
		MybankPayTppcustomerWithholdagrtSignRequestV1 request = new MybankPayTppcustomerWithholdagrtSignRequestV1();
		
		//访问工行API平台URL
		request.setServiceUrl(API_SERVICE_URL + "/mybank/pay/tppcustomer/withholdagrt/V1");

		MybankPayTppcustomerWithholdagrtSignRequestV1Biz bizContent = new MybankPayTppcustomerWithholdagrtSignRequestV1Biz();

		//APPID
		bizContent.setMerID("011*********61");
		bizContent.setAppID("011***************09");
		bizContent.setAppCustID("011********88");
		bizContent.setAreaCode("0**9");
		bizContent.setWithholdAgrNo("011******37");
		request.setBizContent(bizContent);

		MybankPayTppcustomerWithholdagrtSignResponseV1 response;
