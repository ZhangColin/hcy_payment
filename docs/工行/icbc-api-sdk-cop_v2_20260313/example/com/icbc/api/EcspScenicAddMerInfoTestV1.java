...
import com.icbc.api.request.EcspScenicAddMerInfoRequestV1;
import com.icbc.api.request.EcspScenicAddMerInfoRequestV1.EcspScenicAddMerInfoRequestV1Biz;
 ...
 */
public class EcspScenicAddMerInfoTestV1 {
  // 1、网关公钥
  ...
  public static void main(String[] args) throws Exception {
    ...
    EcspScenicAddMerInfoRequestV1 request = new EcspScenicAddMerInfoRequestV1();
    // 4、根据测试环境和生产环境替换相应ip和端口
    request.setServiceUrl("https://ip:port/api/ecsp/religion/alarm/addMerInfo/V1");

    // 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
    EcspScenicAddMerInfoRequestV1Biz bizContent = new EcspScenicAddMerInfoRequestV1Biz();
    bizContent.setCustId("1111").setMerId("1111");
    request.setBizContent(bizContent);

    EcspScenicAddMerInfoResponseV1 response;
    try {
