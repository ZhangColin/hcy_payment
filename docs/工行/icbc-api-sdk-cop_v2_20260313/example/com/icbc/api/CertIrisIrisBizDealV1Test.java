...
import com.icbc.api.request.CertIrisIrisBizDealRequestV1;
import com.icbc.api.request.CertIrisIrisBizDealRequestV1.CertIrisIrisBizDealRequestV1Biz;
import com.icbc.api.response.CertIrisIrisBizDealResponseV1;
public class CertIrisIrisBizDealV1Test {
	//	调用方自己的AppId
...
//		签名类型为SHA256WithRSA时，传入appid，私钥和网关公钥，签名类型使用定值IcbcConstants.SIGN_TYPE_RSA2，其他参数使用缺省�1�7�1�7
		...
		CertIrisIrisBizDealRequestV1 request = new CertIrisIrisBizDealRequestV1();
...
//		请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋倄1�7
		CertIrisIrisBizDealRequestV1Biz bizContent = new CertIrisIrisBizDealRequestV1Biz ();
		...
		bizContent.setBranchName("用于外部人员的内部办公�1�7�勤");
		...
		CertIrisIrisBizDealResponseV1 response= new CertIrisIrisBizDealResponseV1();
		Logger log = Logger.getLogger(CertIrisIrisBizDealV1Test.class.getName());
		try{
