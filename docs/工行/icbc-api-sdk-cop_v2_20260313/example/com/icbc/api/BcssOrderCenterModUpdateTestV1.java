 ...
 *
 */
class BcssOrderCenterUpdateTestV1 {
    // MY_PRIVATE_KEY
    ...
    public static void main(String[] args) throws Exception {
        BcssOrderCenterUpdateTestV1 a = new BcssOrderCenterUpdateTestV1();
        a.test_cop();
    }

    public void test_cop() throws IcbcApiException {
        BcssOrderCenterModUpdateRequestTestV1 request = new BcssOrderCenterModUpdateRequestTestV1();
        request.setServiceUrl("http://ip:port/api/bcss/orderCenter/mod/update/updateOrder/V1");
        BcssOrderCenterUpdateRequestBizV1 bizContent = new BcssOrderCenterUpdateRequestBizV1();
        ...
        BcssOrderCenterModUpdateResponseV1 response = client.execute(request);
        java.util.logging.Logger log = Logger
                .getLogger(BcssOrderCenterUpdateTestV1.class
                        .getName());
