...
import com.icbc.api.request.TipsTaxSpecialProtclVerifyRequestV1;
 ...
 */
public class TipsTaxSpecialProtclVerifyTest {
	...
	//4、服务url
	protected static final String URL = "http://ip:port/api/mybank_pay/tipstax/specialprotclverify/V1";
	// 加密类型和秘钥
...
//				APIGW_PUBLIC_KEY);
		...
		TipsTaxSpecialProtclVerifyRequestV1 request= new TipsTaxSpecialProtclVerifyRequestV1();
		// 4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl(URL);
		// 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		TipsTaxSpecialProtclVerifyRequestV1.TipsTaxSpecialProtclVerifyRequestV1Biz bizContent = new TipsTaxSpecialProtclVerifyRequestV1.TipsTaxSpecialProtclVerifyRequestV1Biz();
		TipsTaxSpecialProtclVerifyRequestV1.TipsTaxSpecialProtclVerifyRequestV1Biz.Msg msg = new TipsTaxSpecialProtclVerifyRequestV1.TipsTaxSpecialProtclVerifyRequestV1Biz.Msg();
		bizContent.setTrxCode("95413A");
		bizContent.setMsg(msg);
		msg.setMqFlag("0");
		msg.setMapStipsFlag("2");
		msg.setTrxOrigin("10");
		msg.setAppCode("7020");
		msg.setSzone("00200");
		msg.setSoperationType("0");
		msg.setSprotocol("88820281205");
		msg.setSendOrgCode("24600022100");
		msg.setEntrustDate("20210101");
		request.setBizContent(bizContent);
		TipsTaxSpecialProtclVerifyResponseV1 response;
		try {
