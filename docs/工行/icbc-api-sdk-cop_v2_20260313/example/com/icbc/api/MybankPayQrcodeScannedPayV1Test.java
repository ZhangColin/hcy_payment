...
import com.icbc.api.request.QrcodeScannedPayRequestV1;
import com.icbc.api.request.QrcodeScannedPayRequestV1.QrcodeScannedPayRequestV1Biz;
import com.icbc.api.response.QrcodeScannedPayResponseV1;
 ...
 */
public class MybankPayQrcodeScannedPayV1Test {
	...
	public static void main(String[] args) throws Exception {
		...
		QrcodeScannedPayRequestV1 request = new QrcodeScannedPayRequestV1();
		
		//4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("http://****/api/mybank/pay/qrcode/scanned/pay/V1");
		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		QrcodeScannedPayRequestV1Biz bizContent = new QrcodeScannedPayRequestV1Biz();
		...
		QrcodeScannedPayResponseV1 response;
		try {
