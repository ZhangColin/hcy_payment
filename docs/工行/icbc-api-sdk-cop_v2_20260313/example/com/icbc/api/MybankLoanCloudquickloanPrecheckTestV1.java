...
import com.icbc.api.request.MybankLoanCloudquickloanPrecheckRequestV1;
import com.icbc.api.response.MybankLoanCloudquickloanPrecheckResponseV1;
 ...
 * @Date: 2019/11/11
 */
public class MybankLoanCloudquickloanPrecheckTestV1 {
    /*public static void main(String[] args) {
        ...
        //5、设置请求对象
        MybankLoanCloudquickloanPrecheckRequestV1 request = new MybankLoanCloudquickloanPrecheckRequestV1();
        //6、设置请求路径；联测时，请联系我行告知并替换成测试环境地址。
        request.setServiceUrl("http://ip:port/api/mybank/loan/cloudquickloan/precheck/V1");
        //7、设置业务参数
        MybankLoanCloudquickloanPrecheckRequestV1.MybankLoanPrecheckRequestV1Biz bizContent = new MybankLoanCloudquickloanPrecheckRequestV1.MybankLoanPrecheckRequestV1Biz();
        ...
        MybankLoanCloudquickloanPrecheckResponseV1 response;
        try {
