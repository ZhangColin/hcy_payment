...
import com.icbc.api.request.MybankOpaySmsVerifyRequestV1;
import com.icbc.api.request.MybankOpaySmsVerifyRequestV1.MybankOpaySmsVerifyRequestV1Biz;
import com.icbc.api.response.MybankOpaySmsVerifyResponseV1;

public class MybankOpaySmsVerifyTestV1 {
	    ...
	    static Logger log = Logger.getLogger(MybankOpaySmsVerifyTestV1.class.getName());
		...
		public static void main(String[] args) {
			...
			MybankOpaySmsVerifyRequestV1 request = new MybankOpaySmsVerifyRequestV1();
			
			//访问工行API平台URL
			request.setServiceUrl(API_SERVICE_URL + "/mybank/opay/sms/verify/V1");

			MybankOpaySmsVerifyRequestV1Biz bizContent = new MybankOpaySmsVerifyRequestV1Biz();

			//APPID
			bizContent.setBind_wallet_session_id("1111111");
			bizContent.setSms_verification_code("11111111");

			request.setBizContent(bizContent);

			MybankOpaySmsVerifyResponseV1 response;
