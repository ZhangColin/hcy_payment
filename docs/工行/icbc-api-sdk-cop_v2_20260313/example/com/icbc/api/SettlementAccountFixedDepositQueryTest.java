...
import com.icbc.api.request.SettlementAccountFixedDepositQueryRequestV1;
import com.icbc.api.request.SettlementAccountFixedDepositQueryRequestV1.FixedDepositQueryRequestV1Biz;
import com.icbc.api.response.SettlementAccountFixedDepositQueryResponseV1;

public class SettlementAccountFixedDepositQueryTest{
	...
	public void test_cop() throws IcbcApiException {
		...
		SettlementAccountFixedDepositQueryRequestV1 request = new SettlementAccountFixedDepositQueryRequestV1();
		FixedDepositQueryRequestV1Biz bizContent = new FixedDepositQueryRequestV1Biz();
		request.setServiceUrl("ip:port/api/settlement/account/fixed/deposit/query/V1");
		...
		bizContent.setOutServiceCode("fixedquery"); //外部服务代码
		...
		bizContent.setQueryFlag("1"); //查询标志
        request.setBizContent(bizContent);
		SettlementAccountFixedDepositQueryResponseV1 response = client.execute(request, "msgId");
