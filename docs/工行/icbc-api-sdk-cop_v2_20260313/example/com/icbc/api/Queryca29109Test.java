...
import com.icbc.api.request.Queryca29109RequestV1;
import com.icbc.api.request.Queryca29109RequestV1.Queryca29109RequestV1Biz;
import com.icbc.api.request.Queryca29109RequestV1.Queryca29109RequestV1Pub;
import com.icbc.api.request.Queryca29109RequestV1.Queryca29109RequestV1In;
import com.icbc.api.response.Queryca29109ResponseV1;
import com.icbc.api.response.Queryca29109ResponseV1.Queryca29109ResponseV1Pub;
import com.icbc.api.response.Queryca29109ResponseV1.Queryca29109ResponseV1Out;
import com.icbc.api.response.Queryca29109ResponseV1.Queryca29109ResponseV1Detail;

public class Queryca29109Test {
	...
	public void test_CA() throws IcbcApiException {
		...
		Queryca29109RequestV1 request = new Queryca29109RequestV1();
		request.setServiceUrl("http://ip:port/api/queryca29109/query/V1");

		Queryca29109RequestV1Biz bizContent = new Queryca29109RequestV1Biz();
		
		Queryca29109RequestV1Pub pub = new Queryca29109RequestV1Pub();
		pub.setCode("29109");
		pub.setZone("0200");
		pub.setFr("0");
		pub.setDt("2018-12-26");
		
		Queryca29109RequestV1In in = new Queryca29109RequestV1In();
		...
		Queryca29109ResponseV1 response = client.execute(request, "msgId");

		if (response.isSuccess()) {
			// 接收成功
			Queryca29109ResponseV1Pub RetPub = response.getPub();
			Queryca29109ResponseV1Out RetOut = response.getOut();
			if(RetOut.getResult().equals("00000000")){
				//查询成功 获取返回结果
				List<Queryca29109ResponseV1Detail> resultList = RetOut.getDetail();
				//获取结果集中字段
				for(Queryca29109ResponseV1Detail detail:resultList){
					//获取信息.....
					detail.getGRPMERNO();
				}
			} else {
