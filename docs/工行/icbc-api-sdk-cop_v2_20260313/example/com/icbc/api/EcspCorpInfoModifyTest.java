...
import com.icbc.api.request.EcspCorpInfoModifyRequestV1;
 ...
 * @author kfzx-linfeng
 */
public class EcspCorpInfoModifyTest {
  // 1、网关公钥
  ...
  public static void main(String[] args) throws Exception {
    ...
    EcspCorpInfoModifyRequestV1 request = new EcspCorpInfoModifyRequestV1();
    // 4、根据测试环境和生产环境替换相应ip和端口
    request.setServiceUrl("http://****/api/ecsp/assn/class/meeting/sign/V1");

    // 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
    EcspCorpInfoModifyRequestV1.EcspCorpInfoModifyRequestV1Biz bizContent = new EcspCorpInfoModifyRequestV1.EcspCorpInfoModifyRequestV1Biz();
    bizContent.setCorpName("corpName").setCorpSname("corpSName")
    ...
    EcspCorpInfoModifyResponseV1 response;
    try {
