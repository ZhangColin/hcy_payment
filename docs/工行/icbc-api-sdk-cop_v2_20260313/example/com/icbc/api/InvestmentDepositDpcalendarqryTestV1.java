...
import com.icbc.api.request.InvestmentDepositDpcalendarqryRequestV1;
...
public class InvestmentDepositDpcalendarqryTestV1 {
    ...
    public void test_cop() throws IcbcApiException {
        ...
        InvestmentDepositDpcalendarqryRequestV1 request = new InvestmentDepositDpcalendarqryRequestV1();
        request.setServiceUrl(Const.URL_PREFIX + "/investment/deposit/dpcalendarqry/V1");
        InvestmentDepositDpcalendarqryRequestV1.InvestmentDepositDpcalendarqryRequestV1Biz bizContent =
                new InvestmentDepositDpcalendarqryRequestV1.InvestmentDepositDpcalendarqryRequestV1Biz();
        ...
        bizContent.setCalendarType("1");
        bizContent.setYear("2020");


        request.setBizContent(bizContent);
        InvestmentDepositDpcalendarqryResponseV1 response;
        try {
