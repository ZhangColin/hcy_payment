...
public class CardbusinessNcpayUpdateAgreementTestV1 {
    public static void main(String[] args) throws IcbcApiException {
        ...
        //1、API平台申请的APPID
        //String APP_ID = "10000000000004110241";
        //4月
        //String APP_ID = "10000000000004097118";
        //5月
        String APP_ID = "1000000000000BCSS4097118";
      ...
      /*  //交易流水号(16)
        bizContent.setTrxSerno("0421172035869638");
        //交易日期(10)
        ...
        //绑定介质编号(50)
        bizContent.setSignMedid("湘J66666");
        //绑定商圈(13)
        bizContent.setMerGroupNo("957438212242");
        //操作标识(3) 1-解约  2-换卡
        ...
        //新卡号
        bizContent.setNewCardno("622202100106BCSS4425835");
        //手机号
        bizContent.setMobileNo("13637802100");

        //签约要素包含必输，否则选输
        bizContent.setCustName("黄可欣");
        bizContent.setIdNo("1301011992BCSS06110021");
        // bizContent.setExpiredDate("202601");
        // bizContent.setCardCvv2("908");
        //bizContent.setVerifyCode("123456");
        //bizContent.setVerifyCodeNo("1213154512132123");

        //新平台
        //服务商编号
        //bizContent.setSerId("020000001485");
        //服务上协议编号
        //bizContent.setSerAgrId("2000000148500101");
        //新旧平台标志 0-商户，2-服务商
