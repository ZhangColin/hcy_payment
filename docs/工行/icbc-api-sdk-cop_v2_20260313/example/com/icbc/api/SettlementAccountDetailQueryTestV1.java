...
public class SettlementAccountDetailQueryTestV1 {
	...
	public void test_cop() throws IcbcApiException {
		...
		request.setServiceUrl("http://ip:port/api/settlement/account/detail/V1/query");
		SettlementAccountDetailQueryRequestV1Biz bizContent = new SettlementAccountDetailQueryRequestV1Biz();
		bizContent.setCorpNo("000000000126"); //合作方机构编号
		...
		bizContent.setBeginDate("2016-08-23"); //开始日期
		bizContent.setEndDate("2019-08-23"); //结束日期
