...
import com.icbc.api.request.CardbusinessAggregatepayB2cOnlineAgentbatchpayRequestV1;
import com.icbc.api.request.CardbusinessAggregatepayB2cOnlineAgentbatchpayRequestV1.CardbusinessAggregatepayB2cOnlineAgentbatchpayRequestV1Biz;
import com.icbc.api.response.CardbusinessAggregatepayB2cOnlineAgentbatchpayResponseV1;

public class CardbusinessAggregatepayB2cOnlineAgentbatchpayV1Test {
	// 1、网关公钥
	...
	// 3、appid
	protected static final String APP_ID = "xxxxxxxx";
	private Logger logger = Logger.getLogger(CardbusinessAggregatepayB2cOnlineAgentbatchpayV1Test.class.getName());

	public void test_cop() throws IcbcApiException {
		
		//4、签名类型为RSA时，需传入appid，私钥和网关公钥，签名类型使用定值IcbcConstants.SIGN_TYPE_RSA，其他参数使用缺省值
		DefaultIcbcClient client = new DefaultIcbcClient(APP_ID, IcbcConstants.SIGN_TYPE_RSA,MY_PRIVATE_KEY, APIGW_PUBLIC_KEY);
		CardbusinessAggregatepayB2cOnlineAgentbatchpayRequestV1 request = new CardbusinessAggregatepayB2cOnlineAgentbatchpayRequestV1();
		//5、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("http://ip:port/api/cardbusiness/aggregatepay/b2c/online/agentbatchpay/V1");
		CardbusinessAggregatepayB2cOnlineAgentbatchpayRequestV1Biz bizContent = new CardbusinessAggregatepayB2cOnlineAgentbatchpayRequestV1Biz();
		request.setBizContent(bizContent);
		//6、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		bizContent.setMer_id("xxxx");
		bizContent.setMer_prtcl_no("xxxx");
		bizContent.setTxn_time("x");
		bizContent.setBatchNo("xxxxxxx");
		bizContent.setTotalqty("xxx");
		bizContent.setTotalamt("xxx");
		bizContent.setOrder_submit_input(new JSONArray(new ArrayList<>()));

		CardbusinessAggregatepayB2cOnlineAgentbatchpayResponseV1 response;
		try {
