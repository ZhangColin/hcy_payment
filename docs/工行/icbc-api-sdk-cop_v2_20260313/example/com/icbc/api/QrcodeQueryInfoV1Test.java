...
import com.icbc.api.request.QrcodeQueryInfoRequestV1;
import com.icbc.api.request.QrcodeQueryInfoRequestV1.QrcodeQueryInfoRequestV1Biz;

public class QrcodeQueryInfoV1Test {
	...
	private Logger logger = Logger.getLogger(QrcodeQueryInfoV1Test.class.getName());


	public void test_cop() throws IcbcApiException {
		QrcodeQueryInfoRequestV1 request = new QrcodeQueryInfoRequestV1();
		// 4、需传入appid，私钥，字符集
		UiIcbcClient client;
		...
		request.setServiceUrl("https://ip:port/api/mybank/pay/qrcode/query/info/V1");
		QrcodeQueryInfoRequestV1Biz bizContent = new QrcodeQueryInfoRequestV1Biz();
		request.setBizContent(bizContent);
		// 6、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		bizContent.setMer_id("xxx");
		bizContent.setQr_code("xxx");
		bizContent.setOut_trade_no("xxx");
		bizContent.setTrade_date("xxx");
		bizContent.setTrade_time("xxx");
