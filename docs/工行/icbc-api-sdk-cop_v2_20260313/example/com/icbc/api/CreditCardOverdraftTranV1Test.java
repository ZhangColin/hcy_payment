...
import com.icbc.api.request.CreditCardOverdraftTranRequestV1;
import com.icbc.api.request.CreditCardOverdraftTranRequestV1.CreditCardOverdraftTranRequestV1Biz;
import com.icbc.api.response.CreditCardOverdraftTranResponseV1;

public class CreditCardOverdraftTranV1Test {
    ...
    public static void main(String[] args) {
        ...
        CreditCardOverdraftTranRequestV1 request = new CreditCardOverdraftTranRequestV1();

        //访问工行API平台URL
        request.setServiceUrl(API_SERVICE_URL + "/mybank/pay/creditcard/transfer/overdrafttran/V1");

        CreditCardOverdraftTranRequestV1Biz bizContent = new CreditCardOverdraftTranRequestV1Biz();
        ...
        CreditCardOverdraftTranResponseV1 response;
