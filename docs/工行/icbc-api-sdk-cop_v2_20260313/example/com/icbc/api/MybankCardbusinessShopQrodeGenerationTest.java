...
import com.icbc.api.request.MybankCardbusinessShopQrodeGenerationRequestV1;
import com.icbc.api.response.MybankCardbusinessShopQrodeGenerationResponseV1;

public class MybankCardbusinessShopQrodeGenerationTest {
    ...
    public static void main(String[] args) throws Exception{
        ...
        MybankCardbusinessShopQrodeGenerationRequestV1 request = new MybankCardbusinessShopQrodeGenerationRequestV1();

        request.setServiceUrl("http://ip:port:16257/api/mybank/cardbusiness/shop/qrodeGeneration/V1");
        MybankCardbusinessShopQrodeGenerationRequestV1.MybankCardbusinessShopQrodeGenerationRequestV1Biz bizRes = new MybankCardbusinessShopQrodeGenerationRequestV1.MybankCardbusinessShopQrodeGenerationRequestV1Biz();

        bizRes.setTrxserno("050213342165818105101002561");
        bizRes.setTrxdate("2022-06-13");
        bizRes.setTrxtime("10:27:32");
        bizRes.setPrtiId("020057018890");
        request.setBizContent(bizRes);
        MybankCardbusinessShopQrodeGenerationResponseV1 response = new MybankCardbusinessShopQrodeGenerationResponseV1();
        try{
