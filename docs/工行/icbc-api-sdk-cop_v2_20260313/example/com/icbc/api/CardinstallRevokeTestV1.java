...
import com.icbc.api.request.CardinstallRevokeRequestV1;
import com.icbc.api.request.CardinstallRevokeRequestV1.CancelEOrderRequestV1Biz;
 ...
 */
public class CardinstallRevokeTestV1 {
	...
	public static void main(String[] args) throws Exception {
		...
		CardinstallRevokeRequestV1 request = new CardinstallRevokeRequestV1();
		
		//4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("https://ip:port/api/cardinstall/revoke/V1");
		
		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		CancelEOrderRequestV1Biz bizContent = new CancelEOrderRequestV1Biz();
		bizContent.setCustId("1076dAbpBsrJXpI4J+/HXthaHj+mORib");
		bizContent.setShopId("020002040095");
		bizContent.setOrderId("020002040095202110101070458");
		bizContent.setOutTradeNo("5678901234");
