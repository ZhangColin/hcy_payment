...
import com.icbc.api.request.JftUiVendorCloudOtherInfoAddRequestV1;
import com.icbc.api.request.JftUiVendorCloudOtherInfoAddRequestV1.JftUiVendorCloudOtherInfoAddRequestV1Biz;

/**
 * 聚富通云鉴证子商户注册其他信息页测试类
 */
public class JftUiVendorCloudOtherInfoAddTestV1 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			JftUiVendorCloudOtherInfoAddRequestV1 request = new JftUiVendorCloudOtherInfoAddRequestV1();
			request.setServiceUrl("https://ip:port/ui/jft/ui/vendor/cloud/other/info/add/V1"); 
			
			JftUiVendorCloudOtherInfoAddRequestV1Biz bizContent = new JftUiVendorCloudOtherInfoAddRequestV1Biz();
