...
import com.icbc.api.request.DepositFixedProdqueryRequestV1.DepositFixedProdqueryRequestV1Biz;
import com.icbc.api.response.DepositFixedProdqueryResponseV1;

public class DepositFixedProdqueryTest{
	...
	public void test_cop() throws IcbcApiException {
		...
		DepositFixedProdqueryRequestV1Biz bizContent = new DepositFixedProdqueryRequestV1Biz();
		request.setServiceUrl("ip:port/api/deposit/fixed/prodquery/V1");
		...
		bizContent.setStart("0"); //从第几条记录开始读取
		bizContent.setRows("5"); //读取几条记录
		bizContent.setProdCode(""); //产品代码
        request.setBizContent(bizContent);
		DepositFixedProdqueryResponseV1 response = client.execute(request, "msgId");
