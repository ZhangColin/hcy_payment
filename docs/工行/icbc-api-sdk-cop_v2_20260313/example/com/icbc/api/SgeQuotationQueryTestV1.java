...
import com.icbc.api.request.SgeQuotationQueryRequestV1;
import com.icbc.api.request.SgeQuotationQueryRequestV1.SgeQuotationQueryRequestBiz;
import com.icbc.api.response.SgeQuotationQueryResponseV1;

public class SgeQuotationQueryTestV1 {
	...
	public void test_cop() throws IcbcApiException {
		...
		SgeQuotationQueryRequestV1 request = new SgeQuotationQueryRequestV1();
		request.setServiceUrl("http://ip:port/api/sge/quotation/query/V1");

		SgeQuotationQueryRequestBiz bizContent = new SgeQuotationQueryRequestBiz();
		bizContent.setContractId("iAu100g");
		bizContent.setQueryFlag(1);
		bizContent.setQueryRow(5);
		request.setBizContent(bizContent);

		SgeQuotationQueryResponseV1 response = client.execute(request);
