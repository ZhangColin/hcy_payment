...
public class SettlementAccountBindingQueryTest {
	...
	public void test_cop() throws IcbcApiException {
		...
		request.setServiceUrl("http://ip:port/api/settlement/account/binding/V1/query");
		...
		SettlementAccountBindingQueryResponseV1 response = client.execute(request, "msgId");
