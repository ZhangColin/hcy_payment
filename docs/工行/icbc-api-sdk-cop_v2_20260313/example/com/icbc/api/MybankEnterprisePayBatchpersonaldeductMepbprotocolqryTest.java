...
public class MybankEnterprisePayBatchpersonaldeductMepbprotocolqryTest {
    ...
    public static void main(String[] args) throws Exception {
        String URI = "mybank/enterprise/pay/Batchpersonaldeduct/mepbprotocolqry/V1";
        ...
        try {
            ...
            bizContent.setTransCode("QENDIIMPU");
            bizContent.setTranDate("20190101");
            bizContent.setTranTime("103231001");
            bizContent.setLanguage("zh_CN");
            bizContent.setfSeqNo("QENDIIMPU2142166376");
            bizContent.setProjectId("null");
