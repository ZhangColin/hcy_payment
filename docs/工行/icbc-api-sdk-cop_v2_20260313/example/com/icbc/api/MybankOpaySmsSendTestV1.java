...
import com.icbc.api.request.MybankOpaySmsSendRequestV1;
import com.icbc.api.request.MybankOpaySmsSendRequestV1.MybankOpaySmsSendRequestV1Biz;
import com.icbc.api.response.MybankOpaySmsSendResponseV1;

public class MybankOpaySmsSendTestV1 {
	    ...
	    static Logger log = Logger.getLogger(MybankOpaySmsSendTestV1.class.getName());
		...
		public static void main(String[] args) {
			...
			MybankOpaySmsSendRequestV1 request = new MybankOpaySmsSendRequestV1();
			
			//访问工行API平台URL
			request.setServiceUrl(API_SERVICE_URL + "/mybank/opay/sms/send/V1");

			MybankOpaySmsSendRequestV1Biz bizContent = new MybankOpaySmsSendRequestV1Biz();
			...
			MybankOpaySmsSendResponseV1 response;
