...
import com.icbc.api.request.MybankOpayAlipayCancelRequestV1;
import com.icbc.api.request.MybankOpayAlipayCancelRequestV1.MybankOpayAlipayCancelRequestV1Biz;
import com.icbc.api.response.MybankOpayAlipayCancelResponseV1;

public class MybankOpayAlipayCancelTestV1 {
	    ...
	    static Logger log = Logger.getLogger(MybankOpayAlipayCancelTestV1.class.getName());
		...
		public static void main(String[] args) {
			...
			MybankOpayAlipayCancelTestV1 request = new MybankOpayAlipayCancelTestV1();
			
			//访问工行API平台URL
			request.setServiceUrl(API_SERVICE_URL + "/mybank/opay/alipay/cancel/V1);

			MybankOpayAlipayCancelRequestV1Biz bizContent = new MybankOpayAlipayCancelRequestV1Biz();
			...
			MybankOpayAlipayCancelResponseV1 response;
