...
import com.icbc.api.request.JftUiWalletFundmanageRequestV1;

public class JftUiWalletFundmanageTestV1 extends HttpServlet {
	private static final long serialVersionUID = 7082115106440379278L;
	  ...
	  protected void doPost(HttpServletRequest req, HttpServletResponse resp)throws ServletException, IOException  {
	    ...
	    try {
	    	String appId = "100XXXXX102010";
		    String corpAppid = "1000XXXXX010533";//合作方机构编号
		    String corpMediumId = "128XXXXX20344";//用户介质号
		    String custName = "李四";//用户名
		    String certNo = "12856XXXXX020344";//身份证号
		    String phoneNo = "13412XXXXX4";//手机号
	      ...
	      JftUiWalletFundmanageRequestV1 request = new JftUiWalletFundmanageRequestV1();
	      request.setServiceUrl("https://ip:port/ui/jft/ui/wallet/fundmanage/V1");
	      
	      JftUiWalletFundmanageRequestV1.JftUiWalletFundmanageRequestV1Biz bizC = new JftUiWalletFundmanageRequestV1.JftUiWalletFundmanageRequestV1Biz();
