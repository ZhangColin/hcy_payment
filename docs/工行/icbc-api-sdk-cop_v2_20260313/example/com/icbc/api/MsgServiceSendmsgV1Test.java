 ...
 * @date 2022/7/5
 */
public class MsgServiceSendmsgV1Test {

    private static final Logger LOG = Logger.getLogger(MsgServiceSendmsgV1Test.class.getName());

    public static void main(String[] args) throws Exception {

        //1.调用参数准备
        Map<String, Object> paramMap = new HashMap<>();
        List<Map<String, Object>> messages = new ArrayList<>(5);
        Map<String, Object> message = new HashMap<>();
        message.put("msg_id", "");
        message.put("stru_id", "");
        message.put("zoneno", "");
        message.put("brno", "");
        message.put("user_id", "020000201");
        message.put("msg_type", "108");
        message.put("msg_title", "测试消息");
        message.put("msg_body", "测试消息体");
        message.put("msg_para", "");
        message.put("push_mode", 1);
        ...
        invoker.setUri("/msg/service/sendmsg/V1");
