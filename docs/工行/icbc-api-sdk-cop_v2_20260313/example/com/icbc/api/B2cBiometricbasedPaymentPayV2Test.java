...
import com.icbc.api.request.B2cBiometricbasedPaymentPayRequestV2;
import com.icbc.api.request.B2cBiometricbasedPaymentPayRequestV2.B2cBiometricbasedPaymentPayRequestV2Biz;
import com.icbc.api.response.B2cBiometricbasedPaymentPayResponseV2;

public class B2cBiometricbasedPaymentPayV2Test {
	...
	public void test_cop() throws IcbcApiException {
		DefaultIcbcClient client = new DefaultIcbcClient(
														...
														AES_KEY, 
														null, null);
		B2cBiometricbasedPaymentPayRequestV2 request = new B2cBiometricbasedPaymentPayRequestV2();
		Date date = new Date();
        ...
        request.setServiceUrl("https://apipcs4.dccnet.com.cn/api/biometricbased/payment/pay/V2");

		
		B2cBiometricbasedPaymentPayRequestV2Biz bizContent = new B2cBiometricbasedPaymentPayRequestV2Biz();
		...
		bizContent.setCustomerId("0014");//上送用于识别客户的标识信息，如手机号后四位等
		...
		B2cBiometricbasedPaymentPayResponseV2 response;
		try {
			response = (B2cBiometricbasedPaymentPayResponseV2) client.execute(request, "msgId");
