...
import com.icbc.api.request.InvestmentDepositDpredpacketreceiveRequestV1;
...
public class InvestmentDepositDpredpacketreceiveTestV1 {
    ...
    public void test_cop() throws IcbcApiException {
        ...
        InvestmentDepositDpredpacketreceiveRequestV1 request = new InvestmentDepositDpredpacketreceiveRequestV1();
        request.setServiceUrl(Const.URL_PREFIX + "/investment/deposit/dpredpacketreceive/V1");
        InvestmentDepositDpredpacketreceiveRequestV1.InvestmentDepositDpredpacketreceiveRequestV1Biz bizContent =
                new InvestmentDepositDpredpacketreceiveRequestV1.InvestmentDepositDpredpacketreceiveRequestV1Biz();
        ...
        bizContent.setBrno("00200");
        bizContent.setWorkDate(Const.WORK_DATE);
        bizContent.setWorkTime("13:56:00");
        bizContent.setCooperCode("123");
        // PMD检查
        bizContent.setSendCardNo("62322" +
                "90200000299519");
        bizContent.setReceiveCardNo("62322" +
                "90200000299519");
        bizContent.setRedPacketOrderNo("1");
        bizContent.setSubRedPacketOrderNo("1");
        bizContent.setRedPacketQuantity("1");


        request.setBizContent(bizContent);
        InvestmentDepositDpredpacketreceiveResponseV1 response;
        try {
