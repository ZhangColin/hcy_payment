...
import com.icbc.api.request.CardbusinessSzfhwebserviceSingleacpQueryRequestV1;
import com.icbc.api.request.CardbusinessSzfhwebserviceSingleacpQueryRequestV1.CardbusinessSzfhwebserviceSingleacpQueryRequestBizV1;
import com.icbc.api.response.CardbusinessSzfhwebserviceSingleacpQueryResponseV1;

/**
 * @Author: szfh-lj
 * @Description: 深结算跨行单笔代收业务查询，测试类
 * @Date: 2021/03/11
 */
public class CardbusinessSzfhwebserviceSingleacpQueryTestV1 {
    ...
    //请求url
    protected static final String REQ_URL = "https://apipcs3.dccnet.com.cn/api/cardbusiness/szfhwebservice/singleacp/query/V1";
    //签名类型
    ...
    public static void main(String[] args) {
    	...
    	CardbusinessSzfhwebserviceSingleacpQueryRequestBizV1 bizContent = new CardbusinessSzfhwebserviceSingleacpQueryRequestBizV1();
        ...
        String requestxml = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"no\"?>" +
			        		"<BizTransQuery xmlns=\"szfs.tws.actqry.biztransquery.v2\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">" +
				        		...
				        		"<omsgtype>SINGLEACP</omsgtype>" +
				        		"<oversion>2.0</oversion>" +
				        		"<osubnode>B01500000002</osubnode>" +
				        		"<oseqid>2021032600000000003</oseqid>" +
			        		"</BizTransQuery>";
        bizContent.setRequestxml(requestxml);

        CardbusinessSzfhwebserviceSingleacpQueryRequestV1 request = new CardbusinessSzfhwebserviceSingleacpQueryRequestV1();
        request.setServiceUrl(REQ_URL);
        request.setBizContent(bizContent);

        System.out.println("req=" + JSON.toJSONString(bizContent));

        CardbusinessSzfhwebserviceSingleacpQueryResponseV1 response = null;
