...
import com.icbc.api.request.CardbusinessAggregatepayB2cOnlineApplytripleRequestV1;
...
public class CardbusinessAggregatepayB2cOnlineApplytripleV1Test {
    // 1、网关公钥
    ...
    private Logger logger = Logger.getLogger(CardbusinessAggregatepayB2cOnlineApplytripleV1Test.class.getName());


    public void test_cop() throws IcbcApiException {
        CardbusinessAggregatepayB2cOnlineApplytripleRequestV1 request = new CardbusinessAggregatepayB2cOnlineApplytripleRequestV1();
        // 4、需传入appid，私钥，字符集
        UiIcbcClient client;
        ...
        request.setServiceUrl("https://ip:port/api/cardbusiness/aggregatepay/b2c/online/applytriple/V1");
        CardbusinessAggregatepayB2cOnlineApplytripleRequestV1.CardbusinessAggregatepayB2cOnlineApplytripleV1Biz bizContent = new CardbusinessAggregatepayB2cOnlineApplytripleRequestV1.CardbusinessAggregatepayB2cOnlineApplytripleV1Biz();
        request.setBizContent(bizContent);
        // 6、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
        bizContent.setMer_ser_flag("xxx");
        bizContent.setMer_id("xxx");
        bizContent.setOut_trade_no("xxx");
        bizContent.setTxn_time("xxx");
        bizContent.setAcc_no("xxx");
        bizContent.setTrxcardtype("xxx");
        bizContent.setExpired("xxx");
        // 如果cvn2有值，需要上送，那么也需要进行AES加密
        // 注意：加密的字段需要带上双引号进行加密
        bizContent.setCvn2(IcbcEncrypt.encryptContent("\"123\"", "AES", "6lrVTBDXfKBkoX8UbaqAEA==", "UTF-8"));
        bizContent.setCertiftp("xxx");
        // 注意：加密的字段需要带上双引号进行加密
        bizContent.setCertifid(IcbcEncrypt.encryptContent("\"123\"", "AES", "6lrVTBDXfKBkoX8UbaqAEA==", "UTF-8"));
        bizContent.setContract_name("xxx");
        bizContent.setEnd_date("xxx");
        bizContent.setAcc_nm("xxx");
        bizContent.setMobile_phone("xxx");
        bizContent.setMerchant("xxx");
        bizContent.setIssuer_bank("xxx");
        bizContent.setPayee("xxx");
        bizContent.setAccount_opening_institution("xxx");
        bizContent.setPay_purpose("xxx");
        bizContent.setPay_period("xxx");
        bizContent.setPay_num("xxx");
        bizContent.setDeadline("xxx");
        bizContent.setNotifyurl("xxx");

        CardbusinessAggregatepayB2cOnlineApplytripleResponseV1 response;
        try {
