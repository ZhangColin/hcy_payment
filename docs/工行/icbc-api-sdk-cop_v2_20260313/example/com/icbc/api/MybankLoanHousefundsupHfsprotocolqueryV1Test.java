...
import com.icbc.api.request.MybankLoanHousefundsupHfsprotocolqueryRequestV1;
import com.icbc.api.request.MybankLoanHousefundsupHfsprotocolqueryRequestV1.MybankLoanHousefundsupHfsprotocolquery;
import com.icbc.api.request.MybankLoanHousefundsupHfsprotocolqueryRequestV1.MybankLoanHousefundsupHfsprotocolqueryRequestV1Biz;
import com.icbc.api.response.MybankLoanHousefundsupHfsprotocolqueryResponseV1;

public class MybankLoanHousefundsupHfsprotocolqueryV1Test {
    static Logger log = Logger.getLogger(MybankLoanHousefundsupHfsprotocolqueryV1Test.class.getName());
    //估值表
    ...
    public static void main(String[] args) throws Exception {
       ...
       // DefaultIcbcClient client = new DefaultIcbcClient(APP_ID, "RSA2",PRI_KEY, APIGW_PUBLIC_KEY);
        ...
        try {
            ...
            // 请求实体
        	MybankLoanHousefundsupHfsprotocolqueryRequestV1 request = new  MybankLoanHousefundsupHfsprotocolqueryRequestV1();
            // bizContent实体
        	MybankLoanHousefundsupHfsprotocolqueryRequestV1Biz bizContent  = new  MybankLoanHousefundsupHfsprotocolqueryRequestV1Biz();

        	MybankLoanHousefundsupHfsprotocolquery param = new MybankLoanHousefundsupHfsprotocolquery();
            ...
            String url = "http"+"://8"+"3.28"+".222."+"45:80"+"81/api/mybank/loa"+"n/housefundsup/hfsprotocolquery/V1"; 
            
            request.setServiceUrl(url);
            request.setBizContent(bizContent);
            MybankLoanHousefundsupHfsprotocolqueryResponseV1 response = client.execute(request);
