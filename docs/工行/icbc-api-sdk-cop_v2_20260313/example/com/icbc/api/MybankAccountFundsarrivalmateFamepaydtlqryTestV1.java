...
import com.icbc.api.request.MybankAccountFundsarrivalmateFamepaydtlqryRequestV1;
import com.icbc.api.response.MybankAccountFundsarrivalmateFamepaydtlqryResponseV1;

public interface MybankAccountFundsarrivalmateFamepaydtlqryTestV1 {
    ...
    public static void main(String[] args) {
        ...
        MybankAccountFundsarrivalmateFamepaydtlqryRequestV1 request = new MybankAccountFundsarrivalmateFamepaydtlqryRequestV1();
        request.setServiceUrl("http://ip:port/api/mybank/account/fundsarrivalmate/famnovadtlqry/V1");

        MybankAccountFundsarrivalmateFamepaydtlqryRequestV1.FamMsgdtlInfoQueryRequestV1Biz bizContent = new MybankAccountFundsarrivalmateFamepaydtlqryRequestV1.FamMsgdtlInfoQueryRequestV1Biz();
        bizContent.setAgreeno("1");
        bizContent.setSellerid("1103");
        bizContent.setCustomerid("guq_dealer_002");
        bizContent.setCustacct("1");
        bizContent.setCustname("测试户002");
        bizContent.setAcctno("1");
        bizContent.setAcctname("测试户001");
        bizContent.setAmount("2050");
        bizContent.setProjectname("测试户003");
        bizContent.setDrcrf("2");
        bizContent.setStartdate("20201118");
        bizContent.setEnddate("20201119");
        bizContent.setPushfailedonly("0");
        bizContent.setPage("1");
        bizContent.setPagesize("10");

        request.setBizContent(bizContent);
        MybankAccountFundsarrivalmateFamepaydtlqryResponseV1 response;
        try {
