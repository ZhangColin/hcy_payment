...
import com.icbc.api.request.QualQueryRequestV1;
import com.icbc.api.request.QualQueryRequestV1.QualQueryRequestV1Biz;
import com.icbc.api.response.QualQueryResponseV1;

public class QualQueryTest {
	...
	public static void main(String[] args) throws Exception {
		...
		QualQueryRequestV1 request = new QualQueryRequestV1();
		
		//4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("http://ip:port/api/qual/query/V1");
		
		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		QualQueryRequestV1Biz bizContent = new QualQueryRequestV1Biz();
		...
		QualQueryResponseV1 response = new QualQueryResponseV1();
		try {
