...
import com.icbc.api.request.JftApiUserRiOrderConfirmAuthRequestV1;
import com.icbc.api.response.JftApiUserRiOrderConfirmAuthResponseV1;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class JftApiUserRiOrderConfirmAuthTestV1 {
    private static final Logger LOGGER = LoggerFactory.getLogger(JftApiUserRiOrderConfirmAuthTestV1.class);
    ...
    public static void main(String[] args) {
        ...
        JftApiUserRiOrderConfirmAuthRequestV1 request = new JftApiUserRiOrderConfirmAuthRequestV1();
        request.setServiceUrl("[需替换]工行API网关地址/api/jft/api/user/riOrderConfirm/auth/V1");

        JftApiUserRiOrderConfirmAuthRequestV1.JftApiUserRiOrderConfirmAuthRequestV1Biz bizContent = new JftApiUserRiOrderConfirmAuthRequestV1.JftApiUserRiOrderConfirmAuthRequestV1Biz();
        bizContent.setAppId(APP_ID);
        bizContent.setOutUserId("10001112");
        bizContent.setTransNo("1000000012345");
        request.setBizContent(bizContent);
        JftApiUserRiOrderConfirmAuthResponseV1 response;
        try {
