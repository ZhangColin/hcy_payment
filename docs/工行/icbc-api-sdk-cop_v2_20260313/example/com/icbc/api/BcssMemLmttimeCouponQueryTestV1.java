...
import com.icbc.api.request.BcssMemLmttimeCouponQueryRequestV1;
import com.icbc.api.request.BcssMemLmttimeCouponQueryRequestV1.BcssMemLmttimeCouponQueryRequesBizV1;
import com.icbc.api.response.BcssMemLmttimeCouponQueryResponseV1;

import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;

public class BcssMemLmttimeCouponQueryTestV1 {
	
	private static final Log logger = LogFactory.getLog(BcssMemLmttimeCouponQueryTestV1.class);
	// MY_PRIVATE_KEY
    ...
    public static void main(String[] args) throws Exception {
    	BcssMemLmttimeCouponQueryTestV1 a = new BcssMemLmttimeCouponQueryTestV1();
        a.test_cop();
    }

    public void test_cop() throws IcbcApiException {
        BcssMemLmttimeCouponQueryRequestV1 request = new BcssMemLmttimeCouponQueryRequestV1();
        request.setServiceUrl("http://ip:port/api/bcss/member/lmttimeCouponQuery/V1");
        BcssMemLmttimeCouponQueryRequesBizV1 bizContent = new BcssMemLmttimeCouponQueryRequesBizV1();         
        bizContent.setCorpId("0***********3");
        bizContent.setOperType("1");
        bizContent.setMemMerNo("121212");
        ...
        BcssMemLmttimeCouponQueryResponseV1 result = client.execute(request);
