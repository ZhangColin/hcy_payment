...
import com.icbc.api.request.JftApiVacctNovelAcctOrderConsumptionRequestV1;
import com.icbc.api.request.JftApiVacctNovelAcctOrderConsumptionRequestV1.JftApiVacctNovelAcctOrderConsumptionRequestV1Biz;
import com.icbc.api.response.JftApiVacctNovelAcctOrderConsumptionResponseV1;
import org.junit.Test;

public class JftApiVacctNovelAcctOrderConsumptionTestV1 {
    ...
    public void test_cop() {
        ...
        JftApiVacctNovelAcctOrderConsumptionRequestV1 request = new JftApiVacctNovelAcctOrderConsumptionRequestV1();
        request.setServiceUrl("http://ip:port/api/jft/api/vacct/novel/acct/order/consumption/V1");
        JftApiVacctNovelAcctOrderConsumptionRequestV1Biz bizContent = new JftApiVacctNovelAcctOrderConsumptionRequestV1Biz();
        ...
        bizContent.setAbstractInfo("下单消费摘要，非必输");
        bizContent.setVersion("1.0.0");//设置接口访问版本号
        request.setBizContent(bizContent);
        JftApiVacctNovelAcctOrderConsumptionResponseV1 response;
        try {
            response = (JftApiVacctNovelAcctOrderConsumptionResponseV1) client.execute(request, System.currentTimeMillis()+"");
