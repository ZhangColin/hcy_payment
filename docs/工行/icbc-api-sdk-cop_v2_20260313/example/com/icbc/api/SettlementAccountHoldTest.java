...
import com.icbc.api.request.SettlementAccountHoldRequestV1.SettlementAccountHoldRequestV1Biz;
import com.icbc.api.response.SettlementAccountHoldResponseV1;

public class SettlementAccountHoldTest {
	...
	public void test_cop() throws IcbcApiException{
		...
		SettlementAccountHoldRequestV1Biz bizContent = new SettlementAccountHoldRequestV1Biz();
		
		request.setServiceUrl("http://ip:port/api/settlement/account/hold/V1");
		...
		SettlementAccountHoldResponseV1 response = client.execute(request, "msgId");
