...
import com.icbc.api.request.EcspScenicTerminalProductQrcodeRequestV1;
import com.icbc.api.request.EcspScenicTerminalProductQrcodeRequestV1.EcspScenicTerminalProductQrcodeRequestV1Biz;
 ...
 */
public class EcspEcspScenicTerminalProductQrcodeV1Test {
  public static void main(String[] args) {
    final String APP_ID = "app_id";
    final String URL = "http://ip:port/api/ecsp/scenic/terminal/product/qrcode/query/V1";
    ...
    EcspScenicTerminalProductQrcodeRequestV1Biz biz = new EcspScenicTerminalProductQrcodeRequestV1Biz();
    biz.setCorpId("0000000272");
    biz.setCcType(3);
    biz.setCommId("1");
    biz.setTerminalType(3);
    biz.setTerminalNo("ECSPVanstone0100021030019");

    EcspScenicTerminalProductQrcodeRequestV1 requestV1 = new EcspScenicTerminalProductQrcodeRequestV1();
    ...
    DefaultIcbcClient client = new DefaultIcbcClient(APP_ID, IcbcConstants.SIGN_TYPE_RSA2, YOUR_PRIVATE_KEY,
                                                     APIGW_PUBLIC_KEY);
    try {
      EcspScenicTerminalProductQrcodeResponseV1 responseV1 = client.execute(requestV1);
