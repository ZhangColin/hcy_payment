 ...
 */
public class EcspScenicTicketVerfQryTestV1 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    EcspScenicQueryTicketVerfRequestV1 request = new EcspScenicQueryTicketVerfRequestV1();
    // 4、根据测试环境和生产环境替换相应ip和端口
    request.setServiceUrl("http://appid/api/ecsp/scenic/ticketverf/query/V1");

    // 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
    EcspScenicQueryTicketVerfRequestV1Biz bizContent = new EcspScenicQueryTicketVerfRequestV1Biz();
    bizContent.setCorpId("0000000272").setCurrentPage(1).setPageSize(10).setQryCcType((byte) 3)
              .setQryTimeBeg("2001-01-01 00:00:00").setQryTimeEnd("2020-01-01 00:00:00");
    request.setBizContent(bizContent);

    EcspScenicQueryTicketVerfResponseV1 response;
    try {
