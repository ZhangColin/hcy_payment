...
import com.icbc.api.request.MybankDepositQrcodeConfirmRequestV1;
import com.icbc.api.request.MybankDepositQrcodeConfirmRequestV1.MybankDepositQrcodeConfirmRequestV1Biz;
import com.icbc.api.response.MybankDepositQrcodeConfirmResponseV1;
 ...
 */
public class MybankDepositQrcodeConfirmV1Test {
	...
	public static void main(String[] args) throws Exception {
		...
		MybankDepositQrcodeConfirmRequestV1 request = new MybankDepositQrcodeConfirmRequestV1();
		
		//4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("http://****/api/mybank/deposit/qrcode/scanned/confirm/V1");
		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		MybankDepositQrcodeConfirmRequestV1Biz bizContent = new MybankDepositQrcodeConfirmRequestV1Biz();
		...
		bizContent.setConfirmAmt("100");  //押金确认金额,单位：分

		request.setBizContent(bizContent);
		MybankDepositQrcodeConfirmResponseV1 response;
		try {
