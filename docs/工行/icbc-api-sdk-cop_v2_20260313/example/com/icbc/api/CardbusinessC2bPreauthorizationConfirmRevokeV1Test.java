...
import com.icbc.api.request.CardbusinessC2bPreauthorizationConfirmRevokeRequestV1;
import com.icbc.api.request.CardbusinessC2bPreauthorizationConfirmRevokeRequestV1.CardbusinessC2bPreauthorizationConfirmRevokeRequestV1Biz;
...
public class CardbusinessC2bPreauthorizationConfirmRevokeV1Test {
    // 1、网关公钥
    ...
    public void test_cop() throws IcbcApiException {
        ...
        CardbusinessC2bPreauthorizationConfirmRevokeRequestV1 request = new CardbusinessC2bPreauthorizationConfirmRevokeRequestV1();
        //5、根据测试环境和生产环境替换相应ip和端口
        request.setServiceUrl("https://ip:port/api/cardbusiness/c2b/preauthorization/confirmrevoke/V1");
        CardbusinessC2bPreauthorizationConfirmRevokeRequestV1Biz bizContent = new CardbusinessC2bPreauthorizationConfirmRevokeRequestV1Biz();
        request.setBizContent(bizContent);
        //6、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
        bizContent.setOutTradeNo("xxxxx");
        bizContent.setOrigDateTime("yyyy-MM-ddTHH:mm:ss");
        bizContent.setMerPrtclNo("xxxxx");
        bizContent.setMerId("xxxxx");
        bizContent.setoOrderId("xxxxx");
        bizContent.setoOutTradeNo("xxxxx");
        bizContent.setoTrxAmt("xxxxx");
        bizContent.setoAuthorNo("xxxxx");
        bizContent.setAttach("xxxxx");
        bizContent.setOrderApdInf("xxxxx");
        bizContent.setOrderAmt("xxx");

        CardbusinessC2bPreauthorizationConfirmRevokeResponseV1 response;
        try {
