...
import com.icbc.api.request.CacaReceiptPosreceiptQueryposzcreceiptRequestV1;
import com.icbc.api.response.CacaReceiptPosreceiptQueryposzcreceiptResponseV1;

public class CacaReceiptPosreceiptQueryposzcreceiptTestV1 {
    ...
    public static void main(String[] args) {
        ...
        CacaReceiptPosreceiptQueryposzcreceiptRequestV1 request = new CacaReceiptPosreceiptQueryposzcreceiptRequestV1();
        request.setServiceUrl("https://ip:port/api/caca/receipt/posreceipt/QueryNettingPoszcreceipt/V1");
        CacaReceiptPosreceiptQueryposzcreceiptRequestV1.QueryNettingPosRequestV1Biz bizContent = new CacaReceiptPosreceiptQueryposzcreceiptRequestV1.QueryNettingPosRequestV1Biz();
        // public 通讯区定义赋值
        CacaReceiptPosreceiptQueryposzcreceiptRequestV1.QueryNettingPosRequestV1Pub pubObj = new CacaReceiptPosreceiptQueryposzcreceiptRequestV1.QueryNettingPosRequestV1Pub();
        pubObj.setCode("29009");
        pubObj.setZone("0200");
        pubObj.setFr("0");
        pubObj.setDt("2017-07-06");
        // private 通讯区定义赋值
        CacaReceiptPosreceiptQueryposzcreceiptRequestV1.QueryNettingPosRequestV1In inObj = new CacaReceiptPosreceiptQueryposzcreceiptRequestV1.QueryNettingPosRequestV1In();
        ...
        try {
            CacaReceiptPosreceiptQueryposzcreceiptResponseV1 response = client.execute(request);
