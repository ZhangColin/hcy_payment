...
import com.icbc.api.request.CardbusinessAggregatepayB2cOnlineRsignRequestV1;
import com.icbc.api.response.CardbusinessAggregatepayB2cOnlineRsignResponseV1;
import com.icbc.api.request.CardbusinessAggregatepayB2cOnlineRsignRequestV1.CardbusinessAggregatepayB2cOnlineRsignV1Biz;
...
public class CardbusinessAggregatepayB2cOnlineRsignV1Test {
	...
	private Logger logger = Logger.getLogger(CardbusinessAggregatepayB2cOnlineRsignV1Test.class.getName());


	public void test_cop() throws IcbcApiException {
		CardbusinessAggregatepayB2cOnlineRsignRequestV1 request = new CardbusinessAggregatepayB2cOnlineRsignRequestV1();
		// 4、需传入appid，私钥，字符集
		UiIcbcClient client;
		...
		request.setServiceUrl("https://ip:port/api/cardbusiness/aggregatepay/b2c/online/rsign/V1");
		CardbusinessAggregatepayB2cOnlineRsignV1Biz bizContent = new CardbusinessAggregatepayB2cOnlineRsignV1Biz();
		...
		bizContent.setContractid("xxx");

		CardbusinessAggregatepayB2cOnlineRsignResponseV1 response;
		try {
