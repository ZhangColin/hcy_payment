...
import com.icbc.api.request.MybankCardbusinessShopSerWechatConfigQueryRequestV1;
import com.icbc.api.response.MybankCardbusinessShopSerWechatConfigQueryResponseV1;

public class MybankCardbusinessShopSerWechatConfigQueryTest {
    ...
    public static void main(String[] args) throws Exception{
	    ...
	    MybankCardbusinessShopSerWechatConfigQueryRequestV1 request = new MybankCardbusinessShopSerWechatConfigQueryRequestV1();

        request.setServiceUrl("http://IP:PORT/api/mybank/cardbusiness/shop/wechatconfigQuery/V1");
	    MybankCardbusinessShopSerWechatConfigQueryRequestV1.MybankCardbusinessShopSerWechatConfigQueryRequestV1Biz bizRes =
			    new MybankCardbusinessShopSerWechatConfigQueryRequestV1.MybankCardbusinessShopSerWechatConfigQueryRequestV1Biz();

	    bizRes.setAppserino("1234567890");
		bizRes.setTrxtime("2023-05-29 09:25:36");
	    bizRes.setSerid("020000001295");
		bizRes.setIcbc_id("020008990127");

        request.setBizContent( bizRes);
	    MybankCardbusinessShopSerWechatConfigQueryResponseV1 response = new MybankCardbusinessShopSerWechatConfigQueryResponseV1();
        try{
