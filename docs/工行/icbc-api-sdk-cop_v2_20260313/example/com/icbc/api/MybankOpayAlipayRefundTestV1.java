...
import com.icbc.api.request.MybankOpayAlipayRefundRequestV1;
import com.icbc.api.request.MybankOpayAlipayRefundRequestV1.MybankOpayAlipayRefundRequestV1Biz;
import com.icbc.api.response.MybankOpayAlipayRefundResponseV1;

public class MybankOpayAlipayRefundTestV1 {
	    ...
	    static Logger log = Logger.getLogger(MybankOpayAlipayRefundTestV1.class.getName());
		...
		public static void main(String[] args) {
			...
			MybankOpayAlipayRefundTestV1 request = new MybankOpayAlipayRefundTestV1();
			
			//访问工行API平台URL
			request.setServiceUrl(API_SERVICE_URL + "/mybank/opay/alipay/refund/V1);

			MybankOpayAlipayRefundRequestV1Biz bizContent = new MybankOpayAlipayRefundRequestV1Biz();

			bizContent.setAcquirerId("1022188000000000000");
			bizContent.setPspId("1022172000000000000");
			bizContent.setPaymentRequestId("201811291907410100070000000000");
			bizContent.setPaymentId("201811291907410100070000000000");
			bizContent.setRefundRequestId("201811291907410200070000000000");
			bizContent.setRefundAmount(null);
			bizContent.setRefundFromAmount(null);
			bizContent.setRefundQuote(null);
			bizContent.setRefundPromoInfo(null);
			bizContent.setSurchargeInfo(null);
			bizContent.setRefundReason("Customer requested refund");

			request.setBizContent(bizContent);

			MybankOpayAlipayRefundResponseV1 response;
