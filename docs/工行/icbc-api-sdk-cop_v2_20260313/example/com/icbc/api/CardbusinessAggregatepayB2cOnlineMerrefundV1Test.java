...
public class CardbusinessAggregatepayB2cOnlineMerrefundV1Test {
	// 1、网关公钥
	...
	private Logger logger = Logger.getLogger(CardbusinessAggregatepayB2cOnlineMerrefundV1Test.class.getName());
	...
	public void test_cop() throws IcbcApiException {
		...
		request.setServiceUrl("http://ip:port/api/cardbusiness/aggregatepay/b2c/online/merrefund/V1");
		CardbusinessAggregatepayB2cOnlineMerrefundRequestV1Biz bizContent = new CardbusinessAggregatepayB2cOnlineMerrefundRequestV1Biz();
		request.setBizContent(bizContent);
		// 6、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值


		bizContent.setOrder_id("xxx");//消费工行订单号
		bizContent.setMer_id("xxx");//商户编号
		bizContent.setOut_trade_no("xxx");//商户订单号
		bizContent.setOuttrx_serial_no("xxx");//外部退货流水号
		bizContent.setRet_total_amt("xxx");//退货总金额
		bizContent.setTrnsc_ccy("xxx");//交易币种
		bizContent.setOrder_apd_inf("xxx");
		bizContent.setIcbc_appid("xxx");
		bizContent.setMer_acct("xxx");
		bizContent.setMer_prtcl_no("xxx");//协议编号
