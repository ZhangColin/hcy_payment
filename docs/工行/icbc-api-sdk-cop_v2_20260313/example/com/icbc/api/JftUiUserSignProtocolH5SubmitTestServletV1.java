...
import com.icbc.api.request.JftUiUserSignProtocolH5SubmitRequestV1;
import com.icbc.api.request.JftUiUserSignProtocolH5SubmitRequestV1.JftUiUserSignProtocolH5SubmitRequestV1Biz;
...
public class JftUiUserSignProtocolH5SubmitTestServletV1 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            // 通过工行 SDK 调用《聚富通免密支付协议签订页面接口V1》页面接口
            UiIcbcClient client = new UiIcbcClient(APP_ID, IcbcConstants.SIGN_TYPE_RSA2, MY_PRIVATE_KEY, IcbcConstants.CHARSET_UTF8);
            JftUiUserSignProtocolH5SubmitRequestV1 request = new JftUiUserSignProtocolH5SubmitRequestV1();
            // 指定《聚富通免密支付协议签订页面接口V1》URL
            request.setServiceUrl("https://ip:port/ui/jft/ui/user/signprotocolH5/submit/V1");

            /**
             * 组装调用页面接口上送报文。接口各请求参数说明详见接口文档
             */
            JftUiUserSignProtocolH5SubmitRequestV1Biz bizContent = new JftUiUserSignProtocolH5SubmitRequestV1Biz();
            bizContent.setAppId(APP_ID);
            bizContent.setOutUserId("M201801112326");
            bizContent.setSerialNo("LSHNO00001");
