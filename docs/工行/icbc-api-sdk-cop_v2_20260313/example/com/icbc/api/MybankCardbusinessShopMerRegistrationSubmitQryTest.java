...
import com.icbc.api.request.MybankCardbusinessShopMerRegistrationSubmitQryRequestV1;
import com.icbc.api.response.MybankCardbusinessShopMerRegistrationSubmitQryResponseV1;

public class MybankCardbusinessShopMerRegistrationSubmitQryTest {
    ...
    public static void main(String[] args) {
        ...
        MybankCardbusinessShopMerRegistrationSubmitQryRequestV1 request = new MybankCardbusinessShopMerRegistrationSubmitQryRequestV1();

        request.setServiceUrl("http://ip:port:16257/api/mybank/cardbusiness/shop/MerRegistrationSubmitQry/V1");
        MybankCardbusinessShopMerRegistrationSubmitQryRequestV1.mybankCardbusinessShopMerRegistrationSubmitQryRequestV1Biz bizRes = new MybankCardbusinessShopMerRegistrationSubmitQryRequestV1.mybankCardbusinessShopMerRegistrationSubmitQryRequestV1Biz();


        bizRes.setShopcode("1234123");
        bizRes.setSn_id("123");
        bizRes.setPrti_id("1234123");

        request.setBizContent(bizRes);

        MybankCardbusinessShopMerRegistrationSubmitQryResponseV1 response;
