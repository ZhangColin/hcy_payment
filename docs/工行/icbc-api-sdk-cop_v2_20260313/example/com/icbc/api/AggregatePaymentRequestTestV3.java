...
public class AggregatePaymentRequestTestV3 {
	//1、网关公钥
	...
	public static void main(String[] args) throws Exception {
		...
		AggregatePaymentRequestV3 request = new AggregatePaymentRequestV3();
		
		//4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("https://ip:port:8080/ui/aggregate/payment/request/V3");
		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		AggregatePaymentRequestV3Biz bizContent = new AggregatePaymentRequestV3Biz();
		...
		bizContent.setTpAppId("");
		bizContent.setTpOpenId("");
		bizContent.setBackup4("");
