 ...
 */
public class B2cOrderQrySearchTest {
	...
	public static void main(String[] args) throws Exception {
		...
		bizContent.setMerid("0200EC20001119");//查询线上支付订单则必输
		bizContent.setO2oMerid("02000002040095");//查询线下支付订单则必输
		bizContent.setOrderid("201003081416290");//该字段必输项,为查询的订单号
