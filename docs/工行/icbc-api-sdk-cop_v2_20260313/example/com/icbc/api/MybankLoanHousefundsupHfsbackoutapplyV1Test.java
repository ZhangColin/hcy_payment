...
import com.icbc.api.request.MybankLoanHousefundsupHfsbackoutapplyRequestV1;
import com.icbc.api.request.MybankLoanHousefundsupHfsbackoutapplyRequestV1.MybankLoanHousefundsupHfsbackoutapplyRequestV1Biz;
import com.icbc.api.response.MybankLoanHousefundsupHfsbackoutapplyResponseV1;

public class MybankLoanHousefundsupHfsbackoutapplyV1Test {
    static Logger log = Logger.getLogger(MybankLoanHousefundsupHfsbackoutapplyV1Test.class.getName());
    //估值表
    protected static String APP_ID = "1000"+"000000"+"00002"+"89005";
    ...
    public static void main(String[] args) throws Exception {
       ...
       // DefaultIcbcClient client = new DefaultIcbcClient(APP_ID, "RSA2",PRI_KEY, APIGW_PUBLIC_KEY);
        ...
        try {
            ...
            // 请求实体
        	MybankLoanHousefundsupHfsbackoutapplyRequestV1 request = new MybankLoanHousefundsupHfsbackoutapplyRequestV1();
            // bizContent实体
        	MybankLoanHousefundsupHfsbackoutapplyRequestV1Biz bizContent  = new MybankLoanHousefundsupHfsbackoutapplyRequestV1Biz();

    		bizContent.setSerialNo("xxxxxxxxxx");
        	bizContent.setAppNo("AppNo");  
        	bizContent.setVer("2.0");
        	bizContent.setLanguage("zh_CN");
        	bizContent.setAreaCode("002000072");
        	bizContent.setEmployeeCode("888800135");
        	bizContent.setTransNo("123456");
        	bizContent.setTurnPageFlag("");
        	bizContent.setBeginRow("");
        	bizContent.setRowCount("");
            bizContent.setNotify_url("http://baidu.com");
            bizContent.setCooperSerial("31245666");
            bizContent.setCooperCode("666666");
            bizContent.setAlterReason("测试类");
            bizContent.setCnlType("405");
            bizContent.setOrderNo("11111111");
            bizContent.setBankNo("325555");
            bizContent.setCooperPK("123456");
            
            //bizContent.setParam(param);                                                        
            //request.setServiceUrl(BASE_URL  + URI);           
            String url = "http"+"://8"+"3.33"+".222."+"62:80"+"81/api/mybank/loan/h"+"ousefundsup/hfsbackoutapply/V1"; 
            request.setServiceUrl(url);
            request.setBizContent(bizContent);
            MybankLoanHousefundsupHfsbackoutapplyResponseV1 response = client.execute(request);
