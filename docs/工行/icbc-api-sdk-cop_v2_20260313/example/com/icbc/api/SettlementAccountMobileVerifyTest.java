...
import com.icbc.api.request.SettlementAccountMobileVerifyRequestV1;
import com.icbc.api.request.SettlementAccountMobileVerifyRequestV1.SettlementAccountMobileVerifyRequestV1Biz;
import com.icbc.api.response.SettlementAccountMobileVerifyResponseV1;



public class SettlementAccountMobileVerifyTest {
	...
	public void test_cop() throws IcbcApiException {
		...
		SettlementAccountMobileVerifyRequestV1 request = new SettlementAccountMobileVerifyRequestV1();
		SettlementAccountMobileVerifyRequestV1Biz bizContent = new SettlementAccountMobileVerifyRequestV1Biz();
		request.setServiceUrl("http://ip:port/api/settlement/account/mobile/identify/V1");
		bizContent.setCorpNo("");
		bizContent.setTrxAccDate("");
		bizContent.setTrxAccTime("");
		bizContent.setCorpDate("");
		bizContent.setCorpSerno("");
		bizContent.setOutServiceCode("");
		bizContent.setCorpMediumId("");
		bizContent.setSecretKey("");
		bizContent.setMediumId("");
		...
		SettlementAccountMobileVerifyResponseV1  response = client.execute(request, "msgId");
