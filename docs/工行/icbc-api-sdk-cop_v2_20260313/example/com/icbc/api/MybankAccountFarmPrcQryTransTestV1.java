...
import com.icbc.api.request.MybankAccountFarmPrcQryTransRequestV1;
import com.icbc.api.response.MybankAccountFarmPrcQryTransResponseV1;

public class MybankAccountFarmPrcQryTransTestV1 {
...
protected static String APP_ID = "10000000000004096993";
	...
	public static void main(String[] args) throws Exception {
		String URI = "mybank/account/farm/prcQryTrans/V1";

		
		DefaultIcbcClient client = new DefaultIcbcClient(APP_ID,"RSA2", PRI_KEY, APIGW_PUBLIC_KEY);
		try {
			MybankAccountFarmPrcQryTransRequestV1 request = new MybankAccountFarmPrcQryTransRequestV1();
			MybankAccountFarmPrcQryTransRequestV1.MybankAccountFarmPrcQryTransRequestBizV1 requestBizV1 = new MybankAccountFarmPrcQryTransRequestV1.MybankAccountFarmPrcQryTransRequestBizV1();
			...
			requestBizV1.setDetail("{\"propertyId\":\"2024030200010403\",\"projectId\":\"YJYproductId555\",\"pageNum\":\"1\",\"pageSize\":\"10\"}");
	        ...
	        MybankAccountFarmPrcQryTransResponseV1 response = client.execute(request);
