...
import com.icbc.api.request.InvestmentDepositDpaccqryRequestV1;
import com.icbc.api.response.InvestmentDepositDpaccqryResponseV1;
...
public class InvestmentDepositDpaccqryTestV1 {
    ...
    public void test_cop() throws IcbcApiException {
        ...
        InvestmentDepositDpaccqryRequestV1 request = new InvestmentDepositDpaccqryRequestV1();
        request.setServiceUrl(Const.URL_PREFIX + "/investment/deposit/dpaccqry/V1");
        InvestmentDepositDpaccqryRequestV1.InvestmentDepositDpaccqryRequestV1Biz bizContent =
                new InvestmentDepositDpaccqryRequestV1.InvestmentDepositDpaccqryRequestV1Biz();
        ...
        bizContent.setWorktime("15:40:22");
        // PMD检查
        bizContent.setCoopercode("1000000000000" +
                "4094655");
        bizContent.setCardno("622202" +
                "0200008791614");
        bizContent.setAccno("");
        bizContent.setCardkind("11");


        request.setBizContent(bizContent);
        InvestmentDepositDpaccqryResponseV1 response;
        try {
