...
import com.icbc.api.request.CertCupcardCupcardauthRequestV1;
import com.icbc.api.request.CertCupcardCupcardauthRequestV1.CupCrdAuthenticateRequestV1Biz;
 ...
 */
public class CertCupcardCupcardauthV1Test {
	   ...
	   //1、网关公钥
		...
		CertCupcardCupcardauthRequestV1 request = new CertCupcardCupcardauthRequestV1();
		
		//4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("http://ip:port/api/cert/cupcard/cupcardauth/V1");
		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		CupCrdAuthenticateRequestV1Biz bizContent = new CupCrdAuthenticateRequestV1Biz();
		
		bizContent.setCardNo("0200000000201");
		bizContent.setLgldocTp(1);
		bizContent.setIdCode("440105201809094567");
		bizContent.setAccName("chenglp");
		bizContent.setMerNo("1234567890123");
		bizContent.setMobilePhone("");
		bizContent.setRelatedBusinessType(10);
		bizContent.setRealNameAuthenticateFg(1);
		bizContent.setAuthProtocolVersion("1.0");
		bizContent.setAuthProtocolNo("123456789");
		
		request.setBizContent(bizContent);
		CertCupcardCupcardauthResponseV1 response;
		try {
