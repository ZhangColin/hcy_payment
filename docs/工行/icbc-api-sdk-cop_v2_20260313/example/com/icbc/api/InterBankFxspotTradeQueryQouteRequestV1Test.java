...
import com.icbc.api.request.InterBankFxspotTradeQueryQouteRequestV1;
import com.icbc.api.request.InterBankFxspotTradeQueryQouteRequestV1.InterBankFxspotTradeQueryQouteRequestBiz;
import com.icbc.api.response.InterBankFxspotTradeQueryQouteResponseV1;

public class InterBankFxspotTradeQueryQouteRequestV1Test {
	public static void main(String[] args) {
        ...
        //5、设置请求对象
        InterBankFxspotTradeQueryQouteRequestV1 request = new InterBankFxspotTradeQueryQouteRequestV1();

        //6、设置请求路径；联测时，请联系我行告知并替换成测试环境地址。
        request.setServiceUrl("https://ip:port/api/interbank/fxspot/trade/queryDetial/V1");
        //7、设置业务参数
        InterBankFxspotTradeQueryQouteRequestBiz bizContent = new InterBankFxspotTradeQueryQouteRequestBiz();
        bizContent.setAmount("60000");
        bizContent.setProductId("243");
        bizContent.setTenor("0");
        bizContent.setCurrPair("AUD.USD");
        bizContent.setReqId("");
        bizContent.setCino("010190000000111");
        bizContent.setDealCurr("USD");
        request.setBizContent(bizContent);

        InterBankFxspotTradeQueryQouteResponseV1 response;
        try {
