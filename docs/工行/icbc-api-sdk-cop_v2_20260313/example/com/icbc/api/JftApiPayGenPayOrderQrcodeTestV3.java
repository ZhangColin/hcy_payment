...
import com.icbc.api.request.JftApiPayGenPayOrderQrcodeRequestV3.JftApiPayGenPayOrderQrcodeRequestV3Biz;
import com.icbc.api.request.JftApiPayGenPayOrderQrcodeRequestV3.SubOrderInfo;
import com.icbc.api.response.JftApiPayGenPayOrderQrcodeResponseV3;

public class JftApiPayGenPayOrderQrcodeTestV3 {
    ...
    public static void main(String[] args) {
        ...
        JftApiPayGenPayOrderQrcodeRequestV3 request = new JftApiPayGenPayOrderQrcodeRequestV3();
        request.setServiceUrl("http://ip:port/api/jft/api/pay/gen/pay/order/qrcode/V3");
        JftApiPayGenPayOrderQrcodeRequestV3Biz bizContent = new JftApiPayGenPayOrderQrcodeRequestV3Biz();
        ...
        bizContent.setCustCerType("0");//证件类型
        bizContent.setCustCertNo("11XXXXXXXXXXXXXXX");//证件号
        //子订单信息
        ...
        JftApiPayGenPayOrderQrcodeRequestV3.TerminalInfo terminalInfo=new JftApiPayGenPayOrderQrcodeRequestV3.TerminalInfo();
        ...
        JftApiPayGenPayOrderQrcodeResponseV3 response;
        try {
