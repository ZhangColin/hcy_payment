...
import com.icbc.api.request.BondSubscriptionInformationBondaddRequestV1;
import com.icbc.api.request.BondSubscriptionInformationBondaddRequestV1.BondSubscriptionInformationBondaddRequestV1Biz;
import com.icbc.api.response.BondSubscriptionInformationBondaddResponseV1;

public class BondSubscriptionInformationBondaddV1Test {
	//appid
	...
	public void testCop() throws IcbcApiException {
		...
		BondSubscriptionInformationBondaddRequestV1 request = new BondSubscriptionInformationBondaddRequestV1();
		
		//根据测试环境和生产环境替换相应ip和端口
        request.setServiceUrl("https://ip:port/api/bond/subscription/information/bondadd/V1");

        BondSubscriptionInformationBondaddRequestV1Biz bizContent = new BondSubscriptionInformationBondaddRequestV1Biz();
        ...
        BondSubscriptionInformationBondaddResponseV1 response;
		try {
