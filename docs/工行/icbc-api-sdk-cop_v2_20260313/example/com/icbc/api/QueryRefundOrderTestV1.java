...
import com.icbc.api.request.QueryRefundOrderRequestV1;
import com.icbc.api.request.QueryRefundOrderRequestV1.QueryRefundOrderRequestV1Biz;
import com.icbc.api.response.QueryRefundOrderResponseV1;

public class QueryRefundOrderTestV1 {
	...
	public static void main(String[] args) {
		...
		QueryRefundOrderRequestV1 request = new QueryRefundOrderRequestV1();
		request.setServiceUrl("http://ip:port/api/jft/api/pay/query/refund/order/V1");
		
		QueryRefundOrderRequestV1Biz bizContent = new QueryRefundOrderRequestV1Biz();
		bizContent.setAppId("10000000000000004434");//平台商户标识
		bizContent.setOutVendorId("10000000000000003923");//子商户标识
		bizContent.setOutOrderId("201804041003");//原平台订单ID
		bizContent.setOutRefundId("201804044013");//平台退款单ID
		
		request.setBizContent(bizContent);
		
		QueryRefundOrderResponseV1 response;
		try {
