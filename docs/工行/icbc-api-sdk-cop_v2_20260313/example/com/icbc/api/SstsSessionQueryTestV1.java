...
import com.icbc.api.request.SstsSessionQueryRequestV1;
import com.icbc.api.response.SstsSessionQueryResponseV1;
import org.junit.Test;

import java.util.HashMap;

public class SstsSessionQueryTestV1 {
	...
	public void test_cop() throws IcbcApiException {
		...
		SstsSessionQueryRequestV1 request = new SstsSessionQueryRequestV1();
		request.setServiceUrl("http://ip:port/api/sge/daily/statement/V1");

		SstsSessionQueryRequestV1.SstsSessionQueryRequestV1Biz bizContent = new SstsSessionQueryRequestV1.SstsSessionQueryRequestV1Biz();
		bizContent.setBaseinfo(new HashMap<>());
		bizContent.setChanCommV10(new HashMap<>());
		bizContent.setInfoCommV10(new HashMap<>());
		request.setBizContent(bizContent);

		SstsSessionQueryResponseV1 response = client.execute(request);
