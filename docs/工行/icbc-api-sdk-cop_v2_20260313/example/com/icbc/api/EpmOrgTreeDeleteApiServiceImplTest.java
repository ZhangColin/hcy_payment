...
import com.icbc.api.request.EpmOrgTreeDeleteRequestV1;
import com.icbc.api.response.EpmOrgTreeDeleteResponseV1;

public class EpmOrgTreeDeleteApiServiceImplTest extends HttpServlet {
	...
	public static void main(String[] args) {
		...
		EpmOrgTreeDeleteRequestV1 request = new EpmOrgTreeDeleteRequestV1();		
		request.setServiceUrl("http://ip:port/api/epm/org/tree/delete/V1");
		EpmOrgTreeDeleteRequestV1.EpmOrgTreeDeleteRequestV1Biz bizContent = new EpmOrgTreeDeleteRequestV1.EpmOrgTreeDeleteRequestV1Biz();
		request.setBizContent(bizContent);
		bizContent.setProtocolNo("PT20181213100000108002");
		bizContent.setOrgId("100150");

		EpmOrgTreeDeleteResponseV1 response;
		try {
