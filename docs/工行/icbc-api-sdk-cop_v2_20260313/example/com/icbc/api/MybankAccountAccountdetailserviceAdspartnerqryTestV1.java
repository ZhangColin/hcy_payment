...
import com.icbc.api.request.MybankAccountAccountdetailserviceAdspartnerqryRequestV1;
import com.icbc.api.response.MybankAccountAccountdetailserviceAdspartnerqryResponseV1;

public class MybankAccountAccountdetailserviceAdspartnerqryTestV1 {
    public static void main(String[] args) {
        ...
        //5、设置请求对象
        MybankAccountAccountdetailserviceAdspartnerqryRequestV1 request = new MybankAccountAccountdetailserviceAdspartnerqryRequestV1();
        //6、设置请求路径；联测时，请联系我行告知并替换成测试环境地址。
        request.setServiceUrl("http://ip:port/com.icbc.api/mybank/account/accountdetailservice/adspartnerqry/V1");
        //7、设置业务参数
        MybankAccountAccountdetailserviceAdspartnerqryRequestV1.AccountdetailserviceAdspartnerqryRequestV1Biz bizContent = new MybankAccountAccountdetailserviceAdspartnerqryRequestV1.AccountdetailserviceAdspartnerqryRequestV1Biz();
        //8、组装请求参数
        bizContent.setStartindex("1");
        bizContent.setQrysize("5");
        bizContent.setCorpno("23456");
        bizContent.setAcccompno("");
        bizContent.setAcccompname("测试");

        request.setBizContent(bizContent);
        MybankAccountAccountdetailserviceAdspartnerqryResponseV1 response;
        try {
