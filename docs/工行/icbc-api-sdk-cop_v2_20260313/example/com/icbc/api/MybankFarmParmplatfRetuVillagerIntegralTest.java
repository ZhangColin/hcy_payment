 ...
 */
public class MybankFarmParmplatfRetuVillagerIntegralTest {
    ...
    public static void main(String[] args) throws Exception {
		String URI = "/mybank/farm/farmplatf/retuVillagerIntegral/V1";
		...
		try {
			...
			bizContent.setfSeqNo("testaaaa4");
			bizContent.setOriFSeqNo("testaaaa");
			bizContent.setIntegralValue("1");
			bizContent.setMobilePhone("13533334349");
