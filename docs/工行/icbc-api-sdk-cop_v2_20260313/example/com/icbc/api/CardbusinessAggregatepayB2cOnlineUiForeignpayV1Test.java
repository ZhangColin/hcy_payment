...
import com.icbc.api.request.CardbusinessAggregatepayB2cOnlineUiForeignpayRequestV1.CardbusinessAggregatepayB2cOnlineUiForeignpayRequestV1Biz;
import com.icbc.api.request.CardbusinessAggregatepayB2cOnlineUiForeignpayRequestV1;

public class CardbusinessAggregatepayB2cOnlineUiForeignpayV1Test {
	// 1、网关公钥
	...
	private Logger logger = Logger.getLogger(CardbusinessAggregatepayB2cOnlineUiForeignpayV1Test.class.getName());
	

	public void test_cop() throws IcbcApiException, UnsupportedEncodingException {
		
		UiIcbcClient client = null;
		CardbusinessAggregatepayB2cOnlineUiForeignpayRequestV1 request = new CardbusinessAggregatepayB2cOnlineUiForeignpayRequestV1();
		...
		request.setServiceUrl("https://ip:port/ui/cardbusiness/aggregatepay/b2c/online/ui/foreignpay/V1");
		CardbusinessAggregatepayB2cOnlineUiForeignpayRequestV1Biz bizContent = new CardbusinessAggregatepayB2cOnlineUiForeignpayRequestV1Biz();
		request.setBizContent(bizContent);
		//6、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		bizContent.setClient_type("xxx");
