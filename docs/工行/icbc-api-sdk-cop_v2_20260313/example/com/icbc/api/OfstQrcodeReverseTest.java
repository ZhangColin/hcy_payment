...
import com.icbc.api.request.OfstQrcodeReverseRequestV1;
import com.icbc.api.request.OfstQrcodeReverseRequestV1.OfstQrcodeReverseRequestV1Biz;
import com.icbc.api.response.OfstQrcodeReverseResponseV1;
 ...
 */
public class OfstQrcodeReverseTest extends JFrame {
	...
	public static void main(String[] args) throws Exception {
		...
		OfstQrcodeReverseRequestV1 request = new OfstQrcodeReverseRequestV1();
		
		//4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("https://ip:port/api/ofst/qrcode/V1/reverse");

		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		OfstQrcodeReverseRequestV1Biz bizContent = new OfstQrcodeReverseRequestV1Biz();
		...
		OfstQrcodeReverseResponseV1 response;
		try {
