...
import com.icbc.api.request.MybankAccountAccountdetailserviceAdsbatchaccdtlqryRequestV1;
import com.icbc.api.response.MybankAccountAccountdetailserviceAdsbatchaccdtlqryResponseV1;

public class MybankAccountAccountdetailserviceAdsbatchaccdtlqryTestV1 {
    public static void main(String[] args) {
        ...
        MybankAccountAccountdetailserviceAdsbatchaccdtlqryRequestV1 request = new MybankAccountAccountdetailserviceAdsbatchaccdtlqryRequestV1();
        request.setServiceUrl("http://ip:port/com.icbc.api/mybank/account/accountdetailservice/adsbatchaccdtlqry/V1");

        MybankAccountAccountdetailserviceAdsbatchaccdtlqryRequestV1.MybankAccountAccountdetailserviceadsbatchaccdtlqryRequestV1Biz bizContent=
                new MybankAccountAccountdetailserviceAdsbatchaccdtlqryRequestV1.MybankAccountAccountdetailserviceadsbatchaccdtlqryRequestV1Biz();

        bizContent.setFseqno("2333311");
        bizContent.setAgreeno("2333311");
        bizContent.setAccount("2333311");
        bizContent.setCurrtype("001");
        bizContent.setCorpno("2333311");
        bizContent.setAcccompno("2333311");
        bizContent.setStartdate("2021-05-01");
        bizContent.setEnddate("2021-05-03");

        request.setBizContent(bizContent);

        MybankAccountAccountdetailserviceAdsbatchaccdtlqryResponseV1 response ;
        try {
