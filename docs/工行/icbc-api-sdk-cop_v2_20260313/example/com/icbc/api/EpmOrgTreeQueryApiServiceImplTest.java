...
import com.icbc.api.request.EpmOrgTreeQueryRequestV1;
import com.icbc.api.response.EpmOrgTreeQueryResponseV1;

public class EpmOrgTreeQueryApiServiceImplTest extends HttpServlet {
	...
	public static void main(String[] args) {
		...
		EpmOrgTreeQueryRequestV1 request = new EpmOrgTreeQueryRequestV1();		
		request.setServiceUrl("http://ip:port/api/epm/org/tree/query/V1");
		EpmOrgTreeQueryRequestV1.EpmOrgTreeQueryRequestV1Biz bizContent = new EpmOrgTreeQueryRequestV1.EpmOrgTreeQueryRequestV1Biz();
		request.setBizContent(bizContent);
		bizContent.setProtocolNo("PT20181213100000108002");
		bizContent.setOrgId("100152");

		EpmOrgTreeQueryResponseV1 response;
		try {
