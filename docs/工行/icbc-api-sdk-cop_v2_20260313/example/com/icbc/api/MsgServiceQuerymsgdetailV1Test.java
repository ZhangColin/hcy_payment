 ...
 * @date 2022/7/5
 */
public class MsgServiceQuerymsgdetailV1Test {

    private static final Logger LOG = Logger.getLogger(MsgServiceQuerymsgdetailV1Test.class.getName());
    ...
    public static void main(String[] args) throws Exception {
        ...
        invoker.setUri("/msg/service/querymsgdetail/V1");
