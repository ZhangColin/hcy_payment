...
import com.icbc.api.request.Queryca29121RequestV1;
import com.icbc.api.request.Queryca29121RequestV1.Queryca29121RequestV1Biz;
import com.icbc.api.request.Queryca29121RequestV1.Queryca29121RequestV1Pub;
import com.icbc.api.request.Queryca29121RequestV1.Queryca29121RequestV1In;
import com.icbc.api.response.Queryca29121ResponseV1;
import com.icbc.api.response.Queryca29121ResponseV1.Queryca29121ResponseV1Pub;
import com.icbc.api.response.Queryca29121ResponseV1.Queryca29121ResponseV1Out;
import com.icbc.api.response.Queryca29121ResponseV1.Queryca29121ResponseV1Detail;
import com.icbc.api.response.Queryca29121ResponseV1.Queryca29121ResponseV1Total;

public class Queryca29121Test {
	...
	public void test_CA() throws IcbcApiException {
		...
		Queryca29121RequestV1 request = new Queryca29121RequestV1();
		request.setServiceUrl("http://ip:port/api/queryca29121/query/V1");

		Queryca29121RequestV1Biz bizContent = new Queryca29121RequestV1Biz();
		
		Queryca29121RequestV1Pub pub = new Queryca29121RequestV1Pub();
		pub.setCode("29121");
		pub.setZone("0200");
		pub.setFr("0");
		pub.setDt("2018-12-26");
		
		Queryca29121RequestV1In in = new Queryca29121RequestV1In();
		in.setLineflag("2");
		in.setTydwno("123412413131000");
		in.setDateb("2017-07-06");
		in.setDatee("2017-07-06");
		in.setQuerytype("1");
		in.setTrxtype("1");
		in.setTotaltype("1");
		in.setQuerycount("50000");
		in.setPage("1");
		in.setSeqno("");
		in.setSadlindate("");
		...
		Queryca29121ResponseV1 response = client.execute(request, "msgId");

		if (response.isSuccess()) {
			// 接收成功
			Queryca29121ResponseV1Pub RetPub = response.getPub();
			Queryca29121ResponseV1Out RetOut = response.getOut();
			if(RetOut.getResult().equals("00000000")){
				//查询成功 获取返回结果
				List<Queryca29121ResponseV1Detail> resultList = RetOut.getDetail();
				//获取结果集中字段
				for(Queryca29121ResponseV1Detail detail:resultList){
					//获取信息.....
					detail.getPOSNO();
				}
			} else {
