...
import com.icbc.api.request.MybankLoanInclufinChainloanLoandetailqueryRequestV3;
import com.icbc.api.request.MybankLoanInclufinChainloanLoandetailqueryRequestV3Biz;
import com.icbc.api.response.MybankLoanInclufinChainloanLoandetailqueryResponseV3;

public class MybankLoanInclufinChainloanLoandetailqueryTestV3 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String url = "http://*.*.*.*:****/api/mybank/loan/inclufin/chainloan/loandetailquery/V3";

			DefaultIcbcClient client = new DefaultIcbcClient(appId, privateKey, apigwPublicKey);
			MybankLoanInclufinChainloanLoandetailqueryRequestV3 request = new MybankLoanInclufinChainloanLoandetailqueryRequestV3();
			request.setServiceUrl(url);
			MybankLoanInclufinChainloanLoandetailqueryRequestV3Biz bizContent = new MybankLoanInclufinChainloanLoandetailqueryRequestV3Biz();
			...
			bizContent.setTransNo("ISupChnCommLoanCocoaService");
			bizContent.setVer("3.0");
			...
			MybankLoanInclufinChainloanLoandetailqueryResponseV3 response;
