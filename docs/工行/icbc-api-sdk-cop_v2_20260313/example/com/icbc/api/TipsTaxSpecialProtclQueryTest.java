...
import com.icbc.api.request.TipsTaxSpecialProtclQueryRequestV1;
 ...
 */
public class TipsTaxSpecialProtclQueryTest {

	//1、网关公钥
	protected static final String APIGW_PUBLIC_KEY = "-----请使用正确的网关公钥-----D4kzEVPdOj03ctKM7KV+16bWZ5BMNgvEeuEQwfQYkRVwI9HFOGkwNTMn5hiJXHnlXYCX+zp5r6R52MY0O7BsTCLT7aHaxsANsvI9ABGx3OaTVlPB59M6GPbJh0uXvio0m1r/lTW3Z60RU6Q3oid/rNhP3CiNgg0W6O3AGqwIDAQAB";

	//2、appid
	//protected static final String APP_ID = "11100000000000001868";
	...
	//4、服务url
	protected static final String URL = "http://ip:port/api/mybank_pay/tipstax/specialprotclquery/V1";
	// 加密类型和秘钥
...
//				APIGW_PUBLIC_KEY);
		...
		TipsTaxSpecialProtclQueryRequestV1 request= new TipsTaxSpecialProtclQueryRequestV1();
		// 4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl(URL);
		// 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		TipsTaxSpecialProtclQueryRequestV1.TipsTaxSpecialProtclQueryRequestV1Biz bizContent = new TipsTaxSpecialProtclQueryRequestV1.TipsTaxSpecialProtclQueryRequestV1Biz();
		TipsTaxSpecialProtclQueryRequestV1.TipsTaxSpecialProtclQueryRequestV1Biz.Msg msg=new TipsTaxSpecialProtclQueryRequestV1.TipsTaxSpecialProtclQueryRequestV1Biz.Msg();
		bizContent.setTrxCode("95411A");
		bizContent.setMsg(msg);
		msg.setZoneNo("00200");
		msg.setBrNo("00260");
		msg.setOperNo("00038");
		msg.setPayAcct("0200099809206006383");
		msg.setPayAcctName("");
		msg.setPageSeq("1");
		msg.setUnitPageNo("22");
		msg.setQueryType("1");
		request.setBizContent(bizContent);
		TipsTaxSpecialProtclQueryResponseV1 response;
		try {
