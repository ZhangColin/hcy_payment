...
import com.icbc.api.request.InvestmentDepositDpredpacketstatsqryRequestV1;
import com.icbc.api.response.InvestmentDepositDpredpacketstatsqryResponseV1;
...
public class InvestmentDepositDpredpacketstatsqryTestV1 {
    ...
    public void test_cop() throws IcbcApiException {
        ...
        InvestmentDepositDpredpacketstatsqryRequestV1 request = new InvestmentDepositDpredpacketstatsqryRequestV1();
        request.setServiceUrl(Const.URL_PREFIX + "/investment/deposit/dpredpacketstatsqry/V1");
        InvestmentDepositDpredpacketstatsqryRequestV1.InvestmentDepositDpredpacketstatsqryRequestV1Biz bizContent =
                new InvestmentDepositDpredpacketstatsqryRequestV1.InvestmentDepositDpredpacketstatsqryRequestV1Biz();
        ...
        // PMD检查
        bizContent.setMediumcardno("62322" +
                "90200000299519");
        bizContent.setOrderno("1");
        bizContent.setSuborderno("1");


        request.setBizContent(bizContent);
        InvestmentDepositDpredpacketstatsqryResponseV1 response;
        try {
