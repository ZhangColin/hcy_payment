...
import com.icbc.api.request.B2cPassfreePaymentSignRequestV1.B2cPassfreePaymentSignRequestV1Biz;
import com.icbc.api.response.B2cPassfreePaymentSignResponseV1;

public class B2cPassfreePaymentSignTest {
	public B2cPassfreePaymentSignTest() {
		super();
	}
	...
	protected void service(HttpServletRequest request,HttpServletResponse response)
		...
		B2cPassfreePaymentSignRequestV1 requestApi = new B2cPassfreePaymentSignRequestV1();
		B2cPassfreePaymentSignRequestV1Biz bizContent = new B2cPassfreePaymentSignRequestV1Biz();
		...
		B2cPassfreePaymentSignResponseV1 responseApi;
		
		
		try{
			responseApi = (B2cPassfreePaymentSignResponseV1) client.execute(requestApi, "msgId");//msgId消息通讯唯一编号，要求每次调用独立生成，APP级唯一
			out.write("<html>");
			out.write("<head>");
