...
import com.icbc.api.request.BcssMemberPayProducttimesQueryRequestV1.BcssMemProductTimesQueryRequesBizV1;
...
public class BcssMemProductTimesQueryTestV1 {
	
	private static final Log logger = LogFactory.getLog(BcssMemProductTimesQueryTestV1.class);
	// MY_PRIVATE_KEY
    ...
    public static void main(String[] args) throws Exception {
    	BcssMemProductTimesQueryTestV1 a = new BcssMemProductTimesQueryTestV1();
        a.test_cop();
    }
    ...
    public void test_cop() throws IcbcApiException {
        ...
        BcssMemProductTimesQueryRequesBizV1 bizContent = new BcssMemProductTimesQueryRequesBizV1();         
