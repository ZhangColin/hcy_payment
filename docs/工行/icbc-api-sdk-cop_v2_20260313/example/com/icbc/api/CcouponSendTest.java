...
import com.icbc.api.request.CcouponSendRequestV1;
import com.icbc.api.request.CcouponSendRequestV1.CcouponSendRequestV1Biz;
import com.icbc.api.response.CcouponSendResponseV1;

public class CcouponSendTest {
	// 1、网关公钥
	...
	public static void main(String[] args) throws Exception {
		...
		CcouponSendRequestV1 request = new CcouponSendRequestV1();
		// 4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("https://ip:port/api/eiop/ccoupon/send/V1");

		// 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		CcouponSendRequestV1Biz bizContent = new CcouponSendRequestV1Biz();
		...
		CcouponSendResponseV1 response;
		try {
