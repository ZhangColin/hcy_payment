...
import com.icbc.api.request.EnterpriseSalaryAnnuityEmployeeQryEmpAssetsRequestV1;
import com.icbc.api.response.EnterpriseSalaryAnnuityEmployeeQryEmpAssetsResponseV1;

public class EnterpriseSalaryAnnuityEmployeeQryEmpAssetsV1Test {
	...
	public void test_appsub() {
		...
		// 6、设置请求对象
		EnterpriseSalaryAnnuityEmployeeQryEmpAssetsRequestV1 request = new EnterpriseSalaryAnnuityEmployeeQryEmpAssetsRequestV1();
		// 7、设置请求路径；联测时，请联系我行告知并替换成测试环境地址。
		request.setServiceUrl("http://ip:port/api/personnel/elements/empid/query/V1");
		// 8、设置业务参数
		EnterpriseSalaryAnnuityEmployeeQryEmpAssetsRequestV1.EnterpriseSalaryAnnuityEmployeeQryEmpAssetsRequestV1Biz bizContent =
				new EnterpriseSalaryAnnuityEmployeeQryEmpAssetsRequestV1.EnterpriseSalaryAnnuityEmployeeQryEmpAssetsRequestV1Biz();

		EnterpriseSalaryAnnuityEmployeeQryEmpAssetsRequestV1.EnterpriseSalaryAnnuityEmployeeQryEmpAssetsRequestV1Biz.ChanCommV10 chanCommV10 = new EnterpriseSalaryAnnuityEmployeeQryEmpAssetsRequestV1.EnterpriseSalaryAnnuityEmployeeQryEmpAssetsRequestV1Biz.ChanCommV10();
		EnterpriseSalaryAnnuityEmployeeQryEmpAssetsRequestV1.EnterpriseSalaryAnnuityEmployeeQryEmpAssetsRequestV1Biz.InfoCommV10 infoCommV10 = new EnterpriseSalaryAnnuityEmployeeQryEmpAssetsRequestV1.EnterpriseSalaryAnnuityEmployeeQryEmpAssetsRequestV1Biz.InfoCommV10();
		// 9、组装请求参数
		...
		bizContent.setEmpId("0012345678");// 姓名

		request.setBizContent(bizContent);
		EnterpriseSalaryAnnuityEmployeeQryEmpAssetsResponseV1 response = null;
		try {
			response = client.execute(request);
		} catch (IcbcApiException e) {
			// 测试环境案例经常调不通 给个默认值
			response = new EnterpriseSalaryAnnuityEmployeeQryEmpAssetsResponseV1();
		} catch (Throwable e2) {
			e2.printStackTrace();
		}
