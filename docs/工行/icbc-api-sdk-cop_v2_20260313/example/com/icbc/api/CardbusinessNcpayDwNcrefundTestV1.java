...
import com.icbc.api.request.CardbusinessNcpayDwNcrefundRequestV1;
import com.icbc.api.response.CardbusinessNcpayDwNcrefundResponseV1;

public class CardbusinessNcpayDwNcrefundTestV1 {
	...
	public static void main(String[] args) throws IcbcApiException {
		...
		CardbusinessNcpayDwNcrefundRequestV1 request = new CardbusinessNcpayDwNcrefundRequestV1();
		// 是否使用AES加密请求数据
		...
		request.setServiceUrl("http://xxxxxxx/api/cardbusiness/ncpay/dwncrefund/V1");//功能
		//request.setServiceUrl("http://xxxxxxx/api/cardbusiness/ncpay/ncpay/V1");//功能外网

		// 5、请参照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		CardbusinessNcpayDwNcrefundRequestV1.CardbusinessNcpayNcpayRequestV1Biz bizContent = new CardbusinessNcpayDwNcrefundRequestV1.CardbusinessNcpayNcpayRequestV1Biz();
		bizContent.setTrx_serno("");
		bizContent.setTrx_date("");
		bizContent.setTrx_time("");
		...
		bizContent.setO_trx_amt("");
		bizContent.setRefund_desc("");
		bizContent.setBak1("");
		bizContent.setBak2("");
		request.setBizContent(bizContent);
		// msgId消息通讯唯一编号，要求每次调用独立生成，APP级唯一
		String msgId = String.valueOf(System.currentTimeMillis());
		CardbusinessNcpayDwNcrefundResponseV1 response = client.execute(request, msgId);
