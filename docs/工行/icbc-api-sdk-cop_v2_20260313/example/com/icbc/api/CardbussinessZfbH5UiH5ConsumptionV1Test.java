...
import com.icbc.api.request.CardbussinessZfbH5UiH5ConsumptionRequestV1.CardbussinessZfbH5UiH5ConsumptionRequestV1Biz;

public class CardbussinessZfbH5UiH5ConsumptionV1Test {
	// 1、网关公钥
	...
	private Logger logger = Logger.getLogger(CardbussinessZfbH5UiH5ConsumptionV1Test.class.getName());
	...
	public void test_cop() throws IcbcApiException, UnsupportedEncodingException {
		...
		request.setServiceUrl("https://ip:port/ui/cardbussiness/zfbh5/ui/h5consumption/V1");
