...
import com.icbc.api.request.EcouponSendRequestV1;
import com.icbc.api.request.EcouponSendRequestV1.EcouponSendRequestV1Biz;
import com.icbc.api.response.EcouponSendResponseV1;

public class EcouponSendTest {
	// 1、网关公钥
	...
	public static void main(String[] args) throws Exception {
		...
		EcouponSendRequestV1 request = new EcouponSendRequestV1();
		// 4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("https://ip:port/api/ecoupon/send/V1");

		// 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		EcouponSendRequestV1Biz bizContent = new EcouponSendRequestV1Biz();
		...
		EcouponSendResponseV1 response;
		try {
