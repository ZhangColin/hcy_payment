...
import com.icbc.api.request.CardbusinessEpaypcConsumptionRequestV2;
import com.icbc.api.request.CardbusinessEpaypcConsumptionRequestV2.CardbusinessEpaypcConsumptionRequestV2Biz;

public class CardbusinessEpaypcConsumptionV2Test {
	...
	// 3、appid
	protected static final String APP_ID = "xxxxxxxxxx";

	private Logger logger = Logger.getLogger(CardbusinessEpaypcConsumptionV2Test.class.getName());
	...
	public void test_cop() throws IcbcApiException {
		...
		CardbusinessEpaypcConsumptionRequestV2 request = new CardbusinessEpaypcConsumptionRequestV2();
		// 5、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("https://ip:port/ui/cardbusiness/epaypc/consumption/V2");
		CardbusinessEpaypcConsumptionRequestV2Biz bizContent = new CardbusinessEpaypcConsumptionRequestV2Biz();
		...
		bizContent.setOrder_submit_act_input(new JSONArray());
		try {
