...
import com.icbc.api.request.Queryca29129RequestV1;
import com.icbc.api.request.Queryca29129RequestV1.Queryca29129RequestV1Biz;
import com.icbc.api.request.Queryca29129RequestV1.Queryca29129RequestV1Pub;
import com.icbc.api.request.Queryca29129RequestV1.Queryca29129RequestV1In;
import com.icbc.api.response.Queryca29129ResponseV1;
import com.icbc.api.response.Queryca29129ResponseV1.Queryca29129ResponseV1Pub;
import com.icbc.api.response.Queryca29129ResponseV1.Queryca29129ResponseV1Out;
import com.icbc.api.response.Queryca29129ResponseV1.Queryca29129ResponseV1Detail;
import com.icbc.api.response.Queryca29129ResponseV1.Queryca29129ResponseV1Total;

public class Queryca29129Test {
	...
	public void test_CA() throws IcbcApiException {
		...
		Queryca29129RequestV1 request = new Queryca29129RequestV1();
		request.setServiceUrl("http://ip:port/api/queryca29129/query/V1");

		Queryca29129RequestV1Biz bizContent = new Queryca29129RequestV1Biz();
		
		Queryca29129RequestV1Pub pub = new Queryca29129RequestV1Pub();
		pub.setCode("29129");
		pub.setZone("0200");
		pub.setFr("0");
		pub.setDt("2018-12-26");
		
		Queryca29129RequestV1In in = new Queryca29129RequestV1In();
		in.setLineflag("2");
		...
		Queryca29129ResponseV1 response = client.execute(request, "msgId");

		if (response.isSuccess()) {
			// 接收成功
			Queryca29129ResponseV1Pub RetPub = response.getPub();
			Queryca29129ResponseV1Out RetOut = response.getOut();
			if(RetOut.getResult().equals("00000000")){
				//查询成功 获取返回结果
				List<Queryca29129ResponseV1Detail> resultList = RetOut.getDetail();
				//获取结果集中字段
				for(Queryca29129ResponseV1Detail detail:resultList){
					//获取信息.....
					detail.getPOSNO();
				}
			} else {
