...
import com.icbc.api.request.JftApiVendorEnterpriseInfoQueryRequestV1;
import com.icbc.api.request.JftApiVendorEnterpriseInfoQueryRequestV1.JftApiVendorEnterpriseInfoQueryRequestV1Biz;
import com.icbc.api.response.JftApiVendorEnterpriseInfoQueryResponseV1;
 ...
 */
public class JftApiVendorEnterpriseInfoQueryTestV1 {
	...
	public static void main(String[] args) throws Exception {
		...
		request.setServiceUrl("http://ip:port/api/jft/api/vendor/enterprise/info/query/V1");
		
		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		JftApiVendorEnterpriseInfoQueryRequestV1Biz bizContent = new JftApiVendorEnterpriseInfoQueryRequestV1Biz();

		bizContent.setAppId(APP_ID);
		bizContent.setOutVendorId("MZ201904261829");
