...
import com.icbc.api.request.JftUiPayWalletQrCodeRequestV1;
import com.icbc.api.request.JftUiPayWalletQrCodeRequestV1.JftUiPayWalletQrCodeRequestV1;

public class JftUiPayWalletQrCodeTestServletV1 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)throws ServletException, IOException {
		...
		try {
			...
			JftUiPayWalletQrCodeRequestV1 request = new JftUiPayWalletQrCodeRequestV1();
			
			request.setServiceUrl("http://ip:port/ui/jft/ui/pay/payWalletQrCode/V1 ");
			JftUiPayWalletQrCodeRequestV1Biz bizContent = new JftUiPayWalletQrCodeRequestV1Biz();
