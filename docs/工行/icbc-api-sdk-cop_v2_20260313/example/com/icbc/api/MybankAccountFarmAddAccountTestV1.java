...
import com.icbc.api.request.MybankAccountFarmAddAccountRequestV1;
import com.icbc.api.response.MybankAccountFarmAddAccountResponseV1;

public class MybankAccountFarmAddAccountTestV1 {
protected static String APP_ID = "10000000000004096993";
	...
	public static void main(String[] args) throws Exception {
		String URI = "mybank/account/farm/addAccount/V1";

		
		DefaultIcbcClient client = new DefaultIcbcClient(APP_ID,"RSA2", PRI_KEY, APIGW_PUBLIC_KEY);
		try {
			MybankAccountFarmAddAccountRequestV1 request = new MybankAccountFarmAddAccountRequestV1();
			MybankAccountFarmAddAccountRequestV1.MybankAccountFarmAddAccountBizV1 requestBizV1 = new MybankAccountFarmAddAccountRequestV1.MybankAccountFarmAddAccountBizV1();

			requestBizV1.setfSeqNo("124325");
			requestBizV1.setTransDate("20220202");
			requestBizV1.setCorpCode("icbc");
			requestBizV1.setParamType("1");
			requestBizV1.setDetail("{\"mktAcc\":\"1234567\",\"payerMemberNo\":\"1234567\",\"receiverMemberNo\":\"1234567\",\"busiClientName\":\"农业托管\"}");
	        ...
	        MybankAccountFarmAddAccountResponseV1 response = client.execute(request);
