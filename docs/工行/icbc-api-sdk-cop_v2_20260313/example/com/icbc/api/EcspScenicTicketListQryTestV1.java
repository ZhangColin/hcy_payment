...
import com.icbc.api.request.EcspScenicTicketListRequestV1;
import com.icbc.api.request.EcspScenicTicketListRequestV1.EcspScenicTicketListRequestV1Biz;
 ...
 */
public class EcspScenicTicketListQryTestV1 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    EcspScenicTicketListRequestV1 request = new EcspScenicTicketListRequestV1();
    // 4、根据测试环境和生产环境替换相应ip和端口
    request.setServiceUrl("http://appid/api/ecsp/scenic/ticketlist/query/V1");

    // 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
    EcspScenicTicketListRequestV1Biz bizContent = new EcspScenicTicketListRequestV1Biz();
    bizContent.setCorpId("0000000272").setCurrentPage(1).setPageSize(10).setQryStatus((byte) 0)
              .setQryTimeBeg("2001-01-01 00:00:00").setQryTimeEnd("2020-01-01 00:00:00");
    request.setBizContent(bizContent);

    EcspScenicTicketListResponseV1 response;
    try {
