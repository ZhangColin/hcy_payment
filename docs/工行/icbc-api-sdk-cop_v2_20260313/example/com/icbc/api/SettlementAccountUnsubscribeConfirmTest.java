...
import com.icbc.api.request.SettlementAccountUnsubscribeConfirmRequestV1;
import com.icbc.api.request.SettlementAccountUnsubscribeConfirmRequestV1.SettlementAccountUnsubscribeConfirmRequestV1Biz;
import com.icbc.api.response.SettlementAccountUnsubscribeConfirmResponseV1;

public class SettlementAccountUnsubscribeConfirmTest {
	...
	public void test_cop() throws IcbcApiException{
		...
		SettlementAccountUnsubscribeConfirmRequestV1 request = new SettlementAccountUnsubscribeConfirmRequestV1();
		SettlementAccountUnsubscribeConfirmRequestV1Biz bizContent = new SettlementAccountUnsubscribeConfirmRequestV1Biz();

		request.setServiceUrl("ip:port/api/settlement/account/earnestconfirm/V1");
		...
		bizContent.setAccountUseamt("100000"); //可用余额
		bizContent.setAccountBalance("100000"); //实际余额
     	request.setBizContent(bizContent);

		SettlementAccountUnsubscribeConfirmResponseV1 response = client.execute(request, "msgId");
