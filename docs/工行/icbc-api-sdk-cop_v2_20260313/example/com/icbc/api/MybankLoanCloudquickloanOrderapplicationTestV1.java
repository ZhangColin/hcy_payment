...
import com.icbc.api.request.MybankLoanCloudquickloanOrderapplicationRequestV1;
import com.icbc.api.request.MybankLoanCloudquickloanOrderapplicationstatusRequestV1;
import com.icbc.api.response.MybankLoanCloudquickloanOrderapplicationResponseV1;
 ...
 * @Date: 2019/11/11
 */
public class MybankLoanCloudquickloanOrderapplicationTestV1 {
    /*public static void main(String[] args) {
        ...
        String APP_ID = "10000000000004096856";
        //3、网关公钥
        ...
        //5、设置请求对象
        MybankLoanCloudquickloanOrderapplicationRequestV1 request = new MybankLoanCloudquickloanOrderapplicationRequestV1();
        //6、设置请求路径；联测时，请联系我行告知并替换成测试环境地址。
        request.setServiceUrl("http://ip:port/api/mybank/loan/cloudquickloan/orderapplication/V1");
        //7、设置业务参数
        MybankLoanCloudquickloanOrderapplicationRequestV1.MybankLoanOrderapplicationRequestV1Biz bizContent = new MybankLoanCloudquickloanOrderapplicationRequestV1.MybankLoanOrderapplicationRequestV1Biz();

        //8、组装请求参数
        MybankLoanCloudquickloanOrderapplicationRequestV1.MybankLoanOrderapplicationRequestV1Biz.SubInput subInput = new MybankLoanCloudquickloanOrderapplicationRequestV1.MybankLoanOrderapplicationRequestV1Biz.SubInput();
        subInput.setOrderNo("CS1911141448DJ21W");
        subInput.setOrderAmt("800");
        subInput.setOrderAdvAmt("500");
        subInput.setLoanAmt("300");
        subInput.setOrderTerm("12");
        subInput.setLoanTerm("12");
        subInput.setOrderDetail("100");

        List<MybankLoanCloudquickloanOrderapplicationRequestV1.MybankLoanOrderapplicationRequestV1Biz.SubInput> subInputs = new ArrayList<>();
        subInputs.add(subInput);

        //组装请求参数
        bizContent.setType("01");
        bizContent.setCIS("054edcaace80d2a60f17c0038276e620");
        bizContent.setPayAcctNo("xxxx");
        bizContent.setPayAcctName("燕燕网银数据1");
        bizContent.setTotalNum("1");
        bizContent.setCooperUnit("ST0340014");
        bizContent.setSubInput(subInputs);

        request.setBizContent(bizContent);

        MybankLoanCloudquickloanOrderapplicationResponseV1 response;
        try {
            response = client.execute(request, "1111111");
