...
import com.icbc.api.request.EcspScenicQueryDstrRequestV1;
import com.icbc.api.request.EcspScenicQueryDstrRequestV1.EcspScenicQueryDstrRequestV1Biz;
 ...
 */
public class EcspScenicDstrQryTestV1 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    EcspScenicQueryDstrRequestV1 request = new EcspScenicQueryDstrRequestV1();
    // 4、根据测试环境和生产环境替换相应ip和端口
    request.setServiceUrl("http://appid/api/ecsp/scenic/dstr/query/V1");

    // 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
    EcspScenicQueryDstrRequestV1Biz bizContent = new EcspScenicQueryDstrRequestV1Biz();
    bizContent.setCorpId("0000000272").setCurrentPage(1).setPageSize(10).setDstrType((byte) 0);
    request.setBizContent(bizContent);

    EcspScenicQueryDstrResponseV1 response;
    try {
