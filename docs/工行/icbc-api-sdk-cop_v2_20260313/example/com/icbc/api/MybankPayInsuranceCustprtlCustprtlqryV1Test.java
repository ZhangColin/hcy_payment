...
import com.icbc.api.request.MybankPayInsuranceCustprtlCustprtlqryRequestV1;
import com.icbc.api.response.MybankPayInsuranceCustprtlCustprtlqryResponseV1;
import java.util.logging.Logger;

public class MybankPayInsuranceCustprtlCustprtlqryV1Test {
    static Logger log = Logger.getLogger(MybankPayInsuranceCustprtlCustprtlqryV1Test.class.getName());
    //估值表
      ...
      //  String URI = "investment/insurance/prodapply/applycheck/V1"; // api地址
       // DefaultIcbcClient client = new DefaultIcbcClient(APP_ID, "RSA2",PRI_KEY, APIGW_PUBLIC_KEY);
        ...
        try {
            ...
            MybankPayInsuranceCustprtlCustprtlqryResponseV1 response = client.execute(request);
