...
import com.icbc.api.request.ServMerWithdrawRequestV1;
import com.icbc.api.request.ServMerWithdrawRequestV1.ServMerWithdrawRequestV1Biz;
 ...
 */
public class ServMerWithdrawV1Test {
	...
	public static void main(String[] args) throws Exception {
		...
		ServMerWithdrawRequestV1 request = new ServMerWithdrawRequestV1();
		
		//4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("http://ip:port/api/saes/servmer/withdraw/V1");
		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		ServMerWithdrawRequestV1Biz bizContent = new ServMerWithdrawRequestV1Biz();
		bizContent.setMerCode("020001020461"); //提现商户编号
		bizContent.setWithdrawType("1"); //提现商户类型1-平台服务商;2-平台类二级商户
		bizContent.setApiId("00000000000"); //该字段非必输项,上送apiid
		bizContent.setOutOrderNo("020001020461202108101080621");//外部订单号
		bizContent.setSerCode("0123456789123"); //服务商档案编号
		request.setBizContent(bizContent);
		ServMerWithdrawResponseV1 response;
		try {
