...
import com.icbc.api.request.JftApiUserEdpopenacctQueryRequestV1.JftApiUserEdpopenacctQueryRequestV1Biz;
...
public class JftApiUserEdpopenacctQueryTestV1 {
    ...
    public static void main(String[] args) {
        ...
        request.setServiceUrl("https://ip:port/api/jft/api/user/edpopenacct/query/V1");

        JftApiUserEdpopenacctQueryRequestV1Biz bizContent = new JftApiUserEdpopenacctQueryRequestV1Biz();
        bizContent.setAppId(APP_ID);
        bizContent.setAppIdSub("SH000001");
        bizContent.setOutUserId("M201801112326");
        request.setBizContent(bizContent);
        JftApiUserEdpopenacctQueryResponseV1 response;
        try {
