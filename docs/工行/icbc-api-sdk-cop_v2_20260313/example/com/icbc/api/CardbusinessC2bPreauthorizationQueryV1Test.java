...
import com.icbc.api.request.CardbusinessC2bPreauthorizationQueryRequestV1;
import com.icbc.api.request.CardbusinessC2bPreauthorizationQueryRequestV1.CardbusinessC2bPreauthorizationQueryRequestV1Biz;

public class CardbusinessC2bPreauthorizationQueryV1Test {
	...
	private Logger logger = Logger.getLogger(CardbusinessC2bPreauthorizationQueryV1Test.class.getName());


	public void test_cop() throws IcbcApiException {
		CardbusinessC2bPreauthorizationQueryRequestV1 request = new CardbusinessC2bPreauthorizationQueryRequestV1();
		// 4、需传入appid，私钥，字符集
		UiIcbcClient client;
		...
		request.setServiceUrl("https://ip:port/api/cardbusiness/c2b/preauthorization/query/V1");
		CardbusinessC2bPreauthorizationQueryRequestV1Biz bizContent = new CardbusinessC2bPreauthorizationQueryRequestV1Biz();
