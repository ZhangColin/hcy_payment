...
import com.icbc.api.request.MybankAccountPensionBranchAccountpreopennosmsRequestV1;
import com.icbc.api.response.MybankAccountPensionBranchAccountpreopennosmsResponseV1;
 ...
 * 第三支柱分行预开户不发送短信测试案例
 */
public class MybankAccountPensionBranchAccountpreopennosmsTest {


    public void test_accountpreopennosms() {
        ...
        //6、设置请求对象
        MybankAccountPensionBranchAccountpreopennosmsRequestV1 request = new MybankAccountPensionBranchAccountpreopennosmsRequestV1();
        ...
        //8、设置业务参数
        MybankAccountPensionBranchAccountpreopennosmsRequestV1.MybankAccountPensionBranchAccountpreopennosmsRequestV1Biz bizContent =
                new MybankAccountPensionBranchAccountpreopennosmsRequestV1.MybankAccountPensionBranchAccountpreopennosmsRequestV1Biz();
        MybankAccountPensionBranchAccountpreopennosmsRequestV1.ChanCommV10 chanCommV10 = new MybankAccountPensionBranchAccountpreopennosmsRequestV1.ChanCommV10();
        MybankAccountPensionBranchAccountpreopennosmsRequestV1.InfoCommV10 infoCommV10 = new MybankAccountPensionBranchAccountpreopennosmsRequestV1.InfoCommV10();
        //9、组装请求参数
        ...
        bizContent.setSaleCode("0010100000");//营销代码
        bizContent.setImageCorpOriginSerno("030302002182100046192701324");//合作方影像上传原交易单号

        request.setBizContent(bizContent);
        MybankAccountPensionBranchAccountpreopennosmsResponseV1 response = null;
        try {
            response = client.execute(request);
        } catch (IcbcApiException e) {
            // 测试环境案例经常调不通 给个默认值
            response = new MybankAccountPensionBranchAccountpreopennosmsResponseV1();
        } catch (Throwable e2) {
            e2.printStackTrace();
        }
