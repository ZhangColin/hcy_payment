...
import com.icbc.api.request.PayEfeepayEfeepayprojectRequestV1;
import com.icbc.api.request.PayEfeepayEfeepayprojectRequestV1.PayEfeepayEfeepayprojectRequestV1Biz;
import com.icbc.api.IcbcResponse;



public class PayEfeepayEfeepayprojectTest {

	//1、网关公钥
	protected static final String APIGW_PUBLIC_KEY = "-----请使用正确的网关公钥-----D4kzEVPdOj03ctKM7KV+16bWZ5BMNgvEeuEQwfQYkRVwI9HFOGkwNTMn5hiJXHnlXYCX+zp5r6R52MY0O7BsTCLT7aHaxsANsvI9ABGx3OaTVlPB59M6GPbJh0uXvio0m1r/lTW3Z60RU6Q3oid/rNhP3CiNgg0W6O3AGqwIDAQAB";

	//2、appid
	protected static final String APP_ID = "shandong";
	...
	public static void main(String[] args) throws IcbcApiException {
		...
		PayEfeepayEfeepayprojectRequestV1 request = new PayEfeepayEfeepayprojectRequestV1();
		request.setServiceUrl("http://ip:port/ui/pay/efeepay/efeepayproject/V1");
		//请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		PayEfeepayEfeepayprojectRequestV1Biz bizContent = new PayEfeepayEfeepayprojectRequestV1Biz();
		bizContent.setComputerId("10");
        bizContent.setUserId("yuzhen");
        bizContent.setAreaCode("0200");
        bizContent.setReturnUrl("");
        bizContent.setPayitemCode("PJ110011021000023701");
