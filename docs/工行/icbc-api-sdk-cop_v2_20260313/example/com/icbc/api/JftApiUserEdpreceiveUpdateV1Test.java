...
import com.icbc.api.request.JftApiUserEdpreceiveUpdateRequestV1.JftApiUserEdpreceiveUpdateRequestV1Biz;
import com.icbc.api.response.JftApiUserEdpreceiveUpdateResponseV1;

public class JftApiUserEdpreceiveUpdateV1Test {
    //1、网关公钥
    ...
    public static void main(String[] args) throws Exception {
        ...
        JftApiUserEdpreceiveUpdateRequestV1.JftApiUserEdpreceiveUpdateRequestV1Biz bizContent = new JftApiUserEdpreceiveUpdateRequestV1.JftApiUserEdpreceiveUpdateRequestV1Biz();
        ...
        bizContent.setReceiverRole("");
        bizContent.setTradeMode("");
        bizContent.setSplitDestAccount("");
        bizContent.setSplitDestAccountType("");
        bizContent.setSplitDestWalletName("");
        bizContent.setAccountKind("");
        ...
        JftApiUserEdpreceiveUpdateResponseV1 response;
        try {
            response = (JftApiUserEdpreceiveUpdateResponseV1) client.execute(request,
