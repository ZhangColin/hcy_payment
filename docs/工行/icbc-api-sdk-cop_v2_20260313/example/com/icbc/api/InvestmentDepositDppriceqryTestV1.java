...
import com.icbc.api.request.InvestmentDepositDppriceqryRequestV1;
...
public class InvestmentDepositDppriceqryTestV1 {
    ...
    public void test_cop() throws IcbcApiException {
        ...
        InvestmentDepositDppriceqryRequestV1 request = new InvestmentDepositDppriceqryRequestV1();
        request.setServiceUrl(Const.URL_PREFIX + "/investment/deposit/dppriceqry/V1");
        InvestmentDepositDppriceqryRequestV1.InvestmentDepositDppriceqryRequestV1Biz bizContent =
                new InvestmentDepositDppriceqryRequestV1.InvestmentDepositDppriceqryRequestV1Biz();
        ...
        bizContent.setWorktime("10:46:08");
        bizContent.setTradetype("0");
        bizContent.setFlag("1");


        request.setBizContent(bizContent);
        InvestmentDepositDppriceqryResponseV1 response;
        try {
