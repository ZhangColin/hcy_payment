...
import com.icbc.api.request.MybankAccountAccountdetailserviceAdsagreementqryRequestV1;
import com.icbc.api.response.MybankAccountAccountdetailserviceAdsagreementqryResponseV1;

public interface MybankAccountAccountdetailserviceAdsagreementqryTestV1 {
    public static void main(String[] args) {
        ...
        MybankAccountAccountdetailserviceAdsagreementqryRequestV1 request = new MybankAccountAccountdetailserviceAdsagreementqryRequestV1();
        request.setServiceUrl("http://ip:port/com.icbc.api/mybank/account/accountdetailservice/adsagreementqry/V1");

        MybankAccountAccountdetailserviceAdsagreementqryRequestV1.AccountdetailserviceAdsagreementqryRequestV1Biz bizContent = new MybankAccountAccountdetailserviceAdsagreementqryRequestV1.AccountdetailserviceAdsagreementqryRequestV1Biz();
        MybankAccountAccountdetailserviceAdsagreementqryRequestV1.AccountdetailserviceAdsagreementqryRequestV1Biz.Inqwork inqwork = new MybankAccountAccountdetailserviceAdsagreementqryRequestV1.AccountdetailserviceAdsagreementqryRequestV1Biz.Inqwork();
        inqwork.setBegnum("0");
        inqwork.setFetnum("10");
        MybankAccountAccountdetailserviceAdsagreementqryRequestV1.AccountdetailserviceAdsagreementqryRequestV1Biz.Cond cond = new MybankAccountAccountdetailserviceAdsagreementqryRequestV1.AccountdetailserviceAdsagreementqryRequestV1Biz.Cond();
        cond.setQrytype("1");
        cond.setCurrtype("001");
        cond.setAcccompno("345213001");
        cond.setAccount("2350001231");
        bizContent.setInqwork(inqwork);
        bizContent.setCond(cond);
        bizContent.setCorpno("45612354");

        request.setBizContent(bizContent);
        MybankAccountAccountdetailserviceAdsagreementqryResponseV1 response;
        try {
