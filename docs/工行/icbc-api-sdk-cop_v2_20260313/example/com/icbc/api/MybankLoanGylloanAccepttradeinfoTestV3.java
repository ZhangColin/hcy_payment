...
import com.icbc.api.request.MybankLoanGylloanAccepttradeinfoRequestV3;
import com.icbc.api.request.MybankLoanGylloanAccepttradeinfoRequestV3Biz;
import com.icbc.api.response.MybankLoanGylloanAccepttradeinfoResponseV3;

public class MybankLoanGylloanAccepttradeinfoTestV3 {

	private static Log log = LogFactory.getLog(MybankLoanGylloanAccepttradeinfoTestV3.class);

	public static void main(String[] args) throws ParseException {
		
		try {
			String apigwPublicKey =  "-----请使用正确的网关公钥-----D4kzEVPdOj03ctKM7KV+16bWZ5BMNgvEeuEQwfQYkRVwI9HFOGkwNTMn5hiJXHnlXYCX+zp5r6R52MY0O7BsTCLT7aHaxsANsvI9ABGx3OaTVlPB59M6GPbJh0uXvio0m1r/lTW3Z60RU6Q3oid/rNhP3CiNgg0W6O3AGqwIDAQA";
			...
			String appId = "xxxx";
			String url = "http://ip:port/api/mybank/loan/gylloan/accepttradeinfo/V3";
			
			DefaultIcbcClient client = new DefaultIcbcClient(appId, privateKey,apigwPublicKey);
			MybankLoanGylloanAccepttradeinfoRequestV3 request = new MybankLoanGylloanAccepttradeinfoRequestV3();
			request.setServiceUrl(url);
			MybankLoanGylloanAccepttradeinfoRequestV3Biz bizContent = new MybankLoanGylloanAccepttradeinfoRequestV3Biz();
			...
			bizContent.setApplyNo("00XXXXX0000000788");
			...
			MybankLoanGylloanAccepttradeinfoResponseV3 response;
