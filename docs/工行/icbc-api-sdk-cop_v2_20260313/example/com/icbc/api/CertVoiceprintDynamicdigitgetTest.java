...
import com.icbc.api.request.CertVoiceprintDynamicdigitgetRequestV1;
import com.icbc.api.request.CertVoiceprintDynamicdigitgetRequestV1.CertVoiceprintDynamicdigitgetRequestV1Biz;
import com.icbc.api.response.CertVoiceprintDynamicdigitgetResponseV1;

public class CertVoiceprintDynamicdigitgetTest {
	//	调用方自己的AppId
	private static final String APP_ID = new String("1000000000s00040975a29");
	//	调用方私钥
...
//		签名类型为SHA256WithRSA时，传入appid，私钥和网关公钥，签名类型使用定值IcbcConstants.SIGN_TYPE_RSA2，其他参数使用缺省
		...
		CertVoiceprintDynamicdigitgetRequestV1 request = new CertVoiceprintDynamicdigitgetRequestV1();
		
//		测试环境替换ip和端口，生成环境已有默认值，此语句可删除
		request.setServiceUrl(API_SERVICE_URL + "/cert/voiceprint/dynamicdigitget/V1");
		Logger log = Logger.getLogger(CertVoiceprintDynamicdigitgetTest.class.getName());
//		请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		CertVoiceprintDynamicdigitgetRequestV1Biz bizContent =  new CertVoiceprintDynamicdigitgetRequestV1Biz();
		...
		bizContent.setProgramName("Dynamicdigitget");
		bizContent.setDynamicDigitType("1");
		request.setBizContent(bizContent);
		CertVoiceprintDynamicdigitgetResponseV1 response;
		try {
