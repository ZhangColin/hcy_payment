...
import com.icbc.api.request.EcspNftColletionQueryRequestV1;
import com.icbc.api.response.EcspNftCollectionQueryResponseV1;

/**
 * @author kfzx-linfeng
 */
public class EcspNftCollectionQueryV1Test {
    // 1、网关公钥
    ...
    public static void main(String[] args) throws Exception {
        ...
        EcspNftColletionQueryRequestV1 request = new EcspNftColletionQueryRequestV1();

        // 4、根据测试环境和生产环境替换相应ip和端口
        request.setServiceUrl("http://ip:port/api/ecsp/nft/collection/query/V1");
        // 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
        EcspNftColletionQueryRequestV1.EcspNftColletionQueryRequestV1Biz bizContent = new EcspNftColletionQueryRequestV1.EcspNftColletionQueryRequestV1Biz();
        bizContent.setCorpId("0000000001");
        bizContent.setPageNum(1);
        request.setBizContent(bizContent);

        EcspNftCollectionQueryResponseV1 response;
        try {
