...
import com.icbc.api.request.JftApiVendorInfoMaintainRequestV1;
import com.icbc.api.request.JftApiVendorInfoMaintainRequestV1.JftApiVendorInfoMaintainRequestV1Biz;
import com.icbc.api.response.JftApiVendorInfoMaintainResponseV1;
 ...
 */
public class JftApiVendorInfoMaintainTestV1 {
	...
	public static void main(String[] args) throws Exception {
		...
		JftApiVendorInfoMaintainRequestV1 request = new JftApiVendorInfoMaintainRequestV1();
		
		//4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("https://ip:port/api/jft/api/vendor/info/maintain/V1");
			
		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		JftApiVendorInfoMaintainRequestV1Biz bizContent = new JftApiVendorInfoMaintainRequestV1Biz();
		...
		JftApiVendorInfoMaintainResponseV1 response;
		try {
			response = (JftApiVendorInfoMaintainResponseV1) client.execute(request, System.currentTimeMillis()+"");
