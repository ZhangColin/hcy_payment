...
import com.icbc.api.request.CacaElecreceiptAgreementExhibitperiodsynRequestV1;
import com.icbc.api.response.CacaElecreceiptAgreementExhibitperiodsynResponseV1;

public class CacaElecreceiptAgreementExhibitperiodsynTestV1 {
    ...
    public static void main(String[] args) {
        ...
        //5、设置请求对象
        CacaElecreceiptAgreementExhibitperiodsynRequestV1 request = new CacaElecreceiptAgreementExhibitperiodsynRequestV1();
        //6、设置请求路径；联测时，请联系我行告知并替换成测试环境地址。
        request.setServiceUrl("http://ip:port/api/caca/elecreceipt/agreement/exhibitperiodsyn/V1");
        //7、设置业务参数
        CacaElecreceiptAgreementExhibitperiodsynRequestV1.CacaElecreceiptAgreementExhibitperiodsynRequestV1Biz bizContent =
                new CacaElecreceiptAgreementExhibitperiodsynRequestV1.CacaElecreceiptAgreementExhibitperiodsynRequestV1Biz();
        //8、组装请求参数
        bizContent.setCHANNEL("00004");
        bizContent.setSEQNO("2022-04-14");
        bizContent.setAGREENO("1");
        bizContent.setRECTIME("1");
        bizContent.setACTDATE("2022-04-14");
        bizContent.setMATDATE("1");
        bizContent.setLASTUSERID("1");
        request.setBizContent(bizContent);

        CacaElecreceiptAgreementExhibitperiodsynResponseV1 response;
        try {
