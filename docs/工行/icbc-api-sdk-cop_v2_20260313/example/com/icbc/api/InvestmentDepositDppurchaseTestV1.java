...
import com.icbc.api.request.InvestmentDepositDppurchaseRequestV1;
import com.icbc.api.response.InvestmentDepositDppurchaseResponseV1;
...
public class InvestmentDepositDppurchaseTestV1 {
    ...
    public void test_cop() throws IcbcApiException {
        ...
        InvestmentDepositDppurchaseRequestV1 request = new InvestmentDepositDppurchaseRequestV1();
        request.setServiceUrl(Const.URL_PREFIX + "/investment/deposit/dppurchase/V1");
        InvestmentDepositDppurchaseRequestV1.InvestmentDepositDppurchaseRequestV1Biz bizContent =
                new InvestmentDepositDppurchaseRequestV1.InvestmentDepositDppurchaseRequestV1Biz();
        ...
        bizContent.setCardno("622202" +
                "0200008791614");
        bizContent.setAccno("");
        bizContent.setJctype("0");
        bizContent.setPrice("1600000");
        bizContent.setCashamount("1000");
        bizContent.setCashcount("1000");
        bizContent.setTimestmp("2023-12-31 10:18:09");
        bizContent.setOperflag("4");


        request.setBizContent(bizContent);
        InvestmentDepositDppurchaseResponseV1 response;
        try {
