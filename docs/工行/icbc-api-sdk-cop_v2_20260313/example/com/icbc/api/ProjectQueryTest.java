...
public class ProjectQueryTest extends HttpServlet {
	...
	public static void main(String[] args) {
		...
		request.setServiceUrl("http://ip:port/api/project/query/V1");
