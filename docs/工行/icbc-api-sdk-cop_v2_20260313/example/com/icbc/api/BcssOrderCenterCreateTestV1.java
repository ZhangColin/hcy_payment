...
import com.icbc.api.request.BcssOrderCenterCreateRequestTestV1;
import com.icbc.api.request.BcssOrderCenterCreateRequestTestV1.BcssOrderCenterCreateRequestBizV1;
 ...
 *
 */
public class BcssOrderCenterCreateTestV1 {
    // MY_PRIVATE_KEY
    ...
    public static void main(String[] args) throws Exception {
        BcssOrderCenterCreateTestV1 a = new BcssOrderCenterCreateTestV1();
        a.test_cop();
    }

    public void test_cop() throws IcbcApiException {
        BcssOrderCenterCreateRequestTestV1 request = new BcssOrderCenterCreateRequestTestV1();
        request.setServiceUrl("http://ip:port/api/bcss/orderCenter/create/insertOrder/V1");
        BcssOrderCenterCreateRequestBizV1 bizContent = new BcssOrderCenterCreateRequestBizV1();
        bizContent.setClientTransNo("XXXXXXXXXXXXXXXXXXXX");
        bizContent.setClientType("X");
        bizContent.setCorpId("XXXXXXXXXX");
        bizContent.setCouponAmt(new BigDecimal(444));
        ...
        bizContent.setManufacturerId("XXXXXXXXXX");
        bizContent.setIndustry("XXX");
        bizContent.setPayType("x");
        bizContent.setTimeStamp("XXXX-XX-XX XX:XX:XX");
        bizContent.setPayType("X");
        bizContent.setTotalAmt(new BigDecimal(4));
        bizContent.setPayAmt(new BigDecimal(44));
        bizContent.setOrdersrc("X");
        bizContent.setTrademode("X");
        List<BcssOrderCenterCreateRequestTestV2.BcssOrderCenterCreateRequestBizV2> goods = new ArrayList<BcssOrderCenterCreateRequestTestV2.BcssOrderCenterCreateRequestBizV2>();
        BcssOrderCenterCreateRequestTestV2.BcssOrderCenterCreateRequestBizV2 good1 = new BcssOrderCenterCreateRequestTestV2.BcssOrderCenterCreateRequestBizV2();
        good1.setGoodsId("XX");
        bizContent.setSetUser("XXXXXXXXXX");
        try {
            good1.setGoodsName(URLEncoder.encode("XXXXX","UTF-8"));
        } catch (UnsupportedEncodingException e) {
            good1.setGoodsName("XXXXXXXXXX");
        }
        ...
        goods.add(good1);
        BcssOrderCenterCreateRequestTestV2.BcssOrderCenterCreateRequestBizV2 good2 = new BcssOrderCenterCreateRequestTestV2.BcssOrderCenterCreateRequestBizV2();
        good2.setGoodsId("X");
        try {
            good2.setGoodsName(URLEncoder.encode("XXXXX","UTF-8"));
        } catch (UnsupportedEncodingException e) {
            good2.setGoodsName("XXXXXXX");
        }
        good2.setGoodsNum(new BigDecimal(4));
        good2.setGoodsAmt(new BigDecimal(4));
        good2.setGoodstype("XXX");
        try {
            good2.setGoodsName(URLEncoder.encode("XXX","UTF-8"));
        } catch (UnsupportedEncodingException e) {
            good2.setGoodsName("XXXX");
        }
...
//        bizContent.setGoods(goods);
        ...
        BcssOrderCenterCreateResponseV1 response = client.execute(request);
        java.util.logging.Logger log = Logger
                .getLogger(BcssOrderCenterCreateTestV1.class
                        .getName());
