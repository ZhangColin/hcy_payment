...
import com.icbc.api.request.JftUiUserOpenacctH5SubmitRequestV1;
import com.icbc.api.request.JftUiUserOpenacctH5SubmitRequestV1.JftUiUserOpenacctH5SubmitRequestV1Biz;
...
public class JftUiUserOpenacctH5SubmitTestServletV1 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            // 通过工行 SDK 调用《聚富通电子钱包账户开立通用页面接口V1》页面接口
            UiIcbcClient client = new UiIcbcClient(APP_ID, IcbcConstants.SIGN_TYPE_RSA2, MY_PRIVATE_KEY, IcbcConstants.CHARSET_UTF8);
            JftUiUserOpenacctH5SubmitRequestV1 request = new JftUiUserOpenacctH5SubmitRequestV1();
            // 指定《聚富通电子钱包账户开立通用页面接口V1》URL
            request.setServiceUrl("https://ip:port/ui/jft/ui/user/openacctH5/submit/V1");

            /**
             * 组装调用页面接口上送报文。接口各请求参数说明详见接口文档
             */
            JftUiUserOpenacctH5SubmitRequestV1Biz bizContent = new JftUiUserOpenacctH5SubmitRequestV1Biz();
            ...
            bizContent.setOpenProtocol("1");
            bizContent.setCertPreId("");
            Map<String, Object> preFillItems = new HashMap<>();
            preFillItems.put("custName", "");
            preFillItems.put("certNo", "");
            preFillItems.put("mobile", "");
            preFillItems.put("occupation", "");
