...
import com.icbc.api.request.JftUiVendorRegisterRequestV3;
import com.icbc.api.request.JftUiVendorRegisterRequestV3.JftUiVendorRegisterRequestV3Biz;

/**
 * 聚富通子商户注册维护页V3
 */
public class JftUiVendorRegisterTestV3 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			JftUiVendorRegisterRequestV3 request = new JftUiVendorRegisterRequestV3();
			// 4、根据测试环境和生产环境替换相应ip和端口
			request.setServiceUrl("https://ip:port/ui/jft/ui/vendor/register/V3");

			// 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
			JftUiVendorRegisterRequestV3Biz bizContent = new JftUiVendorRegisterRequestV3Biz();
			...
			bizContent.setOutUpperVendorId("10000000000000004473");
