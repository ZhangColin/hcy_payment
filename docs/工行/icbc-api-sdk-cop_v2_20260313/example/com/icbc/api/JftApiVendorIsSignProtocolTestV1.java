...
import com.icbc.api.request.JftApiVendorIsSignProtocolRequestV1;
import com.icbc.api.request.JftApiVendorIsSignProtocolRequestV1.JftApiVendorIsSignProtocolRequestV1Biz;
import com.icbc.api.response.JftApiVendorIsSignProtocolResponseV1;
 ...
 */
public class JftApiVendorIsSignProtocolTestV1 {
	...
	public static void main(String[] args) throws Exception {
		...
		JftApiVendorIsSignProtocolRequestV1 request = new JftApiVendorIsSignProtocolRequestV1();
		
		//4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("https://ip:port/api/jft/api/vendor/is/sign/protocol/V1");

		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		JftApiVendorIsSignProtocolRequestV1Biz bizContent = new JftApiVendorIsSignProtocolRequestV1Biz();
		bizContent.setAppId("10000000000000012150");
		bizContent.setOutUserId("150404199108026335");
		bizContent.setProtocolType("0003");
		bizContent.setAccountNo("");
		bizContent.setProtocolId("1");
		bizContent.setQueryType("2");
		request.setBizContent(bizContent);
		
		JftApiVendorIsSignProtocolResponseV1 response;
		try {
			response = (JftApiVendorIsSignProtocolResponseV1) client.execute(request, System.currentTimeMillis()+"");
