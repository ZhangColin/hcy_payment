...
import com.icbc.api.request.OfstQrcodeQueryRequestV1;
import com.icbc.api.request.OfstQrcodeQueryRequestV1.OfstQrcodeQueryRequestV1Biz;
import com.icbc.api.response.OfstQrcodeQueryResponseV1;
 ...
 */
public class OfstQrcodeQueryTest {
	...
	public static void main(String[] args) throws Exception {
		...
		OfstQrcodeQueryRequestV1 request = new OfstQrcodeQueryRequestV1();
		
		//4、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("https://ip:port/api/ofst/qrcode/V1/query");

		//5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
		OfstQrcodeQueryRequestV1Biz bizContent = new OfstQrcodeQueryRequestV1Biz();
		...
		OfstQrcodeQueryResponseV1 response;
		try {
