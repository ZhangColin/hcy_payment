...
import com.icbc.api.request.CacaReceiptTipsreceiptQueryreceiptRequestV1;
import com.icbc.api.response.CacaReceiptTipsreceiptQueryreceiptResponseV1;

public class CacaReceiptTipsreceiptQueryreceiptTestV1 {
    ...
    public static void main(String[] args) {
        ...
        CacaReceiptTipsreceiptQueryreceiptRequestV1 request = new CacaReceiptTipsreceiptQueryreceiptRequestV1();
        request.setServiceUrl("https://ip:port/api/caca/receipt/tipsreceipt/queryreceipt/V1");
        CacaReceiptTipsreceiptQueryreceiptRequestV1.QueryTipsReceiptRequestV1Biz bizContent = new CacaReceiptTipsreceiptQueryreceiptRequestV1.QueryTipsReceiptRequestV1Biz();
        // public 通讯区定义赋值
        CacaReceiptTipsreceiptQueryreceiptRequestV1.QueryTipsReceiptRequestV1Pub pubObj = new CacaReceiptTipsreceiptQueryreceiptRequestV1.QueryTipsReceiptRequestV1Pub();
        pubObj.setCode("29027");
        pubObj.setZone("0200");
        pubObj.setFr("0");
        pubObj.setDt("2017-07-06");
        // private 通讯区定义赋值
        CacaReceiptTipsreceiptQueryreceiptRequestV1.QueryTipsReceiptRequestV1In inObj = new CacaReceiptTipsreceiptQueryreceiptRequestV1.QueryTipsReceiptRequestV1In();
        ...
        try {
            CacaReceiptTipsreceiptQueryreceiptResponseV1 response = client.execute(request);
