...
import com.icbc.api.request.CreditCardRepayWrtOffBadDbtAccRequestV1;
import com.icbc.api.request.CreditCardRepayWrtOffBadDbtAccRequestV1.CreditCardRepayWrtOffBadDbtAccRequestV1Biz;
import com.icbc.api.response.CreditCardRepayWrtOffBadDbtAccResponseV1;

public class CreditCardRepayWrtOffBadDbtAccV1Test {
    ...
    public static void main(String[] args) {
        ...
        CreditCardRepayWrtOffBadDbtAccRequestV1 request = new CreditCardRepayWrtOffBadDbtAccRequestV1();

        //访问工行API平台URL
        request.setServiceUrl(API_SERVICE_URL + "/mybank/pay/creditcard/baddbt/repay/V1");

        CreditCardRepayWrtOffBadDbtAccRequestV1Biz bizContent = new CreditCardRepayWrtOffBadDbtAccRequestV1Biz();
        ...
        CreditCardRepayWrtOffBadDbtAccResponseV1 response;
