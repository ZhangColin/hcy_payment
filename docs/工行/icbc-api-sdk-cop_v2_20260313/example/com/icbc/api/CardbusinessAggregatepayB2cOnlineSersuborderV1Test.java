...
import com.icbc.api.request.CardbusinessAggregatepayB2cOnlineSersuborderRequestV1;
import com.icbc.api.response.CardbusinessAggregatepayB2cOnlineSersuborderResponseV1;
import com.icbc.api.request.CardbusinessAggregatepayB2cOnlineSersuborderRequestV1.CardbusinessAggregatepayB2cOnlineSersuborderRequestV1Biz;
...
public class CardbusinessAggregatepayB2cOnlineSersuborderV1Test {
	// 1、网关公钥
	...
	private Logger logger = Logger.getLogger(CardbusinessAggregatepayB2cOnlineSersuborderV1Test.class.getName());
	...
	public void test_cop() throws IcbcApiException {
		...
		DefaultIcbcClient client = new DefaultIcbcClient(APP_ID, IcbcConstants.SIGN_TYPE_RSA, MY_PRIVATE_KEY,
				APIGW_PUBLIC_KEY);
		CardbusinessAggregatepayB2cOnlineSersuborderRequestV1 request = new CardbusinessAggregatepayB2cOnlineSersuborderRequestV1();
		// 5、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("http://IP:port/api/cardbusiness/aggregatepay/b2c/online/sersuborder/V1");
		CardbusinessAggregatepayB2cOnlineSersuborderRequestV1Biz bizContent = new CardbusinessAggregatepayB2cOnlineSersuborderRequestV1Biz();
		...
		bizContent.setOrderNum("xxx");
		bizContent.setMerPrtclNo("xxx");
		bizContent.setOrderSubmitActInput(orderSubmitActInputArray);
		request.setBizContent(bizContent);
		CardbusinessAggregatepayB2cOnlineSersuborderResponseV1 response;
		try {
