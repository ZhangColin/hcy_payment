...
public class MybankMicrofundOrderMicrofundorderrefundV1Test {
  ...
  // 1、网关公钥
	...
	public static void main(String[] args) {
		...
		// 设置请求对象request
		MybankMicrofundOrderMicrofundorderrefundRequestV1 req = new MybankMicrofundOrderMicrofundorderrefundRequestV1();
		
		// 设置请求路径
		req.setServiceUrl("http://ip:port/api/mybank/microfund/order/microfundorderrefund/V1");

		MybankMicrofundOrderMicrofundorderrefundRequestV1Biz biz = new MybankMicrofundOrderMicrofundorderrefundRequestV1Biz();
