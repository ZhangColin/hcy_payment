...
public class EcspReligionOfflineOrderSubmitTestV1 {
    // 1、网关公钥
    ...
    public static void main(String[] args) throws Exception {
        ...
        EcspReligionOfflineOrderSubmitRequestV1 request = new EcspReligionOfflineOrderSubmitRequestV1();

        // 4、根据测试环境和生产环境替换相应ip和端口
        request.setServiceUrl("http://ip:port/api/ecsp/religion/offline/order/submit/V1");
        // 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
        EcspReligionOfflineOrderSubmitRequestV1Biz bizContent = new EcspReligionOfflineOrderSubmitRequestV1Biz();
        bizContent.setCorpId("0000000001");
        bizContent.setMeritName("上香");
        bizContent.setDesc("{上香中}");
        bizContent.setUserName("张三");
        bizContent.setUserContact("13000000001");
        bizContent.setOrderNo("200728141127231100048");
        bizContent.setWechatUserId("wxid12345");
        bizContent.setAmount("100");//此值为1元，以分为单位
        bizContent.setMerchantOrderNo("200429159591666427113");
        bizContent.setOperUserId("0000000003");
        bizContent.setOnlineType("1");

        request.setBizContent(bizContent);

        EcspReligionOfflineOrderSubmitResponseV1 response;
        try {
