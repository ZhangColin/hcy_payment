...
public class XafcSecureaccSecureaccdetailqryV1 {
	public static void main(String[] args) {
		...
		String ICBCAPI_URL = "http://ip:port/api/xafc/secureacc/secureaccdetailqry/V1"; // 工行API平台测试环境付款指令URL，调用方需要修改为贵州分行前置机上游IP和端口

		// 以下bizContent为业务数据字段，需要set具体业务数据
		String reqparams = "<ZXBMsg>"
				+"<Head>"
					+"<ReqSN>201820111626</ReqSN>"
					+"<MsgTyp>EV0003</MsgTyp>"
					+"<CustID>001025931</CustID>"
				+"</Head>"
				+"<Body>"
					+"<AccNo>02000417380120136</AccNo>"
					+"<BgnDate>20210121</BgnDate>"
					+"<EndDate>20210131</EndDate>"
					+"<NextPage>0</NextPage>"
				+"</Body>"
		+"</ZXBMsg>";
