...
import com.icbc.api.request.MybankLoanCloudquickloanServapplyRequestV1;
 ...
 * @Date: 2019/11/11
 */
public class MybankLoanCloudquickloanServapplyTestV1 {
    public static void main(String[] args) {
        ...
        //5、设置请求对象
        MybankLoanCloudquickloanServapplyRequestV1 request = new MybankLoanCloudquickloanServapplyRequestV1();
        //6、设置请求路径；联测时，请联系我行告知并替换成测试环境地址。
        request.setServiceUrl("http://ip:port/api/mybank/loan/cloudquickloan/servapply/V1");
        //7、设置业务参数
        MybankLoanCloudquickloanServapplyRequestV1.MybankLoanServapplyRequestV1Biz bizContent = new MybankLoanCloudquickloanServapplyRequestV1.MybankLoanServapplyRequestV1Biz();
        ...
        bizContent.setCName("华为技术有限公司");
        bizContent.setCreditcode("xxxx");
        bizContent.setName("谢凤雨");
        bizContent.setIdtype("0");
        bizContent.setIdNo("xxxx");
        bizContent.setCardNo("62220202000020");
        bizContent.setPhoneNo("13738663147");
        bizContent.setEmail("shenkezhi.com");
        bizContent.setHwid("05819f7c1a80d35d0fd3c01ad03f5000");
        ...
        MybankLoanCloudquickloanServapplyResponseV1 response;
        try {
