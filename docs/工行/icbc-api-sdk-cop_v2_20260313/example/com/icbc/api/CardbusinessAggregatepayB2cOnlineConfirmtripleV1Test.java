...
import com.icbc.api.request.CardbusinessAggregatepayB2cOnlineConfirmtripleRequestV1;
import com.icbc.api.request.CardbusinessAggregatepayB2cOnlineConfirmtripleRequestV1.CardbusinessAggregatepayB2cOnlineConfirmtripleRequestV1Biz;
import com.icbc.api.response.CardbusinessAggregatepayB2cOnlineConfirmtripleResponseV1;
...
public class CardbusinessAggregatepayB2cOnlineConfirmtripleV1Test {
	// 1、网关公钥
	...
	private Logger logger = Logger.getLogger(CardbusinessAggregatepayB2cOnlineConfirmtripleV1Test.class.getName());
	...
	public void test_cop() throws IcbcApiException {
		...
		CardbusinessAggregatepayB2cOnlineConfirmtripleRequestV1 request = new CardbusinessAggregatepayB2cOnlineConfirmtripleRequestV1();
		//5、根据测试环境和生产环境替换相应ip和端口
		request.setServiceUrl("https://ip:port/api/cardbusiness/aggregatepay/b2c/online/confirmtriple/V1");
		CardbusinessAggregatepayB2cOnlineConfirmtripleRequestV1Biz bizContent = new CardbusinessAggregatepayB2cOnlineConfirmtripleRequestV1Biz();
		...
		bizContent.setAcc_nm("zhangsan");
		bizContent.setOut_trade_no("65964126858");
		bizContent.setTxn_time("20220719151300");
		bizContent.setSms_code("123456");
		bizContent.setAcc_no("123456789");
		bizContent.setCertiftp("0");
		bizContent.setCertifid("DzRP4ltNkbmXWOto1qvbn+8GGJKEZQC5LPHF949/Z98=");
		bizContent.setExpired("xxx");
		bizContent.setCvn2("xxx");
		CardbusinessAggregatepayB2cOnlineConfirmtripleResponseV1 response;
		try {
