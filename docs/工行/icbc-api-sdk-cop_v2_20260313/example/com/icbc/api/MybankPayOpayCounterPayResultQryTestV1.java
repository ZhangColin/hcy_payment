...
import com.icbc.api.request.MybankPayOpayCounterPayResultQryRequestV1;
import com.icbc.api.request.MybankPayOpayCounterPayResultQryRequestV1.MybankPayOpayCounterPayResultQryRequestV1Biz;
import com.icbc.api.response.MybankPayOpayCounterPayResultQryResponseV1;

public class MybankPayOpayCounterPayResultQryTestV1 {

	// 调用方自己的AppId
	private static final String APP_ID = new String("10000xxxx45"); //20年1月
	// 调用方私钥
	...
	public static void main(String[] args) {
		...
		DefaultIcbcClient client = new DefaultIcbcClient(APP_ID,IcbcConstants.SIGN_TYPE_RSA2, MY_PRIVATE_KEY, IcbcConstants.CHARSET_UTF8,IcbcConstants.FORMAT_JSON,APIGW_PUBLIC_KEY,IcbcConstants.ENCRYPT_TYPE_AES, AES_KEY, null, null);
		
		MybankPayOpayCounterPayResultQryRequestV1 request = new MybankPayOpayCounterPayResultQryRequestV1();
		
		//访问工行API平台URL
		request.setServiceUrl(API_SERVICE_URL + "/mybank/pay/opay/counterpayresultqry/V1");

		 MybankPayOpayCounterPayResultQryRequestV1Biz bizContent = new MybankPayOpayCounterPayResultQryRequestV1Biz();

		//APPID
		bizContent.setMerID("0119xx00461");
		bizContent.setAreaCode("01x9");
		bizContent.setOrderId("0062019xxxx18001255");
		request.setBizContent(bizContent);

		 MybankPayOpayCounterPayResultQryResponseV1 response;
