...
import com.icbc.api.request.MybankOspayTppcustomerWithholdagrtqryRequestV1;
import com.icbc.api.request.MybankOspayTppcustomerWithholdagrtqryRequestV1.MybankOspayTppcustomerWithholdagrtqryRequestV1Biz;
import com.icbc.api.response.MybankOspayTppcustomerWithholdagrtqryResponseV1;

public class MybankOspayTppcustomerWithholdagrtqryTestV1 {

	// 调用方自己的AppId
	private static final String APP_ID = new String("test0101"); //11月
	// 调用方私�?
	...
	public static void main(String[] args) {
		...
		MybankOspayTppcustomerWithholdagrtqryRequestV1 request = new MybankOspayTppcustomerWithholdagrtqryRequestV1();
		
		//访问工行API平台URL
		request.setServiceUrl(API_SERVICE_URL + "/mybank/ospay/tppcustomer/withholdagrtqry/V1");
		
		MybankOspayTppcustomerWithholdagrtqryRequestV1Biz bizContent = new MybankOspayTppcustomerWithholdagrtqryRequestV1Biz();

		//APPID 0119EC20000461
		bizContent.setMerID("0119*******461");
		bizContent.setAppID("1000*************776");
		bizContent.setAppCustID("0119*******55");
		bizContent.setAreaCode("0**9");
		bizContent.setWithholdAgrNo("0119****036");
		request.setBizContent(bizContent);

		MybankOspayTppcustomerWithholdagrtqryResponseV1 response;
