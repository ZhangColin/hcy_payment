...
import com.icbc.api.request.EcspScenicQueryCouponVerfRequestV1;
import com.icbc.api.request.EcspScenicQueryCouponVerfRequestV1.EcspScenicQueryCouponVerfRequestV1Biz;
import com.icbc.api.request.EcspScenicQueryTicketVerfRequestV1;
import com.icbc.api.request.EcspScenicQueryTicketVerfRequestV1.EcspScenicQueryTicketVerfRequestV1Biz;
import com.icbc.api.response.EcspScenicQueryCouponVerfResponseV1;
 ...
 */
public class EcspScenicQueryCouponVerfTestV1 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    EcspScenicQueryCouponVerfRequestV1 request = new EcspScenicQueryCouponVerfRequestV1();
    // 4、根据测试环境和生产环境替换相应ip和端口
    request.setServiceUrl("http://appid/api/ecsp/scenic/couponverf/query/V1");

    // 5、请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
    EcspScenicQueryCouponVerfRequestV1Biz bizContent = new EcspScenicQueryCouponVerfRequestV1Biz();
    bizContent.setCorpId("0000000272").setCurrentPage(1).setPageSize(10).setQryTimeBeg("2001-01-01 00:00:00")
              .setQryTimeEnd("2020-01-01 00:00:00");
    request.setBizContent(bizContent);

    EcspScenicQueryCouponVerfResponseV1 response;
    try {
