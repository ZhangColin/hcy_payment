...
import com.icbc.api.request.InvestmentDepositDpproductqryRequestV1;
...
public class InvestmentDepositDpproductqryTestV1 {
    ...
    public void test_cop() throws IcbcApiException {
        ...
        InvestmentDepositDpproductqryRequestV1 request = new InvestmentDepositDpproductqryRequestV1();
        request.setServiceUrl(Const.URL_PREFIX + "/investment/deposit/dpproductqry/V1");
        InvestmentDepositDpproductqryRequestV1.InvestmentDepositDpproductqryRequestV1Biz bizContent =
                new InvestmentDepositDpproductqryRequestV1.InvestmentDepositDpproductqryRequestV1Biz();
        ...
        bizContent.setActcode("0");

        request.setBizContent(bizContent);
        InvestmentDepositDpproductqryResponseV1 response;
        try {
