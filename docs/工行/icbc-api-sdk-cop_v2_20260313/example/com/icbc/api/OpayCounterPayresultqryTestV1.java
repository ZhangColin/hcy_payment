...
import com.icbc.api.request.OpayCounterPayresultqryRequestV1;
import com.icbc.api.request.OpayCounterPayresultqryRequestV1.OpayCounterPayresultqryRequestV1Biz;
import com.icbc.api.response.OpayCounterPayresultqryResponseV1;

public class OpayCounterPayresultqryTestV1 {

	// 调用方自己的AppId
	private static final String APP_ID = new String("1000xxxx5545"); //20年1月
	// 调用方私钥
	...
	public static void main(String[] args) {
		...
		OpayCounterPayresultqryRequestV1 request = new OpayCounterPayresultqryRequestV1();
		
		//访问工行API平台URL
		request.setServiceUrl(API_SERVICE_URL + "/opay/counter/payresultqry/V1");

		OpayCounterPayresultqryRequestV1Biz bizContent = new OpayCounterPayresultqryRequestV1Biz();

		//APPID
		bizContent.setMerID("011xx00461");
		bizContent.setAreaCode("01x9");
		bizContent.setOrderId("006201912xxx001255");
		request.setBizContent(bizContent);

		 OpayCounterPayresultqryResponseV1 response;
