...
import com.icbc.api.request.CacaElecreceiptAgreementModifysynRequestV1;
import com.icbc.api.response.CacaElecreceiptAgreementModifysynResponseV1;

import java.util.ArrayList;
import java.util.List;

public class CacaElecreceiptAgreementModifysynTestV1 {
    ...
    public static void main(String[] args) {
        ...
        //5、设置请求对象
        CacaElecreceiptAgreementModifysynRequestV1 request = new CacaElecreceiptAgreementModifysynRequestV1();
        //6、设置请求路径；联测时，请联系我行告知并替换成测试环境地址。
        request.setServiceUrl("\thttp://ip:port/api/caca/elecreceipt/agreement/modifysyn/V1");
        //7、设置业务参数
        CacaElecreceiptAgreementModifysynRequestV1.CacaElecreceiptAgreementModifysynRequestV1ACCLIST acc = new CacaElecreceiptAgreementModifysynRequestV1.CacaElecreceiptAgreementModifysynRequestV1ACCLIST();
        acc.setACCOUNT("");
        acc.setACCNAME("");
        acc.setCURRTYPE("");
        acc.setKZONENO("");
        ...
        acc.setCINO("");
        acc.setACCTYPE("");
        List<CacaElecreceiptAgreementModifysynRequestV1.CacaElecreceiptAgreementModifysynRequestV1ACCLIST> acclist = new ArrayList<>();
        acclist.add(acc);

        CacaElecreceiptAgreementModifysynRequestV1.CacaElecreceiptAgreementModifysynRequestV1Biz bizContent =
                new CacaElecreceiptAgreementModifysynRequestV1.CacaElecreceiptAgreementModifysynRequestV1Biz();
        //8、组装请求参数
        bizContent.setCHANNEL("00004");
        bizContent.setSEQNO("2022-04-14");
        bizContent.setAGREENO("1");
        bizContent.setRECEIPTFLAG("1");
        bizContent.setDZDFLAG("1");
        bizContent.setSENDMODE("1");
        bizContent.setAPPID("00004");
        bizContent.setEMAIL("2022-04-14");
        bizContent.setFHTYPE("1");
        bizContent.setSENDINFO("1");
        bizContent.setRECEIPTFORMAT("1");
        bizContent.setSIGNFLAG("1");
        bizContent.setXMLFLAG("00004");
        bizContent.setACTDATE("2022-04-14");
        bizContent.setMATDATE("1");
        bizContent.setPHONE("1");
        bizContent.setLASTUSERID("1");
        bizContent.setDZDFORM("00004");
        bizContent.setDZDSENDFREQ("2022-04-14");
        bizContent.setACCLIST(acclist);
        request.setBizContent(bizContent);

        CacaElecreceiptAgreementModifysynResponseV1 response;
        try {
            //测试时，避免apip识别成重放，请修改msgId,每次跑，递加1比如
            response = client.execute(request);
            if (response.isSuccess()) {
                // 业务成功处理
                // response.getAppStatV10();
