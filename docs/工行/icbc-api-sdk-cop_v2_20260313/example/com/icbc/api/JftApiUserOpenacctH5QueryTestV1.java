...
import com.icbc.api.request.JftApiUserOpenacctH5QueryRequestV1;
import com.icbc.api.request.JftApiUserOpenacctH5QueryRequestV1.JftApiUserOpenacctH5QueryRequestV1Biz;
import com.icbc.api.response.JftApiUserOpenacctH5QueryResponseV1;
...
public class JftApiUserOpenacctH5QueryTestV1 {
    ...
    public static void main(String[] args) {
        ...
        // 组装调用《聚富通电子钱包账户开立通用页面接口结果查询V1》上送报文
        JftApiUserOpenacctH5QueryRequestV1 request = new JftApiUserOpenacctH5QueryRequestV1();
        request.setServiceUrl("https://ip:port/api/jft/api/user/OpenacctH5/query/V1");

        JftApiUserOpenacctH5QueryRequestV1Biz bizContent = new JftApiUserOpenacctH5QueryRequestV1Biz();
        bizContent.setAppId(APP_ID);
        bizContent.setOutUserId("M201801112326");
        request.setBizContent(bizContent);
        JftApiUserOpenacctH5QueryResponseV1 response;
        try {
