...
import com.icbc.api.request.JftApiPayB2bPayLoanRefundRequestV1;
import com.icbc.api.response.JftApiPayB2bPayLoanRefundResponseV1;

public class JftApiPayB2bPayLoanRefundTestV1 {
    ...
    public static void main(String[] args) {
        ...
        JftApiPayB2bPayLoanRefundRequestV1 request=new JftApiPayB2bPayLoanRefundRequestV1();
        request.setServiceUrl("http://ip:port/api/jft/api/pay/b2bpay/loan/refund/V1");
        JftApiPayB2bPayLoanRefundRequestV1.JftApiPayB2bPayLoanRefundRequestV1Biz bizContent=new JftApiPayB2bPayLoanRefundRequestV1.JftApiPayB2bPayLoanRefundRequestV1Biz();
        ...
        JftApiPayB2bPayLoanRefundResponseV1 response;
        try {
            response =(JftApiPayB2bPayLoanRefundResponseV1) client.execute(request, System.currentTimeMillis()+"");//msgId消息通讯唯一编号，要求每次调用独立生成，APP级唯一
