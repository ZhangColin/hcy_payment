...
import com.icbc.api.request.PartyerDeleteRequestV1;
import com.icbc.api.response.PartyerDeleteResponseV1;

public class EpmOrgPartymemberDeleteTest extends HttpServlet{
	...
	public static void main(String[] args) {
		...
		String url = "http://ip:port/api/epm/org/partymember/delete/V1";
		DefaultIcbcClient client = new DefaultIcbcClient(appId, MY_PRIVATE_KEY, APIGW_PUBLIC_KEY);

		PartyerDeleteRequestV1 request = new PartyerDeleteRequestV1();
		PartyerDeleteRequestV1.PartyerDeleteRequestV1Biz bizContent = new PartyerDeleteRequestV1.PartyerDeleteRequestV1Biz();
		bizContent.setPersonalId("123412312");
		bizContent.setProtocolNo("PT20181213100000108002"); 
 
	  bizContent.setOrgId("100");
		request.setServiceUrl(url);
		request.setBizContent(bizContent);	
		PartyerDeleteResponseV1 resp = new PartyerDeleteResponseV1();
