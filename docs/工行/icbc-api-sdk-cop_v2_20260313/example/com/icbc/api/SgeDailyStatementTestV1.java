...
import com.icbc.api.request.SgeDailyStatementRequestV1;
import com.icbc.api.request.SgeDailyStatementRequestV1.SgeDailyStatementRequestBiz;
import com.icbc.api.response.SgeDailyStatementResponseV1;

public class SgeDailyStatementTestV1 {
	...
	public void test_cop() throws IcbcApiException {
		...
		SgeDailyStatementRequestV1 request = new SgeDailyStatementRequestV1();
		request.setServiceUrl("http://ip:port/api/sge/daily/statement/V1");

		SgeDailyStatementRequestBiz bizContent = new SgeDailyStatementRequestBiz();
		bizContent.setClientId(1311022886);
		bizContent.setTradeDate("2017-01-01");
		request.setBizContent(bizContent);

		SgeDailyStatementResponseV1 response = client.execute(request);
