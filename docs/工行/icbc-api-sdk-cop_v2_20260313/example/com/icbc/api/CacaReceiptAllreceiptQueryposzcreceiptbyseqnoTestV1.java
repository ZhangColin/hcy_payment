...
import com.icbc.api.request.CacaReceiptAllreceiptQueryposzcreceiptbyseqnoRequestV1;
import com.icbc.api.response.CacaReceiptAllreceiptQueryposzcreceiptbyseqnoResponseV1;

import java.util.*;

public class CacaReceiptAllreceiptQueryposzcreceiptbyseqnoTestV1 {
    ...
    public static void main(String[] args) {
        ...
        CacaReceiptAllreceiptQueryposzcreceiptbyseqnoRequestV1 request = new CacaReceiptAllreceiptQueryposzcreceiptbyseqnoRequestV1();
        request.setServiceUrl("https://ip:port/api/caca/receipt/allreceipt/queryposzcreceiptbyseqno/V1");
        CacaReceiptAllreceiptQueryposzcreceiptbyseqnoRequestV1.QPosZCReceiptBySeqnoRequestV1Biz bizContent = new CacaReceiptAllreceiptQueryposzcreceiptbyseqnoRequestV1.QPosZCReceiptBySeqnoRequestV1Biz();

        // public 通讯区定义赋值
        CacaReceiptAllreceiptQueryposzcreceiptbyseqnoRequestV1.QPosZCReceiptBySeqnoRequestV1Pub pubObj = new CacaReceiptAllreceiptQueryposzcreceiptbyseqnoRequestV1.QPosZCReceiptBySeqnoRequestV1Pub();
        pubObj.setCode("29060");
        pubObj.setZone("0200");
        pubObj.setFr("0");
        pubObj.setDt("2017-07-06");
        // private 通讯区定义赋值
        CacaReceiptAllreceiptQueryposzcreceiptbyseqnoRequestV1.QPosZCReceiptBySeqnoRequestV1In inObj = new CacaReceiptAllreceiptQueryposzcreceiptbyseqnoRequestV1.QPosZCReceiptBySeqnoRequestV1In();

        List<CacaReceiptAllreceiptQueryposzcreceiptbyseqnoRequestV1.QPosZCReceiptBySeqnoCondRequestV1In> cond = new ArrayList<CacaReceiptAllreceiptQueryposzcreceiptbyseqnoRequestV1.QPosZCReceiptBySeqnoCondRequestV1In>();
        inObj.setZone("0200");
        inObj.setBrno("");
        inObj.setTelno("");
        inObj.setChannel("");
        inObj.setHuidantype("");
        CacaReceiptAllreceiptQueryposzcreceiptbyseqnoRequestV1.QPosZCReceiptBySeqnoCondRequestV1In qPosZCReceiptBySeqnoCondRequestV1In = new CacaReceiptAllreceiptQueryposzcreceiptbyseqnoRequestV1.QPosZCReceiptBySeqnoCondRequestV1In();
        qPosZCReceiptBySeqnoCondRequestV1In.setAccno("");
        qPosZCReceiptBySeqnoCondRequestV1In.setCurrtype("");
        qPosZCReceiptBySeqnoCondRequestV1In.setSerialno("");
        qPosZCReceiptBySeqnoCondRequestV1In.setSadlindate("");
        cond.add(qPosZCReceiptBySeqnoCondRequestV1In);
        inObj.setCond(cond);
        ...
        try {
            CacaReceiptAllreceiptQueryposzcreceiptbyseqnoResponseV1 response = client.execute(request);
