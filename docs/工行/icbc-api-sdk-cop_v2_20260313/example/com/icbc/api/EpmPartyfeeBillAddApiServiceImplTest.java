...
import com.icbc.api.request.EpmPartyfeeBillAddRequestV1;
import com.icbc.api.response.EpmPartyfeeBillAddResponseV1;

public class EpmPartyfeeBillAddApiServiceImplTest extends HttpServlet {
	...
	public static void main(String[] args) {
		...
		EpmPartyfeeBillAddRequestV1 request = new EpmPartyfeeBillAddRequestV1();		
		request.setServiceUrl("http://ip:port/api/epm/partyfee/bill/add/V1");
		EpmPartyfeeBillAddRequestV1.EpmPartyfeeBillAddRequestV1Biz bizContent = new EpmPartyfeeBillAddRequestV1.EpmPartyfeeBillAddRequestV1Biz();
		request.setBizContent(bizContent);
		bizContent.setProtocolNo("PT20181213100000108002");
		bizContent.setOrgId("100152");
		bizContent.setPersonalID("TESTLDJ001");
		bizContent.setPayDuration("20195");
		bizContent.setAmount("101");
		bizContent.setStartDate("20190401");
		bizContent.setEndDate("20190630");

		EpmPartyfeeBillAddResponseV1 response;
		try {
			response = client.execute(request, "test20171015024");
			// 业务成功处理
